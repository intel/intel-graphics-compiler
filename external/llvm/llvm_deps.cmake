...
string(REGEX MATCH "^[0-9]+" IGC_OPTION__LLVM_PREFERRED_VERSION_MAJOR "${IGC_OPTION__LLVM_PREFERRED_VERSION}")
if(WIN32)
  set(IGC_OPTION__LLVM_WORKSPACE_VERSION ${IGC_OPTION__LLVM_PREFERRED_VERSION})
else()
  set(IGC_OPTION__LLVM_WORKSPACE_VERSION ${IGC_OPTION__LLVM_PREFERRED_VERSION_MAJOR})
endif()
