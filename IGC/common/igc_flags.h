...
DECLARE_IGC_REGKEY(DWORD, ControlInlineTinySizeForSPGT, 400, "Tiny function size for controlling kernel total size", true)
...
DECLARE_IGC_GROUP("Raytracing Options")
    ...
    // with new keys for tile dimension (horizontal, vertical) defined, these 4 legacy keys won't be used
    ...
    // new keys to replace legacy custom tile dimension
    DECLARE_IGC_REGKEY(DWORD, RayTracingHorizontalTileXDim1D, 256, "X dimension of tile (default: 256)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingHorizontalTileYDim1D, 1, "Y dimension of tile (default: 1)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingHorizontalTileXDim2D, 0, "X dimension of tile (default: 32)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingHorizontalTileYDim2D, 0, "Y dimension of tile (default: 4 for XE, 32 for XE2+)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingVerticalTileXDim1D, 1, "X dimension of tile (default: 1)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingVerticalTileYDim1D, 256, "Y dimension of tile (default: 256)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingVerticalTileXDim2D, 0, "X dimension of tile (default: 4 for XE, 32 for XE2+)", true)
    DECLARE_IGC_REGKEY(DWORD, RayTracingVerticalTileYDim2D, 0, "Y dimension of tile (default: 32)", true)
