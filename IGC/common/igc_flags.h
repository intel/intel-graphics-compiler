...
DECLARE_IGC_REGKEY(DWORD, ControlInlineTinySizeForSizeContribution, 1000, "Tiny function size for controlling kernel total size", true)
DECLARE_IGC_REGKEY(DWORD, ControlInlineSizeContribution, 1000, "The size contribution of a function for controlling kernel total size", true)
