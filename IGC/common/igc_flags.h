...
DECLARE_IGC_REGKEY(bool, NewSpillCostFunction,          false, "Use new spill cost function in VISA RA", true)
...
DECLARE_IGC_REGKEY(bool, EnableZEBinary, true,  "Enable output in ZE binary format", true)
