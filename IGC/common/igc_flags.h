...
DECLARE_IGC_REGKEY(bool, LoopSinkEnable2dBlockReads,    false, "Allow sinking of the 2d block reads", false)
DECLARE_IGC_REGKEY(bool, LoopSinkEnableVectorShuffle,   false, "Allow sinking of the lowered vector shuffle pattern", false)
