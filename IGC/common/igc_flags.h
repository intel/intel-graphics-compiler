...
DECLARE_IGC_REGKEY(DWORD, CSSIMD8_SpillThreshold,       1,     "Percentage of instructions allowed for spilling on CS SIMD8", false)
...
DECLARE_IGC_REGKEY(bool, EnableTestVecCopy,             false, "Test uniform vector copy that starts from simd32, to be deleted once test is done[temp]", true)
