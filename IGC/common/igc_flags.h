...
DECLARE_IGC_REGKEY(bool, EnableLeafCollapsing,          true, "Collapse leaf functions in order to avoid trimming small leaf functions", true)
DECLARE_IGC_REGKEY(bool, UseFrequencyInfoForSPGT,       true, "Consider frequency information for trimming functions", true)
DECLARE_IGC_REGKEY(bool, EnableSizeContributionOptimization, true, "Put more weight on a function when the potential size contirubion is big", true)
