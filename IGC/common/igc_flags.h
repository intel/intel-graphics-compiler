...
DECLARE_IGC_REGKEY(DWORD, VISALTO,                         63, "vISA LTO optimization flags. check LINKER_TYPE for more details", false)
...
DECLARE_IGC_REGKEY(bool, EnableGatherWithImmPostRA,           false,  "enable gather send with immediate", true)
...
DECLARE_IGC_REGKEY(bool, EnableDebugging,                           true, " Enable shader debugging for release internal", false)
...
DECLARE_IGC_REGKEY(DWORD, MetricForKernelSizeReduction,  0, "Set 1 to active a normal distribution, 2 a long-tail distribution, and 4 an average%", true)
DECLARE_IGC_REGKEY(bool,  BlockFrequencySampling,       false, "Use block frequencies to derive a distribution", true)
DECLARE_IGC_REGKEY(DWORD, ParameterForColdFuncThreshold,        30, "C/10-STD for a normal distribution / low K% for a long-tail distribution", true)
