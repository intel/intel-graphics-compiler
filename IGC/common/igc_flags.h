...
DECLARE_IGC_REGKEY(bool, RematLog, false, "Enable clone adress arithmetic pass not only on retry", false)
DECLARE_IGC_REGKEY(bool, RematMoveAddrSpaceCast, true, "Move addrspace cast instructions closer to user", false)
...
DECLARE_IGC_REGKEY(bool, RematCallsOperand, false, "Allow rematerialization of inttoptr that are used inside AddrSpaceCastInst", false)
DECLARE_IGC_REGKEY(bool, RematAllowOneUseLoad, false, "Allow rematerialization of inttoptr that are used inside AddrSpaceCastInst", false)
DECLARE_IGC_REGKEY(bool, RematAllowLoads, false, "Allow rematerialization of inttoptr that are used inside AddrSpaceCastInst", false)
