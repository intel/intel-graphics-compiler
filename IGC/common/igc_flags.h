...
DECLARE_IGC_REGKEY(DWORD, OptInstNumThresholdLow,                   0,     "The kernel G4 instruction number, low bound", false)
DECLARE_IGC_REGKEY(DWORD, OptInstNumThresholdHigh,                   0,     "The kernel G4 instruction number, high bound", false)
DECLARE_IGC_REGKEY(DWORD, ACCPreSchedThresholdPerc,                   0,     "Threshold percentage for ACC pre RA scheduling", false)
...
DECLARE_IGC_REGKEY(DWORD, PixelSampleHoistingLimit,     0,     "A sub-option of AdvMemOpt: hoist sample instruction in pixel shader", false)
...
DECLARE_IGC_REGKEY(DWORD, FunctionCloningThreshold,     0,
    ...
    "Setting this to '0' allows IGC to choose the default value.", true)
...
DECLARE_IGC_REGKEY(DWORD, SubroutineThreshold,          85000, "Minimal kernel size to enable subroutines", false)
