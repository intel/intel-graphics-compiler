...
DECLARE_IGC_REGKEY(DWORD, SkipPaddingScratchSpaceSize,  0,     "Skip adding padding when estimated scratch space size is smaller than or equal to this value", false)
