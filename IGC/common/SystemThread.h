...
namespace SIP
{
    enum SIP_ID {
        ...
        XE2_CSR_DEBUG_BINDLESS_BMG_config4,
        XE2_CSR_DEBUG_BINDLESS_BMG_config5,
        GEN_SIP_MAX_INDEX
    };
    ...
    enum WMTP_DATA_SIZE
    {
        ...
        XE2_CSR_DEBUG_BINDLESS_BMG_config4_WMTP_DATA_SIZE = 50339968,
        XE2_CSR_DEBUG_BINDLESS_BMG_config5_WMTP_DATA_SIZE = 51396736,
    };
