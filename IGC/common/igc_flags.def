...
DECLARE_IGC_REGKEY(bool, DisablePrintfOnZEBinary, false,  "Disable printf support for ZEBinary. Fall back to legacy format if there's printf in the shader", true)
