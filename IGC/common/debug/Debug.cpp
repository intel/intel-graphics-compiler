...
namespace {
class DebugOutputStream : public raw_ostream {
public:
  DebugOutputStream() : raw_ostream(true /* unbuffered */) {}

  ~DebugOutputStream() { flush(); }

  bool has_colors() { return false; }

  bool is_displayed() { return true; }

  virtual uint64_t current_pos() const { return 0; }

  size_t preferred_buffer_size() const { return 0; }
...
int getPointerSize(llvm::Module &M) { return M.getDataLayout().getPointerSize(); }
