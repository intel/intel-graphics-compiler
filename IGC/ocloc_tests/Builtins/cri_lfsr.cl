                      ...
                      global uchar4  *in_uchar4,  global uchar4  *out_uchar4)
{
    ...
    // CHECK-DAG: lfsr.b32 (M1_NM, 1) [[DstInt:[A-z0-9_]*]](0,0)<1> [[SrcInt:[A-z0-9_]*]](0,0)<1;1,0> [[SrcInt]](0,1)<1;1,0>
    ...
    // CHECK-DAG: lfsr.b16v2 (M1_NM, 1) [[DstShort:[A-z0-9_]*]](0,0)<1> [[Src0Short:[A-z0-9_]*]](0,0)<1;1,0> [[Src0Short]](0,1)<1;1,0>
