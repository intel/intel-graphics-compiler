...
// produces a code sequence with sr0 and msg0 concatenation.
...
// CHECK-VISA: and (M1_NM, 1) {{(HWTID|V[0-9]+)}}(0,0)<1> %msg0(0,0)<0;1,0> 0xff:ud
// CHECK-VISA: and (M1_NM, 1) {{(SR_0_6|V[0-9]+)}}(0,0)<1> %sr0(0,0)<0;1,0> 0x7f:ud
// CHECK-VISA: shl (M1_NM, 1) {{(HWTID|V[0-9]+)}}(0,0)<1> {{(HWTID|V[0-9]+)}}(0,0)<0;1,0> 0x7:{{.?}}d
// CHECK-VISA: or (M1_NM, 1) {{(HWTID|V[0-9]+)}}(0,0)<1> {{(HWTID|V[0-9]+)}}(0,0)<0;1,0> {{(SR_0_6|V[0-9]+)}}(0,0)<0;1,0>
