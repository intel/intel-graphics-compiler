...
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_1r32x1c -DVALUE_TYPE=ushort -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_2r32x1c -DVALUE_TYPE=ushort2 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_4r32x1c -DVALUE_TYPE=ushort4 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_8r32x1c -DVALUE_TYPE=ushort8 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_16b_1r16x1c -DVALUE_TYPE=ushort -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_16b_2r16x1c -DVALUE_TYPE=ushort2 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_16b_4r16x1c -DVALUE_TYPE=ushort4 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_16b_8r16x1c -DVALUE_TYPE=ushort8 -DSCALAR_TYPE=ushort" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_1r16x1c -DVALUE_TYPE=uchar -DSCALAR_TYPE=uchar" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_2r16x1c -DVALUE_TYPE=uchar2 -DSCALAR_TYPE=uchar" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_4r16x1c -DVALUE_TYPE=uchar4 -DSCALAR_TYPE=uchar" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_8b_8r16x1c -DVALUE_TYPE=uchar8 -DSCALAR_TYPE=uchar" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_32b_1r16x1c -DVALUE_TYPE=uint -DSCALAR_TYPE=uint" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_32b_2r16x1c -DVALUE_TYPE=uint2 -DSCALAR_TYPE=uint" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_32b_4r16x1c -DVALUE_TYPE=uint4 -DSCALAR_TYPE=uint" \
...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'DumpVISAASMToConsole=1' \
// RUN: -DFUNCTION=intel_sub_group_2d_block_write_32b_8r16x1c -DVALUE_TYPE=uint8 -DSCALAR_TYPE=uint" \
...
kernel void test_uc_uc(global VALUE_TYPE* output, VALUE_TYPE value, const global int2* coord) {
  FUNCTION(output, 512, 46, 512, *coord, (private SCALAR_TYPE *)&value);
}
