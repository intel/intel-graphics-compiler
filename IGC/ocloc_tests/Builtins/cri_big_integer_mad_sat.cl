...
__kernel void sample_test(__global LONG_TYPE *sourceA, __global LONG_TYPE *sourceB, __global LONG_TYPE *sourceC, __global LONG_TYPE *destValues)
{
    int  tid = get_global_id(0);
    LONG_TYPE sA = sourceA[ tid ];
    LONG_TYPE sB = sourceB[ tid ];
    LONG_TYPE sC = sourceC[ tid ];
    LONG_TYPE dst = mad_sat( sA, sB, sC );
    destValues[ tid ] = dst;
}
