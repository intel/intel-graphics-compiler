...
// CHECK-LLVM22: %[[CLAMP_MIN:.+]] = call half @llvm.maxnum.f16(half %[[FP_SRC]], half {{0xHD800|-1\.280000e\+02}})
// CHECK-LLVM22: %[[CLAMP_MAX:.+]] = call half @llvm.minnum.f16(half %[[CLAMP_MIN]], half {{0xH57F0|1\.270000e\+02}})
// CHECK-LLVM22: %[[CLAMP_NAN:.+]] = select i1 %[[NAN_CMP]], half %[[CLAMP_MAX]], half {{0xH0000|0\.000000e\+00}}
...
// CHECK-LLVM22: %[[CLAMP_MIN:.+]] = call half @llvm.maxnum.f16(half %[[FP_SRC]], half {{0xH0000|0\.000000e\+00}})
// CHECK-LLVM22: %[[CLAMP_MAX:.+]] = call half @llvm.minnum.f16(half %[[CLAMP_MIN]], half {{0xH5BF8|2\.550000e\+02}})
// CHECK-LLVM22: %[[CLAMP_NAN:.+]] = select i1 %[[NAN_CMP]], half %[[CLAMP_MAX]], half {{0xH0000|0\.000000e\+00}}
...
// CHECK-LLVM22: %[[CLAMP_MIN:.+]] = call half @llvm.maxnum.f16(half %[[FP_SRC]], half {{0xHF800|-3\.276800e\+04}})
// CHECK-LLVM22: %[[CLAMP_NAN:.+]] = select i1 %[[NAN_CMP]], half %[[CLAMP_MIN]], half {{0xH0000|0\.000000e\+00}}
// CHECK-LLVM22-DAG: %[[CONV:.+]] = fptosi half %[[CLAMP_NAN]] to i16
// CHECK-LLVM22-DAG: %[[INT_MAX_CMP:.+]] = fcmp oge half %[[CLAMP_NAN]], {{0xH7800|3\.276800e\+04}}
...
// CHECK: %[[POS_INF_CMP:.+]] = fcmp oeq half %[[FP_SRC]], {{0xH7C00|\+inf}}
...
//
// CHECK-DAG: %[[NEG_INF_CMP:.+]] = fcmp oeq half %[[FP_SRC]], {{0xHFC00|-inf}}
// CHECK-DAG: %[[CLAMP_MIN:.+]] = select i1 %[[NEG_INF_CMP]], i32 -2147483648, i32 %[[CLAMP_NAN]]
// CHECK-DAG: %[[POS_INF_CMP:.+]] = fcmp oeq half %[[FP_SRC]], {{0xH7C00|\+inf}}
...
// CHECK-LLVM22: %[[CLAMP_MIN:.+]] = call float @llvm.maxnum.f32(float %[[FP_SRC]], float {{0xC1E0000000000000|f0xCF000000}})
// CHECK-LLVM22: %[[CLAMP_MAX:.+]] = call float @llvm.minnum.f32(float %[[CLAMP_MIN]], float {{0x41E0000000000000|f0x4F000000}})
// CHECK-LLVM22: %[[CLAMP_NAN:.+]] = select i1 %[[NAN_CMP]], float %[[CLAMP_MAX]], float 0.000000e+00
...
// CHECK-LLVM22: %[[CLAMP_MIN:.+]] = call float @llvm.maxnum.f32(float %[[FP_SRC]], float 0.000000e+00)
// CHECK-LLVM22: %[[CLAMP_MAX:.+]] = call float @llvm.minnum.f32(float %[[CLAMP_MIN]], float {{0x41F0000000000000|f0x4F800000}})
// CHECK-LLVM22: %[[CLAMP_NAN:.+]] = select i1 %[[NAN_CMP]], float %[[CLAMP_MAX]], float 0.000000e+00
