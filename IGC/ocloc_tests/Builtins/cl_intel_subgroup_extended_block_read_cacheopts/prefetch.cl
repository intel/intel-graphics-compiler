...
// RUN: -DINPUT_TYPE=ushort -DOUTPUT_TYPE=ushort2 -DFUNCTION=intel_subgroup_block_prefetch_u8_m1k32v2 -DINPUT_WIDTH=512 -DINPUT_HEIGHT=46 -DPITCH=512 \
...
test(global INPUT_TYPE *input, const global int2 *coord,
  ...
  FUNCTION(input, INPUT_WIDTH, INPUT_HEIGHT, PITCH, *coord, CACHE_CONTROL);
}
