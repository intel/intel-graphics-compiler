...
// RUN: ocloc compile -file %s -device pvc -options "-igc_opts 'EnablePromoteToPredicatedMemoryAccess=1 PrintToConsole=1 PrintAfter=Layout'" 2>&1 | FileCheck %s
...
// CHECK: call <2 x i32> @llvm.genx.GenISA.PredicatedLoad.v2i32.p1v2i32.v2i32(<2 x i32> addrspace(1)* {{%.*}}, i64 8, i1 {{%.*}}, <2 x i32> [[BC1]])
...
// CHECK: call <2 x i32> @llvm.genx.GenISA.PredicatedLoad.v2i32.p1v2i32.v2i32(<2 x i32> addrspace(1)* {{%.*}}, i64 8, i1 {{%.*}}, <2 x i32> [[BC2]])
...
// CHECK: call <2 x i32> @llvm.genx.GenISA.PredicatedLoad.v2i32.p1v2i32.v2i32(<2 x i32> addrspace(1)* {{%.*}}, i64 8, i1 {{%.*}}, <2 x i32> [[BC3]])
