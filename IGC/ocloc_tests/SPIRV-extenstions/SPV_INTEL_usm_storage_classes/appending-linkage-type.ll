...
; RUN: llvm-spirv %t.bc -opaque-pointers=1 --spirv-ext=+SPV_INTEL_vector_compute,+SPV_INTEL_usm_storage_classes -o %t.spv
...
; RUN: llvm-spirv %t.bc -opaque-pointers=0 --spirv-ext=+SPV_INTEL_vector_compute,+SPV_INTEL_usm_storage_classes -o %t.spv
