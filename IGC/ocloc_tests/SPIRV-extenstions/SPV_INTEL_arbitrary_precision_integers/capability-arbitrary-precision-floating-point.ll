...
;           A, MA, Mout, Subnorm, RndMode, RndTmp);
; }
;
...
;           A, Mout, FromSign, Subnorm, RndMode, RndTmp);
; }
;
...
;           A, MA, ToSign, Subnorm, RndMode, RndTmp);
; }
;
...
;           A1, MA, B1, MB, Mout, Subnorm, RndMode, RndTmp);
;   ap_int<1+Eout+Mout> add_res_2 =
;       __spirv_ArbitraryFloatAddINTEL<1+EA+MA, 1+EB+MB, 1+Eout+Mout>(
;           A2, MA, B2, MB, Mout, Subnorm, RndMode, RndTmp);
; }
;
; template <int EA, int MA, int EB, int MB, int Eout, int Mout>
; void ap_float_sub() {
...
;           A, MA, B, MB, Mout, Subnorm, RndMode, RndTmp);
; }
;
; template <int EA, int MA, int EB, int MB, int Eout, int Mout>
; void ap_float_mul() {
...
;           A, MA, B, SignOfB, Mout, Subnorm, RndMode, RndTmp);
; }
;
