...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDF16b(bfloat %inputVal)
...
declare dso_local spir_func i4 @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDF16b(bfloat)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <2 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv2_DF16b(<2 x bfloat> %inputVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv2_DF16b(<2 x bfloat>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <3 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv3_DF16b(<3 x bfloat> %inputVal)
...
declare dso_local spir_func <3 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv3_DF16b(<3 x bfloat>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <4 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv4_DF16b(<4 x bfloat> %inputVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv4_DF16b(<4 x bfloat>)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %conv = call <8 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv8_DF16b(<8 x bfloat> %inputVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv8_DF16b(<8 x bfloat>)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %conv = call <16 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv16_DF16b(<16 x bfloat> %inputVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z38__builtin_spirv_ConvertBF16ToInt4INTELDv16_DF16b(<16 x bfloat>)
