...
; CHECK-LABEL: .kernel "Test_ConvertFP16ToE4M3"
...
declare spir_func signext i8 @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDh(half)
define spir_kernel void @Test_ConvertFP16ToE4M3(half addrspace(1)* %inbuf, i8 addrspace(1)* %outbuf) {
entry:
  ...
  %call1 = call spir_func signext i8 @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDh(half %loaded)
  %arrayidx3 = getelementptr inbounds i8, i8 addrspace(1)* %outbuf, i64 %call
  store i8 %call1, i8 addrspace(1)* %arrayidx3, align 1
  ret void
}

; CHECK-LABEL: .kernel "Test2_ConvertFP16ToE4M3"
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
...
declare spir_func <2 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv2_Dh(<2 x half>)
define spir_kernel void @Test2_ConvertFP16ToE4M3(<2 x half> addrspace(1)* %inbuf, <2 x i8> addrspace(1)* %outbuf) {
entry:
  %call = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  ...
  %call1 = call spir_func <2 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv2_Dh(<2 x half> %loaded)
...
; CHECK-LABEL: .kernel "Test3_ConvertFP16ToE4M3"
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](0,32)<1> [[IN]](1,0)<1;1,0>
...
declare spir_func <3 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv3_Dh(<3 x half>)
define spir_kernel void @Test3_ConvertFP16ToE4M3(<3 x half> addrspace(1)* %inbuf, <3 x i8> addrspace(1)* %outbuf) {
entry:
  %call = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  ...
  %call1 = call spir_func <3 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv3_Dh(<3 x half> %inputLoaded)
...
; CHECK-LABEL: .kernel "Test4_ConvertFP16ToE4M3"
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](0,32)<1> [[IN]](1,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](1,0)<1> [[IN]](2,0)<1;1,0>
...
declare spir_func <4 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv4_Dh(<4 x half>)
define spir_kernel void @Test4_ConvertFP16ToE4M3(<4 x half> addrspace(1)* %inbuf, <4 x i8> addrspace(1)* %outbuf) {
entry:
  %call = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  ...
  %call1 = call spir_func <4 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv4_Dh(<4 x half> %loaded)
...
; CHECK-LABEL: .kernel "Test8_ConvertFP16ToE4M3"
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](0,32)<1> [[IN]](1,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](1,0)<1> [[IN]](2,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](1,32)<1> [[IN]](3,0)<1;1,0>
...
declare spir_func <8 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv8_Dh(<8 x half>)
define spir_kernel void @Test8_ConvertFP16ToE4M3(<8 x half> addrspace(1)* %inbuf, <8 x i8> addrspace(1)* %outbuf) {
entry:
  %call = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  ...
  %call1 = call spir_func <8 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv8_Dh(<8 x half> %loaded)
...
; CHECK-LABEL: .kernel "Test16_ConvertFP16ToE4M3"
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](0,32)<1> [[IN]](1,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](1,0)<1> [[IN]](2,0)<1;1,0>
; CHECK-DAG: fcvt (M1_NM, 32) [[OUT]](1,32)<1> [[IN]](3,0)<1;1,0>
...
declare spir_func <16 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv16_Dh(<16 x half>)
define spir_kernel void @Test16_ConvertFP16ToE4M3(<16 x half> addrspace(1)* %inbuf, <16 x i8> addrspace(1)* %outbuf) {
entry:
  %call = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  ...
  %call1 = call spir_func <16 x i8> @_Z38__builtin_spirv_ConvertFP16ToE4M3INTELDv16_Dh(<16 x half> %loaded)
