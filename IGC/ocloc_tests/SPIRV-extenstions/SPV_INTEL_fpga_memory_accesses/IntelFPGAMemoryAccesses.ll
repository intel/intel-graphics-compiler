...
; CHECK-LLVM: [[PARAM_0_CACHE_127:@[a-z0-9_.]+]] = {{.*}}{params:0}{cache-size:127}
...
; CHECK-LLVM: %[[STRUCT_FUNC_PARAM:[[:alnum:].]+]] = alloca %struct._ZTS5State.State addrspace(4)*, align 8
...
; CHECK-LLVM: %[[STRUCT_VAR:[[:alnum:].]+]] = alloca %struct._ZTS5State.State addrspace(4)*, align 8
...
; CHECK-LLVM: %[[FLOAT_BITCAST:[[:alnum:].]+]] = bitcast float addrspace(4)** %[[FLOAT_VAR]] to i8*
  %0 = bitcast float addrspace(4)** %x to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #5
; CHECK-LLVM: %[[INT_BITCAST:[[:alnum:].]+]] = bitcast i32 addrspace(4)** %[[INT_VAR]] to i8*
  %1 = bitcast i32 addrspace(4)** %y to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #5
; CHECK-LLVM: %[[STRUCT_BITCAST:[[:alnum:].]+]] = bitcast %struct._ZTS5State.State addrspace(4)** %[[STRUCT_VAR]] to i8*
...
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call float addrspace(4)* @llvm.ptr.annotation.p4f32(float addrspace(4)* %[[FLOAT_FUNC_PARAM_LOAD]], i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[PARAM_3_CACHE_0]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
...
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call i32 addrspace(4)* @llvm.ptr.annotation.p4i32(i32 addrspace(4)* %[[INT_FUNC_PARAM_LOAD]], i8* getelementptr inbounds ([12 x i8], [12 x i8]* [[PARAM_12_CACHE_0]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
...
; CHECK-LLVM: %[[WHOLE_STRUCT_LOAD:[0-9]+]] = [[WHOLE_STRUCT_LOAD_INST:load\ %struct._ZTS5State.State.*]][[STRUCT_FUNC_PARAM]]
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call %struct._ZTS5State.State addrspace(4)* @llvm.ptr.annotation.p4s_struct._ZTS5State.States(%struct._ZTS5State.State addrspace(4)* %[[WHOLE_STRUCT_LOAD]], i8* getelementptr inbounds ([27 x i8], [27 x i8]* [[PARAM_2_CACHE_127]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
; CHECK-LLVM: store %struct._ZTS5State.State addrspace(4)* %[[INTRINSIC_CALL]], %struct._ZTS5State.State addrspace(4)** %[[STRUCT_VAR]]
...
; CHECK-LLVM: %[[FLOAT_FIELD_GEP:[[:alnum:].]+]] = getelementptr inbounds %struct._ZTS5State.State, %struct._ZTS5State.State addrspace(4)* %[[WHOLE_STRUCT_LOAD_FOR_FLOAT]], i32 0, i32 0
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call float addrspace(4)* @llvm.ptr.annotation.p4f32(float addrspace(4)* %[[FLOAT_FIELD_GEP]], i8* getelementptr inbounds ([27 x i8], [27 x i8]* [[PARAM_3_CACHE_127]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
; CHECK-LLVM: store float addrspace(4)* %[[INTRINSIC_CALL]], float addrspace(4)** %[[FLOAT_VAR]]
...
; CHECK-LLVM: %[[INT_FIELD_GEP:[[:alnum:].]+]] = getelementptr inbounds %struct._ZTS5State.State, %struct._ZTS5State.State addrspace(4)* %[[WHOLE_STRUCT_LOAD_FOR_INT]], i32 0, i32 1
...
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call %struct._ZTS5State.State addrspace(4)* @llvm.ptr.annotation.p4s_struct._ZTS5State.States(%struct._ZTS5State.State addrspace(4)* %[[WHOLE_STRUCT_LOAD]], i8* getelementptr inbounds ([28 x i8], [28 x i8]* [[PARAM_15_CACHE_127]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
; CHECK-LLVM: store %struct._ZTS5State.State addrspace(4)* %[[INTRINSIC_CALL]], %struct._ZTS5State.State addrspace(4)** %[[STRUCT_VAR]]
...
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call double addrspace(4)* @llvm.ptr.annotation.p4f64(double addrspace(4)* %24, i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[PARAM_3_CACHE_0]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
...
; CHECK-LLVM: %[[INTRINSIC_CALL:[[:alnum:].]+]] = call i32 addrspace(4)* @llvm.ptr.annotation.p4i32(i32 addrspace(4)* %[[INT1_FUNC_PARAM_LOAD]], i8* getelementptr inbounds ([12 x i8], [12 x i8]* [[PARAM_12_CACHE_0]], i32 0, i32 0), i8* {{.*}}, i32 {{.*}}, i8* {{.*}})
