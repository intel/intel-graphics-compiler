...
entry:
  ...
  ; CHECK-LLVM-DAG: %{{[0-9]+}} = call i8* @llvm.ptr.annotation.p0i8(i8* {{[%a-z0-9]+}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @[[STR8]]
  ; CHECK-LLVM-DAG: %[[CAST1:[%0-9A-Za-z._]+]] = bitcast %struct._ZTS2st.st* %agg-temp to i8*
  ...
  ; CHECK-LLVM-DAG: %{{[0-9]+}} = call i8* @llvm.ptr.annotation.p0i8(i8* {{[%a-z0-9]+}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @[[STR9]]
  ; CHECK-LLVM-DAG: %[[CAST2:[%0-9A-Za-z._]+]] = bitcast %struct._ZTS2st.st* %agg-temp2 to i8*
  ...
  ; CHECK-LLVM-DAG: %{{[0-9]+}} = call i8* @llvm.ptr.annotation.p0i8(i8* {{[%a-z0-9]+}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @[[STR11]]
  ; CHECK-LLVM-DAG: %[[CAST4:[%0-9A-Za-z._]+]] = bitcast %union._ZTS2un.un* %agg-temp4 to i8*
  ...
  ; CHECK-LLVM-DAG: %{{[0-9]+}} = call i8* @llvm.ptr.annotation.p0i8(i8* {{[%a-z0-9]+}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @[[STR13]]
  ; CHECK-LLVM-DAG: %[[CAST5:[%0-9A-Za-z._]+]] = bitcast %class._ZTS1A.A* %agg-temp5 to i8*
