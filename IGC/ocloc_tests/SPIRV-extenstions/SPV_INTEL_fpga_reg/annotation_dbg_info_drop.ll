...
; CHECK-LLVM: [[STR0:@.*]] = private unnamed_addr constant [25 x i8] c"{memory:DEFAULT}{pump:1}\00", align 1
; CHECK-LLVM: [[STR1:@.*]] = private unnamed_addr constant [29 x i8] c"{memory:DEFAULT}{numbanks:2}\00", align 1
; CHECK-LLVM: [[STR2:@.*]] = private unnamed_addr constant [25 x i8] c"__builtin_intel_fpga_reg\00", align 1
; CHECK-LLVM: [[STR3:@.*]] = private unnamed_addr constant [25 x i8] c"__builtin_intel_fpga_reg\00", align 1
; CHECK-LLVM: [[STR4:@.*]] = private unnamed_addr constant [25 x i8] c"__builtin_intel_fpga_reg\00", align 1

; CHECK-LLVM: call void @llvm.var.annotation(i8* %{{.*}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[STR0]], i32 0, i32 0), i8* undef, i32 undef, i8* undef)
; CHECK-LLVM: call i8* @llvm.ptr.annotation.p0i8(i8* %{{.*}}, i8* getelementptr inbounds ([29 x i8], [29 x i8]* [[STR1]], i32 0, i32 0), i8* undef, i32 undef, i8* undef)
; CHECK-LLVM: call i32 @llvm.annotation.i32(i32 %{{.*}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[STR2]], i32 0, i32 0), i8* undef, i32 undef)
; CHECK-LLVM: call i64 @llvm.annotation.i64(i64 %{{.*}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[STR3]], i32 0, i32 0), i8* undef, i32 undef)
; CHECK-LLVM: call i8* @llvm.ptr.annotation.p0i8(i8* %{{.*}}, i8* getelementptr inbounds ([25 x i8], [25 x i8]* [[STR4]], i32 0, i32 0), i8* undef, i32 undef, i8* undef)
...
!1 = !DIFile(filename: "annotation_dbg_info_drop.cpp", directory: "/test")
