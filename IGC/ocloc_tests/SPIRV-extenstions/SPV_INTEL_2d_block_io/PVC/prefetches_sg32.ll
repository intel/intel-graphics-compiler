...
; Test for 2D block prefetch for subgroup-size=32. Compared to subgroup-size=16 (test prefetches.ll), VISA ASM is exactly the same.
...
; OpSubgroup2DBlockPrefetchINTEL Element size: 2, Block Width: 8, Block Height: 1, 2, 4, 8, 16, Block Count: 1
; CHECK: lsc_load_block2d.ugm.ca.ca (M1, 1)  %null:d16.8x1nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
...
; CHECK: lsc_load_block2d.ugm.ca.ca (M1, 1)  %null:d16.8x2nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
...
; CHECK: lsc_load_block2d.ugm.ca.ca (M1, 1)  %null:d16.8x4nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
...
; CHECK: lsc_load_block2d.ugm.ca.ca (M1, 1)  %null:d16.8x16nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
