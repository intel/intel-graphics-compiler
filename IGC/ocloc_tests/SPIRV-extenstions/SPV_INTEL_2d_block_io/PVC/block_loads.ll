...
; OpSubgroup2DBlockLoadINTEL, Element size: 1, Block Width: 16, Block Height: 8, 16, 32, Block Count: 4
...
; CHECK: lsc_load_block2d.ugm (M1, 1)  V{{[0-9]+}}:d8.2x32x1nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
...
; CHECK: lsc_load_block2d.ugm (M1, 1)  V{{[0-9]+}}:d16.2x16x1nn  flat[{{.+}},0x1FF,0x2D,0x1FF,V{{[0-9]+}},V{{[0-9]+}}
...
; OpSubgroup2DBlockLoadTransposeINTEL Element size: 4, Block Width: 8, Block Height: 16, 32, Block Count: 1
