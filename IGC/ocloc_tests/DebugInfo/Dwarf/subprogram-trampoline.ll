...
; REQUIRES: regkeys, oneapi-readelf, llvm-17-plus, dg2-supported
...
; CHECK:      DW_AT_name        : func_.t75p.t76p
; CHECK:      DW_AT_trampoline  : func_{{$}}

define spir_func void @"func_.t75p.t76p"() #0 !dbg !5 {
  ret void, !dbg !7
}

define spir_kernel void @foo() !dbg !6 {
  call spir_func void @"func_.t75p.t76p"(), !dbg !8
  ret void
}
...
!1 = !DIFile(filename: "test", directory: "trampoline")
!2 = !{i32 2, !"Dwarf Version", i32 4}
!3 = !{i32 2, !"Debug Info Version", i32 3}
!4 = !DISubroutineType(types: !{})
!5 = distinct !DISubprogram(name: "func_.t75p.t76p", file: !1, type: !4, spFlags: DISPFlagDefinition, unit: !0, targetFuncName: "func_")
