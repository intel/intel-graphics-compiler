...
; CHECK:         call void @llvm.genx.GenISA.LSCPrefetch.p1i32(i32 addrspace(1)* %{{[0-9]+}}, i32 0, i32 3, i32 1, i32 3)
  %i = call spir_func i64 @_Z12get_local_idj(i32 0)
...
; CHECK:         call void @llvm.genx.GenISA.LSCPrefetch.p1i32(i32 addrspace(1)* %{{[0-9]+}}, i32 0, i32 3, i32 1, i32 4)
  %i = call spir_func i64 @_Z12get_local_idj(i32 0)
...
; CHECK:         call void @llvm.genx.GenISA.LSCPrefetch.p1i32(i32 addrspace(1)* %{{[0-9]+}}, i32 0, i32 3, i32 1, i32 25)
  %i = call spir_func i64 @_Z12get_local_idj(i32 0)
