...
declare spir_func void @_Z51intel_sub_group_2d_block_read_transpose_32b_16r8x1cPU3AS1viiiDv2_iPj(i8 addrspace(1)*, i32, i32, i32, <2 x i32>, i32*)

; CHECK: .kernel "test_uncached_uncached"

define spir_kernel void @test_uncached_uncached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
; CHECK: lsc_load_block2d.ugm.uc.uc (M1, 1)  V{{[0-9]+}}:d32.8x16tn  flat[{{.*}},0x1FF,0x2D,0x1FF,{{.*}},{{.*}}]
  call spir_func void @_Z51intel_sub_group_2d_block_read_transpose_32b_16r8x1cPU3AS1viiiDv2_iPj(i8 addrspace(1)* %decorated_ptr, i32 512, i32 46, i32 512, <2 x i32> %coord, i32* %dst)

  %value = load i32, i32* %dst, align 2
  %gid = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  %out_ptr = getelementptr inbounds i32, i32 addrspace(1)* %output, i64 %gid
  store i32 %value, i32 addrspace(1)* %out_ptr, align 4
  ret void
}
...
define spir_kernel void @test_uncached_cached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_cached_uncached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_cached_cached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_streaming_uncached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_streaming_cached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_iar_cached(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
...
define spir_kernel void @test_unsupported_cache_controls_config(i8 addrspace(1)* %input, <2 x i32> %coord, i32 addrspace(1)* %output) !intel_reqd_sub_group_size !24 {
entry:
  %alloca = alloca [8 x i32], align 2
  %dst = getelementptr inbounds [8 x i32], [8 x i32]* %alloca, i64 0, i64 0
