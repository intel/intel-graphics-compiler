...
; RUN: ocloc compile -llvm_input -file %t.bc -options "-igc_opts 'DisableInlining=1, EnableDropTargetFunctions=1, VerboseDropTargetFunctions=1, CrashOnDroppedFnAccess=1, DropTargetFnListPath=%t.dir, PrintToConsole=1, PrintBefore=EmitPass'" -device pvc > %t.output 2>&1
