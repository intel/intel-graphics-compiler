...
// CHECK: [[MB_DATA_PTR:%[0-9]+]] = bitcast [500 x i8] addrspace(3)* [[MB_DATA_SLM]] to i8 addrspace(3)*

//// Get pointer to the ManageableBarriers ID Pool
// CHECK: [[BarrierIDPool_GetIntPtr_MB_DATA:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_PTR]] to i32
// CHECK: [[BarrierIDPool_GetIntPtr_Offset:%[0-9]+]] = add i32 [[BarrierIDPool_GetIntPtr_MB_DATA]], 496
// CHECK: [[BarrierIDPool_Ptr:%[0-9]+]] = inttoptr i32 [[BarrierIDPool_GetIntPtr_Offset]] to i32 addrspace(3)*

//// Fill the ManageableBarriers ID Pool with init-value
// CHECK: store i32 -2, i32 addrspace(3)* [[BarrierIDPool_Ptr]], align 4
...
// CHECK: [[BarrierIDPool_Load:%[0-9]+]] = load i32, i32 addrspace(3)* [[BarrierIDPool_Ptr]], align 4
...
// CHECK: [[MB_DATA_GetIntPTR:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_PTR]] to i32
...
// CHECK: [[MB_DATA_OFFSET_PTR:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_IntPTR]] to i8 addrspace(3)*
...
// CHECK: [[BarrierIDPool_Load2:%[0-9]+]] = load i32, i32 addrspace(3)* [[BarrierIDPool_Ptr]], align 4
// CHECK: [[BarrierIDPool_UpdateBits:%[0-9]+]] = and i32 [[FreeID_InBitNeg]], [[BarrierIDPool_Load2]]
// CHECK: store i32 [[BarrierIDPool_UpdateBits]], i32 addrspace(3)* [[BarrierIDPool_Ptr]], align 4
...
// CHECK: [[MB_DATA_OFFSET_ID_GetIntPTR:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_ID_GetIntOffsetPTR:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_ID_GetIntPTR]], 0
// CHECK: [[MB_DATA_OFFSET_ID_PTR8:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_ID_GetIntOffsetPTR]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_ID_PTR32:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_ID_PTR8]] to i32 addrspace(3)*
// CHECK: store i32 [[BarrierIDPool_FirstFreeID]], i32 addrspace(3)* [[MB_DATA_OFFSET_ID_PTR32]], align 4

//// Fill the producer count in the ManageableBarriers Data ProducerCount offset
// CHECK: [[MB_DATA_OFFSET_PrdCnt_GetIntPTR:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_PrdCnt_GetIntOffsetPTR:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_PrdCnt_GetIntPTR]], 4
// CHECK: [[MB_DATA_OFFSET_PrdCnt_PTR8:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_PrdCnt_GetIntOffsetPTR]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PrdCnt_PTR32:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_PrdCnt_PTR8]] to i32 addrspace(3)*
// CHECK: store i32 8, i32 addrspace(3)* [[MB_DATA_OFFSET_PrdCnt_PTR32]], align 4

//// Fill the consumer count in the ManageableBarriers Data ConsumerCount offset
// CHECK: [[MB_DATA_OFFSET_CnsCnt_GetIntPTR:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_CnsCnt_GetIntOffsetPTR:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_CnsCnt_GetIntPTR]], 8
// CHECK: [[MB_DATA_OFFSET_CnsCnt_PTR8:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_CnsCnt_GetIntOffsetPTR]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_CnsCnt_PTR32:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_CnsCnt_PTR8]] to i32 addrspace(3)*
// CHECK: store i32 8, i32 addrspace(3)* [[MB_DATA_OFFSET_CnsCnt_PTR32]], align 4

//// Fill the expected arrvial count in the ManageableBarriers Data ExpectedArrvial offset
// CHECK: [[MB_DATA_OFFSET_ExpArv_GetIntPTR:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_ExpArv_GetIntOffsetPTR:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_ExpArv_GetIntPTR]], 12
// CHECK: [[MB_DATA_OFFSET_ExpArv_PTR8:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_ExpArv_GetIntOffsetPTR]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_ExpArv_PTR32:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_ExpArv_PTR8]] to i32 addrspace(3)*
// CHECK: store i32 8, i32 addrspace(3)* [[MB_DATA_OFFSET_ExpArv_PTR32]], align 4
...
// CHECK: [[MB_DATA_OFFSET_GetIntPTR_Arrive:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_GetIntOffsetPTR_Arrive:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_GetIntPTR_Arrive]], 0
// CHECK: [[MB_DATA_OFFSET_PTR8_Arrive:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_GetIntOffsetPTR_Arrive]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PTR32_Arrive:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_PTR8_Arrive]] to i32 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PTR32v4_Arrive:%[0-9]+]] = bitcast i32 addrspace(3)* [[MB_DATA_OFFSET_PTR32_Arrive]] to [4 x i32] addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_Arrive_Int32v4:%[0-9]+]] = load [4 x i32], [4 x i32] addrspace(3)* [[MB_DATA_OFFSET_PTR32v4_Arrive]], align 4
...
/// Get the data for this barrier
// CHECK: [[MB_DATA_OFFSET_GetIntPTR_Wait:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_GetIntOffsetPTR_Wait:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_GetIntPTR_Wait]], 0
// CHECK: [[MB_DATA_OFFSET_PTR8_Wait:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_GetIntOffsetPTR_Wait]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PTR32_Wait:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_PTR8_Wait]] to i32 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PTR32v4_Wait:%[0-9]+]] = bitcast i32 addrspace(3)* [[MB_DATA_OFFSET_PTR32_Wait]] to [4 x i32] addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_Wait_Int32v4:%[0-9]+]] = load [4 x i32], [4 x i32] addrspace(3)* [[MB_DATA_OFFSET_PTR32v4_Wait]], align 4
...
//// Get the producer count in the ManageableBarriers Data ProducerCount offset
// CHECK: [[MB_DATA_OFFSET_PrdCnt_GetIntPTR_Wait2:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_PrdCnt_GetIntOffsetPTR_Wait2:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_PrdCnt_GetIntPTR_Wait2]], 4
// CHECK: [[MB_DATA_OFFSET_PrdCnt_PTR8_Wait2:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_PrdCnt_GetIntOffsetPTR_Wait2]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_PrdCnt_PTR32_Wait2:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_PrdCnt_PTR8_Wait2]] to i32 addrspace(3)*

//// Store the ExpectedArrvial value under ProducerCount pointer
// CHECK: store i32 [[MB_DATA_OFFSET_ExpArv_Wait_Int32]], i32 addrspace(3)* [[MB_DATA_OFFSET_PrdCnt_PTR32_Wait2]], align 4

//////////////////////////////////////////////
//// ManageableBarriersReleaseINTEL resolution
//// Get the FreeID in the ManageableBarriers Data ID offset
// CHECK: [[MB_DATA_OFFSET_ID_GetIntPTR_Release:%[0-9]+]] = ptrtoint i8 addrspace(3)* [[MB_DATA_OFFSET_PTR]] to i32
// CHECK: [[MB_DATA_OFFSET_ID_GetIntOffsetPTR_Release:%[0-9]+]] = add i32 [[MB_DATA_OFFSET_ID_GetIntPTR_Release]], 0
// CHECK: [[MB_DATA_OFFSET_ID_PTR8_Release:%[0-9]+]] = inttoptr i32 [[MB_DATA_OFFSET_ID_GetIntOffsetPTR_Release]] to i8 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_ID_PTR32_Release:%[0-9]+]] = bitcast i8 addrspace(3)* [[MB_DATA_OFFSET_ID_PTR8_Release]] to i32 addrspace(3)*
// CHECK: [[MB_DATA_OFFSET_ID_Release_Int32:%[0-9]+]] = load i32, i32 addrspace(3)* [[MB_DATA_OFFSET_ID_PTR32_Release]], align 4

// CHECK: [[FreeID_InBit2:%[0-9]+]] = shl i32 1, [[MB_DATA_OFFSET_ID_Release_Int32]]

//// Xor the FreeID on bits with the BarrierIDPool
// CHECK: call i32 @llvm.genx.GenISA.intatomicrawsinglelane.i32.p3i32.i32(i32 addrspace(3)* [[BarrierIDPool_Ptr]], i32 [[BarrierIDPool_GetIntPtr_Offset]], i32 [[FreeID_InBit2]], i32 9)
