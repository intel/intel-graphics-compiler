...
// Tests the intel_reqd_sub_group_size(16) gate path for EnableOCLRetry512GRF.
//
// 24 independent chains of int8 multiply-add drive sufficient live-range
// pressure so that the first-attempt at 256 GRF spills and the retry fires.
// On retry EnableOCLRetry512GRF=1 promotes the ceiling to 512 GRF.
