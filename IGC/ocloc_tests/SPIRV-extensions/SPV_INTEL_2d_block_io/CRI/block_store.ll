...
entry:
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v1i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 32, i32 1, i32 1, i1 false, i1 false, i32 0, <1 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v1i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 64, i32 1, i32 1, i1 false, i1 false, i32 0, <1 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 16, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 32, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 64, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 8, i32 4, i32 1, i1 false, i1 false, i32 0, <2 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 16, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 32, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 64, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 4, i32 8, i32 1, i1 false, i1 false, i32 0, <2 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 8, i32 8, i32 1, i1 false, i1 false, i32 0, <4 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i8(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i8> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 32, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 8, i32 64, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v1i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 32, i32 1, i32 1, i1 false, i1 false, i32 0, <1 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 16, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 32, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 8, i32 4, i32 1, i1 false, i1 false, i32 0, <2 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 16, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 32, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 4, i32 8, i32 1, i1 false, i1 false, i32 0, <2 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 8, i32 8, i32 1, i1 false, i1 false, i32 0, <4 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i16(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i16> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 16, i32 32, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 16, i32 2, i32 1, i1 false, i1 false, i32 0, <2 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 8, i32 4, i32 1, i1 false, i1 false, i32 0, <2 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 16, i32 4, i32 1, i1 false, i1 false, i32 0, <4 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 4, i32 8, i32 1, i1 false, i1 false, i32 0, <2 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 8, i32 8, i32 1, i1 false, i1 false, i32 0, <4 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i32(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 32, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0, <8 x i32> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i64(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 64, i32 8, i32 4, i32 1, i1 false, i1 false, i32 0, <2 x i64> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v2i64(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 64, i32 4, i32 8, i32 1, i1 false, i1 false, i32 0, <2 x i64> %{{.*}})
  ...
  ; CHECK-GENISA:  call void @llvm.genx.GenISA.LSC2DBlockWrite.v4i64(i64 %{{[0-9]+}}, i32 511, i32 45, i32 511, i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i32 64, i32 8, i32 8, i32 1, i1 false, i1 false, i32 0, <4 x i64> %{{.*}})
