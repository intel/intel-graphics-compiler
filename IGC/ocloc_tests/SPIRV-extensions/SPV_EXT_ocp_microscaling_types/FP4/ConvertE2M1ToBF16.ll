...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %3 = call bfloat @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTi(i4 %2)
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %1 = load <2 x i4>, <2 x i4> addrspace(1)* %inputAddr, align 1
  %2 = call <2 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv2_i(<2 x i4> %1)
  store <2 x bfloat> %2, <2 x bfloat> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <2 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv2_i(<2 x i4>)
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %3 = call <3 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv3_i(<3 x i4> %2)
  store <3 x bfloat> %3, <3 x bfloat> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <3 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv3_i(<3 x i4>)
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %1 = load <4 x i4>, <4 x i4> addrspace(1)* %inputAddr, align 2
  %2 = call <4 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv4_i(<4 x i4> %1)
  store <4 x bfloat> %2, <4 x bfloat> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <4 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv4_i(<4 x i4>)
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %2 = call <8 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv8_i(<8 x i4> %1)
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=ub num_elts=128
  ...
  %2 = call <16 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv16_i(<16 x i4> %1)
  store <16 x bfloat> %2, <16 x bfloat> addrspace(1)* %outputAddr, align 32
  ret void
}
declare dso_local spir_func <16 x bfloat> @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTDv16_i(<16 x i4>)
