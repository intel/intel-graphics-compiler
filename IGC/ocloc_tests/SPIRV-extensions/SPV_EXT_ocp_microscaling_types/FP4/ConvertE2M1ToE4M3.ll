...
; RUN: llvm-spirv %t.bc -o %t.spv --spirv-ext=+SPV_EXT_float8,+SPV_EXT_ocp_microscaling_types,+SPV_INTEL_int4
...
define spir_kernel void @E2M1_to_E4M3_scalar(<2 x i4> addrspace(1)* %input, i8 addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_scalar"
; CHECK: mov ({{.*}}, 1) [[LUT:[A-z0-9.]*]](0,0)<1> 0x3030303000000000:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,1)<1> 0x3c3c3c3c38383838:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,2)<1> 0x4444444440404040:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,3)<1> 0x4c4c4c4c48484848:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,4)<1> 0xb0b0b0b080808080:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,5)<1> 0xbcbcbcbcb8b8b8b8:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,6)<1> 0xc4c4c4c4c0c0c0c0:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,7)<1> 0xccccccccc8c8c8c8:q
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %3 = call i8 @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTi(i4 %2)
  store i8 %3, i8 addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func i8 @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTi(i4)

define spir_kernel void @E2M1_to_E4M3_vector2(<2 x i4> addrspace(1)* %input, <2 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_vector2"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %1 = load <2 x i4>, <2 x i4> addrspace(1)* %inputAddr, align 1
  %2 = call <2 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv2_i(<2 x i4> %1)
  store <2 x i8> %2, <2 x i8> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <2 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv2_i(<2 x i4>)

define spir_kernel void @E2M1_to_E4M3_vector3(<4 x i4> addrspace(1)* %input, <3 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_vector3"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %3 = call <3 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv3_i(<3 x i4> %2)
  store <3 x i8> %3, <3 x i8> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <3 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv3_i(<3 x i4>)

define spir_kernel void @E2M1_to_E4M3_vector4(<4 x i4> addrspace(1)* %input, <4 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_vector4"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %1 = load <4 x i4>, <4 x i4> addrspace(1)* %inputAddr, align 2
  %2 = call <4 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv4_i(<4 x i4> %1)
  store <4 x i8> %2, <4 x i8> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <4 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv4_i(<4 x i4>)

define spir_kernel void @E2M1_to_E4M3_vector8(<8 x i4> addrspace(1)* %input, <8 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_vector8"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %2 = call <8 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv8_i(<8 x i4> %1)
...
define spir_kernel void @E2M1_to_E4M3_vector16(<16 x i4> addrspace(1)* %input, <16 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E4M3_vector16"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %2 = call <16 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv16_i(<16 x i4> %1)
  store <16 x i8> %2, <16 x i8> addrspace(1)* %outputAddr, align 16
  ret void
}
declare dso_local spir_func <16 x i8> @_Z36__builtin_spirv_ConvertE2M1ToE4M3EXTDv16_i(<16 x i4>)
