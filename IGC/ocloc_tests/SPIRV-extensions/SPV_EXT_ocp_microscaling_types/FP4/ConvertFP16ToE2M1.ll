...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDh(half %inputVal)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <2 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv2_Dh(<2 x half> %inputVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv2_Dh(<2 x half>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <3 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv3_Dh(<3 x half> %inputVal)
...
declare dso_local spir_func <3 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv3_Dh(<3 x half>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <4 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv4_Dh(<4 x half> %inputVal)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %conv = call <8 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv8_Dh(<8 x half> %inputVal)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %conv = call <16 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv16_Dh(<16 x half> %inputVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv16_Dh(<16 x half>)
