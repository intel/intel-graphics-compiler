...
; CHECK-FP16DN-DAG: // .decl [[DST]] v_type=G type=ud num_elts=1
  ...
  %conv = call <4 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv4_Dh(<4 x half> <half 0xH3800, half 0xH3C00, half 0xH3E00, half 0xH4133>)
  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z36__builtin_spirv_ConvertFP16ToE2M1EXTDv4_Dh(<4 x half>)
...
; CHECK-BF16DN-DAG: // .decl [[DST]] v_type=G type=ud num_elts=1
  %gid = call spir_func i64 @_Z33__spirv_BuiltInGlobalInvocationIdi(i32 0)
  %outputAddr = getelementptr <4 x i4>, <4 x i4> addrspace(1)* %output, i64 %gid
  %conv = call <4 x i4> @_Z36__builtin_spirv_ConvertBF16ToE2M1EXTDv4_DF16b(<4 x bfloat> <bfloat 0xR3F00, bfloat 0xR3F80, bfloat 0xR4000, bfloat 0xR4040>)
  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
...
; CHECK-E2M1HF: shfl_idx4
  ...
  %conv = call half @_Z36__builtin_spirv_ConvertE2M1ToFP16EXTi(i4 3)
...
; CHECK-E2M1BF: shfl_idx4
  ...
  %conv = call bfloat @_Z36__builtin_spirv_ConvertE2M1ToBF16EXTi(i4 3)
