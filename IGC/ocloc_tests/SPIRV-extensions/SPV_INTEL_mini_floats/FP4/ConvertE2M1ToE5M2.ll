...
; RUN: llvm-spirv %t.bc -o %t.spv --spirv-ext=+SPV_EXT_float8,+SPV_INTEL_float4,+SPV_INTEL_int4
...
define spir_kernel void @E2M1_to_E5M2_scalar(<2 x i4> addrspace(1)* %input, i8 addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_scalar"
; CHECK: mov ({{.*}}, 1) [[LUT:[A-z0-9.]*]](0,0)<1> 0x3838383800000000:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,1)<1> 0x3e3e3e3e3c3c3c3c:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,2)<1> 0x4242424240404040:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,3)<1> 0x4646464644444444:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,4)<1> 0xb8b8b8b880808080:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,5)<1> 0xbebebebebcbcbcbc:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,6)<1> 0xc2c2c2c2c0c0c0c0:q
; CHECK: mov ({{.*}}, 1) [[LUT]](0,7)<1> 0xc6c6c6c6c4c4c4c4:q
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %3 = call i8 @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELi(i4 %2)
...
define spir_kernel void @E2M1_to_E5M2_vector2(<2 x i4> addrspace(1)* %input, <2 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_vector2"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %1 = load <2 x i4>, <2 x i4> addrspace(1)* %inputAddr, align 1
  %2 = call <2 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv2_i(<2 x i4> %1)
  store <2 x i8> %2, <2 x i8> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <2 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv2_i(<2 x i4>)

define spir_kernel void @E2M1_to_E5M2_vector3(<4 x i4> addrspace(1)* %input, <3 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_vector3"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %3 = call <3 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv3_i(<3 x i4> %2)
  store <3 x i8> %3, <3 x i8> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <3 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv3_i(<3 x i4>)

define spir_kernel void @E2M1_to_E5M2_vector4(<4 x i4> addrspace(1)* %input, <4 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_vector4"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK-NOT: shfl_idx4
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[LUT_SRC]] v_type=G type=ud num_elts=16
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %1 = load <4 x i4>, <4 x i4> addrspace(1)* %inputAddr, align 2
  %2 = call <4 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv4_i(<4 x i4> %1)
  store <4 x i8> %2, <4 x i8> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <4 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv4_i(<4 x i4>)

define spir_kernel void @E2M1_to_E5M2_vector8(<8 x i4> addrspace(1)* %input, <8 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_vector8"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %2 = call <8 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv8_i(<8 x i4> %1)
...
define spir_kernel void @E2M1_to_E5M2_vector16(<16 x i4> addrspace(1)* %input, <16 x i8> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "E2M1_to_E5M2_vector16"
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST:[A-z0-9]*]].0 [[LUT_SRC:[A-z0-9]*]](0,0)<0;16,1> [[INPUT:[A-z0-9]*]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
; CHECK: shfl_idx4 ({{.*}}, 32) [[DST]].0 [[LUT_SRC]](0,0)<0;16,1> [[INPUT]](0,0)<2;1,0>
...
; CHECK-DAG: // .decl [[INPUT]] v_type=G type=uw num_elts=64
  ...
  %2 = call <16 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv16_i(<16 x i4> %1)
  store <16 x i8> %2, <16 x i8> addrspace(1)* %outputAddr, align 16
  ret void
}
declare dso_local spir_func <16 x i8> @_Z38__builtin_spirv_ConvertE2M1ToE5M2INTELDv16_i(<16 x i4>)
