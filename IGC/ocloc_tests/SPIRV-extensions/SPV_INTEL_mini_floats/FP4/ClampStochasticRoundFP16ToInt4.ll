...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDhi(half %inputVal, i32 %seedVal)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv2_Dhi(<2 x half> %inputVal, i32 %seedVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv2_Dhi(<2 x half>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv3_Dhi(<3 x half> %inputVal, i32 %seedVal)
...
declare dso_local spir_func <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv3_Dhi(<3 x half>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv4_Dhi(<4 x half> %inputVal, i32 %seedVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv4_Dhi(<4 x half>, i32)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv8_Dhi(<8 x half> %inputVal, i32 %seedVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv8_Dhi(<8 x half>, i32)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <16 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv16_Dhi(<16 x half> %inputVal, i32 %seedVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv16_Dhi(<16 x half>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load half, half addrspace(1)* %inputAddr, align 2
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call i4 @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDhiPi(half %inputVal, i32 %seedVal, i32* %seedMem)
  %v1 = insertelement <2 x i4> undef, i4 %conv, i32 0
  %v2 = insertelement <2 x i4> %v1, i4 0, i32 1
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <2 x half>, <2 x half> addrspace(1)* %inputAddr, align 4
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv2_DhiPi(<2 x half> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv2_DhiPi(<2 x half>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <3 x half>, <3 x half> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv3_DhiPi(<3 x half> %inputVal, i32 %seedVal, i32* %seedMem)
  %conv4 = shufflevector <3 x i4> %conv, <3 x i4> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
...
declare dso_local spir_func <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv3_DhiPi(<3 x half>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <4 x half>, <4 x half> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv4_DhiPi(<4 x half> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv4_DhiPi(<4 x half>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <8 x half>, <8 x half> addrspace(1)* %inputAddr, align 16
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv8_DhiPi(<8 x half> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv8_DhiPi(<8 x half>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <16 x half>, <16 x half> addrspace(1)* %inputAddr, align 32
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <16 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv16_DhiPi(<16 x half> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <16 x i4> @_Z51__builtin_spirv_ClampStochasticRoundFP16ToInt4INTELDv16_DhiPi(<16 x half>, i32, i32*)
