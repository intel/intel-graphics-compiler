...
define spir_kernel void @BF16_to_Int4_scalar(bfloat addrspace(1)* %input, <2 x i4> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "BF16_to_Int4_scalar"
; CHECK-DAG: dnscl.bftoint4.mode0.rne (M1, 32) [[DST:[A-z0-9]*]].0 [[INPUT0:[A-z0-9]*]].0 [[INPUT1:[A-z0-9]*]].0 %null.0
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDF16b(bfloat %inputVal)
...
define spir_kernel void @BF16_to_Int4_vector2(<2 x bfloat> addrspace(1)* %input, <2 x i4> addrspace(1)* %output) {
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <2 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv2_DF16b(<2 x bfloat> %inputVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv2_DF16b(<2 x bfloat>)

define spir_kernel void @BF16_to_Int4_vector3(<3 x bfloat> addrspace(1)* %input, <4 x i4> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "BF16_to_Int4_vector3"
; CHECK: dnscl.bftoint4.mode0.rne (M1, 32) [[DST:[A-z0-9]*]].0 [[INPUT0:[A-z0-9]*]].0 [[INPUT1:[A-z0-9]*]].0 %null.0
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <3 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv3_DF16b(<3 x bfloat> %inputVal)
...
declare dso_local spir_func <3 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv3_DF16b(<3 x bfloat>)

define spir_kernel void @BF16_to_Int4_vector4(<4 x bfloat> addrspace(1)* %input, <4 x i4> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "BF16_to_Int4_vector4"
; CHECK: dnscl.bftoint4.mode0.rne (M1, 32) [[DST:[A-z0-9]*]].0 [[INPUT:[A-z0-9]*]].0 [[INPUT]].128 %null.0
; CHECK-NOT: dnscl.bftoint4
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <4 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv4_DF16b(<4 x bfloat> %inputVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv4_DF16b(<4 x bfloat>)

define spir_kernel void @BF16_to_Int4_vector8(<8 x bfloat> addrspace(1)* %input, <8 x i4> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "BF16_to_Int4_vector8"
; CHECK: dnscl.bftoint4.mode0.rne (M1, 32) [[DST0:[A-z0-9]*]].0 [[INPUT:[A-z0-9]*]].0 [[INPUT]].256 %null.0
; CHECK: dnscl.bftoint4.mode2.rne (M1, 32) [[DST1:[A-z0-9]*]].0 [[INPUT]].128 [[INPUT]].384 %null.0
; CHECK-NOT: dnscl.bftoint4
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %conv = call <8 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv8_DF16b(<8 x bfloat> %inputVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv8_DF16b(<8 x bfloat>)

define spir_kernel void @BF16_to_Int4_vector16(<16 x bfloat> addrspace(1)* %input, <16 x i4> addrspace(1)* %output) {
; CHECK-LABEL: .kernel "BF16_to_Int4_vector16"
; CHECK: dnscl.bftoint4.mode0.rne (M1, 32) [[DST0:[A-z0-9]*]].0 [[INPUT:[A-z0-9]*]].0 [[INPUT]].256 %null.0
; CHECK: dnscl.bftoint4.mode2.rne (M1, 32) [[DST1:[A-z0-9]*]].0 [[INPUT]].128 [[INPUT]].384 %null.0
; CHECK: dnscl.bftoint4.mode0.rne (M1, 32) [[DST2:[A-z0-9]*]].0 [[INPUT]].512 [[INPUT]].768 %null.0
; CHECK: dnscl.bftoint4.mode2.rne (M1, 32) [[DST3:[A-z0-9]*]].0 [[INPUT]].640 [[INPUT]].896 %null.0
; CHECK-NOT: dnscl.bftoint4
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %conv = call <16 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv16_DF16b(<16 x bfloat> %inputVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z43__builtin_spirv_ClampConvertBF16ToInt4INTELDv16_DF16b(<16 x bfloat>)
