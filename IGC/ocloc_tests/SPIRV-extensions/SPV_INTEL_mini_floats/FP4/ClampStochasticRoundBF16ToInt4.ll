...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDF16bi(bfloat %inputVal, i32 %seedVal)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv2_DF16bi(<2 x bfloat> %inputVal, i32 %seedVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv2_DF16bi(<2 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv3_DF16bi(<3 x bfloat> %inputVal, i32 %seedVal)
...
declare dso_local spir_func <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv3_DF16bi(<3 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv4_DF16bi(<4 x bfloat> %inputVal, i32 %seedVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv4_DF16bi(<4 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv8_DF16bi(<8 x bfloat> %inputVal, i32 %seedVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv8_DF16bi(<8 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load bfloat, bfloat addrspace(1)* %inputAddr, align 2
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call i4 @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDF16biPi(bfloat %inputVal, i32 %seedVal, i32* %seedMem)
  %v1 = insertelement <2 x i4> undef, i4 %conv, i32 0
  %v2 = insertelement <2 x i4> %v1, i4 0, i32 1
...
declare dso_local spir_func i4 @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDF16biPi(bfloat, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <2 x bfloat>, <2 x bfloat> addrspace(1)* %inputAddr, align 4
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv2_DF16biPi(<2 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <2 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv2_DF16biPi(<2 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <3 x bfloat>, <3 x bfloat> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv3_DF16biPi(<3 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
  %conv4 = shufflevector <3 x i4> %conv, <3 x i4> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
...
declare dso_local spir_func <3 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv3_DF16biPi(<3 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <4 x bfloat>, <4 x bfloat> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv4_DF16biPi(<4 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <4 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv4_DF16biPi(<4 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <8 x bfloat>, <8 x bfloat> addrspace(1)* %inputAddr, align 16
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv8_DF16biPi(<8 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <8 x i4> @_Z51__builtin_spirv_ClampStochasticRoundBF16ToInt4INTELDv8_DF16biPi(<8 x bfloat>, i32, i32*)
