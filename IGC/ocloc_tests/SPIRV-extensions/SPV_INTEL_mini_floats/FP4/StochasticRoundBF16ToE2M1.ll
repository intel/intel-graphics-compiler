...
; RUN: llvm-spirv %t.bc -o %t.spv --spirv-ext=+SPV_INTEL_float4,+SPV_KHR_bfloat16,+SPV_INTEL_int4,+SPV_INTEL_fp_conversions,+SPV_EXT_ocp_microscaling_types
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDF16bi(bfloat %inputVal, i32 %seedVal)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv2_DF16bi(<2 x bfloat> %inputVal, i32 %seedVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv2_DF16bi(<2 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv3_DF16bi(<3 x bfloat> %inputVal, i32 %seedVal)
...
declare dso_local spir_func <3 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv3_DF16bi(<3 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv4_DF16bi(<4 x bfloat> %inputVal, i32 %seedVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv4_DF16bi(<4 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv8_DF16bi(<8 x bfloat> %inputVal, i32 %seedVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv8_DF16bi(<8 x bfloat>, i32)
...
; CHECK: dnscl.bftoe2m1.mode2.srnd (M1, 32) [[DST3:[A-z0-9]*]].0 [[INPUT]].640 [[INPUT]].896 [[RAND3]].0
; CHECK-NOT: dnscl.bftoe2m1
; CHECK-DAG: // .decl [[RAND0]] v_type=G type=ud num_elts=32
; CHECK-DAG: // .decl [[RAND1]] v_type=G type=ud num_elts=32
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <16 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv16_DF16bi(<16 x bfloat> %inputVal, i32 %seedVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv16_DF16bi(<16 x bfloat>, i32)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load bfloat, bfloat addrspace(1)* %inputAddr, align 2
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call i4 @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDF16biPi(bfloat %inputVal, i32 %seedVal, i32* %seedMem)
  %v1 = insertelement <2 x i4> undef, i4 %conv, i32 0
  %v2 = insertelement <2 x i4> %v1, i4 0, i32 1
...
declare dso_local spir_func i4 @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDF16biPi(bfloat, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <2 x bfloat>, <2 x bfloat> addrspace(1)* %inputAddr, align 4
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <2 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv2_DF16biPi(<2 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <2 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv2_DF16biPi(<2 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <3 x bfloat>, <3 x bfloat> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <3 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv3_DF16biPi(<3 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
  %conv4 = shufflevector <3 x i4> %conv, <3 x i4> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
...
declare dso_local spir_func <3 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv3_DF16biPi(<3 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <4 x bfloat>, <4 x bfloat> addrspace(1)* %inputAddr, align 8
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <4 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv4_DF16biPi(<4 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <4 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv4_DF16biPi(<4 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <8 x bfloat>, <8 x bfloat> addrspace(1)* %inputAddr, align 16
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <8 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv8_DF16biPi(<8 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <8 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv8_DF16biPi(<8 x bfloat>, i32, i32*)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %inputVal = load <16 x bfloat>, <16 x bfloat> addrspace(1)* %inputAddr, align 32
  %seedVal = load i32, i32 addrspace(1)* %seedAddr, align 4
  %conv = call <16 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv16_DF16biPi(<16 x bfloat> %inputVal, i32 %seedVal, i32* %seedMem)
...
declare dso_local spir_func <16 x i4> @_Z46__builtin_spirv_StochasticRoundBF16ToE2M1INTELDv16_DF16biPi(<16 x bfloat>, i32, i32*)
