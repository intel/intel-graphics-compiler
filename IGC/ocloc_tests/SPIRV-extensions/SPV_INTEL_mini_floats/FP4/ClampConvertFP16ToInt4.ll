...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call i4 @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDh(half %inputVal)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <2 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv2_Dh(<2 x half> %inputVal)

  store <2 x i4> %conv, <2 x i4> addrspace(1)* %outputAddr, align 1
  ret void
}
declare dso_local spir_func <2 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv2_Dh(<2 x half>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <3 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv3_Dh(<3 x half> %inputVal)
...
declare dso_local spir_func <3 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv3_Dh(<3 x half>)
...
; CHECK-DAG: // .decl [[DST]] v_type=G type=ud num_elts=32
  ...
  %conv = call <4 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv4_Dh(<4 x half> %inputVal)

  store <4 x i4> %conv, <4 x i4> addrspace(1)* %outputAddr, align 2
  ret void
}
declare dso_local spir_func <4 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv4_Dh(<4 x half>)
...
; CHECK-DAG: // .decl [[DST1]] v_type=G type=ud num_elts=32
  ...
  %conv = call <8 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv8_Dh(<8 x half> %inputVal)

  store <8 x i4> %conv, <8 x i4> addrspace(1)* %outputAddr, align 4
  ret void
}
declare dso_local spir_func <8 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv8_Dh(<8 x half>)
...
; CHECK-DAG: // .decl [[DST3]] v_type=G type=ud num_elts=32
  ...
  %conv = call <16 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv16_Dh(<16 x half> %inputVal)

  store <16 x i4> %conv, <16 x i4> addrspace(1)* %outputAddr, align 8
  ret void
}
declare dso_local spir_func <16 x i4> @_Z43__builtin_spirv_ClampConvertFP16ToInt4INTELDv16_Dh(<16 x half>)
