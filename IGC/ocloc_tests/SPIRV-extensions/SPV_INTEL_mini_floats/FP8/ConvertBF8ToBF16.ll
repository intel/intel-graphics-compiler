...
; CHECK-DAG: mov (M1, 32) [[OUT_HF:bf8_cvt[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
; CHECK-DAG: mov (M1, 32) [[OUT_F:[A-z0-9]*]](0,0)<1> [[OUT_HF]](0,0)<1;1,0>
; CHECK-DAG: mov (M1, 32) [[OUT_BF:[A-z0-9]*]](0,0)<1> [[OUT_F]](0,0)<1;1,0>
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=32
...
declare spir_func bfloat @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTc(i8 signext)
...
entry:
  ...
  %call1 = call spir_func bfloat @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTc(i8 signext %loaded)
...
;
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=64
...
;
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=96
...
declare spir_func <3 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv3_c(<3 x i8>)
...
entry:
  ...
  %call1 = call spir_func <3 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv3_c(<3 x i8> %inputLoaded)
...
;
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=128
...
declare spir_func <4 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv4_c(<4 x i8>)
...
entry:
  ...
  %call1 = call spir_func <4 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv4_c(<4 x i8> %loaded)
...
;
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=256
...
declare spir_func <8 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv8_c(<8 x i8>)
...
entry:
  ...
  %call1 = call spir_func <8 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv8_c(<8 x i8> %loaded)
...
;
; CHECK-DAG: .decl [[IN]] v_type=G type=bf8 num_elts=512
...
declare spir_func <16 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv16_c(<16 x i8>)
...
entry:
  ...
  %call1 = call spir_func <16 x bfloat> @_Z36__builtin_spirv_ConvertE5M2ToBF16EXTDv16_c(<16 x i8> %loaded)
