...
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2:[A-z0-9]*]](0,0)<1> [[OUT_HF]](0,0)<1;1,0>
; CHECK-DAG: .decl [[IN]] v_type=G type=bf num_elts=32
; CHECK-DAG: .decl [[OUT_HF]] v_type=G type=hf num_elts=32
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=32
...
;
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2:[A-z0-9]*]](0,0)<1> [[OUT_VEC_HF]](0,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](0,32)<1> [[OUT_VEC_HF]](1,0)<1;1,0>
;
...
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=64
...
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2:[A-z0-9]*]](0,0)<1> [[OUT_VEC_HF]](0,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](0,32)<1> [[OUT_VEC_HF]](1,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](1,0)<1> [[OUT_VEC_HF]](2,0)<1;1,0>
;
...
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=96
...
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](0,32)<1> [[OUT_VEC_HF]](1,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](1,0)<1> [[OUT_VEC_HF]](2,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](1,32)<1> [[OUT_VEC_HF]](3,0)<1;1,0>
;
...
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=128
...
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](1,0)<1> [[OUT_VEC_HF]](2,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](1,32)<1> [[OUT_VEC_HF]](3,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](2,0)<1> [[OUT_VEC_HF]](4,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](2,32)<1> [[OUT_VEC_HF]](5,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](3,0)<1> [[OUT_VEC_HF]](6,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](3,32)<1> [[OUT_VEC_HF]](7,0)<1;1,0>
;
...
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=256
...
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](3,0)<1> [[OUT_VEC_HF]](6,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](3,32)<1> [[OUT_VEC_HF]](7,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](4,0)<1> [[OUT_VEC_HF]](8,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](4,32)<1> [[OUT_VEC_HF]](9,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](5,0)<1> [[OUT_VEC_HF]](10,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](5,32)<1> [[OUT_VEC_HF]](11,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](6,0)<1> [[OUT_VEC_HF]](12,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](6,32)<1> [[OUT_VEC_HF]](13,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](7,0)<1> [[OUT_VEC_HF]](14,0)<1;1,0>
; CHECK-DAG: fcvt.sat (M1_NM, 32) [[OUT_E5M2]](7,32)<1> [[OUT_VEC_HF]](15,0)<1;1,0>
;
...
; CHECK-DAG: .decl [[OUT_E5M2]] v_type=G type=ub num_elts=512
