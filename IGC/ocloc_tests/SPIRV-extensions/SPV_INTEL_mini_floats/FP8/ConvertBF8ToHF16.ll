...
; CHECK-DAG: mov (M1, 32) [[OUT:bf8_cvt[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
...
entry:
  ...
  %call1 = call spir_func half @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTc(i8 signext %loaded)
...
declare spir_func <2 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv2_c(<2 x i8>)
...
entry:
  ...
  %call1 = call spir_func <2 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv2_c(<2 x i8> %loaded)
...
declare spir_func <3 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv3_c(<3 x i8>)
...
entry:
  ...
  %call1 = call spir_func <3 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv3_c(<3 x i8> %inputLoaded)
...
declare spir_func <4 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv4_c(<4 x i8>)
...
entry:
  ...
  %call1 = call spir_func <4 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv4_c(<4 x i8> %loaded)
...
declare spir_func <8 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv8_c(<8 x i8>)
...
entry:
  ...
  %call1 = call spir_func <8 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv8_c(<8 x i8> %loaded)
...
declare spir_func <16 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv16_c(<16 x i8>)
...
entry:
  ...
  %call1 = call spir_func <16 x half> @_Z36__builtin_spirv_ConvertE5M2ToFP16EXTDv16_c(<16 x i8> %loaded)
