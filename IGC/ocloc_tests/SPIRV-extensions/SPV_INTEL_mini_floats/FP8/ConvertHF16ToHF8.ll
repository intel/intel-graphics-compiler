...
; CHECK-DAG: mov (M1_NM, 32) [[OUT:[A-z0-9]*]](0,0)<1> [[IN:[A-z0-9]*]](0,0)<1;1,0>
...
entry:
  ...
  %call1 = call spir_func signext i8 @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDh(half %loaded)
...
declare spir_func <2 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv2_Dh(<2 x half>)
...
entry:
  ...
  %call1 = call spir_func <2 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv2_Dh(<2 x half> %loaded)
...
declare spir_func <3 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv3_Dh(<3 x half>)
...
entry:
  ...
  %call1 = call spir_func <3 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv3_Dh(<3 x half> %inputLoaded)
...
declare spir_func <4 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv4_Dh(<4 x half>)
...
entry:
  ...
  %call1 = call spir_func <4 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv4_Dh(<4 x half> %loaded)
...
declare spir_func <8 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv8_Dh(<8 x half>)
...
entry:
  ...
  %call1 = call spir_func <8 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv8_Dh(<8 x half> %loaded)
...
declare spir_func <16 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv16_Dh(<16 x half>)
...
entry:
  ...
  %call1 = call spir_func <16 x i8> @_Z36__builtin_spirv_ConvertFP16ToE4M3EXTDv16_Dh(<16 x half> %loaded)
