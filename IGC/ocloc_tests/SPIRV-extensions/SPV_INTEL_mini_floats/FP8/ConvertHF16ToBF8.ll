...
entry:
  ...
  %call1 = call spir_func signext i8 @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDh(half %loaded)
...
entry:
  ...
  %call1 = call spir_func <2 x i8> @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDv2_Dh(<2 x half> %loaded)
...
entry:
  ...
  %call1 = call spir_func <3 x i8> @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDv3_Dh(<3 x half> %inputLoaded)
...
entry:
  ...
  %call1 = call spir_func <4 x i8> @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDv4_Dh(<4 x half> %loaded)
...
entry:
  ...
  %call1 = call spir_func <8 x i8> @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDv8_Dh(<8 x half> %loaded)
...
entry:
  ...
  %call1 = call spir_func <16 x i8> @_Z36__builtin_spirv_ConvertFP16ToE5M2EXTDv16_Dh(<16 x half> %loaded)
