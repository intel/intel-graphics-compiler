...
public:
  ...
  virtual llvm::StringRef getPassName() const override { return "Split structure phis"; }
...
private:
  ...
  void createVectorPhi(llvm::PHINode *OldPhi, const IndicesTuple &Indices, llvm::ExtractValueInst *ExtractInst,
                       llvm::InsertValueInst *InsertVal);
  void createScalarPhi(llvm::PHINode *OldPhi, llvm::Type *NewScalarType, const IndicesTuple &Indices,
                       llvm::ExtractValueInst *OldExtractInst, llvm::InsertValueInst *OldInsertValInst);
