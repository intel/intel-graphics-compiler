...
namespace IGC
{
    ...
    public:
        ...
        static const llvm::StringRef SUB_GROUP_BROADCAST;
        static const llvm::StringRef SUB_GROUP_BROADCAST_US;
        static const llvm::StringRef SUB_GROUP_BROADCAST_F;
        static const llvm::StringRef SUB_GROUP_BROADCAST_H;
