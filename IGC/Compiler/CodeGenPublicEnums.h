...
enum DomainShaderDispatchModes : signed int {
  DS_SIMD32_SINGLE_PATCH_DISPATCH_MODE = 0x0,
  DS_SIMD16_SINGLE_PATCH_DISPATCH_MODE = 0x1,
  DS_SIMD16_SINGLE_OR_QUAD_PATCH_DISPATCH_MODE = 0x2,
  DS_SIMD32_SINGLE_OR_8PATCH_DISPATCH_MODE = 0x3,
...
enum class WaveOps : unsigned int { SUM, PROD, UMIN, UMAX, IMIN, IMAX, OR, XOR, AND, FSUM, FPROD, FMIN, FMAX, UNDEF };
...
enum EPreemptionMode { PREEMPTION_ENABLED, PREEMPTION_DISABLED };
...
enum EMIT_LOCAL_MASK { EM_NONE = 0, EM_X = 1, EM_XY = 3, EM_XYZ = 7 };
