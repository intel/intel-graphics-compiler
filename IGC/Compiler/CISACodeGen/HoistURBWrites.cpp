...
#define PASS_DESCRIPTION "Hoists URB write instructions"
...
Instruction* HoistURBWrites::searchBackForAliasedURBRead(
...
bool HoistURBWrites::isSafeToHoistURBWriteInstruction(
    Instruction* urbWrite,
    Instruction*& tgtInst)
{
...
void HoistURBWrites::hoistURBWriteInBB(BasicBlock& blk)
{
    if (blk.empty())
        return;
...
void HoistURBWrites::gatherLastURBReadInEachBB(llvm::Function& F)
{
