...
public:
  ...
  TypeDemote() : FunctionPass(ID), IRB(nullptr) { initializeTypeDemotePass(*PassRegistry::getPassRegistry()); }
...
FunctionPass *IGC::createTypeDemotePass() { return new TypeDemote(); }
