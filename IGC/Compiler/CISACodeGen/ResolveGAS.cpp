            ...
            if (BrI && BrI->isConditional()) {
                ...
                for (auto BTI = trueDestBB->begin(), BTE = trueDestBB->end(); BTI != BTE;) {
                    ...
                    if (CI) {
                        ...
                        if (Callee->getName().contains("__builtin_IB_atomic") && Callee->getName().contains("global"))
                ...
                for (auto BFI = falseDestBB->begin(), BFE = falseDestBB->end(); BFI != BFE;) {
                    ...
                    if (CI) {
                        Function* Callee = CI->getCalledFunction();
                        if (Callee->getName().contains("__builtin_IB_atomic") && Callee->getName().contains("local"))
