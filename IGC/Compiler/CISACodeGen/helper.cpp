...
unsigned EncodeAS4GFXResource(const llvm::Value &bufIdx, BufferType bufType, unsigned uniqueIndAS,
...
bool isStatefulAddrSpace(unsigned AS) { return AS > ADDRESS_SPACE_NUM_ADDRESSES; }
