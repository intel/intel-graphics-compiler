...
public:
  ...
  void emitJointWaveBroadcast(llvm::Instruction *inst);
  ...
  void emitSubgroupBitcastShuffle(llvm::Instruction *inst);
  ...
  void emitFPOWithNonDefaultRoundingMode(llvm::CallInst *inst);
