...
public:
  FixSampleDInputsPass() : FunctionPass(ID) {}
...
FunctionPass *createFixSampleDInputsPass() { return new FixSampleDInputsPass(); }
} // namespace IGC
