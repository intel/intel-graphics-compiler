...
define void @main(double addrspace(1)* %base, i64 %offset, i64 %I, i64 %J) nounwind {
entry:
...
;CHECK: N: 128 (4)        call void @foo()
;CHECK: N: 128 (4)        call void @baz()
;CHECK: N: 128 (4)        call void @dave()
...
;CHECK: N: 192 (6)        call void @dave()
;CHECK: N: 192 (6)        call void @foo()
...
;CHECK: N: 64 (2)         call void @bar()
;CHECK: N: 64 (2)         call void @baz()
