...
; CHECK: ==============================================
; CHECK: MaxPressure In Function: baz --> 0
; CHECK: Max Uniform Pressure In Function: baz --> 0
; CHECK: Max NonUniform Pressure In Function: baz --> 0
...
; CHECK: N: 0 (0)          ret void
; CHECK: ==============================================
; CHECK: MaxPressure In Function: bar --> 0
; CHECK: Max Uniform Pressure In Function: bar --> 0
; CHECK: Max NonUniform Pressure In Function: bar --> 0
...
; CHECK: N: 0 (0)          ret void
; CHECK: ==============================================
; CHECK: MaxPressure In Function: main --> 8
; CHECK: Max Uniform Pressure In Function: main --> 0
; CHECK: Max NonUniform Pressure In Function: main --> 8

; CHECK: SIMD: 8, external pressure: 0
; CHECK: block: entry function: main_2
; CHECK: IN:     [       0       ]
; CHECK: OUT:    [       0       ]
; CHECK: N: 32 (1)         %alloca0 = alloca i32, align 4
; CHECK: N: 64 (2)         %alloca1 = alloca i32, align 4
; CHECK: N: 96 (3)         %alloca2 = alloca i32, align 4
; CHECK: N: 96 (3)         call spir_func void @dave()
; CHECK: N: 96 (3)         call spir_func void @foo()
; CHECK: N: 64 (2)         store i32 0, i32* %alloca0, align 4
; CHECK: N: 32 (1)         store i32 0, i32* %alloca1, align 4
; CHECK: N: 0 (0)          store i32 0, i32* %alloca2, align 4
; CHECK: N: 0 (0)          ret void
; CHECK: ==============================================
; CHECK: MaxPressure In Function: main_2 --> 3
; CHECK: Max Uniform Pressure In Function: main_2 --> 0
; CHECK: Max NonUniform Pressure In Function: main_2 --> 3

; CHECK: SIMD: 8, external pressure: 5
; CHECK: block: entry function: foo
; CHECK: IN:     [       0       ]
; CHECK: OUT:    [       0       ]
; CHECK: N: 32 (1)         %alloca = alloca i32, align 4
; CHECK: N: 32 (1)         call spir_func void @bar()
; CHECK: N: 32 (1)         call spir_func void @baz()
; CHECK: N: 0 (0)          store i32 0, i32* %alloca, align 4
; CHECK: ==============================================
; CHECK: MaxPressure In Function: foo --> 1
; CHECK: Max Uniform Pressure In Function: foo --> 0
; CHECK: Max NonUniform Pressure In Function: foo --> 1

; CHECK: SIMD: 8, external pressure: 4
; CHECK: block: entry function: dave
; CHECK: IN:     [       0       ]
; CHECK: OUT:    [       0       ]
; CHECK: N: 32 (1)         %alloca0 = alloca i32, align 4
; CHECK: N: 32 (1)         call spir_func void @foo()
; CHECK: N: 0 (0)          store i32 0, i32* %alloca0, align 4
; CHECK: N: 0 (0)          ret void
; CHECK: ==============================================
; CHECK: MaxPressure In Function: dave --> 1
; CHECK: Max Uniform Pressure In Function: dave --> 0
; CHECK: Max NonUniform Pressure In Function: dave --> 1
