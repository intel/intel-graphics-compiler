...
; RUN: igc_opt --opaque-pointers -enable-debugify -igc-rewrite-local-size -S < %s 2>&1 | FileCheck %s
; ------------------------------------------------
; RewriteLocalSize
; ------------------------------------------------
...
; Declare is not present and added
; CHECK: declare {{.*}} i32 @__builtin_IB_get_enqueued_local_size
