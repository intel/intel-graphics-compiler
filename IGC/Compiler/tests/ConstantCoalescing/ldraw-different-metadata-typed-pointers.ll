...
entry:
  ...
  %2 = add i32 %src, 8
  %3 = call <2 x float> @llvm.genx.GenISA.ldrawvector.indexed.v2f32.p2490368i8(i8 addrspace(2490368)* %0, i32 %2, i32 8, i1 false)
 ...
 ; CHECK: %1 = call <2 x float> @llvm.genx.GenISA.ldrawvector.indexed.v2f32.p2490368i8(i8 addrspace(2490368)* %0, i32 %src, i32 8, i1 false), !lsc.cache.ctrl !3
 ; CHECK: %2 = add i32 %src, 8
 ; CHECK: %3 = call <2 x float> @llvm.genx.GenISA.ldrawvector.indexed.v2f32.p2490368i8(i8 addrspace(2490368)* %0, i32 %2, i32 8, i1 false)
