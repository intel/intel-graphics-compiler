...
entry:
 ...
 ; CHECK: %1 = call <4 x float> @llvm.genx.GenISA.ldrawvector.indexed.v4f32.p2490368i8(i8 addrspace(2490368)* %0, i32 %src, i32 8, i1 false), !lsc.cache.ctrl {{![0-9]+}}
...
!5 = !{!"FuncMDMap[0]", <4 x float> (i32)* @f0}
!6 = !{!"FuncMDValue[0]", !4}
!7 = !{!"FuncMD", !5, !6}
!8 = !{!"ModuleMD", !7}
