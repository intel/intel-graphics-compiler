...
!313 = !{!"requiredSubGroupSize", i32 16}
!314 = !{!"requiredSubGroupSize", i32 32}
!315 = !{!"FuncMDMap[0]", i32 ()* @wave_interleave_2_simd8}
!316 = !{!"FuncMDValue[0]", !303}
!317 = !{!"FuncMDMap[1]", i32 ()* @wave_interleave_4_simd8}
!318 = !{!"FuncMDValue[1]", !304}
!319 = !{!"FuncMDMap[2]", i32 ()* @wave_interleave_2_simd16}
!320 = !{!"FuncMDValue[2]", !305}
!321 = !{!"FuncMDMap[3]", i32 ()* @wave_interleave_4_simd16}
!322 = !{!"FuncMDValue[3]", !306}
!323 = !{!"FuncMDMap[4]", i32 ()* @wave_interleave_8_simd16}
!324 = !{!"FuncMDValue[4]", !307}
!325 = !{!"FuncMDMap[5]", i32 ()* @wave_interleave_2_simd32}
!326 = !{!"FuncMDValue[5]", !308}
!327 = !{!"FuncMDMap[6]", i32 ()* @wave_interleave_4_simd32}
!328 = !{!"FuncMDValue[6]", !309}
!329 = !{!"FuncMDMap[7]", i32 ()* @wave_interleave_8_simd32}
!330 = !{!"FuncMDValue[7]", !310}
!331 = !{!"FuncMDMap[8]", i32 ()* @wave_interleave_16_simd32}
!332 = !{!"FuncMDValue[8]", !311}
!333 = !{!"FuncMDMap[9]", i32 ()* @simd8_not_wave_interleave}
!334 = !{!"FuncMDValue[9]", !312}
!335 = !{!"FuncMDMap[10]", i32 ()* @simd16_not_wave_interleave}
!336 = !{!"FuncMDValue[10]", !313}
!337 = !{!"FuncMDMap[11]", i32 ()* @simd32_not_wave_interleave}
!338 = !{!"FuncMDValue[11]", !314}
!339 = !{!"FuncMD", !315, !316, !317, !318, !319, !320, !321, !322, !323, !324, !325, !326, !327, !328, !329, !330, !331, !332, !333, !334, !335, !336, !337, !338}
!340 = !{!"ModuleMD", !339}
!IGCMetadata = !{!340}
