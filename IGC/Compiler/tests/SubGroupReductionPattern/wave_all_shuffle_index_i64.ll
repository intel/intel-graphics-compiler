...
!104 = !{!"requiredSubGroupSize", i32 32}
!105 = !{!"requiredSubGroupSize", i32 32}
!106 = !{!"FuncMDMap[0]", i64 ()* @wave_all_add_i64}
!107 = !{!"FuncMDValue[0]", !103}
!108 = !{!"FuncMDMap[1]", i64 ()* @mixed_extract_insert_indices}
!109 = !{!"FuncMDValue[1]", !104}
!110 = !{!"FuncMDMap[2]", i64 ()* @mixed_shuffle_lanes}
