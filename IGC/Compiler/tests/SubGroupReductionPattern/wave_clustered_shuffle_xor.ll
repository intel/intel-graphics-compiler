...
!106 = !{!"FuncMDMap[0]", float ()* @wave_clustered_add_float_cluster_size_8}
!107 = !{!"FuncMDValue[0]", !103}
!108 = !{!"FuncMDMap[1]", float ()* @wave_clustered_add_float_cluster_size_4}
!109 = !{!"FuncMDValue[1]", !104}
!110 = !{!"FuncMDMap[2]", float ()* @wave_clustered_add_float_cluster_size_2}
!111 = !{!"FuncMDValue[2]", !105}
!112 = !{!"FuncMD", !106, !107, !108, !109, !110, !111}
!113 = !{!"ModuleMD", !112}
!IGCMetadata = !{!113}
