...
;
; CHECK: %valu = mul <2 x i32> %{{[0-9]+}}, %{{[0-9]+}}, !igc.simple.alu.vectorized {{![0-9]+}}
; CHECK: extractelement <2 x i32> %valu, i32 0
; CHECK: extractelement <2 x i32> %valu, i32 1
; CHECK-NOT: %r0 = mul i32
; CHECK-NOT: %r1 = mul i32
...
define spir_kernel void @test_pair_mul(i32 %a, i32 %b, i32 %c, ptr addrspace(1) %out) #0 {
entry:
  %r0 = mul i32 %a, %b
  %r1 = mul i32 %a, %c
...
!IGCMetadata = !{!7}
!igc.functions = !{!0}
!0 = !{ptr @test_pair_mul, !1}
!1 = !{!2}
!2 = !{!"function_type", i32 0}
!3 = !{!"functionType", !"KernelFunction"}
!4 = !{!"FuncMDMap[0]", ptr @test_pair_mul}
!5 = !{!"FuncMDValue[0]", !3}
!6 = !{!"FuncMD", !4, !5}
!7 = !{!"ModuleMD", !6}
