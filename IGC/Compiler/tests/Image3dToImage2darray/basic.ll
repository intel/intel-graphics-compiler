...
define void @test_i3dto2da(ptr %a) {
; CHECK-LABEL: @test_i3dto2da(
; CHECK:    [[TMP1:%.*]] = call <16 x i32> @llvm.genx.GenISA.ldptr.v16i32.p0.p0(i32 1, i32 2, i32 3, i32 4, ptr [[A:%.*]], ptr [[A]], i32 0, i32 1, i32 2)
; CHECK:    call void @use.v16i32(<16 x i32> [[TMP1]])
; CHECK:    ret void
;
  %1 = call <16 x i32> @llvm.genx.GenISA.ldptr.v16i32.p0.p0(i32 1, i32 2, i32 3, i32 4, ptr %a, ptr %a, i32 0, i32 1, i32 2)
  call void @use.v16i32(<16 x i32> %1)
  ret void
}

define void @test_i3dto2da_f32(ptr %a, ptr %b) {
; CHECK-LABEL: @test_i3dto2da_f32(
; CHECK:    [[TMP1:%.*]] = call <4 x float> @llvm.genx.GenISA.sampleLptr.v4f32.f32.p0.p0.p0(float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.500000e+00, float 5.000000e+00, ptr null, ptr [[A:%.*]], ptr [[B:%.*]], i32 1, i32 2, i32 3)
; CHECK:    call void @use.v4f32(<4 x float> [[TMP1]])
; CHECK:    ret void
;
  %1 = call <4 x float> @llvm.genx.GenISA.sampleLptr.v4f32.f32.p0.p0.p0(float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.500000e+00, float 5.000000e+00, ptr null, ptr %a, ptr %b, i32 1, i32 2, i32 3)
...
declare <16 x i32> @llvm.genx.GenISA.ldptr.v16i32.p0.p0(i32, i32, i32, i32, ptr, ptr, i32, i32, i32)

declare <4 x float> @llvm.genx.GenISA.sampleLptr.v4f32.f32.p0.p0.p0(float, float, float, float, float, ptr, ptr, ptr, i32, i32, i32)
...
!5 = !{!"ModuleMD", !6}
!6 = !{!"FuncMD", !7, !8, !29, !30}
!7 = !{!"FuncMDMap[0]", ptr @test_i3dto2da}
!8 = !{!"FuncMDValue[0]", !9}
!9 = !{!"resAllocMD", !10, !11}
...
!29 = !{!"FuncMDMap[1]", ptr @test_i3dto2da_f32}
!30 = !{!"FuncMDValue[1]", !9}
