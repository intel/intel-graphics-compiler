...
entry:
  ...
  %0 = call i32 @llvm.genx.GenISA.PredicatedLoad.i32.p1i32.i32(i32 addrspace(1)* %arrayidx1, i64 2, i1 true, i32 42)
  %conv.i.i.1 = add i64 %conv.i.i, 1
  %arrayidx2 = getelementptr inbounds i32, i32 addrspace(1)* %ss, i64 %conv.i.i.1
  %1 = call i32 @llvm.genx.GenISA.PredicatedLoad.i32.p1i32.i32(i32 addrspace(1)* %arrayidx2, i64 4, i1 true, i32 43)
  %conv.i.i.2 = add i64 %conv.i.i, 2
  %arrayidx3 = getelementptr inbounds i32, i32 addrspace(1)* %ss, i64 %conv.i.i.2
  %2 = call i32 @llvm.genx.GenISA.PredicatedLoad.i32.p1i32.i32(i32 addrspace(1)* %arrayidx3, i64 4, i1 true, i32 44)
  call void @llvm.genx.GenISA.PredicatedStore.p1i32.i32(i32 addrspace(1)* %d, i32 %0, i64 2, i1 true)
  %arrayidx4 = getelementptr inbounds i32, i32 addrspace(1)* %d, i64 1
  call void @llvm.genx.GenISA.PredicatedStore.p1i32.i32(i32 addrspace(1)* %arrayidx4, i32 %1, i64 4, i1 true)
  %arrayidx5 = getelementptr inbounds i32, i32 addrspace(1)* %d, i64 2
  call void @llvm.genx.GenISA.PredicatedStore.p1i32.i32(i32 addrspace(1)* %arrayidx5, i32 %2, i64 4, i1 true)
  ret void
}

; CHECK-LABEL: define spir_kernel void @test_uniformness
; CHECK:   %1 = call i32 @llvm.genx.GenISA.PredicatedLoad.i32.p1i32.i32(i32 addrspace(1)* %arrayidx1, i64 2, i1 true, i32 42)
...
; CHECK:   call void @llvm.genx.GenISA.PredicatedStore.p1i32.i32(i32 addrspace(1)* %d, i32 %1, i64 2, i1 true)
...
!80 = !{!"FuncMDValue[0]", !87, !114, !166, !366}
...
!356 = !{!"argId", i32 0}
!357 = !{!"implicitArgInfoListVec[0]", !356}
!358 = !{!"argId", i32 1}
!359 = !{!"implicitArgInfoListVec[1]", !358}
!360 = !{!"argId", i32 8}
!361 = !{!"implicitArgInfoListVec[2]", !360}
!362 = !{!"argId", i32 9}
!363 = !{!"implicitArgInfoListVec[3]", !362}
!364 = !{!"argId", i32 10}
!365 = !{!"implicitArgInfoListVec[4]", !364}
!366 = !{!"implicitArgInfoList", !357, !359, !361, !363, !365}
