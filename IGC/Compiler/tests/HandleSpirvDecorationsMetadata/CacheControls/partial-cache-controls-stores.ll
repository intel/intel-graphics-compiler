...
define spir_func void @test(ptr addrspace(1) %buffer) {
  ...
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx1, align 4, !lsc.cache.ctrl [[S1_CC:!.*]]
  ...
  %arrayidx3 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !13
