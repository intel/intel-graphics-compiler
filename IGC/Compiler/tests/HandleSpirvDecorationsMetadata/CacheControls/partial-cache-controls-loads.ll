...
define spir_func void @test(ptr addrspace(1) %buffer) {
entry:
  ...
  ; CHECK: %l1 = load i32, ptr addrspace(1) %arrayidx0, align 4, !lsc.cache.ctrl [[L0_CC:!.*]]
  %l1 = load i32, ptr addrspace(1) %arrayidx0, align 4

  ; Test changing load default { L1 Cached, L3 Cached } -> { L1 Streaming, L3 Cached }
  %arrayidx1 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !9
  ; CHECK: %l2 = load i32, ptr addrspace(1) %arrayidx1, align 4, !lsc.cache.ctrl [[L1_CC:!.*]]
  %l2 = load i32, ptr addrspace(1) %arrayidx1, align 4

  ; Test changing load default { L1 Cached, L3 Cached } -> { L1 Cached, L3 Uncached }
  %arrayidx2 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !11
  ; CHECK: %l0 = load i32, ptr addrspace(1) %arrayidx2, align 4, !lsc.cache.ctrl [[L2_CC:!.*]]
  %l0 = load i32, ptr addrspace(1) %arrayidx2, align 4
