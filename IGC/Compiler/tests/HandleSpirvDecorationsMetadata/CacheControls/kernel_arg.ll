...
define spir_kernel void @test(ptr addrspace(1) %dummy, ptr addrspace(1) %buffer) !spirv.ParameterDecorations !7 {
entry:
  ; CHECK: store i32 0, ptr addrspace(1) %buffer, align 4, !lsc.cache.ctrl [[S_CC:!.*]]
  store i32 0, ptr addrspace(1) %buffer, align 4
  ; CHECK: %0 = load i32, ptr addrspace(1) %buffer, align 4, !lsc.cache.ctrl [[L_CC:!.*]]
