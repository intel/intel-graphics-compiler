...
entry:
  ...
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx0, align 4, !lsc.cache.ctrl [[S0_CC:!.*]]
  store i32 0, ptr addrspace(1) %arrayidx0, align 4
  %arrayidx1 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !10
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx1, align 4, !lsc.cache.ctrl
  ...
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx2, align 4, !lsc.cache.ctrl [[S2_CC:!.*]]
  ...
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx3, align 4, !lsc.cache.ctrl [[S3_CC:!.*]]
  ...
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx4, align 4, !lsc.cache.ctrl [[S4_CC:!.*]]
  store i32 0, ptr addrspace(1) %arrayidx4, align 4
  %arrayidx5 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !22
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx5, align 4, !lsc.cache.ctrl [[S5_CC:!.*]]
  store i32 0, ptr addrspace(1) %arrayidx5, align 4
  %arrayidx6 = getelementptr inbounds i32, ptr addrspace(1) %buffer, i64 1, !spirv.Decorations !25
  ; CHECK: store i32 0, ptr addrspace(1) %arrayidx6, align 4, !lsc.cache.ctrl [[S6_CC:!.*]]
  store i32 0, ptr addrspace(1) %arrayidx6, align 4
  ret void
}
