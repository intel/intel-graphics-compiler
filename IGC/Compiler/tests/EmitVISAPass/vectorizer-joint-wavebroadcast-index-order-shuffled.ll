...
define spir_kernel void @foo_shuffled() {
  br label %._crit_edge
...
._crit_edge:
  ...
  %bc = call <8 x float> @llvm.genx.GenISA.JointWaveBroadcast.v8f32.f32.v8i32(float %s, <8 x i32> <i32 1, i32 0, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, i32 0)
