...
._crit_edge:                                      ; preds = %._crit_edge.._crit_edge_crit_edge, %6
  ...
  %vector = insertelement <8 x float> zeroinitializer, float 0.000000e+00, i64 0
    %vectorized_binary = fmul fast <8 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, %vectorized_phi
