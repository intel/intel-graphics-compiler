...
; CHECK-FRL1:          (P6) lsc_load.ugm (M1, 16)  V0077:d32  bss(V0082)[V0074]:a32
; CHECK-FRL1-NEXT:     or (M1, 16) V0083(0,0)<1> V0074(0,0)<1;1,0> 0x4:d
; CHECK-FRL1-NEXT:     (P6) lsc_load.ugm (M1, 16)  V0084:d32  bss(V0082)[V0083]:a32
; CHECK-FRL1-NEXT:     (!P6) goto (M1, 16) _test_ldraw_fusion_006__opt_resource_loop
