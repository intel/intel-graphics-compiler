...
; Test checks that llvm.powi.f32 call is emited as pow

; CHECK: pow (M1_NM, 1) [[POWI:[A-z0-9]*]](0,0)<1> [[A:[A-z0-9]*]](0,0)<0;1,0> 0x41500000:f
; CHECK: lsc_store.ugm (M1_NM, 1) {{.*}} [[POWI]]:d32

define spir_kernel void @intrinsic_powi(float %a, float addrspace(1)* %res32, <8 x i32> %r0, <8 x i32> %payloadHeader, i32 %bufferOffset) {
entry:
  %powi32 = call float @llvm.powi.f32(float %a, i32 13)
  store float %powi32, float addrspace(1)* %res32
  ret void
}
...
!0 = !{!"ModuleMD", !1}
!1 = !{!"FuncMD", !2, !3}
!2 = !{!"FuncMDMap[0]", void (float, float addrspace(1)*, <8 x i32>, <8 x i32>, i32)* @intrinsic_powi}
...
!21 = !{void (float, float addrspace(1)*, <8 x i32>, <8 x i32>, i32)* @intrinsic_powi, !22}
!22 = !{!23}
