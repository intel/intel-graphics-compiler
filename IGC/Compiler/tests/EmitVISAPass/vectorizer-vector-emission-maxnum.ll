...
; RUN: igc_opt -S -dce -platformmtl -igc-emit-visa --regkey=DumpVISAASMToConsole=1 -simd-mode 16 < %s | FileCheck %s
; RUN: igc_opt -S -dce -platformpvc -igc-emit-visa --regkey=DumpVISAASMToConsole=1 -simd-mode 16 < %s | FileCheck %s
; RUN: igc_opt -S -dce -platformbmg -igc-emit-visa --regkey=DumpVISAASMToConsole=1 -simd-mode 16 < %s | FileCheck %s
; RUN: igc_opt -S -dce -platformPtl -igc-emit-visa --regkey=DumpVISAASMToConsole=1 -simd-mode 16 < %s | FileCheck %s
...
; CHECK:  max (M1, 16) vectorized_intrinsic2(0,0)<1> vectorized_intrinsic(0,0)<1;1,0> vector331(0,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(1,0)<1> vectorized_intrinsic(1,0)<1;1,0> vector331(1,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(2,0)<1> vectorized_intrinsic(2,0)<1;1,0> vector331(2,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(3,0)<1> vectorized_intrinsic(3,0)<1;1,0> vector331(3,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(4,0)<1> vectorized_intrinsic(4,0)<1;1,0> vector331(4,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(5,0)<1> vectorized_intrinsic(5,0)<1;1,0> vector331(5,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(6,0)<1> vectorized_intrinsic(6,0)<1;1,0> vector331(6,0)<1;1,0>
; CHECK:  max (M1, 16) vectorized_intrinsic2(7,0)<1> vectorized_intrinsic(7,0)<1;1,0> vector331(7,0)<1;1,0>
...
._crit_edge:                                      ; preds = %._crit_edge, %6
  ...
  %vectorized_intrinsic2 = call <8 x float> @llvm.maxnum.v8f32(<8 x float> %vectorized_intrinsic, <8 x float> %vector331)
...
!11 = !{!"argAllocMDListVec[1]", !24, !25, !26}
!12 = !{!"argAllocMDListVec[2]", !24, !25, !26}
!13 = !{!"argAllocMDListVec[3]", !24, !25, !26}
!14 = !{!"argAllocMDListVec[4]", !24, !25, !26}
!15 = !{!"argAllocMDListVec[5]", !24, !25, !26}
!16 = !{!"argAllocMDListVec[6]", !24, !25, !26}
!17 = !{!"argAllocMDListVec[7]", !24, !25, !26}
!18 = !{!"argAllocMDListVec[8]", !24, !25, !26}
!19 = !{!"argAllocMDListVec[9]", !24, !25, !26}
!20 = !{!"argAllocMDListVec[10]", !24, !25, !26}
!21 = !{!"argAllocMDListVec[11]", !24, !25, !26}
!22 = !{!"argAllocMDListVec[12]", !24, !25, !26}
!23 = !{!"argAllocMDListVec[13]", !24, !25, !26}
!24 = !{!"type", i32 0}
