...
!14 = distinct !{!"requiredSubGroupSize", i32 16}
!15 = distinct !{!"FuncMDValue[0]", !14}
!16 = distinct !{!"FuncMDMap[0]", void ()* @foo}
!17 = distinct !{!"requiredSubGroupSize", i32 16}
!18 = distinct !{!"FuncMDValue[1]", !17}
!19 = distinct !{!"FuncMDMap[1]", void ()* @foo_elem0}
!20 = distinct !{!"requiredSubGroupSize", i32 16}
!21 = distinct !{!"FuncMDValue[2]", !20}
!22 = distinct !{!"FuncMDMap[2]", void ()* @foo_elem7}
!23 = distinct !{!"requiredSubGroupSize", i32 16}
!24 = distinct !{!"FuncMDValue[3]", !23}
!25 = distinct !{!"FuncMDMap[3]", void ()* @foo_fadd}
!26 = distinct !{!"requiredSubGroupSize", i32 16}
!27 = distinct !{!"FuncMDValue[4]", !26}
!28 = distinct !{!"FuncMDMap[4]", void ()* @foo_long}
!29 = distinct !{!"requiredSubGroupSize", i32 16}
!30 = distinct !{!"FuncMDValue[5]", !29}
!31 = distinct !{!"FuncMDMap[5]", void ()* @foo_ugly}
!32 = distinct !{!"FuncMD", !16, !15, !19, !18, !22, !21, !25, !24, !28, !27, !31, !30}
!33 = distinct !{!"ModuleMD", !32}
!IGCMetadata = !{!33}