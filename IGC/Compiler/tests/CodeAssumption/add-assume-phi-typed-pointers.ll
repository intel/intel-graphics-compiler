...
; REQUIRES: regkeys
;
; RUN: igc_opt -enable-debugify -regkey EnableCodeAssumption=2 -igc-stateless-to-stateful-resolution -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK%if llvm-22-plus %{,CHECK-LLVM22%}
; ------------------------------------------------
