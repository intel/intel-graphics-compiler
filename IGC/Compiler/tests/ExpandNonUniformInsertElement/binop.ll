...
; Demonstrate a vector of 4 x i32 with a nonuniform insertion index,
...
; CHECK-NEXT: [[B3:%.*]] = or i32 [[E3]], [[S3]]
; CHECK-NEXT: [[V3:%.*]] = insertelement <4 x i32> [[V2]], i32 [[B3]], i32 3

define <4 x i32> @test_binop(<4 x i32> %vec, i32 %val, i32 %idx) {
entry:
...
!358 = !{<4 x i32> (<4 x i32>, i32, i32)* @test_binop, !359}
!359 = !{!360}
