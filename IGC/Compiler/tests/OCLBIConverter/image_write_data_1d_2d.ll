...
define spir_kernel void @kernel_1d(ptr addrspace(1) %img_1d) {
  %img_as_int = ptrtoint ptr addrspace(1) %img_1d to i64
  %trunc = trunc i64 %img_as_int to i32

  ; CHECK-LABEL: @kernel_1d(

  ; CHECK-NOT: __builtin_IB_write_1d_u1i
  ; CHECK: [[IMG1D1:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
  ; CHECK: call void @llvm.genx.GenISA.typedwrite.p196608(ptr addrspace(196608) [[IMG1D1]], i32 0, i32 0, i32 0, i32 0, float %floatColor, float undef, float undef, float undef)
...
define spir_kernel void @kernel_1d_arr(ptr addrspace(1) %img_1d_arr) {
  %img_as_int = ptrtoint ptr addrspace(1) %img_1d_arr to i64
  %trunc = trunc i64 %img_as_int to i32

  ; CHECK-LABEL: @kernel_1d_arr(

  ; CHECK-NOT: __builtin_IB_write_1darr_u1i
  ; CHECK: [[IMG1DARR1:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
  ; CHECK: call void @llvm.genx.GenISA.typedwrite.p196608(ptr addrspace(196608) [[IMG1DARR1]], i32 %{{.*}}, i32 %{{.*}}, i32 0, i32 0, float %floatColor, float undef, float undef, float undef)
...
define spir_kernel void @kernel_2d(ptr addrspace(1) %img_2d) {
  %img_as_int = ptrtoint ptr addrspace(1) %img_2d to i64
  %trunc = trunc i64 %img_as_int to i32

  ; CHECK-LABEL: @kernel_2d(

  ; CHECK-NOT: __builtin_IB_write_2d_u1i
  ; CHECK: [[IMG2D1:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
  ; CHECK: call void @llvm.genx.GenISA.typedwrite.p196608(ptr addrspace(196608) [[IMG2D1]], i32 %{{.*}}, i32 %{{.*}}, i32 0, i32 0, float %floatColor, float undef, float undef, float undef)
  ...
  ; CHECK: [[IMG2D2:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
...
define spir_kernel void @kernel_2d_arr(ptr addrspace(1) %img_2d_arr) {
  %img_as_int = ptrtoint ptr addrspace(1) %img_2d_arr to i64
  %trunc = trunc i64 %img_as_int to i32

  ; CHECK-LABEL: @kernel_2d_arr(

  ; CHECK-NOT: __builtin_IB_write_2darr_u1i
  ; CHECK: [[IMG2DARR1:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
  ; CHECK: call void @llvm.genx.GenISA.typedwrite.p196608(ptr addrspace(196608) [[IMG2DARR1]], i32 %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 0, float %floatColor, float undef, float undef, float undef)
...
define spir_kernel void @kernel_3d(ptr addrspace(1) %img_3d) {
  %img_as_int = ptrtoint ptr addrspace(1) %img_3d to i64
  %trunc = trunc i64 %img_as_int to i32

  ; CHECK-LABEL: @kernel_3d(

  ; CHECK-NOT: __builtin_IB_write_3d_u1i
  ; CHECK: [[IMG3D1:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
  ; CHECK: call void @llvm.genx.GenISA.typedwrite.p196608(ptr addrspace(196608) [[IMG3D1]], i32 %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 0, float %floatColor, float undef, float undef, float undef)
  ...
  ; CHECK: [[IMG3D2:%.*]] = call ptr addrspace(196608) @llvm.genx.GenISA.GetBufferPtr.p196608(i32 0, i32 2)
...
!0 = !{ptr @kernel_1d, !1}
!1 = !{}
!2 = !{ptr @kernel_1d_arr, !1}
!3 = !{ptr @kernel_2d, !1}
!4 = !{ptr @kernel_2d_arr, !1}
!5 = !{ptr @kernel_3d, !1}
!6 = !{!"ModuleMD", !7}
!7 = !{!"FuncMD", !8, !9, !16, !9, !17, !9, !18, !9, !19, !9}
!8 = distinct !{!"FuncMDMap[0]", ptr @kernel_1d}
!9 = !{!"FuncMDValue[0]", !10}
!10 = !{!"resAllocMD", !11}
...
!15 = !{!"indexType", i32 0}
!16 = distinct !{!"FuncMDMap[0]", ptr @kernel_1d_arr}
!17 = distinct !{!"FuncMDMap[0]", ptr @kernel_2d}
!18 = distinct !{!"FuncMDMap[0]", ptr @kernel_2d_arr}
!19 = distinct !{!"FuncMDMap[0]", ptr @kernel_3d}
