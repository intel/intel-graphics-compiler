...
define void @test() #0 {
  %alloca1 = alloca float, addrspace(420)
  %alloca2 = alloca float, addrspace(420)
; CHECK: alloca float
; CHECK-NOT: alloca float
  %load1 = load float, ptr addrspace(420) %alloca1
  %load2 = load float, ptr addrspace(420) %alloca2
  ret void
}
