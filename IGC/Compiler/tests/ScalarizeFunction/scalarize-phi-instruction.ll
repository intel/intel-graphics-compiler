; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --tool igc_opt --version 5
...
; CHECK-NEXT:    call void @llvm.genx.GenISA.simdBlockWrite.p1.v2i32(ptr addrspace(1) [[SHOULD_NOT_SCALARIZE_ME]], <2 x i32> <i32 2, i32 4>)
; CHECK-NEXT:    ret void
;
entry:
  br i1 %switch, label %first, label %second
...
exit:
  ...
  call void @llvm.genx.GenISA.simdBlockWrite.p1.v2i32(ptr addrspace(1) %should_not_scalarize_me, <2 x i32> <i32 2, i32 4>)
  ret void
}
...
; CHECK-NEXT:    call void @llvm.genx.GenISA.simdBlockWriteBindless.p2490368.v2f32(ptr addrspace(2490368) [[TMP0]], <2 x float> [[SHOULD_NOT_SCALARIZE_ME]], i32 0)
; CHECK-NEXT:    ret void
;
entry:
...
exit:
  ...
  call void @llvm.genx.GenISA.simdBlockWriteBindless.p2490368.v2f32(ptr addrspace(2490368) %0, <2 x float> %should_not_scalarize_me, i32 0)
  ret void
}
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SHOULD_NOT_SCALARIZE_ME:%.*]] = phi <16 x i16> [ [[SRC1]], %[[FIRST]] ], [ [[SRC2]], %[[SECOND]] ]
; CHECK-NEXT:    call void @llvm.genx.GenISA.LSC2DBlockWriteAddrPayload.p0.v16i16(ptr [[TMP0]], i32 0, i32 0, i32 16, i32 16, i32 16, i32 1, i1 false, i1 false, i32 0, <16 x i16> [[SHOULD_NOT_SCALARIZE_ME]])
; CHECK-NEXT:    ret void
;
entry:
  %0 = alloca i32
...
exit:
  %should_not_scalarize_me = phi <16 x i16> [ %src1, %first], [ %src2, %second]
  call void @llvm.genx.GenISA.LSC2DBlockWriteAddrPayload.p0.v16i16(ptr %0, i32 0, i32 0, i32 16, i32 16, i32 16, i32 1, i1 false, i1 false, i32 0, <16 x i16> %should_not_scalarize_me)
  ret void
}
...
declare void @llvm.genx.GenISA.simdBlockWrite.p1.v2i32(ptr addrspace(1), <2 x i32>)
declare void @llvm.genx.GenISA.simdBlockWriteBindless.p2490368.v2f32(ptr addrspace(2490368), <2 x float>, i32)
...
declare void @llvm.genx.GenISA.LSC2DBlockWriteAddrPayload.p0.v16i16(ptr, i32, i32, i32, i32, i32, i32, i1, i1, i32, <16 x i16>)
