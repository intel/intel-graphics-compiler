...
!14 = !{!"argId", i32 0}
!15 = !{!"implicitArgInfoListVec[0]", !14}
!16 = !{!"argId", i32 1}
!17 = !{!"implicitArgInfoListVec[1]", !16}
!18 = !{!"argId", i32 5}
!19 = !{!"implicitArgInfoListVec[2]", !18}
!20 = !{!"argId", i32 6}
!21 = !{!"implicitArgInfoListVec[3]", !20}
!22 = !{!"argId", i32 13}
!23 = !{!"implicitArgInfoListVec[4]", !22}
!24 = !{!"argId", i32 15}
!25 = !{!"explicitArgNum", i32 0}
!26 = !{!"implicitArgInfoListVec[5]", !24, !25}
!27 = !{!"implicitArgInfoList", !15, !17, !19, !21, !23, !26}
!28 = !{!"FuncMDMap[0]", ptr @test}
!29 = !{!"FuncMDValue[0]", !27}
!30 = !{!"FuncMD", !28, !29}
!31 = !{!"ModuleMD", !30}
!IGCMetadata = !{!31}
