...
!21 = !{!"argId", i32 15}
!22 = !{!"explicitArgNum", i32 0}
!23 = !{!"implicitArgInfoListVec[5]", !21, !22}
!24 = !{!"implicitArgInfoList", !12, !14, !16, !18, !20, !23}
!25 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, i16, i16, i16, <3 x i32>, <3 x i32>, <3 x i32>, i8*, i32)* @test}
!26 = !{!"FuncMDValue[0]", !24}
!27 = !{!"FuncMD", !25, !26}
!28 = !{!"ModuleMD", !27}
!IGCMetadata = !{!28}
