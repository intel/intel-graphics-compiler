...
declare i32 @llvm.genx.GenISA.icmpxchgatomicrawA64.i32.p1.p1(ptr addrspace(1), ptr addrspace(1), i32, i32)

define spir_kernel void @kernel1(ptr addrspace(1) %src) {
entry:
  br label %back
back:
  %call1 = call i32 @llvm.genx.GenISA.intatomicrawA64.i32.p1.p1(ptr addrspace(1) %src, ptr addrspace(1) %src, i32 0, i32 9)
  %bc1 = bitcast i32 %call1 to float
  %operation = fadd fast float %bc1, -2.000000e+00
  %bc2 = bitcast float %operation to i32
  %call2 = call i32 @llvm.genx.GenISA.icmpxchgatomicrawA64.i32.p1.p1(ptr addrspace(1) %src, ptr addrspace(1) %src, i32 %call1, i32 %bc2)
...
; CHECK:       [[TMP4]]:
; CHECK-NEXT:    [[CALL1:%.*]] = call i32 @llvm.genx.GenISA.intatomicrawA64.i32.p1.p1(ptr addrspace(1) [[SRC:%.*]], ptr addrspace(1) [[SRC]], i32 0, i32 9)
...
; CHECK-NEXT:    [[CALL2:%.*]] = call i32 @llvm.genx.GenISA.icmpxchgatomicrawA64.i32.p1.p1(ptr addrspace(1) [[SRC]], ptr addrspace(1) [[SRC]], i32 [[CALL1]], i32 [[BC2]])
...
define spir_kernel void @kernel2(ptr addrspace(1) %src) {
entry:
  br label %back
back:
  %call1 = call i32 @llvm.genx.GenISA.intatomicrawA64.i32.p1.p1(ptr addrspace(1) %src, ptr addrspace(1) %src, i32 0, i32 9)
...
;
; CHECK-LABEL: define spir_kernel void @kernel2(ptr addrspace(1) %src) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    br label %back
; CHECK:       back:
; CHECK-NEXT:    %call1 = call i32 @llvm.genx.GenISA.intatomicrawA64.i32.p1.p1(ptr addrspace(1) %src, ptr addrspace(1) %src, i32 0, i32 9)
