...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: invalid number of arguments. Expected 5. Actual 4
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: Operands argument must be a constant scalar 32-bit integer
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: expected Result type to match type of Matrix C for targeted HW. Result type: i32, Matrix C type: i16
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: expected Result to be a scalar or vector of int32_t, int16_t, float32_t, or float16_t for targeted HW
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: expected Matrix A to be a scalar or vector of int32_t, int16_t, float32_t, or float16_t for targeted HW
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: M dimension must be 1, 2, 4 or 8 for targeted HW. Actual: 3
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: Matrix A argument must have ceil(M/2) components when MatrixATF32INTEL operand is set for targeted HW. Expected 1. Actual 2
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: Matrix A argument must have size 1 to match M defined by Result type for targeted HW. Actual: 2
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: Matrix B argument must have 8 components for targeted HW. Actual: 1
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: expected A element type to be int32_t for K Dim = 32, for Result element type int32_t, for targeted HW. Actual: int16_t
...
;CHECK: error: in kernel 'test': __spirv_SubgroupMatrixMultiplyAccumulateINTEL: expected B element type to be int32_t for K Dim = 32, for Result element type int32_t, for A element type int32_t, for targeted HW. Actual: float32_t
