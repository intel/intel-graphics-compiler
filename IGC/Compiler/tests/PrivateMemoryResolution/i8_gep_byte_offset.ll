...
; The offset (64) is a whole multiple of the 4-byte lane, so it is scalarized to element index 16.
; Offsets that land inside a lane are still rejected by SOALayoutChecker and left untouched.
