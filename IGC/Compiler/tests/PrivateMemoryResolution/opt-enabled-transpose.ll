...
; CHECK:    [[DST_ADDR_SIMDBUFFEROFFSET:%.*]] = mul i32 [[SIMDSIZE]], 64
...
; CHECK:    [[DST_ADDR_PRIVATEBUFFERPTR:%.*]] = inttoptr i32 [[DST_ADDR_THREADOFFSET]] to <8 x i32> addrspace(1)**
...
; CHECK:    [[SRC_ADDR_SIMDBUFFEROFFSET:%.*]] = mul i32 [[SIMDSIZE]], 72
...
; CHECK:    [[BB_SIMDBUFFEROFFSET:%.*]] = mul i32 [[SIMDSIZE]], 32
