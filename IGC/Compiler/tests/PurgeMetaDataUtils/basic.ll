...
; RUN: igc_opt --opaque-pointers -igc-purgeMetaDataUtils-import -S < %s | FileCheck %s --check-prefixes=CHECK,%if llvm-22-plus %{CHECK-LLVM22%} %else %{CHECK-PRE22%}
; ------------------------------------------------
; PurgeMetaDataUtils
; ------------------------------------------------
;
...
!61 = !{!"functionType", !"KernelFunction"}
