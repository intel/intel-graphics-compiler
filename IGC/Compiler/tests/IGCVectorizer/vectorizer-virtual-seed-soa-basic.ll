...
; A group of scalar values feeding GenISA_PredicatedStore, where each scalar is a
; bitcast of a sequential extractelement from one source vector (a "naive
; swizzle"), is turned into a virtual vector seed and vectorized.

; CHECK-LABEL: @test_soa_basic
; CHECK: %vectorized_cast = bitcast <8 x float> %src to <8 x i32>
; CHECK: extractelement <8 x i32> %vectorized_cast, i32 0
; CHECK: extractelement <8 x i32> %vectorized_cast, i32 7
...
define spir_kernel void @test_soa_basic(i1 %pred, <8 x i16> %a, <8 x i32> %b) {
entry:
...
!igc.functions = !{!0}
!0 = !{void (i1, <8 x i16>, <8 x i32>)* @test_soa_basic, !1}
!1 = !{!2}
!2 = !{!"function_type", i32 0}
!4 = !{!"requiredSubGroupSize", i32 16}
!5 = !{!"FuncMDValue[0]", !4}
!6 = !{!"FuncMDMap[0]", void (i1, <8 x i16>, <8 x i32>)* @test_soa_basic}
!7 = !{!"FuncMD", !6, !5}
!8 = !{!"ModuleMD", !7}
!IGCMetadata = !{!8}
