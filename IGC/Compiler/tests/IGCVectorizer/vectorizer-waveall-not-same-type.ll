...
;CHECK-NOT: %vectorized_joint_waveall = call <8 x float> @llvm.genx.GenISA.WaveAll.v8f32(<8 x float> %{{.*}}, i8 12, i32 0)
;CHECK-NOT: %{{vectorized_joint_waveall.*}} = call <8 x float> @llvm.genx.GenISA.WaveAll.v8f32(<8 x float> %{{.*}}, i8 12, i32 0)
...
bb7:                                              ; preds = %bb7, %bb5
  ...
  %tmp35 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp27, i8 11, i32 0)
...
bb102:                                            ; preds = %bb102, %bb101
  ...
  %tmp130 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp122, i8 10, i32 0)
  %tmp131 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp123, i8 10, i32 0)
  %tmp132 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp124, i8 10, i32 0)
  %tmp133 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp125, i8 10, i32 0)
  %tmp134 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp126, i8 10, i32 0)
  %tmp135 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp127, i8 10, i32 0)
  %tmp136 = call float @llvm.genx.GenISA.WaveAll.f32(float %tmp128, i8 10, i32 0)
