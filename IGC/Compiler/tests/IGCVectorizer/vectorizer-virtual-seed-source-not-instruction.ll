...
; The swizzle source is a kernel argument (not an instruction), so the group
; cannot be connected to a producing vector instruction: no virtual seed.

; CHECK: Source is not an instruction
...
define spir_kernel void @k(i1 %pred, <8 x i16> %a, <8 x i32> %b, <8 x float> %srcarg) {
entry:
  ; natural seed of width 8 -> establishes PreferredVectorSize = 8
  %n0 = extractelement <8 x float> %srcarg, i64 0
  ...
  %e0 = extractelement <8 x float> %srcarg, i64 0
  %e1 = extractelement <8 x float> %srcarg, i64 1
  %e2 = extractelement <8 x float> %srcarg, i64 2
  %e3 = extractelement <8 x float> %srcarg, i64 3
  %e4 = extractelement <8 x float> %srcarg, i64 4
  %e5 = extractelement <8 x float> %srcarg, i64 5
  %e6 = extractelement <8 x float> %srcarg, i64 6
  %e7 = extractelement <8 x float> %srcarg, i64 7
...
!igc.functions = !{!0}
!0 = !{void (i1, <8 x i16>, <8 x i32>, <8 x float>)* @k, !1}
!1 = !{!2}
!2 = !{!"function_type", i32 0}
!4 = !{!"requiredSubGroupSize", i32 16}
!5 = !{!"FuncMDValue[0]", !4}
!6 = !{!"FuncMDMap[0]", void (i1, <8 x i16>, <8 x i32>, <8 x float>)* @k}
!7 = !{!"FuncMD", !6, !5}
!8 = !{!"ModuleMD", !7}
!IGCMetadata = !{!8}
