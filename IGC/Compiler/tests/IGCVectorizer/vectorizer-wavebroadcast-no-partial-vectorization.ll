...
; NODCE: %vectorized_joint_wavebroadcast = call <8 x float> @llvm.genx.GenISA.JointWaveBroadcast.v8f32.f32.v8i32
; NODCE-NOT: extractelement <8 x float> %vectorized_joint_wavebroadcast

; DCE-NOT: %vectorized_joint_wavebroadcast = call <8 x float> @llvm.genx.GenISA.JointWaveBroadcast.v8f32.f32.v8i32
; DCE-COUNT-8: call float @llvm.genx.GenISA.WaveBroadcast.f32
...
define spir_kernel void @zot.12(float %arg0) {
...
loop:                                            ; preds = %bb2221, %bb
  ...
  %tmp1636 = fmul float %arg0, %tmp1634
