...
; The only natural seed is a degenerate <1 x float>, so PreferredVectorSize is 1
; and virtual seed formation is skipped.
...
entry:
  ...
  %seed = insertelement <1 x float> zeroinitializer, float %n0, i64 0
  %use = fadd <1 x float> %seed, %seed
