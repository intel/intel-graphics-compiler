...
; There is no natural insert-element seed at all, so the pass returns before
; PreferredVectorSize is computed: virtual seeds are only attempted alongside
; existing natural seeds.
