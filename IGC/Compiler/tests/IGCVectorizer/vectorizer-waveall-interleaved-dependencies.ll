...
; CHECK: Slice Scope:   %tmp121 = fmul float %tmp113, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp122 = fmul float %tmp114, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp123 = fmul float %tmp115, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp124 = fmul float %tmp116, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp125 = fmul float %tmp117, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp126 = fmul float %tmp118, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
...
; CHECK: Slice Scope:   %tmp127 = fmul float %tmp119, {{(0x3FF7154760000000|f0x3FB8AA3B)}}
