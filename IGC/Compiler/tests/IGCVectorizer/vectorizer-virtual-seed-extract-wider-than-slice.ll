...
define spir_kernel void @k(i1 %pred, <8 x i16> %a, <8 x i32> %b, <16 x float> %wide) {
entry:
  ; natural seed of width 8 -> establishes PreferredVectorSize = 8
  %src = fadd <16 x float> %wide, %wide
  %n0 = extractelement <16 x float> %src, i64 0
...
!igc.functions = !{!0}
!0 = !{void (i1, <8 x i16>, <8 x i32>, <16 x float>)* @k, !1}
!1 = !{!2}
!2 = !{!"function_type", i32 0}
!4 = !{!"requiredSubGroupSize", i32 16}
!5 = !{!"FuncMDValue[0]", !4}
!6 = !{!"FuncMDMap[0]", void (i1, <8 x i16>, <8 x i32>, <16 x float>)* @k}
!7 = !{!"FuncMD", !6, !5}
!8 = !{!"ModuleMD", !7}
!IGCMetadata = !{!8}
