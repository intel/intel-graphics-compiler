...
; the third argument (helper lane) is 1 instead of 0.  The vectorizer requires
; helper lane == 0 across the whole slice.
...
define spir_kernel void @test_nonzero_helper() {
...
loop:                                             ; preds = %loop, %bb
  ...
  ; Group A: lanes 0-7, all with helper lane = 1 (non-zero)
  %tmp1634 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 0, i32 1)
  ...
  %tmp1638 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 1, i32 1)
  ...
  %tmp1642 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 2, i32 1)
  ...
  %tmp1646 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 3, i32 1)
  ...
  %tmp1650 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 4, i32 1)
  ...
  %tmp1654 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 5, i32 1)
  ...
  %tmp1658 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 6, i32 1)
  ...
  %tmp1662 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 7, i32 1)
  ...
  ; Group B: lanes 8-15, all with helper lane = 1 (non-zero)
  %tmp1666 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 8, i32 1)
  ...
  %tmp1670 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 9, i32 1)
  %tmp1672 = fmul float %tmp1, %tmp1670
  %tmp1673 = insertelement <8 x float> %tmp1669, float %tmp1672, i64 1
  %tmp1674 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 10, i32 1)
  %tmp1676 = fmul float %tmp2, %tmp1674
  %tmp1677 = insertelement <8 x float> %tmp1673, float %tmp1676, i64 2
  %tmp1678 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 11, i32 1)
  %tmp1680 = fmul float %tmp3, %tmp1678
  %tmp1681 = insertelement <8 x float> %tmp1677, float %tmp1680, i64 3
  %tmp1682 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 12, i32 1)
  %tmp1684 = fmul float %tmp4, %tmp1682
  %tmp1685 = insertelement <8 x float> %tmp1681, float %tmp1684, i64 4
  %tmp1686 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 13, i32 1)
  %tmp1688 = fmul float %tmp5, %tmp1686
  %tmp1689 = insertelement <8 x float> %tmp1685, float %tmp1688, i64 5
  %tmp1690 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 14, i32 1)
  %tmp1692 = fmul float %tmp6, %tmp1690
  %tmp1693 = insertelement <8 x float> %tmp1689, float %tmp1692, i64 6
  %tmp1694 = call float @llvm.genx.GenISA.WaveBroadcast.f32(float %tmp658, i32 15, i32 1)
