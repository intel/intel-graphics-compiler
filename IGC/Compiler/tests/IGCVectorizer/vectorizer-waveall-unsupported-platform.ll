...
; this tests checks that waveall is not being vectorized on unsupported platforms
; currently all of the unsupported platforms for waveall, unsupported by vector emission itself
; so this is excessive, the test is not deleted because probably in the future we'll have such platform
; and test is going to be updated
; REQUIRES: llvm-16-plus, regkeys, platform-without-waveall-and-grf-64b
