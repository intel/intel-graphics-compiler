; REQUIRES: regkeys, !llvm-17-plus
; RUN: igc_opt -S --typed-pointers --igc-vectorizer -dce --regkey=VectorizerAllowEXP2=0 --regkey=VectorizerEnablePartialVectorization=1 --platformbmg < %s 2>&1 | FileCheck %s
