...
; REQUIRES: regkeys
; RUN: igc_opt -S  --igc-vectorizer -dce --platformbmg --regkey=VectorizerAllowADD=1 --regkey=VectorizerAllowMUL=1 --regkey=VectorizerLog=1 --regkey=VectorizerLogToErr=1 < %s 2>&1 | FileCheck %s
