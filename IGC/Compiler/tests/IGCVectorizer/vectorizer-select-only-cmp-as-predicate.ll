...
bb59:                                             ; preds = %bb2
  ...
  %and60 = and i1 %tmp60, true
  %and61 = and i1 %tmp61, false
  %and62 = and i1 %tmp62, true
  %and63 = and i1 %tmp63, false
  %and64 = and i1 %tmp64, true
  %and65 = and i1 %tmp65, false
  %and66 = and i1 %tmp66, true
  %and67 = and i1 %tmp67, false

  %tmp68 = select i1 %and60, float 0.000000e+00, float 0.000000e+00
  %tmp69 = select i1 %and61, float 0.000000e+00, float 0.000000e+00
  %tmp70 = select i1 %and62, float 0.000000e+00, float 0.000000e+00
  %tmp71 = select i1 %and63, float 0.000000e+00, float 0.000000e+00
  %tmp72 = select i1 %and64, float 0.000000e+00, float 0.000000e+00
  %tmp73 = select i1 %and65, float 0.000000e+00, float 0.000000e+00
  %tmp74 = select i1 %and66, float 0.000000e+00, float 0.000000e+00
  %tmp75 = select i1 %and67, float 0.000000e+00, float 0.000000e+00
