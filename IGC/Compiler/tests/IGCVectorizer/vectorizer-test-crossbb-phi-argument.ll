...
; CHECK-NEXT: %tmp90 = phi float [ %a0, %bb60 ], [ %tmp114, %bb88 ]
; CHECK-NEXT: %tmp91 = phi float [ %a1, %bb60 ], [ %tmp115, %bb88 ]
; CHECK-NEXT: %tmp92 = phi float [ %a2, %bb60 ], [ %tmp116, %bb88 ]
; CHECK-NEXT: %tmp93 = phi float [ %a3, %bb60 ], [ %tmp117, %bb88 ]
; CHECK-NEXT: %tmp94 = phi float [ %a4, %bb60 ], [ %tmp118, %bb88 ]
; CHECK-NEXT: %tmp95 = phi float [ %a5, %bb60 ], [ %tmp119, %bb88 ]
; CHECK-NEXT: %tmp96 = phi float [ %a6, %bb60 ], [ %tmp120, %bb88 ]
; CHECK-NEXT: %tmp97 = phi float [ %a7, %bb60 ], [ %tmp121, %bb88 ]
; CHECK-NOT: %vectorized_phi
...
bb43:
  %a4 = fadd float 0.0000e+00, 1.0000e+00
  %a5 = fadd float 1.0000e+00, 1.0000e+00
  %a6 = fadd float 2.0000e+00, 1.0000e+00
  %a7 = fadd float 3.0000e+00, 1.0000e+00
  br label %bb123

bb60:
  %a0 = fadd float 0.0000e+00, 1.0000e+00
  %a1 = fadd float 1.0000e+00, 1.0000e+00
  %a2 = fadd float 2.0000e+00, 1.0000e+00
  %a3 = fadd float 3.0000e+00, 1.0000e+00
  br label %bb88

bb88:
  %tmp90 = phi float [ %a0, %bb60 ], [ %tmp114, %bb88 ]
  %tmp91 = phi float [ %a1, %bb60 ], [ %tmp115, %bb88 ]
  %tmp92 = phi float [ %a2, %bb60 ], [ %tmp116, %bb88 ]
  %tmp93 = phi float [ %a3, %bb60 ], [ %tmp117, %bb88 ]
  %tmp94 = phi float [ %a4, %bb60 ], [ %tmp118, %bb88 ]
  %tmp95 = phi float [ %a5, %bb60 ], [ %tmp119, %bb88 ]
  %tmp96 = phi float [ %a6, %bb60 ], [ %tmp120, %bb88 ]
  %tmp97 = phi float [ %a7, %bb60 ], [ %tmp121, %bb88 ]
  ...
  %tmp113 = call <8 x float> @llvm.genx.GenISA.sub.group.dpas.v8f32.v8f32.v8i16.v8i32(<8 x float> %tmp112, <8 x i16> zeroinitializer, <8 x i32> zeroinitializer, i32 0, i32 0, i32 0, i32 0, i1 false)
