...
; There are 10 candidate stores but PreferredVectorSize is 8, so only the first
; aligned group of 8 is vectorized; the trailing 2 stores are left untouched
; (chunking is program-order aligned, the tail is dropped).

; CHECK-LABEL: @k
; CHECK: %vectorized_cast = bitcast <8 x float> %src to <8 x i32>
; CHECK: call void @llvm.genx.GenISA.PredicatedStore.p1.i32(ptr addrspace(1) @g8, i32 %bc8
; CHECK: call void @llvm.genx.GenISA.PredicatedStore.p1.i32(ptr addrspace(1) @g9, i32 %bc9
...
@g8 = external addrspace(1) global i32
@g9 = external addrspace(1) global i32
...
entry:
  ...
  %bc8 = bitcast float %e0 to i32
  %bc9 = bitcast float %e1 to i32
  call void @llvm.genx.GenISA.PredicatedStore.p1.i32(ptr addrspace(1) @g8, i32 %bc8, i64 4, i1 %pred)
  call void @llvm.genx.GenISA.PredicatedStore.p1.i32(ptr addrspace(1) @g9, i32 %bc9, i64 4, i1 %pred)
  ret void
}
