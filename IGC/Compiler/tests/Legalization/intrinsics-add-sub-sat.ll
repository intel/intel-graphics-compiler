...
; CHECK-PRE22:    [[TMP3:%.*]] = select <4 x i1> [[TMP2]], <4 x i64> <i64 -1, i64 -1, i64 -1, i64 -1>, <4 x i64> [[TMP1]]
; CHECK-LLVM22:    [[TMP3:%.*]] = select <4 x i1> [[TMP2]], <4 x i64> splat (i64 -1), <4 x i64> [[TMP1]]
; CHECK:    ret <4 x i64> [[TMP3]]
;
...
; CHECK-PRE22:    [[TMP4:%.*]] = xor <4 x i64> [[TMP2]], <i64 -1, i64 -1, i64 -1, i64 -1>
; CHECK-LLVM22:    [[TMP4:%.*]] = xor <4 x i64> [[TMP2]], splat (i64 -1)
; CHECK:    [[TMP5:%.*]] = xor <4 x i64> [[TMP1]], [[TMP4]]
; CHECK:    [[TMP6:%.*]] = xor <4 x i64> [[TMP3]], [[TMP1]]
; CHECK-PRE22:    [[TMP7:%.*]] = xor <4 x i64> [[TMP5]], <i64 -1, i64 -1, i64 -1, i64 -1>
; CHECK-LLVM22:    [[TMP7:%.*]] = xor <4 x i64> [[TMP5]], splat (i64 -1)
...
; CHECK-PRE22:    [[TMP11:%.*]] = select <4 x i1> [[TMP10]], <4 x i64> <i64 -9223372036854775808, i64 -9223372036854775808, i64 -9223372036854775808, i64 -9223372036854775808>, <4 x i64> <i64 9223372036854775807, i64 9223372036854775807, i64 9223372036854775807, i64 9223372036854775807>
; CHECK-LLVM22:    [[TMP11:%.*]] = select <4 x i1> [[TMP10]], <4 x i64> splat (i64 -9223372036854775808), <4 x i64> splat (i64 9223372036854775807)
...
; CHECK-PRE22:    [[TMP6:%.*]] = xor <4 x i64> [[TMP4]], <i64 -1, i64 -1, i64 -1, i64 -1>
; CHECK-LLVM22:    [[TMP6:%.*]] = xor <4 x i64> [[TMP4]], splat (i64 -1)
...
; CHECK-PRE22:    [[TMP10:%.*]] = select <4 x i1> [[TMP9]], <4 x i64> <i64 9223372036854775807, i64 9223372036854775807, i64 9223372036854775807, i64 9223372036854775807>, <4 x i64> <i64 -9223372036854775808, i64 -9223372036854775808, i64 -9223372036854775808, i64 -9223372036854775808>
; CHECK-LLVM22:    [[TMP10:%.*]] = select <4 x i1> [[TMP9]], <4 x i64> splat (i64 9223372036854775807), <4 x i64> splat (i64 -9223372036854775808)
...
; CHECK-PRE22:    [[TMP3:%.*]] = select <4 x i1> [[TMP2]], <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>, <4 x i32> [[TMP1]]
; CHECK-LLVM22:    [[TMP3:%.*]] = select <4 x i1> [[TMP2]], <4 x i32> splat (i32 -1), <4 x i32> [[TMP1]]
; CHECK:    ret <4 x i32> [[TMP3]]
;
...
; CHECK-PRE22:    [[TMP4:%.*]] = xor <4 x i32> [[TMP2]], <i32 -1, i32 -1, i32 -1, i32 -1>
; CHECK-LLVM22:    [[TMP4:%.*]] = xor <4 x i32> [[TMP2]], splat (i32 -1)
; CHECK:    [[TMP5:%.*]] = xor <4 x i32> [[TMP1]], [[TMP4]]
; CHECK:    [[TMP6:%.*]] = xor <4 x i32> [[TMP3]], [[TMP1]]
; CHECK-PRE22:    [[TMP7:%.*]] = xor <4 x i32> [[TMP5]], <i32 -1, i32 -1, i32 -1, i32 -1>
; CHECK-LLVM22:    [[TMP7:%.*]] = xor <4 x i32> [[TMP5]], splat (i32 -1)
...
; CHECK-PRE22:    [[TMP11:%.*]] = select <4 x i1> [[TMP10]], <4 x i32> <i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648>, <4 x i32> <i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647>
; CHECK-LLVM22:    [[TMP11:%.*]] = select <4 x i1> [[TMP10]], <4 x i32> splat (i32 -2147483648), <4 x i32> splat (i32 2147483647)
...
; CHECK-PRE22:    [[TMP6:%.*]] = xor <4 x i32> [[TMP4]], <i32 -1, i32 -1, i32 -1, i32 -1>
; CHECK-LLVM22:    [[TMP6:%.*]] = xor <4 x i32> [[TMP4]], splat (i32 -1)
...
; CHECK-PRE22:    [[TMP10:%.*]] = select <4 x i1> [[TMP9]], <4 x i32> <i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647>, <4 x i32> <i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648>
; CHECK-LLVM22:    [[TMP10:%.*]] = select <4 x i1> [[TMP9]], <4 x i32> splat (i32 2147483647), <4 x i32> splat (i32 -2147483648)
...
; CHECK-PRE22:    [[TMP3:%.*]] = select <8 x i1> [[TMP2]], <8 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, <8 x i16> [[TMP1]]
; CHECK-LLVM22:    [[TMP3:%.*]] = select <8 x i1> [[TMP2]], <8 x i16> splat (i16 -1), <8 x i16> [[TMP1]]
; CHECK:    ret <8 x i16> [[TMP3]]
;
...
; CHECK-PRE22:    [[TMP4:%.*]] = xor <8 x i16> [[TMP2]], <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>
; CHECK-LLVM22:    [[TMP4:%.*]] = xor <8 x i16> [[TMP2]], splat (i16 -1)
; CHECK:    [[TMP5:%.*]] = xor <8 x i16> [[TMP1]], [[TMP4]]
; CHECK:    [[TMP6:%.*]] = xor <8 x i16> [[TMP3]], [[TMP1]]
; CHECK-PRE22:    [[TMP7:%.*]] = xor <8 x i16> [[TMP5]], <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>
; CHECK-LLVM22:    [[TMP7:%.*]] = xor <8 x i16> [[TMP5]], splat (i16 -1)
...
; CHECK-PRE22:    [[TMP11:%.*]] = select <8 x i1> [[TMP10]], <8 x i16> <i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768>, <8 x i16> <i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767>
; CHECK-LLVM22:    [[TMP11:%.*]] = select <8 x i1> [[TMP10]], <8 x i16> splat (i16 -32768), <8 x i16> splat (i16 32767)
...
; CHECK-PRE22:    [[TMP6:%.*]] = xor <8 x i16> [[TMP4]], <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>
; CHECK-LLVM22:    [[TMP6:%.*]] = xor <8 x i16> [[TMP4]], splat (i16 -1)
...
; CHECK-PRE22:    [[TMP10:%.*]] = select <8 x i1> [[TMP9]], <8 x i16> <i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767, i16 32767>, <8 x i16> <i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768, i16 -32768>
; CHECK-LLVM22:    [[TMP10:%.*]] = select <8 x i1> [[TMP9]], <8 x i16> splat (i16 32767), <8 x i16> splat (i16 -32768)
...
; CHECK-PRE22:    [[TMP3:%.*]] = select <16 x i1> [[TMP2]], <16 x i8> <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>, <16 x i8> [[TMP1]]
; CHECK-LLVM22:    [[TMP3:%.*]] = select <16 x i1> [[TMP2]], <16 x i8> splat (i8 -1), <16 x i8> [[TMP1]]
; CHECK:    ret <16 x i8> [[TMP3]]
;
...
; CHECK-PRE22:    [[TMP6:%.*]] = xor <16 x i8> [[TMP4]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; CHECK-LLVM22:    [[TMP6:%.*]] = xor <16 x i8> [[TMP4]], splat (i8 -1)
...
; CHECK-PRE22:    [[TMP10:%.*]] = select <16 x i1> [[TMP9]], <16 x i8> <i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127>, <16 x i8> <i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128>
; CHECK-LLVM22:    [[TMP10:%.*]] = select <16 x i1> [[TMP9]], <16 x i8> splat (i8 127), <16 x i8> splat (i8 -128)
...
; CHECK-PRE22:    [[TMP4:%.*]] = xor <16 x i8> [[TMP2]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; CHECK-LLVM22:    [[TMP4:%.*]] = xor <16 x i8> [[TMP2]], splat (i8 -1)
; CHECK:    [[TMP5:%.*]] = xor <16 x i8> [[TMP1]], [[TMP4]]
; CHECK:    [[TMP6:%.*]] = xor <16 x i8> [[TMP3]], [[TMP1]]
; CHECK-PRE22:    [[TMP7:%.*]] = xor <16 x i8> [[TMP5]], <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; CHECK-LLVM22:    [[TMP7:%.*]] = xor <16 x i8> [[TMP5]], splat (i8 -1)
...
; CHECK-PRE22:    [[TMP11:%.*]] = select <16 x i1> [[TMP10]], <16 x i8> <i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128, i8 -128>, <16 x i8> <i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127, i8 127>
; CHECK-LLVM22:    [[TMP11:%.*]] = select <16 x i1> [[TMP10]], <16 x i8> splat (i8 -128), <16 x i8> splat (i8 127)
