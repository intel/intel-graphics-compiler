...
; CHECK:    ret double {{(0x7FF800007FF80000|\+nan\(0x7FF80000\))}}
;
...
; CHECK:    [[TMP1:%.*]] = insertelement <2 x float> undef, float {{(0x7FFF000000000000|\+nan\(0x380000\))}}, i32 0
; CHECK:    [[TMP2:%.*]] = insertelement <2 x float> [[TMP1]], float {{(0x7FFF000000000000|\+nan\(0x380000\))}}, i32 1
...
; CHECK-LLVM22:    [[TMP4:%.*]] = insertelement <2 x float> splat (float {{(0x7FFF000000000000|\+nan\(0x380000\))}}), float 1.000000e+00, i32 0
