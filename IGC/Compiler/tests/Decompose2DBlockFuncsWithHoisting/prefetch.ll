...
; RUN: igc_opt --igc-restore-genisa-intrinsics --opaque-pointers -decompose-2d-block-funcs-with-hoisting --regkey=AllowPrefetchDecomposeWithHoisting=1 -dce -platformbmg -S < %s 2>&1 | FileCheck %s
