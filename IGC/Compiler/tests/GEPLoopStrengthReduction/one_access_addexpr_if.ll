...
define spir_kernel void @test(ptr addrspace(1) %p, i32 %n, i32 %c, <8 x i32> %r0, <8 x i32> %payloadHeader, <3 x i32> %enqueuedLocalSize, i16 %localIdX, i16 %localIdY, i16 %localIdZ, i32 %bufferOffset) #0 {
entry:
...
; CHECK:         %arrayidx6 = getelementptr inbounds i32, ptr addrspace(1) %p, i64 %idxprom5
; CHECK:         %0 = load i32, ptr addrspace(1) %arrayidx6, align 4
cond.1:                                           ; preds = %for.body
  %sub4 = add nsw i32 %add, -32
  %idxprom5 = sext i32 %sub4 to i64
  %arrayidx6 = getelementptr inbounds i32, ptr addrspace(1) %p, i64 %idxprom5
  %0 = load i32, ptr addrspace(1) %arrayidx6, align 4
