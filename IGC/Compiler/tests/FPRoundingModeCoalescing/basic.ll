...
; RUN: igc_opt -debugify --igc-fp-rounding-mode-coalescing -check-debugify -S < %s 2>&1 | FileCheck %s
...
!5 = !{void (double, double, double, double addrspace(1)*)* @uses_in_default_rm_create_dependency, !100}
!6 = !{void (double, double, double, double addrspace(1)*)* @multiple_rm_modes, !100}
!7 = !{void (double, double, double, double addrspace(1)*)* @max_distance_threshold_with_insert_point, !100}
!8 = !{void (double, double, double, double addrspace(1)*)* @max_distance_threshold_without_insert_point, !100}
!9 = !{void (double, double, double, double addrspace(1)*)* @side_effect, !100}
!100 = !{!101}
