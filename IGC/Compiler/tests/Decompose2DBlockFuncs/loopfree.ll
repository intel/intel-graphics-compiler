...
; CHECK-LABEL: entry:
; CHECK-NEXT: call void @llvm.genx.GenISA.LSC2DBlockPrefetch(i64 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i1 false, i1 true, i32 11)
; CHECK-NEXT: ret void
entry:
...
; CHECK-LABEL: entry:
; CHECK-NEXT:  = call <16 x i32> @llvm.genx.GenISA.LSC2DBlockRead.v16i32(i64 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i1 false, i1 true, i32 11)
; CHECK-NEXT: ret void
...
; CHECK-LABEL: entry:
; CHECK-NEXT: call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i32(i64 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i1 false, i1 true, i32 11, <8 x i32> %val)
; CHECK-NEXT: ret void
entry:
  call void @llvm.genx.GenISA.LSC2DBlockWrite.v8i32(i64 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i1 false, i1 true, i32 11, <8 x i32> %val)
  ret void
}
