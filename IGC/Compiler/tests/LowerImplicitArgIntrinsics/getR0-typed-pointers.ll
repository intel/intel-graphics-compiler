...
!29 = !{!"argId", i32 13}
!30 = !{!"implicitArgInfoListVec[6]", !29}
!31 = !{!"argId", i32 15}
!32 = !{!"explicitArgNum", i32 0}
!33 = !{!"implicitArgInfoListVec[7]", !31, !32}
!34 = !{!"implicitArgInfoList", !18, !20, !22, !24, !26, !28, !30, !33}
!35 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, <3 x i32>, i16, i16, i16, i8*, i32)* @test}
!36 = !{!"FuncMDValue[0]", !34}
!37 = !{!"FuncMD", !35, !36}
!38 = !{!"ModuleMD", !37}
!IGCMetadata = !{!38}
