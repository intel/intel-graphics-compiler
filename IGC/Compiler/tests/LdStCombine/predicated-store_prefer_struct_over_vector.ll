...
; CHECK:       call void @llvm.genx.GenISA.PredicatedStore.p1.v2i32(ptr addrspace(1) %{{.*}}, <2 x i32> %[[TMP]]
; CHECK:       ret
...
entry:
  ...
  call void @llvm.genx.GenISA.PredicatedStore.p1f32.f32(float addrspace(1)* %x.sroa.0.0..sroa_idx, float %add, i64 4, i1 true)
  %x.sroa.4.0..sroa_idx2 = getelementptr inbounds %struct.dw1_t, %struct.dw1_t addrspace(1)* %2, i64 %conv.i.i, i32 1
  call void @llvm.genx.GenISA.PredicatedStore.p1i32.i32(i32 addrspace(1)* %x.sroa.4.0..sroa_idx2, i32 %conv5, i64 4, i1 true)
  ret void
}
