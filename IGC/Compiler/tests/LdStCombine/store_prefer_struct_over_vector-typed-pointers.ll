...
!343 = !{!"argId", i32 0}
!344 = !{!"implicitArgInfoListVec[0]", !343}
!345 = !{!"argId", i32 1}
!346 = !{!"implicitArgInfoListVec[1]", !345}
!347 = !{!"argId", i32 8}
!348 = !{!"implicitArgInfoListVec[2]", !347}
!349 = !{!"argId", i32 9}
!350 = !{!"implicitArgInfoListVec[3]", !349}
!351 = !{!"argId", i32 10}
!352 = !{!"implicitArgInfoListVec[4]", !351}
!353 = !{!"implicitArgInfoList", !344, !346, !348, !350, !352}
!354 = !{!"FuncMDMap[0]", void (i8 addrspace(1)*, float addrspace(1)*, i32 addrspace(1)*, <8 x i32>, <8 x i32>, i16, i16, i16)* @test_st}
!355 = !{!"FuncMDValue[0]", !353}
!356 = !{!"FuncMD", !354, !355}
!357 = !{!"ModuleMD", !356}
!IGCMetadata = !{!357}
