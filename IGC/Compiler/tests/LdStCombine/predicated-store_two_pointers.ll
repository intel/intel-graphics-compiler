...
; RUN: | FileCheck %s
 ...
 ; CHECK: call void @llvm.genx.GenISA.PredicatedStore.p1v2i64.v2i64(<2 x i64> addrspace(1)* [[TMP3]], <2 x i64> [[TMP2]], i64 8, i1 true)
 ; CHECK: ret void
...
entry:
  ...
  call void @llvm.genx.GenISA.PredicatedStore.p1p1i64.p1i64(i64 addrspace(1)* addrspace(1)* %arrayidx, i64 addrspace(1)* %d, i64 8, i1 true)
  %add = add nuw nsw i64 %conv.i.i, 1
  %arrayidx1 = getelementptr inbounds i64 addrspace(1)*, i64 addrspace(1)* addrspace(1)* %P, i64 %add
  call void @llvm.genx.GenISA.PredicatedStore.p1p1i64.p1i64(i64 addrspace(1)* addrspace(1)* %arrayidx1, i64 addrspace(1)* %s, i64 8, i1 true)
  ret void
}

declare void @llvm.genx.GenISA.PredicatedStore.p1p1i64.p1i64(i64 addrspace(1)* addrspace(1)*, i64 addrspace(1)*, i64, i1)
