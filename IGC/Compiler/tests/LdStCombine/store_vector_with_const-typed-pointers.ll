...
; RUN: igc_opt %s -S -igc-ldstcombine -regkey=EnableLdStCombine=1 \
; RUN:           -platformbmg \
; RUN: | FileCheck %s
...
!350 = !{!"argId", i32 0}
!351 = !{!"implicitArgInfoListVec[0]", !350}
!352 = !{!"argId", i32 1}
!353 = !{!"implicitArgInfoListVec[1]", !352}
!354 = !{!"argId", i32 8}
!355 = !{!"implicitArgInfoListVec[2]", !354}
!356 = !{!"argId", i32 9}
!357 = !{!"implicitArgInfoListVec[3]", !356}
!358 = !{!"argId", i32 10}
!359 = !{!"implicitArgInfoListVec[4]", !358}
!360 = !{!"implicitArgInfoList", !351, !353, !355, !357, !359}
!361 = !{!"FuncMDMap[0]", void (i8 addrspace(1)*, i64 addrspace(1)*, double addrspace(1)*, i32, <8 x i32>, <8 x i32>, i16, i16, i16)* @test_vector}
!362 = !{!"FuncMDValue[0]", !360}
!363 = !{!"FuncMD", !361, !362}
!364 = !{!"ModuleMD", !363}
!IGCMetadata = !{!364}
