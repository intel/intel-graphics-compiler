...
!26 = !{!"argId", i32 10}
!27 = !{!"implicitArgInfoListVec[5]", !26}
!28 = !{!"argId", i32 11}
!29 = !{!"implicitArgInfoListVec[6]", !28}
!30 = !{!"argId", i32 13}
!31 = !{!"implicitArgInfoListVec[7]", !30}
!32 = !{!"argId", i32 15}
!33 = !{!"explicitArgNum", i32 0}
!34 = !{!"implicitArgInfoListVec[8]", !32, !33}
!35 = !{!"argId", i32 15}
!36 = !{!"explicitArgNum", i32 1}
!37 = !{!"implicitArgInfoListVec[9]", !35, !36}
!38 = !{!"implicitArgInfoList", !17, !19, !21, !23, !25, !27, !29, !31, !34, !37}
!39 = !{!"FuncMDMap[0]", void (<4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, float, i32, <3 x i32>, i16, i16, i16, i8 addrspace(2)*, i8*)* @WaveletDenoise}
!40 = !{!"FuncMDValue[0]", !38}
!41 = !{!"FuncMD", !39, !40}
!42 = !{!"ModuleMD", !41}
!IGCMetadata = !{!42}
