...
; when buffers may not fit in 4GB (GreaterThan4GBBufferRequired == true), so
; offsetFitsIn32Bits must prove each offset fits in u32 via computeKnownBits.

target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"

%struct.S = type { [8 x float], [8 x float] }

define spir_kernel void @narrow_offset_slow_gep_chain(ptr addrspace(1) align 32 %src) {
entry:
  %i = call i16 @get_i()
  %i64 = zext i16 %i to i64
  %j = call i16 @get_j()
  %j64 = zext i16 %j to i64
  %gep1 = getelementptr inbounds %struct.S, ptr addrspace(1) %src, i64 %i64
  %gep2 = getelementptr inbounds %struct.S, ptr addrspace(1) %gep1, i32 0, i32 1
  %gep3 = getelementptr inbounds float, ptr addrspace(1) %gep2, i64 %j64

; CHECK-LABEL: @narrow_offset_slow_gep_chain
;
; --- GEP 1: dynamic index, stride 64 ---
; CHECK: %[[T1:.*]] = trunc i64 %i64 to i32
; CHECK: %[[MUL1:.*]] = mul i32 64, %[[T1]]
; CHECK: %[[ADD1:.*]] = add i32 0, %[[MUL1]]
;
; --- GEP 2: struct field 1 offset = 32 ---
; CHECK: %[[ADD2:.*]] = add i32 %[[ADD1]], 32
;
; --- GEP 3: dynamic index, stride 4 ---
; CHECK: %[[T2:.*]] = trunc i64 %j64 to i32
...
!0 = !{!"ModuleMD", !1, !8}
!1 = !{!"FuncMD", !2, !3}
!2 = !{!"FuncMDMap[0]", ptr @narrow_offset_slow_gep_chain}
!3 = !{!"FuncMDValue[0]", !4}
!4 = !{!"resAllocMD", !5}
!5 = !{!"argAllocMDList", !6}
...
!10 = !{ptr @narrow_offset_slow_gep_chain, !11}
!11 = !{!12}
