...
; RUN: igc_opt %s -S -o - -inputocl -platformdg2 -igc-vectorpreprocess | FileCheck %s

target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "spir64-unknown-unknown"

; CHECK: [[VEC2:%.*]] = call <2 x i64> @llvm.genx.GenISA.ldrawvector.indexed.v2i64.p2490368v4i64(<4 x i64> addrspace(2490368)* %bo0, i32 0, i32 32, i1 false)
; CHECK: [[ELT0:%.*]] = extractelement <2 x i64> [[VEC2]], i32 0
; CHECK: [[ELT1:%.*]] = extractelement <2 x i64> [[VEC2]], i32 1
; CHECK: [[ELT2:%.*]] = call i64 @llvm.genx.GenISA.ldrawvector.indexed.i64.p2490368v4i64(<4 x i64> addrspace(2490368)* %bo0, i32 16, i32 16, i1 false)
