...
define spir_kernel void @sycl_multi_ptr_comparison_op(%half_impl addrspace(3)*, %half_impl addrspace(1)* readonly, %sycl_V1*, %mptr_nullptr_result addrspace(1)*, %sycl_V1*, i64 %const_reg_qword, i64 %const_reg_qword1) {
  ...
  %8 = add i64 %7, %6
  %9 = call i32 @llvm.genx.GenISA.bitcastfromstruct.i32.__StructSOALayout_(%__StructSOALayout_ <{ %__StructAOSLayout_ <{ <2 x i8 > < i8 ptrtoint (ptr addrspace(3) @sycl_multi_ptr_comparison_op-ExtSLM to i8), i8 1 >, i8 ptrtoint (ptr addrspace(3) getelementptr ([0 x i8], ptr addrspace(3) @sycl_multi_ptr_comparison_op-ExtSLM, i64 0, i64 1) to i8), i8 ptrtoint (ptr addrspace(3) getelementptr ([0 x i8], ptr addrspace(3) @sycl_multi_ptr_comparison_op-ExtSLM, i64 0, i64 2) to i8) }> }>)
