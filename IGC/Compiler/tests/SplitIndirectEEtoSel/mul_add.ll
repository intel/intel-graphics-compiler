...
;
; RUN: igc_opt -enable-debugify -SplitIndirectEEtoSel -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,%LLVM_DEPENDENT_CHECK_PREFIX%
; ------------------------------------------------
...
; CHECK-LLVM-14-PLUS:    [[TMP16:%.*]] = select i1 [[TMP14]], float [[TMP15]], float poison
; CHECK-PRE-LLVM-14:    [[TMP16:%.*]] = select i1 [[TMP14]], float [[TMP15]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP28:%.*]] = select i1 [[TMP26]], float [[TMP27]], float poison
; CHECK-PRE-LLVM-14:    [[TMP28:%.*]] = select i1 [[TMP26]], float [[TMP27]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP17:%.*]] = select i1 [[TMP15]], float [[TMP16]], float poison
; CHECK-PRE-LLVM-14:    [[TMP17:%.*]] = select i1 [[TMP15]], float [[TMP16]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP29:%.*]] = select i1 [[TMP27]], float [[TMP28]], float poison
; CHECK-PRE-LLVM-14:    [[TMP29:%.*]] = select i1 [[TMP27]], float [[TMP28]], float undef
