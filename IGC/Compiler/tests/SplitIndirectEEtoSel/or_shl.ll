...
; CHECK-LLVM-14-PLUS:    [[TMP6:%.*]] = select i1 [[TMP4]], float [[TMP5]], float poison
; CHECK-PRE-LLVM-14:     [[TMP6:%.*]] = select i1 [[TMP4]], float [[TMP5]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP14:%.*]] = select i1 [[TMP12]], float [[TMP13]], float poison
; CHECK-PRE-LLVM-14:    [[TMP14:%.*]] = select i1 [[TMP12]], float [[TMP13]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP22:%.*]] = select i1 [[TMP20]], float [[TMP21]], float poison
; CHECK-PRE-LLVM-14:    [[TMP22:%.*]] = select i1 [[TMP20]], float [[TMP21]], float undef
...
; CHECK-LLVM-14-PLUS:    [[TMP8:%.*]] = select i1 [[TMP6]], float [[TMP7]], float poison
; CHECK-PRE-LLVM-14:    [[TMP8:%.*]] = select i1 [[TMP6]], float [[TMP7]], float undef
