...
; REQUIRES: regkeys
; RUN: igc_opt --regkey TotalGRFNum=200 --regkey DumpLoopSink=1 --regkey PrintToConsole=1 --regkey LoopSinkThresholdDelta=20 --regkey DisableCodeSinking=0 --regkey DisableLoopSink=0 --regkey EnableLoadChainLoopSink=1 -platformdg2 -simd-mode 16 --igc-wi-analysis --basic-aa --scev-aa --igc-code-loop-sinking -S %s 2>&1 | FileCheck %s
