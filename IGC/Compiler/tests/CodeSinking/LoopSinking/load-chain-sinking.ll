...
; CHECK:         [[TMP41:%.*]] = inttoptr i64 [[TMP40]] to ptr addrspace(2)
; CHECK:         [[TMP42:%.*]] = load double, ptr addrspace(2) [[TMP41]], align 8
...
; CHECK:         [[TMP44:%.*]] = inttoptr i64 [[TMP43]] to ptr addrspace(2)
; CHECK:         [[TMP45:%.*]] = load double, ptr addrspace(2) [[TMP44]], align 8
...
; CHECK:         [[TMP49:%.*]] = inttoptr i64 [[TMP48]] to ptr addrspace(2)
; CHECK:         [[TMP50:%.*]] = load double, ptr addrspace(2) [[TMP49]], align 8
...
; CHECK:         [[TMP52:%.*]] = inttoptr i64 [[TMP51]] to ptr addrspace(2)
; CHECK:         [[TMP53:%.*]] = load double, ptr addrspace(2) [[TMP52]], align 8
