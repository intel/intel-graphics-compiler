...
define i32 @foo(i32 %dim, <8 x i32> %r0, <8 x i32> %payloadHeader, <3 x i32> %numGroups) nounwind {
  %id = call i32 @__builtin_IB_get_num_groups(i32 1)
  ret i32 %id
}
...
; CHECK:         %numGroups1 = extractelement <3 x i32> %numGroups, i32 1

; CHECK-NOT:     call i32 @__builtin_IB_get_num_groups(i32 1)
