...
define i32 @foo(i32 %dim, <8 x i32> %r0, <8 x i32> %payloadHeader) nounwind {
  %id = call i32 @__builtin_IB_get_global_offset(i32 1)
  ret i32 %id
}
...
; CHECK:         %globalOffset = extractelement <8 x i32> %payloadHeader, i32 1

; CHECK-NOT:     call i32 @__builtin_IB_get_global_offset(i32 1)
