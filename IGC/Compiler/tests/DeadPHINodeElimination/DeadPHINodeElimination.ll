...
outer.loop:                                       ; preds = %outer.loop.preheader, %if.end2
  ...
  call void @llvm.dbg.value(metadata float %a0, metadata !1, metadata !1) ; prevents ai from being removed
  %x0 = phi float [ 0.0, %outer.loop.preheader ], [ %x4, %if.end2 ]
  call void @llvm.dbg.value(metadata float %x0, metadata !1, metadata !1) ; prevents xi from being removed
