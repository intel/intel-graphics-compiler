...
;
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata float [[LOAD_V:%[A-z0-9.]*]], metadata [[LOAD_MD:![0-9]*]], metadata !DIExpression()), !dbg [[LOAD_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value(float [[LOAD_V:%[A-z0-9.]*]], [[LOAD_MD:![0-9]*]], !DIExpression(), [[LOAD_LOC:![0-9]*]])
; CHECK-DAG: [[LOAD_V]] = {{.*}} !dbg [[LOAD_LOC]]
;
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata float [[FADD_V:%[A-z0-9.]*]], metadata [[FADD_MD:![0-9]*]], metadata !DIExpression()), !dbg [[FADD_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value(float [[FADD_V:%[A-z0-9.]*]], [[FADD_MD:![0-9]*]], !DIExpression(), [[FADD_LOC:![0-9]*]])
