...
!15 = !{!16, !17, !19}
!57 = !{!"argId", i32 0}
!58 = !{!"implicitArgInfoListVec[0]", !57}
!59 = !{!"argId", i32 1}
!60 = !{!"implicitArgInfoListVec[1]", !59}
!61 = !{!"implicitArgInfoList", !58, !60}
!62 = !{!"FuncMDMap[0]", void (%opencl.image3d_t.read_only addrspace(1)*, i32 addrspace(1)*)* @sample_kernel}
!63 = !{!"FuncMDValue[0]", !61}
!64 = !{!"FuncMD", !62, !63}
!65 = !{!"ModuleMD", !64}
!IGCMetadata = !{!65}
