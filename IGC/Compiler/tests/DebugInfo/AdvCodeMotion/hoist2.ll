...
; RUN: igc_opt --opaque-pointers  -adv-codemotion-cm=1 -igc-advcodemotion -S < %s | FileCheck %s --check-prefixes=CHECK,%if llvm-22-plus %{CHECK-DBG-RECORDS%} %else %{CHECK-DBG-INTRINSIC%}
; ------------------------------------------------
; AdvCodeMotion
; ------------------------------------------------
...
!91 = !{!"argId", i32 0}
!92 = !{!"implicitArgInfoListVec[0]", !91}
!93 = !{!"argId", i32 1}
!94 = !{!"implicitArgInfoListVec[1]", !93}
!95 = !{!"argId", i32 5}
!96 = !{!"implicitArgInfoListVec[2]", !95}
!97 = !{!"argId", i32 6}
!98 = !{!"implicitArgInfoListVec[3]", !97}
!99 = !{!"argId", i32 13}
!100 = !{!"implicitArgInfoListVec[4]", !99}
!101 = !{!"argId", i32 15}
!102 = !{!"explicitArgNum", i32 0}
!103 = !{!"implicitArgInfoListVec[5]", !101, !102}
!104 = !{!"implicitArgInfoList", !92, !94, !96, !98, !100, !103}
!105 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, i16, i16, i16, <3 x i32>, <3 x i32>, <3 x i32>, i8*, i32)* @test}
