...
define spir_kernel void @test_extarga(i32 %a, <2 x i32> %b, <4 x i32> %c) !dbg !10 {
  %1 = call spir_func ptr @__builtin_IB_media_block_read_uchar(i32 %a, <2 x i32> %b, i32 0, i32 1), !dbg !18
  call void @llvm.dbg.value(metadata ptr %1, metadata !13, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.value(metadata ptr %3, metadata !17, metadata !DIExpression()), !dbg !22
  store i8 13, ptr %1, !dbg !23
  store <4 x i32> %2, ptr %3, !dbg !24
  ret void, !dbg !25
}
...
declare spir_func ptr @__builtin_IB_media_block_read_uchar(i32, <2 x i32>, i32, i32)
