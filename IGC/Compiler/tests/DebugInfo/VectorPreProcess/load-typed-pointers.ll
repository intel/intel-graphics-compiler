...
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata {{.*}}, metadata [[LOAD1_MD:![0-9]*]], metadata !DIExpression()), !dbg [[LOAD1_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value({{.*}}, [[LOAD1_MD:![0-9]*]], !DIExpression(), [[LOAD1_LOC:![0-9]*]])
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata {{.*}} [[EXTR1_V:%[A-z0-9]*]], metadata [[EXTR1_MD:![0-9]*]], metadata !DIExpression()), !dbg [[EXTR1_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value({{.*}} [[EXTR1_V:%[A-z0-9]*]], [[EXTR1_MD:![0-9]*]], !DIExpression(), [[EXTR1_LOC:![0-9]*]])
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata {{.*}} [[EXTR2_V:%[A-z0-9]*]], metadata [[EXTR2_MD:![0-9]*]], metadata !DIExpression()), !dbg [[EXTR2_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value({{.*}} [[EXTR2_V:%[A-z0-9]*]], [[EXTR2_MD:![0-9]*]], !DIExpression(), [[EXTR2_LOC:![0-9]*]])
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata {{.*}} [[EXTR3_V:%[A-z0-9]*]], metadata [[EXTR3_MD:![0-9]*]], metadata !DIExpression()), !dbg [[EXTR3_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value({{.*}} [[EXTR3_V:%[A-z0-9]*]], [[EXTR3_MD:![0-9]*]], !DIExpression(), [[EXTR3_LOC:![0-9]*]])
...
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata {{.*}}, metadata [[CALL0_MD:![0-9]*]], metadata !DIExpression()), !dbg [[CALL0_LOC]]
; CHECK-DBG-RECORDS-DAG: #dbg_value({{.*}}, [[CALL0_MD:![0-9]*]], !DIExpression(), [[CALL0_LOC]])
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata float [[CALL1_V]], metadata [[CALL1_MD:![0-9]*]], metadata !DIExpression()), !dbg [[CALL1_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value(float [[CALL1_V]], [[CALL1_MD:![0-9]*]], !DIExpression(), [[CALL1_LOC:![0-9]*]])
; CHECK-DBG-INTRINSIC-DAG: @llvm.dbg.value(metadata float [[CALL2_V]], metadata [[CALL2_MD:![0-9]*]], metadata !DIExpression()), !dbg [[CALL2_LOC:![0-9]*]]
; CHECK-DBG-RECORDS-DAG: #dbg_value(float [[CALL2_V]], [[CALL2_MD:![0-9]*]], !DIExpression(), [[CALL2_LOC:![0-9]*]])
