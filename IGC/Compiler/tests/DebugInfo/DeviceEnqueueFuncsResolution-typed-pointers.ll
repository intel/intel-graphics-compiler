...
; RUN: igc_opt --typed-pointers --igc-device-enqueue-func-resolution -S < %s | FileCheck %s
; ------------------------------------------------
...
!44 = !{!"argId", i32 40}
!45 = !{!"implicitArgInfoListVec[3]", !44}
!46 = !{!"argId", i32 41}
!47 = !{!"implicitArgInfoListVec[4]", !46}
!48 = !{!"implicitArgInfoList", !39, !41, !43, !45, !47}
!49 = !{!"FuncMDMap[0]", void (i8 addrspace(1)*, i8 addrspace(1)*, i32, i32, i32)* @test_device}
!50 = !{!"FuncMDValue[0]", !48}
!51 = !{!"FuncMD", !49, !50}
!52 = !{!"ModuleMD", !51}
!IGCMetadata = !{!52}
