...
define void @test_samplecmp(float %src1, float %src2, float %src3) !dbg !6 {
  %1 = call <4 x float> @llvm.genx.GenISA.sampleBCptr.v4f32.f32.p196609i8.p524293i8.p0i8(float %src1, float 0.000000e+00, float %src2, float %src3, float 0.000000e+00, float 0.000000e+00, i8 addrspace(196609)* null, i8 addrspace(524293)* inttoptr (i64 5 to i8 addrspace(524293)*), i8* null, i32 0, i32 0, i32 0), !dbg !16
...
declare <4 x float> @llvm.genx.GenISA.sampleBCptr.v4f32.f32.p196609i8.p524293i8.p0i8(float, float, float, float, float, float, i8 addrspace(196609)*, i8 addrspace(524293)*, i8*, i32, i32, i32)
