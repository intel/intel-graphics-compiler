...
;
; RUN: igc_opt -igc-stateless-to-stateful-resolution -S < %s | FileCheck %s --check-prefixes=CHECK,%if llvm-22-plus %{CHECK-DBG-RECORDS%} %else %{CHECK-DBG-INTRINSIC%}
; ------------------------------------------------
; StatelessToStateful
; ------------------------------------------------
...
!8 = !{!"FuncMDValue[0]", !9, !10, !14, !15, !16, !17, !32, !56, !57, !58, !59, !60, !61, !62, !63, !64, !65, !66, !67, !68, !125}
!9 = !{!"localOffsets"}
...
!122 = !{!"argId", i32 15}
!123 = !{!"explicitArgNum", i32 1}
!124 = !{!"implicitArgInfoListVec[7]", !122, !123}
!125 = !{!"implicitArgInfoList", !109, !111, !113, !115, !117, !119, !121, !124}
