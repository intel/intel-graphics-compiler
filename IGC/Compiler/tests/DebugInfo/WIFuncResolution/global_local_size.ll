...
!20 = !{!21, !22}
!41 = !{!"argId", i32 0}
!42 = !{!"implicitArgInfoListVec[0]", !41}
!43 = !{!"argId", i32 1}
!44 = !{!"implicitArgInfoListVec[1]", !43}
!45 = !{!"argId", i32 5}
!46 = !{!"implicitArgInfoListVec[2]", !45}
!47 = !{!"argId", i32 6}
!48 = !{!"implicitArgInfoListVec[3]", !47}
!49 = !{!"argId", i32 13}
!50 = !{!"implicitArgInfoListVec[4]", !49}
!51 = !{!"argId", i32 15}
!52 = !{!"explicitArgNum", i32 0}
!53 = !{!"implicitArgInfoListVec[5]", !51, !52}
!54 = !{!"implicitArgInfoList", !42, !44, !46, !48, !50, !53}
!55 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, <3 x i32>, <3 x i32>, i8*, i32)* @test_wi}
!56 = !{!"FuncMDValue[0]", !54}
!57 = !{!"FuncMD", !55, !56}
!58 = !{!"ModuleMD", !57}
!IGCMetadata = !{!58}
