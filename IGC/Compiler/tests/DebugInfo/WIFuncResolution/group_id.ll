...
entry:
  ...
  %call.i = call spir_func i32 @__builtin_IB_get_group_id(i32 0), !dbg !29
...
; Check MD:
;
; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "group_id.ll", directory: "/")
...
!16 = !DIFile(filename: "group_id.ll", directory: "/")
!17 = !DISubroutineType(types: !18)
!18 = !{!19, !20}
!34 = !{!"argId", i32 0}
!35 = !{!"implicitArgInfoListVec[0]", !34}
!36 = !{!"argId", i32 1}
!37 = !{!"implicitArgInfoListVec[1]", !36}
!38 = !{!"argId", i32 13}
!39 = !{!"implicitArgInfoListVec[2]", !38}
!40 = !{!"argId", i32 15}
!41 = !{!"explicitArgNum", i32 0}
!42 = !{!"implicitArgInfoListVec[3]", !40, !41}
!43 = !{!"implicitArgInfoList", !35, !37, !39, !42}
!44 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, i8*, i32)* @test_wi}
!45 = !{!"FuncMDValue[0]", !43}
!46 = !{!"FuncMD", !44, !45}
!47 = !{!"ModuleMD", !46}
!IGCMetadata = !{!47}
