...
; CHECK-DAG: @llvm.dbg.value(metadata i32 [[X_V]], metadata [[X_MD]], metadata !DIExpression()), !dbg [[XC_LOC:![0-9]*]]

define spir_kernel void @test_wi(i32 addrspace(1)* %dst, <8 x i32> %r0, <8 x i32> %payloadHeader, i32 %workDim, i8* %privateBase, i32 %bufferOffset) #0 !dbg !16 {
entry:
  ...
  %call.i = call spir_func i32 @__builtin_IB_get_work_dim(), !dbg !30
  call void @llvm.dbg.value(metadata i32 %call.i, metadata !27, metadata !DIExpression()), !dbg !30
...
; Check MD:
;
; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "work_dim.ll", directory: "/")
...
; CHECK-DAG: [[XC_LOC]] = !DILocation(line: 3, column: 11, scope: [[SCOPE]])
;
...
!6 = !{void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, i32, i8*, i32)* @test_wi, !7}
!7 = !{!8}
...
!17 = !DIFile(filename: "work_dim.ll", directory: "/")
...
!47 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, i32, i8*, i32)* @test_wi}
!48 = !{!"FuncMDValue[0]", !46}
!49 = !{!"FuncMD", !47, !48}
!50 = !{!"ModuleMD", !49}
!IGCMetadata = !{!50}
...
!30 = !DILocation(line: 3, column: 11, scope: !16)
