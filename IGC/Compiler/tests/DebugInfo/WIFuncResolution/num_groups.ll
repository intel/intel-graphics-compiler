...
!19 = !{!20, !21}
!35 = !{!"argId", i32 0}
!36 = !{!"implicitArgInfoListVec[0]", !35}
!37 = !{!"argId", i32 1}
!38 = !{!"implicitArgInfoListVec[1]", !37}
!39 = !{!"argId", i32 4}
!40 = !{!"implicitArgInfoListVec[2]", !39}
!41 = !{!"argId", i32 13}
!42 = !{!"implicitArgInfoListVec[3]", !41}
!43 = !{!"argId", i32 15}
!44 = !{!"explicitArgNum", i32 0}
!45 = !{!"implicitArgInfoListVec[4]", !43, !44}
!46 = !{!"implicitArgInfoList", !36, !38, !40, !42, !45}
!47 = !{!"FuncMDMap[0]", void (i32 addrspace(1)*, <8 x i32>, <8 x i32>, <3 x i32>, i8*, i32)* @test_wi}
!48 = !{!"FuncMDValue[0]", !46}
!49 = !{!"FuncMD", !47, !48}
!50 = !{!"ModuleMD", !49}
!IGCMetadata = !{!50}
