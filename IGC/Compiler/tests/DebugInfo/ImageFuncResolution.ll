...
!24 = !{!25, !26, !28}
!66 = !{!"argId", i32 0}
!67 = !{!"implicitArgInfoListVec[0]", !66}
!68 = !{!"argId", i32 1}
!69 = !{!"implicitArgInfoListVec[1]", !68}
!70 = !{!"argId", i32 13}
!71 = !{!"implicitArgInfoListVec[2]", !70}
!72 = !{!"argId", i32 21}
!73 = !{!"explicitArgNum", i32 0}
!74 = !{!"implicitArgInfoListVec[3]", !72, !73}
!75 = !{!"argId", i32 22}
!76 = !{!"explicitArgNum", i32 0}
!77 = !{!"implicitArgInfoListVec[4]", !75, !76}
!78 = !{!"argId", i32 23}
!79 = !{!"explicitArgNum", i32 0}
!80 = !{!"implicitArgInfoListVec[5]", !78, !79}
!81 = !{!"argId", i32 25}
!82 = !{!"explicitArgNum", i32 0}
!83 = !{!"implicitArgInfoListVec[6]", !81, !82}
!84 = !{!"argId", i32 26}
!85 = !{!"explicitArgNum", i32 0}
!86 = !{!"implicitArgInfoListVec[7]", !84, !85}
!87 = !{!"argId", i32 15}
!88 = !{!"explicitArgNum", i32 1}
!89 = !{!"implicitArgInfoListVec[8]", !87, !88}
!90 = !{!"implicitArgInfoList", !67, !69, !71, !74, !77, !80, !83, !86, !89}
!91 = !{!"FuncMDMap[0]", void (%opencl.image3d_t.read_only addrspace(1)*, i32 addrspace(1)*, <8 x i32>, <8 x i32>, i8*, i32, i32, i32, i32, i32, i32)* @sample_kernel}
!92 = !{!"FuncMDValue[0]", !90}
!93 = !{!"FuncMD", !91, !92}
!94 = !{!"ModuleMD", !93}
!IGCMetadata = !{!94}
