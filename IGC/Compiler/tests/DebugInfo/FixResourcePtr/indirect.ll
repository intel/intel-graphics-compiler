...
;
; CHECK: [[BUFP_V:%[0-9]*]] = call i32
; CHECK-SAME: !dbg [[BUFP_LOC:![0-9]*]]
; CHECK: call void @llvm.dbg.value{{.*}} [[BUFP_V]]
; CHECK-SAME: metadata [[BUFP_MD:![0-9]*]], metadata !DIExpression()), !dbg [[BUFP_LOC]]
;
; CHECK: [[BCAST_V:%[0-9]*]] = bitcast
; CHECK-SAME: !dbg [[BCAST_LOC:![0-9]*]]
; CHECK: call void @llvm.dbg.value{{.*}} [[BCAST_V]]
...
;
; NOTE: we'll lose gep value here after dce, ask
; CHECK: call void @llvm.dbg.value{{.*}} !dbg [[GEP_LOC:![0-9]*]]
;
...
define spir_kernel void @foo(i32 %src) !dbg !6 {
  %1 = call i32 addrspace(2752512)* @llvm.genx.GenISA.GetBufferPtr.p2752512i32(i32 13, i32 1), !dbg !16
  call void @llvm.dbg.value(metadata i32 addrspace(2752512)* %1, metadata !9, metadata !DIExpression()), !dbg !16
  %2 = bitcast i32 addrspace(2752512)* %1 to <2 x i16> addrspace(2752512)*, !dbg !17
  call void @llvm.dbg.value(metadata <2 x i16> addrspace(2752512)* %2, metadata !11, metadata !DIExpression()), !dbg !17
  %3 = load <2 x i16>, <2 x i16> addrspace(2752512)* %2, !dbg !18
  call void @llvm.dbg.value(metadata <2 x i16> %3, metadata !12, metadata !DIExpression()), !dbg !18
  store <2 x i16> %3, <2 x i16> addrspace(2752512)* %2, !dbg !19
  %4 = getelementptr inbounds i32, i32 addrspace(2752512)* %1, i32 4, !dbg !20
  call void @llvm.dbg.value(metadata i32 addrspace(2752512)* %4, metadata !14, metadata !DIExpression()), !dbg !20
  %5 = load i32, i32 addrspace(2752512)* %4, !dbg !21
  call void @llvm.dbg.value(metadata i32 %5, metadata !15, metadata !DIExpression()), !dbg !21
  store i32 %src, i32 addrspace(2752512)* %4, !dbg !22
  ret void, !dbg !23
}

; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "indirect.ll", directory: "/")
...
!1 = !DIFile(filename: "indirect.ll", directory: "/")
!2 = !{}
!3 = !{i32 8}
!4 = !{i32 5}
