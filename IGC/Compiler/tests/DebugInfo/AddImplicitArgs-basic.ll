...
; AddImplicitArgs
; ------------------------------------------------
; This test checks that AddImplicitArgs pass follows
...
; } st_foo;
;
; int foo(struct _st_foo s)
; {
;   return s.a + s.b;
; }
;
; __kernel void bar(__global uint* bdst, int bs1)
; {
;   bdst[1] = bs1;
; }
;
; __kernel void test_const(__global uint* dst, struct _st_foo src)
; {
;   dst[0] = foo(src);
;   bar(dst, src.a);
; }
...
define internal spir_func i32 @foo(%struct._st_foo* byval(%struct._st_foo) %s) #0 !dbg !32 {
entry:
...
define spir_kernel void @bar(i32 addrspace(1)* %bdst, i32 %bs1) #0 !dbg !47 {
entry:
...
; FOO_F
;
; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "AddImplicitArgs.ll", directory: "/")
...
!33 = !DIFile(filename: "AddImplicitArgs.ll", directory: "/")
...
!66 = !{!50, !51, !37}
!89 = !{!"argId", i32 0}
!90 = !{!"implicitArgInfoListVec[0]", !89}
!91 = !{!"argId", i32 1}
!92 = !{!"implicitArgInfoListVec[1]", !91}
!93 = !{!"argId", i32 13}
!94 = !{!"implicitArgInfoListVec[2]", !93}
!95 = !{!"implicitArgInfoList", !90, !92, !94}
!96 = !{!"argId", i32 0}
!97 = !{!"implicitArgInfoListVec[0]", !96}
!98 = !{!"argId", i32 1}
!99 = !{!"implicitArgInfoListVec[1]", !98}
!100 = !{!"argId", i32 13}
!101 = !{!"implicitArgInfoListVec[2]", !100}
!102 = !{!"argId", i32 18}
!103 = !{!"explicitArgNum", i32 1}
!104 = !{!"structArgOffset", i32 0}
!105 = !{!"implicitArgInfoListVec[3]", !102, !103, !104}
!106 = !{!"argId", i32 18}
!107 = !{!"explicitArgNum", i32 1}
!108 = !{!"structArgOffset", i32 4}
!109 = !{!"implicitArgInfoListVec[4]", !106, !107, !108}
!110 = !{!"implicitArgInfoList", !97, !99, !101, !105, !109}
