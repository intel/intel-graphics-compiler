...
; CHECK-LABEL: define spir_kernel void @matrix_load_checked(
  ...
  ret void
; CHECK: error: in kernel 'matrix_load_checked': Unsupported address space. Matrix checked load supports generic and global pointers.
; CHECK: error: in kernel 'matrix_load_checked': Unsupported row parameter for matrix checked load: 7. Supported values: 1, 2, 4, 8, 16, 32.
; CHECK: error: in kernel 'matrix_load_checked': Unsupported column parameter for matrix checked load: 66. Supported values: 8, 16, 32, 64.
; CHECK: error: in kernel 'matrix_load_checked': Matrix checked load size limit exceeded.
...
!4 = !{!"ModuleMD", !5}
!5 = !{!"FuncMD", !6, !7}
!6 = distinct !{!"FuncMDMap[0]", void (i8 addrspace(3)*)* @matrix_load_checked}
!7 = !{!"FuncMDValue[0]", !8, !9}
!8 = !{!"funcArgs"}
