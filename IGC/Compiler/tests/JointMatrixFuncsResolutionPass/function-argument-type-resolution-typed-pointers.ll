...
%jm = type { %spirv.JointMatrixINTEL._float_16_16_3_3_2 addrspace(1)* }
...
;
  ...
  %r1 = bitcast %jm* %r to %spirv.JointMatrixINTEL._float_16_16_3_3_2 addrspace(1)**
  %r2 = load %spirv.JointMatrixINTEL._float_16_16_3_3_2 addrspace(1)*, %spirv.JointMatrixINTEL._float_16_16_3_3_2 addrspace(1)** %r1
  call spir_func void @_Z29__spirv_JointMatrixStoreINTELPU3AS1fPU3AS143__spirv_JointMatrixINTEL__float_16_16_3_3_2liii(float addrspace(1)* %dst0, %spirv.JointMatrixINTEL._float_16_16_3_3_2 addrspace(1)* %r2, i64 16, i32 0, i32 3, i32 0)
  %tC3 = alloca %jm*
  store %jm* %r, %jm** %tC3
