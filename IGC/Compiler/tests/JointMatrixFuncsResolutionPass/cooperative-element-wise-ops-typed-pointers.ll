...
%spirv.CooperativeMatrixKHR._int_3_8_16_2 = type opaque
%spirv.CooperativeMatrixKHR._char_3_8_32_0 = type opaque
%spirv.CooperativeMatrixKHR._char_3_32_16_1 = type opaque
...
entry:
  %0 = alloca %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)*, align 8, !spirv.Decorations !20
  ...
  %sub_c.ascast.i = addrspacecast %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0 to %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* addrspace(4)*
  ...
  %23 = bitcast %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0 to i8*
  ...
  %call3.i = call spir_func %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* @_Z84__spirv_CooperativeMatrixLoadKHR_RPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2PU3AS1iili(i32 addrspace(1)* %add.ptr.i123, i32 0, i64 32, i32 0) #0
  store %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %call3.i, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0, align 8
  ...
  %sub_c.ascast.i.promoted = load %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)*, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0, align 1
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.body.i, %entry
  %call.i62170 = phi %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* [ %sub_c.ascast.i.promoted, %entry ], [ %call.i62, %for.body.i ]
  %24 = phi %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* [ %call3.i, %entry ], [ %call.i62, %for.body.i ]
...
for.cond.i67.preheader:                           ; preds = %for.cond.i
  store %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %call.i62170, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0, align 1
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  %call2.i51 = call spir_func %spirv.CooperativeMatrixKHR._char_3_8_32_0 addrspace(1)* @_Z85__spirv_CooperativeMatrixLoadKHR_RPU3AS143__spirv_CooperativeMatrixKHR__char_3_8_32_0PU3AS1cili(i8 addrspace(1)* %add.ptr.i132, i32 0, i64 64, i32 0) #0
  %mul25.i = shl nuw nsw i64 %mul17.i, 5, !spirv.Decorations !23
  %gep = getelementptr i8, i8 addrspace(1)* %invariant.gep, i64 %mul25.i
  %call2.i60 = call spir_func %spirv.CooperativeMatrixKHR._char_3_32_16_1 addrspace(1)* @_Z86__spirv_CooperativeMatrixLoadKHR_RPU3AS144__spirv_CooperativeMatrixKHR__char_3_32_16_1PU3AS1cili(i8 addrspace(1)* %gep, i32 2, i64 128, i32 0) #0
  %call.i62 = call spir_func %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* @_Z34__spirv_CooperativeMatrixMulAddKHRPU3AS143__spirv_CooperativeMatrixKHR__char_3_8_32_0PU3AS144__spirv_CooperativeMatrixKHR__char_3_32_16_1PU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2i(%spirv.CooperativeMatrixKHR._char_3_8_32_0 addrspace(1)* %call2.i51, %spirv.CooperativeMatrixKHR._char_3_32_16_1 addrspace(1)* %call2.i60, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %24, i32 0) #0
  %add.i = add nuw nsw i32 %k.0.i, 1, !spirv.Decorations !25
  br label %for.cond.i

for.cond.i67:                                     ; preds = %for.body.i70, %for.cond.i67.preheader
  %26 = phi %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* [ %.pre, %for.body.i70 ], [ %24, %for.cond.i67.preheader ]
  %i.0.i = phi i32 [ %inc.i, %for.body.i70 ], [ 0, %for.cond.i67.preheader ]
  %conv.i = zext i32 %i.0.i to i64
  %call.i = call spir_func i64 @_Z34__spirv_CooperativeMatrixLengthKHRPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2(%spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %26) #0
...
for.body.i70:                                     ; preds = %for.cond.i67
  %call.i145 = call spir_func i32 addrspace(4)* @_Z19__spirv_AccessChainPU3AS4PU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2l(%spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* addrspace(4)* %sub_c.ascast.i, i64 %conv.i) #0
  %27 = load i32, i32 addrspace(4)* %call.i145, align 4
  %mul.i = shl nsw i32 %27, 1, !spirv.Decorations !21
  %call.i148 = call spir_func i32 addrspace(4)* @_Z19__spirv_AccessChainPU3AS4PU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2l(%spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* addrspace(4)* %sub_c.ascast.i, i64 %conv.i) #0
  store i32 %mul.i, i32 addrspace(4)* %call.i148, align 4
  %inc.i = add nuw nsw i32 %i.0.i, 1, !spirv.Decorations !25
  %.pre = load %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)*, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0, align 8
  br label %for.cond.i67
...
_ZN4sycl3_V13ext6oneapi12experimental6matrix18joint_matrix_applyINS0_9sub_groupEiLNS4_3useTESTLm8ELm16ELNS4_6layoutE3EZZZ15matrix_multiplyILm8ELm16ELm32ELm4EZ4mainE16pvc_uint_8x16x32ihLm16ELm32ELm64EEvR10big_matrixIT4_XT6_EXT7_EERSB_IT5_XT6_EXT8_EERSB_ISF_XdvT8_T2_EXmlT7_T2_EEENKUlRNS0_7handlerEE_clESL_ENKUlNS0_7nd_itemILi2EEEE_clESO_EUlRiE_EEvT_RNS4_12joint_matrixISS_T0_XT1_EXT2_EXT3_EXT4_EEEOSF_.exit: ; preds = %for.cond.i67
  %28 = load %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)*, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0, align 8
  call spir_func void @_Z33__spirv_CooperativeMatrixStoreKHRPU3AS1iPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2ili(i32 addrspace(1)* %add.ptr.i123, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %28, i32 0, i64 32, i32 0) #0
  %29 = bitcast %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)** %0 to i8*
...
; Function Attrs: nounwind
declare spir_func %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* @_Z84__spirv_CooperativeMatrixLoadKHR_RPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2PU3AS1iili(i32 addrspace(1)* %0, i32 %1, i64 %2, i32 %3) #0

; Function Attrs: nounwind
declare spir_func %spirv.CooperativeMatrixKHR._char_3_8_32_0 addrspace(1)* @_Z85__spirv_CooperativeMatrixLoadKHR_RPU3AS143__spirv_CooperativeMatrixKHR__char_3_8_32_0PU3AS1cili(i8 addrspace(1)* %0, i32 %1, i64 %2, i32 %3) #0

; Function Attrs: nounwind
declare spir_func %spirv.CooperativeMatrixKHR._char_3_32_16_1 addrspace(1)* @_Z86__spirv_CooperativeMatrixLoadKHR_RPU3AS144__spirv_CooperativeMatrixKHR__char_3_32_16_1PU3AS1cili(i8 addrspace(1)* %0, i32 %1, i64 %2, i32 %3) #0

; Function Attrs: nounwind
declare spir_func %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* @_Z34__spirv_CooperativeMatrixMulAddKHRPU3AS143__spirv_CooperativeMatrixKHR__char_3_8_32_0PU3AS144__spirv_CooperativeMatrixKHR__char_3_32_16_1PU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2i(%spirv.CooperativeMatrixKHR._char_3_8_32_0 addrspace(1)* %0, %spirv.CooperativeMatrixKHR._char_3_32_16_1 addrspace(1)* %1, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %2, i32 %3) #0

; Function Attrs: nounwind
declare spir_func i64 @_Z34__spirv_CooperativeMatrixLengthKHRPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2(%spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %0) #0

; Function Attrs: nounwind
declare spir_func i32 addrspace(4)* @_Z19__spirv_AccessChainPU3AS4PU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2l(%spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* addrspace(4)* %0, i64 %1) #0

; Function Attrs: nounwind
declare spir_func void @_Z33__spirv_CooperativeMatrixStoreKHRPU3AS1iPU3AS142__spirv_CooperativeMatrixKHR__int_3_8_16_2ili(i32 addrspace(1)* %0, %spirv.CooperativeMatrixKHR._int_3_8_16_2 addrspace(1)* %1, i32 %2, i64 %3, i32 %4) #0
