...
; CHECK:   %0 = call i32 @llvm.genx.GenISA.RuntimeValue.i32(i32 6)
; CHECK-NEXT:   %1 = call i64 @llvm.genx.GenISA.RuntimeValue.i64(i32 2)
; CHECK-NEXT:   %2 = add i32 %0, 128
; CHECK-NEXT:   %3 = zext i32 %2 to i64
; CHECK-NEXT:   br label %secondBB
; CHECK: secondBB:
