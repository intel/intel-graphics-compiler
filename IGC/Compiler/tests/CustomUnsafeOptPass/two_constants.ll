...
entry:
  %0 = fadd fast float %x, 1.000000e+00
  %1 = fadd fast float %0, 2.000000e+00
  ret float %1
}

; CHECK-LABEL: define float @test1
; CHECK-NOT: 1.000000e+00
; CHECK: %0 = fadd fast float %x, 3.000000e+00
; CHECK: ret float %0

; 3 - (2 - x) => 1 + x
define float @test2(float %x) #0 {
entry:
  %0 = fsub fast float 2.000000e+00, %x
  %1 = fsub fast float 3.000000e+00, %0
  ret float %1
}

; CHECK-LABEL: define float @test2
; CHECK-NOT: 2.000000e+00
; CHECK: %0 = fadd fast float %x, 1.000000e+00
; CHECK: ret float %0
...
; CHECK-NOT: 2.000000e+00
; CHECK: %0 = fsub fast float 3.000000e+00, %x
; CHECK: ret float %0
...
entry:
  ...
  %1 = fsub fast float %0, 2.000000e+00
  ret float %1
}
...
entry:
  ...
  %1 = fmul fast float %0, 3.000000e+00
  ret float %1
}

; CHECK-LABEL: define float @test5
; CHECK-NOT: 2.000000e+00
; CHECK: %0 = fmul fast float %x, 6.000000e+00
; CHECK: ret float %0
