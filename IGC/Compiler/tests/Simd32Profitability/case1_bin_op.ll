...
;
; RUN: igc_opt --opaque-pointers --regkey PrintToConsole --enable-profitability-print --simd32-profit -igc-serialize-metadata --inputocl --platformbmg -S < %s 2>&1 | FileCheck %s
; ------------------------------------------------
