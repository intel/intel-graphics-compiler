...
define internal spir_func void @set_alloca_to_global_ptr(i32 addrspace(4)** %alloca, i32 addrspace(1)* %global_ptr) {
  %1 = addrspacecast i32 addrspace(1)* %global_ptr to i32 addrspace(4)*
  store i32 addrspace(4)* %1, i32 addrspace(4)** %alloca, align 8
  ret void
}

define internal spir_func void @main(i32 %gid, i32 addrspace(3)* %local_ptr, i32 addrspace(1)* %global_ptr) {
...
if.then:
  ...
  br label %continue
if.else:
  call spir_func void @set_alloca_to_global_ptr(i32 addrspace(4)** %generic_alloca, i32 addrspace(1)* %global_ptr)
  br label %continue
continue:
...
!3 = !{void (i32 addrspace(4)**, i32 addrspace(1)*)* @set_alloca_to_global_ptr, !1}
!4 = !{void (i32, i32 addrspace(3)*, i32 addrspace(1)*)* @main, !1}
