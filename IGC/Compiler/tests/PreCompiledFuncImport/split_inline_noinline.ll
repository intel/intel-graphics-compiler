...
; REQUIRES: regkeys
;
; RUN: igc_opt -regkey TestIGCPreCompiledFunctions=2 -regkey InlinedEmulationThreshold=600 --platformmtl --print-codegencontext --igc-precompiled-import -S < %s 2>&1 | FileCheck %s
; ------------------------------------------------
