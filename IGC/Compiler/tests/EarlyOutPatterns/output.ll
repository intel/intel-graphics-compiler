...
; CHECK:    [[TMP1:%[A-z0-9]*]] = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0.p0.p0(float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00, float 5.000000e+00, ptr null, ptr null, ptr null, i32 1, i32 2, i32 3)
...
; CHECK:    ret void
;
  %1 = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0.p0.p0(float 1.0, float 2.0, float 3.0, float 4.0, float 5.0, ptr null, ptr null, ptr null, i32 1, i32 2, i32 3)
