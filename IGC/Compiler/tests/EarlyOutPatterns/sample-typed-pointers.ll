...
; CHECK:  entry:
; CHECK:    [[TMP0:%[A-z0-9]*]] = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0f32.p0f32.p0i32(float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00, float 5.000000e+00, float* null, float* [[SRC1:%[A-z0-9]*]], i32* [[SRC2:%[A-z0-9]*]], i32 1, i32 2, i32 3)
; CHECK:    [[TMP1:%[A-z0-9]*]] = extractelement <4 x float> [[TMP0]], i32 0
; CHECK:    [[TMP2:%[A-z0-9]*]] = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0f32.p0f32.p0i32(float 2.000000e+00, float 3.000000e+00, float 4.000000e+00, float 5.000000e+00, float 6.000000e+00, float* null, float* [[SRC1]], i32* [[SRC2]], i32 1, i32 2, i32 3)
...
;
entry:
  %0 = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0f32.p0f32.p0i32(float 1.0, float 2.0, float 3.0, float 4.0, float 5.0, float* null, float* %src1, i32* %src2, i32 1, i32 2, i32 3)
  %1 = call <4 x float> @llvm.genx.GenISA.sampleptr.v4f32.f32.p0f32.p0f32.p0i32(float 2.0, float 3.0, float 4.0, float 5.0, float 6.0, float* null, float* %src1, i32* %src2, i32 1, i32 2, i32 3)
