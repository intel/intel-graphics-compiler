...
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 [[CMP]], i8 %0, i8 [[OR]]
; CHECK:  ret i8 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i8 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 true, i8 %0, i8 [[OR]]
; CHECK:  ret i8 [[SEL]]
...
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 [[CMP]], i64 %0, i64 [[OR]]
; CHECK:  ret i64 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i64 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 false, i64 %0, i64 [[OR]]
; CHECK:  ret i64 [[SEL]]
...
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select <2 x i1> [[CMP]], <2 x i16> %0, <2 x i16> [[OR]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i8 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 [[CMP]], i8 %1, i8 [[OR]]
; CHECK:  ret i8 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i8 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 true, i8 %1, i8 [[OR]]
; CHECK:  ret i8 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i32 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 false, i32 %1, i32 [[OR]]
; CHECK:  ret i32 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i64 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 [[CMP]], i64 %1, i64 [[OR]]
; CHECK:  ret i64 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or i64 [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select i1 false, i64 %1, i64 [[OR]]
; CHECK:  ret i64 [[SEL]]
...
; CHECK:  [[OR:%[a-zA-Z0-9]+]] = or <2 x i16> [[SHL]], [[LSHR]]
; CHECK:  [[SEL:%[a-zA-Z0-9]+]] = select <2 x i1> [[CMP]], <2 x i16> %1, <2 x i16> [[OR]]
; CHECK:  ret <2 x i16> [[SEL]]
