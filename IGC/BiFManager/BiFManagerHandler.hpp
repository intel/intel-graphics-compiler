...
namespace IGC
{
    namespace BiFManager
    {
        ...
        public:
            ...
            llvm::DataLayout* DL;
            std::string T;
            std::function<void(llvm::Module&, const llvm::StringSet<>&)> CallbackLinker;
        ...
        private:
            ...
            void getPtrSizeInBits(llvm::Module* pMain);
            ...
            void preapareBiFSections(
                llvm::Module& pMainModule,
                TFunctionsVec& BuiltInNeeded
            );
