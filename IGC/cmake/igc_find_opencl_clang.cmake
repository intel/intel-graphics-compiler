...
if(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  set(WINDOWS_PATH "prebuild-opencl-clang_${IGC_OPTION__LLVM_PREFERRED_VERSION}/windows/Release/${cpuSuffix}")
endif()
...
if(NOT CCLANG_FROM_SYSTEM)
  if(NOT CCLANG_BUILD_PREBUILDS_DIR)
    ...
    if(CMAKE_SYSTEM_NAME MATCHES "Windows")
      if(EXISTS "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../${WINDOWS_PATH}")
        set(CCLANG_BUILD_PREBUILDS_DIR "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../${WINDOWS_PATH}")
        else()
        set(CCLANG_BUILD_PREBUILDS_DIR "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../${LEGACY_PATH}")
      endif()
    endif()

    if(CMAKE_SYSTEM_NAME MATCHES "Linux")
      if(EXISTS "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../prebuild-opencl-clang/Release/64")
        set(CCLANG_BUILD_PREBUILDS_DIR "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../prebuild-opencl-clang/Release/64")
      elseif(EXISTS "${IGC_BUILD__GFX_DEV_SRC_DIR}/../../${LINUX_PATH}")
