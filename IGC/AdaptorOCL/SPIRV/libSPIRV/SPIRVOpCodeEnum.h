...
_SPIRV_OP(SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeMotionVectorsINTEL, 5770)
_SPIRV_OP(SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeDistortionsINTEL, 5771)
_SPIRV_OP(SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTEL, 5772)
_SPIRV_OP(SubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTEL, 5773)
_SPIRV_OP(SubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTEL, 5774)
_SPIRV_OP(SubgroupAvcImeGetStreamoutDualReferenceMajorShapeReferenceIdsINTEL, 5775)
...
_SPIRV_OP(JointMatrixSUMadINTEL, 6128)
...
_SPIRV_OP(GroupIMul, 6401)
_SPIRV_OP(GroupFMul, 6402)
_SPIRV_OP(GroupBitwiseAnd, 6403)
_SPIRV_OP(GroupBitwiseOr, 6404)
_SPIRV_OP(GroupBitwiseXor, 6405)
