...
bool PreprocessSPVIR::runOnModule(Module& M) {
    ...
    // Retype function arguments represented as TargetExtTy to use opaque
    // pointers instead. This is necessary to match function signatures
    // generated by Clang, given that it only has partial TargetExtTy support.
#if LLVM_VERSION_MAJOR >= 16
    retypeTargetExtTyArgs(&M);
#endif
