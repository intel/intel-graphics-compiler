...
char *GetParam(char *Head, char *Tail) {
  ...
  } while ((*Pos != 0) && ((*Pos != Delim) || ((*Pos == Delim) && ((QuoteDouble != Delim) || (QuoteSingle != Delim)))));
  if (*Pos == Delim) {
    *Pos = 0; // finish Head
    Pos++;    // skip zero
    while (*Pos == Delim) {
    ...
    if (pParam) {
      do {
        if (checkBinaryType) {
          ...
          isCommonOption =
              (strcmp(pParam, "-cl-single-precision-constant") == 0) || (strcmp(pParam, "-cl-denorms-are-zero") == 0) ||
              (strcmp(pParam, "-cl-fp32-correctly-rounded-divide-sqrt") == 0) ||
              (strcmp(pParam, "-cl-opt-disable") == 0) || (strcmp(pParam, "-ze-opt-disable") == 0) ||
              (strcmp(pParam, "-cl-strict-aliasing") == 0) || (strcmp(pParam, "-cl-mad-enable") == 0) ||
              (strcmp(pParam, "-cl-no-signed-zeros") == 0) || (strcmp(pParam, "-cl-unsafe-math-optimizations") == 0) ||
              (strcmp(pParam, "-cl-finite-math-only") == 0) || (strcmp(pParam, "-cl-fast-relaxed-math") == 0) ||
              (strcmp(pParam, "-cl-match-sincospi") == 0) || (strcmp(pParam, "-w") == 0) ||
              ...
              (strncmp(pParam, "-spir-std=", 10) == 0) || (strcmp(pParam, "-gline-tables-only") == 0) ||
              ...
              (strcmp(pParam, "-cl-intel-debug-info") == 0) || (strncmp(pParam, "-dump-opt-llvm", 14) == 0) ||
              ...
              (strcmp(pParam, "-cl-intel-enable-auto-large-GRF-mode") == 0) || (strcmp(pParam, "-ze-skip-fde") == 0) ||
              (strcmp(pParam, "-ze-no-fusedCallWA") == 0) || (strcmp(pParam, "-ze-disable-compaction") == 0) ||
              ...
              (strcmp(pParam, "-cl-intel-enable-ieee-float-exception-trap") ==
               0) || // used to enable IEEE float exception trap
              (strcmp(pParam, "-ze-intel-enable-ieee-float-exception-trap") ==
               0) || // used to enable IEEE float exception trap
          ...
          if (isCommonOption) {
            ...
            if ((strcmp(pParam, "-D") == 0) || (strcmp(pParam, "-I") == 0) || (strcmp(pParam, "-igc_opts") == 0)) {
              ...
              ignoreNextToken = true;
            } else if ((strcmp(pParam, "-cl-intel-large-grf-kernel") == 0) ||
                       (strcmp(pParam, "-ze-opt-large-grf-kernel") == 0) ||
                       (strcmp(pParam, "-cl-intel-regular-grf-kernel") == 0) ||
                       (strcmp(pParam, "-ze-opt-regular-grf-kernel") == 0)) {
          ...
          else if ((strcmp(pParam, "-g") == 0) || (strcmp(pParam, "-profiler") == 0) ||
...
bool CClangTranslationBlock::ReturnSuppliedIR(const STB_TranslateInputArgs *pInputArgs,
  ...
  for (unsigned i = 1; i < pHeader->NumSectionHeaderEntries; i++) {
    ...
    if ((pSectionHeader->Type == SH_TYPE_OPENCL_LLVM_ARCHIVE) || (pSectionHeader->Type == SH_TYPE_OPENCL_LLVM_BINARY)) {
      char *pData = NULL;
      size_t dataSize = 0;
...
bool CClangTranslationBlock::TranslateElf(const STB_TranslateInputArgs *pInputArgs,
                                          STB_TranslateOutputArgs *pOutputArgs, std::string &exceptString) {
  ...
  if (m_OutputFormat == TB_DATA_FORMAT_LLVM_BINARY || m_OutputFormat == TB_DATA_FORMAT_SPIR_V) {
    ...
    case EH_TYPE_OPENCL_SOURCE: {
      ...
      GetTranslateClangArgs(pElfReader.get(), pInputArgs->pOptions, pInputArgs->pInternalOptions, &args, exceptString);
...
bool CClangTranslationBlock::Translate(const STB_TranslateInputArgs *pInputArgs, STB_TranslateOutputArgs *pOutputArgs) {
  ...
  case TB_DATA_FORMAT_OCL_TEXT: {
    TranslateClangArgs args;
    GetTranslateClangArgs(pInputArgs->pInput, pInputArgs->InputSize, pInputArgs->pOptions, pInputArgs->pInternalOptions,
                          &args, exceptString);
    ...
    if (FCL_IGC_IS_FLAG_ENABLED(ShaderDumpEnable)) {
      ...
      QWORD hashValue = pInputArgs->SrcHash;
