...
namespace IGC {
  namespace VLD {
    ...
    public:
      ...
      // SPIR-V modules.
      // Returns a pair of binaries: first is SPMD module, second is ESIMD module.
      llvm::Expected<std::pair<ProgramStreamType, ProgramStreamType>> Split(
         const char* spv_buffer, uint32_t spv_buffer_size_in_bytes);
      ...
      static spv_result_t HandleInstructionCallback(
