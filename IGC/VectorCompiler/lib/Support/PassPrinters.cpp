...
FunctionPass *vc::createFunctionPassPrinter(const PassInfo *PI,
                                            raw_ostream &OS) {
  return new FunctionPassPrinter(PI, OS);
}

CallGraphSCCPass *vc::createCallGraphPassPrinter(const PassInfo *PI,
                                                 raw_ostream &OS) {
  return new CallGraphSCCPassPrinter(PI, OS);
}

ModulePass *vc::createModulePassPrinter(const PassInfo *PI, raw_ostream &OS) {
  return new ModulePassPrinter(PI, OS);
}

LoopPass *vc::createLoopPassPrinter(const PassInfo *PI, raw_ostream &OS) {
  return new LoopPassPrinter(PI, OS);
}

RegionPass *vc::createRegionPassPrinter(const PassInfo *PI, raw_ostream &OS) {
