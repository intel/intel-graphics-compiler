...
; CHECK: [[CALL:[^ ]+]] = call <16 x i16> @llvm.smin.v16i16(<16 x i16> [[REDUCE]], <16 x i16> {{(splat \(i16 -180\)|<i16 -180(, i16 -180)*>)}})
...
; CHECK: [[CALL:[^ ]+]] = call <16 x i8> @llvm.umin.v16i8(<16 x i8> %2, <16 x i8> {{(splat \(i8 -76\)|<i8 -76(, i8 -76)*>)}}
