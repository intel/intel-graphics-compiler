...
define dllexport spir_kernel void @test_kernel1()  {
  ...
  ;CHECK:  ashr <8 x i64> {{(splat \(i64 -360\)|<i64 -360(, i64 -360)*>)}}
  ;CHECK:  ashr <8 x i64> {{(splat \(i64 15006\)|<i64 15006(, i64 15006)*>)}}
  ;CHECK:  ashr <8 x i64> {{(splat \(i64 80542\)|<i64 80542(, i64 80542)*>)}}, %2
  ;CHECK:  ashr <8 x i64> {{(splat \(i64 -1576977762\)|<i64 -1576977762(, i64 -1576977762)*>)}}, %2
  ;CHECK:  lshr <8 x i64> {{(splat \(i64 -360\)|<i64 -360(, i64 -360)*>)}}
  ;CHECK:  lshr <8 x i64> {{(splat \(i64 15006\)|<i64 15006(, i64 15006)*>)}}
  ;CHECK:  lshr <8 x i64> {{(splat \(i64 80542\)|<i64 80542(, i64 80542)*>)}}, %2
  ;CHECK:  lshr <8 x i64> {{(splat \(i64 -1576977762\)|<i64 -1576977762(, i64 -1576977762)*>)}}, %2
