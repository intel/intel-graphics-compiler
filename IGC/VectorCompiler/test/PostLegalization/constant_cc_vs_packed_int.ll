...
define <8 x i32> @test_vector_8_i32_P() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[SCALE:%.*]] = mul <8 x i32> [[CONST]], {{(splat \(i32 88\)|<i32 88(, i32 88)*>)}}
  ; CHECK-NEXT:  [[ADJUST:%.*]] = add <8 x i32> [[SCALE]], {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}
...
define <16 x i32> @test_vector_16_i32_P() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[RESULT:%.*]] = mul <16 x i32> [[SPLIT1]], {{(splat \(i32 10\)|<i32 10(, i32 10)*>)}}
...
define <16 x i32> @test_vector_16_i32_CC() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[CONST0:%.*]] = call <1 x i32> @llvm.genx.constanti.v1i32(<1 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}})
  ; CHECK-NEXT:  [[SPLAT:%.*]] = call <16 x i32> @llvm.genx.rdregioni.v16i32.v1i32.i16(<1 x i32> [[CONST0]], i32 0, i32 16, i32 0, i16 0, i32 undef)
  ; CHECK-NEXT:  [[RESULT:%.*]] = call <16 x i32> @llvm.genx.wrconstregion.v16i32.v1i32.i16.i1(<16 x i32> [[SPLAT]], <1 x i32> {{(splat \(i32 89\)|<i32 89(, i32 89)*>)}}, i32 1, i32 1, i32 1, i16 0, i32 undef, i1 true)
  ; CHECK-NEXT:  ret <16 x i32> [[RESULT]]
...
define <16 x i32> @test_vector_16_i32_MIX() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[SCALE:%.*]] = mul <8 x i32> [[CONST]], {{(splat \(i32 72\)|<i32 72(, i32 72)*>)}}
  ; CHECK-NEXT:  [[ADJUST:%.*]] = add <8 x i32> [[SCALE]], {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}
  ...
  ; CHECK-NEXT:  [[CONST0:%.*]] = call <16 x i32> @llvm.genx.wrconstregion.v16i32.v8i32.i16.i1(<16 x i32> [[SPLIT]], <8 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 8, i32 1, i16 0, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST1:%.*]] = call <16 x i32> @llvm.genx.wrconstregion.v16i32.v1i32.i16.i1(<16 x i32> [[CONST0]], <1 x i32> {{(splat \(i32 3\)|<i32 3(, i32 3)*>)}}, i32 1, i32 1, i32 1, i16 4, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST2:%.*]] = call <16 x i32> @llvm.genx.wrconstregion.v16i32.v1i32.i16.i1(<16 x i32> [[CONST1]], <1 x i32> {{(splat \(i32 89\)|<i32 89(, i32 89)*>)}}, i32 1, i32 1, i32 1, i16 0, i32 undef, i1 true)
...
define <32 x i32> @test_vector_32_i32_CC() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[CONST0:%.*]] = call <1 x i32> @llvm.genx.constanti.v1i32(<1 x i32> {{(splat \(i32 89\)|<i32 89(, i32 89)*>)}})
  ; CHECK-NEXT:  [[SPLAT:%.*]] = call <32 x i32> @llvm.genx.rdregioni.v32i32.v1i32.i16(<1 x i32> [[CONST0]], i32 0, i32 32, i32 0, i16 0, i32 undef)
  ; CHECK-NEXT:  [[CONST1:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v8i32.i16.i1(<32 x i32> [[SPLAT]], <8 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 8, i32 1, i16 4, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST2:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v8i32.i16.i1(<32 x i32> [[CONST1]], <8 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 8, i32 1, i16 68, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST3:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v4i32.i16.i1(<32 x i32> [[CONST2]], <4 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 4, i32 1, i16 48, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST4:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v4i32.i16.i1(<32 x i32> [[CONST3]], <4 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 4, i32 1, i16 112, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST5:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v8i32.i16.i1(<32 x i32> [[CONST4]], <8 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 8, i32 1, i16 12, i32 undef, i1 true)
  ; CHECK-NEXT:  [[CONST6:%.*]] = call <32 x i32> @llvm.genx.wrconstregion.v32i32.v2i32.i16.i1(<32 x i32> [[CONST5]], <2 x i32> {{(splat \(i32 1\)|<i32 1(, i32 1)*>)}}, i32 1, i32 2, i32 1, i16 100, i32 undef, i1 true)
...
define <32 x i8> @test_vector_32_i8_CC() local_unnamed_addr #1 {
  ...
  ; CHECK-NEXT:  [[CONST0:%.*]] = call <1 x i32> @llvm.genx.constanti.v1i32(<1 x i32> {{(splat \(i32 16843009\)|<i32 16843009(, i32 16843009)*>)}})
  ...
  ; CHECK-NEXT:  [[RESULT:%.*]] = call <32 x i8> @llvm.genx.wrconstregion.v32i8.v1i8.i16.i1(<32 x i8> [[BITCAST]], <1 x i8> {{(splat \(i8 89\)|<i8 89(, i8 89)*>)}}, i32 1, i32 1, i32 1, i16 0, i32 undef, i1 true)
