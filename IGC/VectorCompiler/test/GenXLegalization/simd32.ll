...
define <64 x i64> @test1(<64 x i64> %src) {
  ...
  ; Xe3P-NEXT: %[[ADD_SPLIT0:.+]] = add <16 x i64> %[[IN_SPLIT0]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
  ...
  ; Xe3P-NEXT: %[[ADD_SPLIT16:.+]] = add <16 x i64> %[[IN_SPLIT16]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
  ...
  ; Xe3PLPG-NEXT: %[[ADD:.+]] = add <32 x i64> %[[IN]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
...
define <72 x i64> @test2(<72 x i64> %src) {
  ...
  ; CHECK-NEXT: %[[ADD0:.+]] = add <8 x i64> %[[IN0]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
  ...
  ; CHECK-NEXT: %[[ADD8:.+]] = add <8 x i64> %[[IN8]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
  ...
  ; CHECK-NEXT: %[[ADD16:.+]] = add <8 x i64> %[[IN16]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
  ...
  ; CHECK-NEXT: %[[ADD24:.+]] = add <8 x i64> %[[IN24]], {{(splat \(i64 1\)|<i64 1(, i64 1)*>)}}
