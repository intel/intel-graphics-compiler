...
define void @test(i32 %bti, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod, <16 x i32> %passthru) {
  ; CHECK: call void @llvm.vc.internal.lsc.prefetch.quad.tgm.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 1, i32 %bti, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod)
  ...
  ; CHECK: %load = call <16 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v16i32.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 15, i32 %bti, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod, <16 x i32> %passthru)
  ...
  ; CHECK: call void @llvm.vc.internal.lsc.store.quad.tgm.v4i1.v2i8.v4i32.v16i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 15, i32 %bti, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod, <16 x i32> %load)
