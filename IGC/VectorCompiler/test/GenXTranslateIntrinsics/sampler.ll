...
; RUN: %opt_new_pm_typed -passes=GenXTranslateIntrinsics -mcpu=XeHPG -mtriple=spir64-unknown-unknown -S < %s | FileCheck %s
...
; CHECK: %load = call <16 x float> @llvm.vc.internal.sampler.load.bti.v16f32.v16i1.v16i32(<16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i16 26, i8 1, i16 0, i32 %bti, <16 x float> undef, <16 x i32> %u, <16 x i32> %v, <16 x i32> %r, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer)
...
; CHECK: %sample = call <16 x float> @llvm.vc.internal.sample.bti.v16f32.v16i1.v16f32(<16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i16 0, i8 1, i16 0, i32 %bti, i32 %sampler, <16 x float> undef, <16 x float> %u, <16 x float> %v, <16 x float> %r, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x float> zeroinitializer)
