...
define float @test_large(<256 x float> %src) {
  ; CHECK: %reduce = call reassoc float @llvm.vector.reduce.fadd.v256f32(float -0.000000e+00, <256 x float> %src)
