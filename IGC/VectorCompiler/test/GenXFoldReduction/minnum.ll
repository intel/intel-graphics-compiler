...
declare <128 x float> @llvm.minnum.v128f32(<128 x float>, <128 x float>)
...
define float @test_large(<256 x float> %src) {
  ; CHECK: %reduce = call reassoc float @llvm.vector.reduce.fmin.v256f32(<256 x float> %src)
  ...
  %3 = call <128 x float> @llvm.minnum.v128f32(<128 x float> %1, <128 x float> %2)
  ...
  %6 = call <64 x float> @llvm.minnum.v64f32(<64 x float> %4, <64 x float> %5)
  ...
  %9 = call <32 x float> @llvm.minnum.v32f32(<32 x float> %7, <32 x float> %8)
  ...
  %15 = call <8 x float> @llvm.minnum.v8f32(<8 x float> %13, <8 x float> %14)
  ...
  %18 = call <4 x float> @llvm.minnum.v4f32(<4 x float> %16, <4 x float> %17)
  ...
  %21 = call <2 x float> @llvm.minnum.v2f32(<2 x float> %19, <2 x float> %20)
  %22 = extractelement <2 x float> %21, i32 0
  %23 = extractelement <2 x float> %21, i32 1
  %reduce = call float @llvm.minnum.f32(float %22, float %23)
  ret float %reduce
}
