...
; RUN: %opt_opaque_ptrs %use_old_pass_manager% -CMABILegacy -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-OPAQUE-PTRS,BIG-ON,BIG-ON-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS
; RUN: %opt_new_pm_typed -passes=CMABI -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-TYPED-PTRS,BIG-ON,BIG-ON-TYPED-PTRS,COMMON,COMMON-TYPED-PTRS
; RUN: %opt_new_pm_opaque -passes=CMABI -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-OPAQUE-PTRS,BIG-ON,BIG-ON-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS


; COM: vc-max-cmabi-byval-size=0: turn off byval generation for CM ABI.
; RUN: %opt_typed_ptrs %use_old_pass_manager% -CMABILegacy -vc-max-cmabi-byval-size=0 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-OFF,SMALL-OFF-TYPED-PTRS,BIG-OFF-TYPED-PTRS,COMMON,COMMON-TYPED-PTRS
; RUN: %opt_opaque_ptrs %use_old_pass_manager% -CMABILegacy -vc-max-cmabi-byval-size=0 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-OFF,SMALL-OFF-OPAQUE-PTRS,BIG-OFF-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS
; RUN: %opt_new_pm_typed -passes=CMABI -vc-max-cmabi-byval-size=0 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-OFF,SMALL-OFF-TYPED-PTRS,BIG-OFF-TYPED-PTRS,COMMON,COMMON-TYPED-PTRS
; RUN: %opt_new_pm_opaque -passes=CMABI -vc-max-cmabi-byval-size=0 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-OFF,SMALL-OFF-OPAQUE-PTRS,BIG-OFF-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS


; COM: vc-max-cmabi-byval-size=8: very small threshold for byval generation for CM ABI.
; RUN: %opt_typed_ptrs %use_old_pass_manager% -CMABILegacy -vc-max-cmabi-byval-size=8 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-TYPED-PTRS,BIG-OFF-TYPED-PTRS,COMMON,COMMON-TYPED-PTRS
; RUN: %opt_opaque_ptrs %use_old_pass_manager% -CMABILegacy -vc-max-cmabi-byval-size=8 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-OPAQUE-PTRS,BIG-OFF-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS
; RUN: %opt_new_pm_typed -passes=CMABI -vc-max-cmabi-byval-size=8 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-TYPED-PTRS,BIG-OFF-TYPED-PTRS,COMMON,COMMON-TYPED-PTRS
; RUN: %opt_new_pm_opaque -passes=CMABI -vc-max-cmabi-byval-size=8 -march=genx64 -mcpu=XeHPG -S < %s | FileCheck %s --check-prefixes=SMALL-ON,SMALL-ON-OPAQUE-PTRS,BIG-OFF-OPAQUE-PTRS,COMMON,COMMON-OPAQUE-PTRS
