...
define dllexport spir_kernel void @bf8_cvtKernel_out_sat(i32 %0, i32 %1) local_unnamed_addr #0 {
  ...
  %sat = tail call <16 x i8> @llvm.genx.uutrunc.sat.v16i8.v16i8(<16 x i8> %upd_vec)
...
!2 = !{i32 1, i32 2}
!3 = !{i16 6, i16 14}
!4 = !{void (i32, i32)* @bf8_cvtKernel_out_sat, !"bf8_cvtKernel_out_sat", !5, i32 0, !6, !1, !7, i32 0}
!5 = !{i32 2, i32 2}
!6 = !{i32 64, i32 68}
!7 = !{!"buffer_t", !"buffer_t"}
!8 = !{void (i32, i32)* @bf8_cvtKernel_out_sat, null, null, null, null}
