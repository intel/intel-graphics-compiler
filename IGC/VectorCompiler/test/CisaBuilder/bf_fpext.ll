...
declare <8 x bfloat> @llvm.genx.oword.ld.v8bf16(i32, i32, i32)
...
define dllexport spir_kernel void @bf_cvtKernel_in(i32 %0, i32 %1) local_unnamed_addr #0 {
  %vec = tail call <8 x bfloat> @llvm.genx.oword.ld.v8bf16(i32 0, i32 %0, i32 0)
  %upd_vec = fpext <8 x bfloat> %vec to <8 x float>
