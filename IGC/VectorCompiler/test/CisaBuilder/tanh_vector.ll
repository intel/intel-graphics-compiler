...
declare <16 x float> @llvm.vc.internal.tanh.v16f32(<16 x float>)
declare <16 x half> @llvm.vc.internal.tanh.v16f16(<16 x half>)

; CHECK-LABEL: .kernel "tanh"
; CHECK-DAG: .decl [[VF32:V[0-9]+]] v_type=G type=f num_elts=16
; CHECK-DAG: .decl [[VF16:V[0-9]+]] v_type=G type=hf num_elts=16
define dllexport spir_kernel void @tanh(i64 %buffer) local_unnamed_addr #0 {
  ...
  ; CHECK: tanh (M1, 16) [[VF32]](0,0)<1> [[VF32]](0,0)<1;1,0>
  %f32d = call <16 x float> @llvm.vc.internal.tanh.v16f32(<16 x float> %f32s)
  ; CHECK: tanh (M1, 16) [[VF16]](0,0)<1> [[VF16]](0,0)<1;1,0>
  %f16d = call <16 x half> @llvm.vc.internal.tanh.v16f16(<16 x half> %f16s)
...
!2 = !{i32 1, i32 2}
!3 = !{i16 6, i16 14}
!4 = !{void (i64)* @tanh, !"tanh", !5, i32 0, !6, !1, !7, i32 0}
!5 = !{i32 0}
!6 = !{i32 64}
!7 = !{!"svmptr_t"}
!8 = !{void (i64)* @tanh, null, null, null, null}
