...
declare void @llvm.genx.oword.st.v8bf16(i32, i32, <8 x bfloat>)
...
define dllexport spir_kernel void @bf_cvtKernel_out(i32 %0, i32 %1) local_unnamed_addr #0 {
  ...
  %upd_vec = fptrunc <8 x float> %vec to <8 x bfloat>
  tail call void @llvm.genx.oword.st.v8bf16(i32 %1, i32 0, <8 x bfloat> %upd_vec)
  ret void
}
