...
define dllexport spir_kernel void @hf8_cvtKernel_in(i32 %0, i32 %1) local_unnamed_addr #0 {
...
!2 = !{i32 1, i32 2}
!3 = !{i16 6, i16 14}
!4 = !{void (i32, i32)* @hf8_cvtKernel_in, !"hf8_cvtKernel_in", !5, i32 0, !6, !1, !7, i32 0}
!5 = !{i32 2, i32 2}
!6 = !{i32 64, i32 68}
!7 = !{!"buffer_t", !"buffer_t"}
!8 = !{void (i32, i32)* @hf8_cvtKernel_in, null, null, null, null}
