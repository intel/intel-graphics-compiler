...
; CHECK-DAG: .decl [[SRC:V[^ ]+]] v_type=G type=hf8 num_elts=16 alias
; CHECK-DAG: .decl [[DST:V[^ ]+]] v_type=G type=hf num_elts=16 alias
; CHECK: mov (M1_NM, 16) [[DST]](0,0)<1> [[SRC]](0,0)<1;1,0>
...
declare <16 x half> @llvm.genx.hf8.cvt.v16f16.v16i8(<16 x i8>)
declare <16 x half> @llvm.genx.sat.v16f16(<16 x half>)
declare void @llvm.genx.oword.st.v16f16(i32, i32, <16 x half>)

define dllexport spir_kernel void @hf8_cvtKernel_in_sat(i32 %0, i32 %1) local_unnamed_addr #0 {
  %vec = tail call <16 x i8> @llvm.genx.oword.ld.v16i8(i32 0, i32 %0, i32 0)
  %upd_vec = tail call <16 x half> @llvm.genx.hf8.cvt.v16f16.v16i8(<16 x i8> %vec)
...
!2 = !{i32 1, i32 2}
!3 = !{i16 6, i16 14}
!4 = !{void (i32, i32)* @hf8_cvtKernel_in_sat, !"hf8_cvtKernel_in_sat", !5, i32 0, !6, !1, !7, i32 0}
!5 = !{i32 2, i32 2}
!6 = !{i32 64, i32 68}
!7 = !{!"buffer_t", !"buffer_t"}
!8 = !{void (i32, i32)* @hf8_cvtKernel_in_sat, null, null, null, null}
