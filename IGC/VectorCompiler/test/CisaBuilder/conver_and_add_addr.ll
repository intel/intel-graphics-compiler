...
entry:
  ...
  %ugm = call <8 x i64> @llvm.vc.internal.lsc.load.ugm.v8i64.v1i1.i64(<1 x i1> <i1 true>, i8 3, i8 4, i8 5, i8 0, i8 0, i64 0, i64 %ptrtoint, i16 1, i32 0, <8 x i64> undef)
  ...
  call void @llvm.vc.internal.lsc.store.ugm.v1i1.i64.v4i64(<1 x i1> <i1 true>, i8 3, i8 4, i8 4, i8 0, i8 0, i64 0, i64 %ptrtoint, i16 1, i32 0, <4 x i64> %bitcast3)
  ret void
}
...
declare !internal_intrinsic_id !6 <8 x i64> @llvm.vc.internal.lsc.load.ugm.v8i64.v1i1.i64(<1 x i1>, i8, i8, i8, i8, i8, i64, i64, i16, i32, <8 x i64>) #2
declare !internal_intrinsic_id !7 void @llvm.vc.internal.lsc.store.ugm.v1i1.i64.v4i64(<1 x i1>, i8, i8, i8, i8, i8, i64, i64, i16, i32, <4 x i64>) #3
declare !genx_intrinsic_id !8 i16 @llvm.genx.convert.i16(i16) #4
