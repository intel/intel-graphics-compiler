...
; RUN: -print-function-group-info -disable-output -mcpu=Xe2 -S < %s | FileCheck \
...
; CHECK-DAG: Users of foo.K1: K1
; CHECK-DAG: Users of foo.K2: K2

define internal spir_func void @foo(i32 %0) #0 {
  ret void
}

define dllexport spir_kernel void @K1(i32 %0, i32 %1) #1 {
  call spir_func void @foo(i32 %0) #0
  call spir_func void @foo(i32 %1) #0
  ret void
}

define dllexport spir_kernel void @K2(i32 %0, i32 %1) #1 {
  call spir_func void @foo(i32 %0) #0
  call spir_func void @foo(i32 %1) #0
  ret void
}
...
!0 = !{i32 0, i32 0}
!1 = !{}
!2 = !{void (i32, i32)* @K1, !"K1", !3, i32 0, !4, !5, !6, i32 0}
!3 = !{i32 2, i32 96}
!4 = !{i32 72, i32 64}
!5 = !{i32 0}
!6 = !{!"buffer_t read_write"}
!7 = !{void (i32, i32)* @K2, !"K2", !3, i32 0, !4, !5, !6, i32 0}
!8 = !{void (i32, i32)* @K1, !0, !9, !1, !9}
!9 = !{i32 0, i32 1}
!10 = !{void (i32, i32)* @K2, !0, !9, !1, !9}
