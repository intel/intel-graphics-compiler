...
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.v1i32.v1i32(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i32> %{{[a-zA-Z0-9.]+}}, <1 x i32> [[I16EXT]], i32 0)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.i32.v1i32(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, <1 x i32> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.i32.v1i64(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, <1 x i64> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.v1i32.v1i32(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i32> %{{[a-zA-Z0-9.]+}}, <1 x i32> [[F16EXT]], i32 0)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.i32.v1f32(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, <1 x float> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK: call void @llvm.genx.scatter.scaled.v2i1.v2i32.v2i32(<2 x i1> <i1 true, i1 true>, i32 2, i16 0, i32 254, i32 %{{[a-zA-Z0-9.]+}}, <2 x i32> <i32 0, i32 4>, <2 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.genx.lsc.store.slm.v1i1.i32.v1f64(<1 x i1> <i1 true>, i8 4, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, <1 x double> %{{[a-zA-Z0-9.]+}}, i32 0)
