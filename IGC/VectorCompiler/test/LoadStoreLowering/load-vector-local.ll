...
; RUN: %opt %use_old_pass_manager% -enable-debugify -GenXLoadStoreLowering -march=genx64 -mcpu=Gen11 -mtriple=spir64-unknown-unknown -enable-ldst-lowering=true -mattr=+ocl_runtime -S < %s 2>&1 | FileCheck --check-prefix=CHECK-SLM-BLOCK %s
...
define void @replace_load_i8_block(<16 x i8> addrspace(3)* %pi8) {
  ...
  ; CHECK-LSC: call <2 x i64> @llvm.vc.internal.lsc.load.slm.v2i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 2, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <2 x i64> undef)
...
define void @replace_load_i16_block(<16 x i16> addrspace(3)* %pi16) {
  ...
  ; CHECK-LSC: call <4 x i64> @llvm.vc.internal.lsc.load.slm.v4i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 4, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <4 x i64> undef)
...
define void @replace_load_i32_block(<16 x i32> addrspace(3)* %pi32) {
  ...
  ; CHECK-LSC: call <8 x i64> @llvm.vc.internal.lsc.load.slm.v8i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 5, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <8 x i64> undef)
...
define void @replace_load_i64_block(<16 x i64> addrspace(3)* %pi64) {
  ...
  ; CHECK-LSC: call <16 x i64> @llvm.vc.internal.lsc.load.slm.v16i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 6, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <16 x i64> undef)
...
define void @replace_load_i8_block_dwalign(<16 x i8> addrspace(3)* %pi8) {
  ...
  ; CHECK-LSC: call <4 x i32> @llvm.vc.internal.lsc.load.slm.v4i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 4, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <4 x i32> undef)
...
define void @replace_load_i16_block_dwalign(<16 x i16> addrspace(3)* %pi16) {
  ...
  ; CHECK-SLM-BLOCK-SAME: <16 x i32> undef)
  ; CHECK-LSC: call <8 x i32> @llvm.vc.internal.lsc.load.slm.v8i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 5, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <8 x i32> undef)
...
define void @replace_load_i32_block_dwalign(<16 x i32> addrspace(3)* %pi32) {
  ...
  ; CHECK-SLM-BLOCK-SAME: <16 x i32> undef)
  ; CHECK-LSC: call <16 x i32> @llvm.vc.internal.lsc.load.slm.v16i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 6, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <16 x i32> undef)
...
define void @replace_load_i64_block_dwalign(<16 x i64> addrspace(3)* %pi64) {
  ...
  ; CHECK-LSC: call <32 x i32> @llvm.vc.internal.lsc.load.slm.v32i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 7, i8 0, i8 0, i32 0, i32 %{{[0-9a-zA-Z.]+}}, i16 1, i32 0, <32 x i32> undef)
...
define void @replace_load_i8_block_1023bytes(<1023 x i8> addrspace(3)* %pi8) {
  ...
  ; CHECK-LSC: call <64 x i64> @llvm.vc.internal.lsc.load.slm.v64i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 8, i8 0, i8 0, i32 0, i32 [[ADDR:%[0-9a-zA-Z.]+]], i16 1, i32 0, <64 x i64> undef)
  ; CHECK-LSC: [[ADDR512:%[^ ]+]] = add i32 [[ADDR]], 512
  ; CHECK-LSC: call <32 x i64> @llvm.vc.internal.lsc.load.slm.v32i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 7, i8 0, i8 0, i32 0, i32 [[ADDR512]], i16 1, i32 0, <32 x i64> undef)
  ; CHECK-LSC: [[ADDR768:%[^ ]+]] = add i32 [[ADDR]], 768
  ; CHECK-LSC: call <16 x i64> @llvm.vc.internal.lsc.load.slm.v16i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 6, i8 0, i8 0, i32 0, i32 [[ADDR768]], i16 1, i32 0, <16 x i64> undef)
  ; CHECK-LSC: [[ADDR896:%[^ ]+]] = add i32 [[ADDR]], 896
  ; CHECK-LSC: call <8 x i64> @llvm.vc.internal.lsc.load.slm.v8i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 5, i8 0, i8 0, i32 0, i32 [[ADDR896]], i16 1, i32 0, <8 x i64> undef)
  ; CHECK-LSC: [[ADDR960:%[^ ]+]] = add i32 [[ADDR]], 960
  ; CHECK-LSC: call <4 x i64> @llvm.vc.internal.lsc.load.slm.v4i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 4, i8 0, i8 0, i32 0, i32 [[ADDR960]], i16 1, i32 0, <4 x i64> undef)
  ; CHECK-LSC: [[ADDR992:%[^ ]+]] = add i32 [[ADDR]], 992
  ; CHECK-LSC: call <3 x i64> @llvm.vc.internal.lsc.load.slm.v3i64.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 4, i8 3, i8 0, i8 0, i32 0, i32 [[ADDR992]], i16 1, i32 0, <3 x i64> undef)
  ; CHECK-LSC: call <7 x i32> @llvm.vc.internal.lsc.load.slm.v7i32.v7i1.v7i32(<7 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 2, i8 5, i8 1, i8 0, i8 0, i32 0, <7 x i32> %{{[0-9a-zA-Z]+}}, i16 1, i32 0, <7 x i32> undef)
...
define void @replace_load_i8_block_1023bytes_dwalign(<1023 x i8> addrspace(3)* %pi8) {
  ...
  ; CHECK-LSC: call <64 x i32> @llvm.vc.internal.lsc.load.slm.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 0, i32 [[ADDRDW:%[0-9a-zA-Z.]+]], i16 1, i32 0, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW256:%[^ ]+]] = add i32 [[ADDRDW]], 256
  ; CHECK-LSC: call <64 x i32> @llvm.vc.internal.lsc.load.slm.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 0, i32 [[ADDRDW256]], i16 1, i32 0, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW512:%[^ ]+]] = add i32 [[ADDRDW]], 512
  ; CHECK-LSC: call <64 x i32> @llvm.vc.internal.lsc.load.slm.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 0, i32 [[ADDRDW512]], i16 1, i32 0, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW768:%[^ ]+]] = add i32 [[ADDRDW]], 768
  ; CHECK-LSC: call <32 x i32> @llvm.vc.internal.lsc.load.slm.v32i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 7, i8 0, i8 0, i32 0, i32 [[ADDRDW768]], i16 1, i32 0, <32 x i32> undef)
  ; CHECK-LSC: [[ADDRDW896:%[^ ]+]] = add i32 [[ADDRDW]], 896
  ; CHECK-LSC: call <16 x i32> @llvm.vc.internal.lsc.load.slm.v16i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 6, i8 0, i8 0, i32 0, i32 [[ADDRDW896]], i16 1, i32 0, <16 x i32> undef)
  ; CHECK-LSC: [[ADDRDW960:%[^ ]+]] = add i32 [[ADDRDW]], 960
  ; CHECK-LSC: call <8 x i32> @llvm.vc.internal.lsc.load.slm.v8i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 5, i8 0, i8 0, i32 0, i32 [[ADDRDW960]], i16 1, i32 0, <8 x i32> undef)
  ; CHECK-LSC: [[ADDRDW992:%[^ ]+]] = add i32 [[ADDRDW]], 992
  ; CHECK-LSC: call <4 x i32> @llvm.vc.internal.lsc.load.slm.v4i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 4, i8 0, i8 0, i32 0, i32 [[ADDRDW992]], i16 1, i32 0, <4 x i32> undef)
  ; CHECK-LSC: [[ADDRDW1008:%[^ ]+]] = add i32 [[ADDRDW]], 1008
  ; CHECK-LSC: call <3 x i32> @llvm.vc.internal.lsc.load.slm.v3i32.v1i1.i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 3, i8 0, i8 0, i32 0, i32 [[ADDRDW1008]], i16 1, i32 0, <3 x i32> undef)
  ; CHECK-LSC: call <3 x i32> @llvm.vc.internal.lsc.load.slm.v3i32.v3i1.v3i32(<3 x i1> <i1 true, i1 true, i1 true>, i8 2, i8 5, i8 1, i8 0, i8 0, i32 0, <3 x i32> %{{[0-9a-zA-Z]+}}, i16 1, i32 0, <3 x i32> undef)
