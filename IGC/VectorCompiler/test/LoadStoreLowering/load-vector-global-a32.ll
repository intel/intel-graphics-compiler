...
define void @replace_load_i8_block(<16 x i8> addrspace(6)* %pi8) {
  ...
  ; CHECK-LSC: call <2 x i64> @llvm.genx.lsc.load.merge.bti.v2i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 2, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <2 x i64> undef)
...
define void @replace_load_i16_block(<16 x i16> addrspace(6)* %pi16) {
  ...
  ; CHECK-LSC: call <4 x i64> @llvm.genx.lsc.load.merge.bti.v4i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 4, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <4 x i64> undef)
...
define void @replace_load_i32_block(<16 x i32> addrspace(6)* %pi32) {
  ...
  ; CHECK-LSC: call <8 x i64> @llvm.genx.lsc.load.merge.bti.v8i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 5, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <8 x i64> undef)
...
define void @replace_load_i64_block(<16 x i64> addrspace(6)* %pi64) {
  ...
  ; CHECK-LSC: call <16 x i64> @llvm.genx.lsc.load.merge.bti.v16i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 6, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <16 x i64> undef)
...
define void @replace_load_i8_block_dwalign(<16 x i8> addrspace(6)* %pi8) {
  ...
  ; CHECK-LSC: call <4 x i32> @llvm.genx.lsc.load.merge.bti.v4i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 4, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <4 x i32> undef)
...
define void @replace_load_i16_block_dwalign(<16 x i16> addrspace(6)* %pi16) {
  ...
  ; CHECK-LSC: call <8 x i32> @llvm.genx.lsc.load.merge.bti.v8i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 5, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <8 x i32> undef)
...
define void @replace_load_i32_block_dwalign(<16 x i32> addrspace(6)* %pi32) {
  ...
  ; CHECK-LSC: call <16 x i32> @llvm.genx.lsc.load.merge.bti.v16i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 6, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <16 x i32> undef)
...
define void @replace_load_i64_block_dwalign(<16 x i64> addrspace(6)* %pi64) {
  ...
  ; CHECK-LSC: call <32 x i32> @llvm.genx.lsc.load.merge.bti.v32i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 7, i8 2, i8 0, i32 %{{[0-9a-zA-Z.]+}}, i32 255, <32 x i32> undef)
...
define void @replace_load_i8_block_1023bytes(<1023 x i8> addrspace(6)* %pi8) {
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR0:[A-Za-z0-9.]+]])
  ; CHECK: %[[ADDR128:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 128
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR128]])
  ; CHECK: %[[ADDR256:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 256
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR256]])
  ; CHECK: %[[ADDR384:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 384
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR384]])
  ; CHECK: %[[ADDR512:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 512
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR512]])
  ; CHECK: %[[ADDR640:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 640
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR640]])
  ; CHECK: %[[ADDR768:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 768
  ; CHECK: call <128 x i8> @llvm.genx.oword.ld.v128i8(i32 0, i32 255, i32 %[[ADDR768]])
  ; CHECK: %[[ADDR896:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 896
  ; CHECK: call <64 x i8> @llvm.genx.oword.ld.v64i8(i32 0, i32 255, i32 %[[ADDR896]])
  ; CHECK: %[[ADDR960:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 960
  ; CHECK: call <32 x i8> @llvm.genx.oword.ld.v32i8(i32 0, i32 255, i32 %[[ADDR960]])
  ; CHECK: %[[ADDR992:[A-Za-z0-9.]+]] = add i32 %[[ADDR0]], 992
  ; CHECK: call <16 x i8> @llvm.genx.oword.ld.v16i8(i32 0, i32 255, i32 %[[ADDR992]])
  ; CHECK: call <15 x i32> @llvm.genx.gather.scaled.v15i32.v15i1.v15i32(<15 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i32 0, i16 0, i32 255, i32 %[[ADDR0]], <15 x i32> <i32 1008, i32 1009, i32 1010, i32 1011, i32 1012, i32 1013, i32 1014, i32 1015, i32 1016, i32 1017, i32 1018, i32 1019, i32 1020, i32 1021, i32 1022>, <15 x i32> undef)

  ; CHECK-LSC: call <64 x i64> @llvm.genx.lsc.load.merge.bti.v64i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 8, i8 2, i8 0, i32 [[ADDR:%[0-9a-zA-Z.]+]], i32 255, <64 x i64> undef)
  ; CHECK-LSC: [[ADDR512:%[^ ]+]] = add i32 [[ADDR]], 512
  ; CHECK-LSC: call <32 x i64> @llvm.genx.lsc.load.merge.bti.v32i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 7, i8 2, i8 0, i32 [[ADDR512]], i32 255, <32 x i64> undef)
  ; CHECK-LSC: [[ADDR768:%[^ ]+]] = add i32 [[ADDR]], 768
  ; CHECK-LSC: call <16 x i64> @llvm.genx.lsc.load.merge.bti.v16i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 6, i8 2, i8 0, i32 [[ADDR768]], i32 255, <16 x i64> undef)
  ; CHECK-LSC: [[ADDR896:%[^ ]+]] = add i32 [[ADDR]], 896
  ; CHECK-LSC: call <8 x i64> @llvm.genx.lsc.load.merge.bti.v8i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 5, i8 2, i8 0, i32 [[ADDR896]], i32 255, <8 x i64> undef)
  ; CHECK-LSC: [[ADDR960:%[^ ]+]] = add i32 [[ADDR]], 960
  ; CHECK-LSC: call <4 x i64> @llvm.genx.lsc.load.merge.bti.v4i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 4, i8 2, i8 0, i32 [[ADDR960]], i32 255, <4 x i64> undef)
  ; CHECK-LSC: [[ADDR992:%[^ ]+]] = add i32 [[ADDR]], 992
  ; CHECK-LSC: call <3 x i64> @llvm.genx.lsc.load.merge.bti.v3i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 3, i8 2, i8 0, i32 [[ADDR992]], i32 255, <3 x i64> undef)
  ; CHECK-LSC: call <7 x i32> @llvm.genx.lsc.load.merge.bti.v7i32.v7i1.v7i32(<7 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <7 x i32> %{{[0-9a-zA-Z]+}}, i32 255, <7 x i32> undef)
...
define void @replace_load_i8_block_1023bytes_dwalign(<1023 x i8> addrspace(6)* %pi8) {
  ...
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.merge.bti.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i32 [[ADDRDW:%[0-9a-zA-Z.]+]], i32 255, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW256:%[^ ]+]] = add i32 [[ADDRDW]], 256
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.merge.bti.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i32 [[ADDRDW256]], i32 255, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW512:%[^ ]+]] = add i32 [[ADDRDW]], 512
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.merge.bti.v64i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i32 [[ADDRDW512]], i32 255, <64 x i32> undef)
  ; CHECK-LSC: [[ADDRDW768:%[^ ]+]] = add i32 [[ADDRDW]], 768
  ; CHECK-LSC: call <32 x i32> @llvm.genx.lsc.load.merge.bti.v32i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 7, i8 2, i8 0, i32 [[ADDRDW768]], i32 255, <32 x i32> undef)
  ; CHECK-LSC: [[ADDRDW896:%[^ ]+]] = add i32 [[ADDRDW]], 896
  ; CHECK-LSC: call <16 x i32> @llvm.genx.lsc.load.merge.bti.v16i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 6, i8 2, i8 0, i32 [[ADDRDW896]], i32 255, <16 x i32> undef)
  ; CHECK-LSC: [[ADDRDW960:%[^ ]+]] = add i32 [[ADDRDW]], 960
  ; CHECK-LSC: call <8 x i32> @llvm.genx.lsc.load.merge.bti.v8i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 5, i8 2, i8 0, i32 [[ADDRDW960]], i32 255, <8 x i32> undef)
  ; CHECK-LSC: [[ADDRDW992:%[^ ]+]] = add i32 [[ADDRDW]], 992
  ; CHECK-LSC: call <4 x i32> @llvm.genx.lsc.load.merge.bti.v4i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 4, i8 2, i8 0, i32 [[ADDRDW992]], i32 255, <4 x i32> undef)
  ; CHECK-LSC: [[ADDRDW1008:%[^ ]+]] = add i32 [[ADDRDW]], 1008
  ; CHECK-LSC: call <3 x i32> @llvm.genx.lsc.load.merge.bti.v3i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 3, i8 2, i8 0, i32 [[ADDRDW1008]], i32 255, <3 x i32> undef)
  ; CHECK-LSC: call <3 x i32> @llvm.genx.lsc.load.merge.bti.v3i32.v3i1.v3i32(<3 x i1> <i1 true, i1 true, i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <3 x i32> %{{[0-9a-zA-Z]+}}, i32 255, <3 x i32> undef)
