...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v2i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 2, i8 0, i8 0, i32 255, i32 %{{[^,]+}}, i16 1, i32 0, <2 x i64> %{{[^)]+}})
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v4i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 4, i8 0, i8 0, i32 255, i32 %{{[^,]+}}, i16 1, i32 0, <4 x i64> %{{[^)]+}})
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v8i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 5, i8 0, i8 0, i32 255, i32 %{{[^,]+}}, i16 1, i32 0, <8 x i64> %{{[^)]+}})
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v16i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 6, i8 0, i8 0, i32 255, i32 %{{[^,]+}}, i16 1, i32 0, <16 x i64> %val)
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v16i1.v16i32.v16i32
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v16i1.v16i32.v16i64
...
; CHECK: call void @llvm.genx.scatter.scaled.v16i1.v16i32.v16i32
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v4i32
...
; CHECK: call void @llvm.genx.scatter.scaled.v16i1.v16i32.v16i32
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v8i32
...
; CHECK: call void @llvm.genx.scatter.scaled.v16i1.v16i32.v16i32
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v16i32
...
; CHECK: call void @llvm.genx.scatter.scaled.v32i1.v32i32.v32i32
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v32i32
...
; CHECK: call void @llvm.genx.oword.st.v16i8(i32 255, i32 %{{[a-zA-Z0-9.]+}}, <16 x i8> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v2i64
...
; CHECK: call void @llvm.genx.oword.st.v16i16(i32 255, i32 %{{[a-zA-Z0-9.]+}}, <16 x i16> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v4i64
...
; CHECK: call void @llvm.genx.oword.st.v16i32(i32 255, i32 %{{[a-zA-Z0-9.]+}}, <16 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v8i64
...
; CHECK: call void @llvm.genx.oword.st.v16i64(i32 255, i32 %{{[a-zA-Z0-9.]+}}, <16 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v16i64
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v64i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 8, i8 0, i8 0, i32 255, i32 [[ADDR:%[a-zA-Z0-9.]+]], i16 1, i32 0, <64 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDR512:%[^ ]+]] = add i32 [[ADDR]], 512
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v32i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 7, i8 0, i8 0, i32 255, i32 [[ADDR512]], i16 1, i32 0, <32 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDR768:%[^ ]+]] = add i32 [[ADDR]], 768
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v16i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 6, i8 0, i8 0, i32 255, i32 [[ADDR768]], i16 1, i32 0, <16 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDR896:%[^ ]+]] = add i32 [[ADDR]], 896
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v8i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 5, i8 0, i8 0, i32 255, i32 [[ADDR896]], i16 1, i32 0, <8 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDR960:%[^ ]+]] = add i32 [[ADDR]], 960
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v4i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 4, i8 0, i8 0, i32 255, i32 [[ADDR960]], i16 1, i32 0, <4 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDR992:%[^ ]+]] = add i32 [[ADDR]], 992
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v3i64(<1 x i1> <i1 true>, i8 2, i8 4, i8 3, i8 0, i8 0, i32 255, i32 [[ADDR992]], i16 1, i32 0, <3 x i64> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v7i1.v7i32.v7i32(<7 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 2, i8 5, i8 1, i8 0, i8 0, i32 255, <7 x i32> %{{[a-zA-Z0-9.]+}}, i16 1, i32 0, <7 x i32> %{{[a-zA-Z0-9.]+}})
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v64i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 255, i32 [[ADDRDW:%[a-zA-Z0-9.]+]], i16 1, i32 0, <64 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW256:%[^ ]+]] = add i32 [[ADDRDW]], 256
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v64i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 255, i32 [[ADDRDW256]], i16 1, i32 0, <64 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW512:%[^ ]+]] = add i32 [[ADDRDW]], 512
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v64i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 8, i8 0, i8 0, i32 255, i32 [[ADDRDW512]], i16 1, i32 0, <64 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW768:%[^ ]+]] = add i32 [[ADDRDW]], 768
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v32i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 7, i8 0, i8 0, i32 255, i32 [[ADDRDW768]], i16 1, i32 0, <32 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW896:%[^ ]+]] = add i32 [[ADDRDW]], 896
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v16i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 6, i8 0, i8 0, i32 255, i32 [[ADDRDW896]], i16 1, i32 0, <16 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW960:%[^ ]+]] = add i32 [[ADDRDW]], 960
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v8i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 5, i8 0, i8 0, i32 255, i32 [[ADDRDW960]], i16 1, i32 0, <8 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW992:%[^ ]+]] = add i32 [[ADDRDW]], 992
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v4i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 4, i8 0, i8 0, i32 255, i32 [[ADDRDW992]], i16 1, i32 0, <4 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: [[ADDRDW1008:%[^ ]+]] = add i32 [[ADDRDW]], 1008
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v1i1.i32.v3i32(<1 x i1> <i1 true>, i8 2, i8 3, i8 3, i8 0, i8 0, i32 255, i32 [[ADDRDW1008]], i16 1, i32 0, <3 x i32> %{{[a-zA-Z0-9.]+}})
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.bti.v3i1.v3i32.v3i32(<3 x i1> <i1 true, i1 true, i1 true>, i8 2, i8 5, i8 1, i8 0, i8 0, i32 255, <3 x i32> %{{[a-zA-Z0-9.]+}}, i16 1, i32 0, <3 x i32> %{{[a-zA-Z0-9.]+}})
