...
; CHECK-LSC: %[[GATHER:.*]] = call <1 x i64> @llvm.genx.lsc.load.stateless.v1i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i64 undef, i32 0)
