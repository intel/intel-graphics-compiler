...
; CHECK-LSC: %[[GATHER:.*]] = call <1 x i64> @llvm.vc.internal.lsc.load.ugm.v1i64.v1i1.i64(<1 x i1> <i1 true>, i8 3, i8 4, i8 1, i8 0, i8 0, i64 0, i64 undef, i16 1, i32 0, <1 x i64> undef)
