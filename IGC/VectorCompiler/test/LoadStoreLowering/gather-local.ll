...
; CHECK-LSC: [[DATA8:[^ ]+]] = call <8 x i32> @llvm.genx.lsc.load.merge.slm.v8i32.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <8 x i32> [[ADDR8]], i32 0, <8 x i32> [[PASSTHRU8]])
...
; CHECK-LSC: [[DATA16:[^ ]+]] = call <8 x i32> @llvm.genx.lsc.load.merge.slm.v8i32.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <8 x i32> [[ADDR16]], i32 0, <8 x i32> [[PASSTHRU16]])
...
; CHECK-LSC: %res = call <8 x i32> @llvm.genx.lsc.load.merge.slm.v8i32.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <8 x i32> [[ADDR32]], i32 0, <8 x i32> %passthru)
...
; CHECK-LSC: %res = call <8 x i64> @llvm.genx.lsc.load.merge.slm.v8i64.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDR32]], i32 0, <8 x i64> %passthru)
...
; CHECK-LSC: [[DATAH:[^ ]+]] = call <8 x i32> @llvm.genx.lsc.load.merge.slm.v8i32.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <8 x i32> [[ADDRH]], i32 0, <8 x i32> [[PASSTHRUH]])
...
; CHECK-LSC: %res = call <8 x float> @llvm.genx.lsc.load.merge.slm.v8f32.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <8 x i32> [[ADDRF]], i32 0, <8 x float> %passthru)
...
; CHECK-LSC: %res = call <8 x double> @llvm.genx.lsc.load.merge.slm.v8f64.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDRD]], i32 0, <8 x double> %passthru)
...
; CHECK-LSC: [[DATAP:[^ ]+]] = call <8 x i64> @llvm.genx.lsc.load.merge.slm.v8i64.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDRP]], i32 0, <8 x i64> [[PTI]])
...
; CHECK-LSC: %res = call <8 x i64> @llvm.genx.lsc.load.merge.slm.v8i64.v8i1.v8i32(<8 x i1> %mask, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDRU64]], i32 0, <8 x i64> %passthru)
