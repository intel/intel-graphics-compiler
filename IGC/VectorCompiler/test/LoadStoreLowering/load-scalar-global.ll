...
; CHECK-LSC: call <1 x double> @llvm.genx.lsc.load.merge.stateless.v1f64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 1, i8 1, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i64 %{{[a-zA-Z0-9.]+}}, i32 0, <1 x double> undef)
