...
; CHECK-LSC: call <1 x double> @llvm.vc.internal.lsc.load.ugm.v1f64.v1i1.i64(<1 x i1> <i1 true>, i8 3, i8 4, i8 1, i8 1, i8 1, i64 0, i64 %{{[a-zA-Z0-9.]+}}, i16 1, i32 0, <1 x double> undef)
