...
define float @fmin_float(float addrspace(1)* %ptr, float %arg) {
  ...
  ; CHECK: [[FMIN_RES:%[^ ]]] = call <1 x float> @llvm.vc.internal.lsc.atomic.ugm.v1f32.v1i1.v2i8.v1i64(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 21, i8 3, i8 3, <2 x i8> zeroinitializer, i64 0, <1 x i64> [[FMIN_VADDR]], i16 1, i32 0, <1 x float> [[FMIN_VDATA]], <1 x float> undef, <1 x float> undef)
...
define float @fmax_float(float addrspace(1)* %ptr, float %arg) {
  ...
  ; CHECK: [[FMAX_RES:%[^ ]]] = call <1 x float> @llvm.vc.internal.lsc.atomic.ugm.v1f32.v1i1.v2i8.v1i64(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 22, i8 3, i8 3, <2 x i8> zeroinitializer, i64 0, <1 x i64> [[FMAX_VADDR]], i16 1, i32 0, <1 x float> [[FMAX_VDATA]], <1 x float> undef, <1 x float> undef)
