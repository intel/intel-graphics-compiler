...
define i32 @xchg_i32(i32 addrspace(1)* %ptr, i32 %arg) {
  ...
  ; CHECK-LSC: [[XCHG_VRES:%[^ ]+]] = call <1 x i32> @llvm.genx.lsc.xatomic.stateless.v1i32.v1i1.v1i64(<1 x i1> <i1 true>, i8 11, i8 1, i8 1, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <1 x i64> [[XCHG_VADDR]], <1 x i32> [[XCHG_VDATA]], <1 x i32> undef, i32 0, <1 x i32> undef)
...
define i32 @and_i32(i32 addrspace(1)* %ptr, i32 %arg) {
  ...
  ; CHECK-LSC: [[AND_VRES:%[^ ]+]] = call <1 x i32> @llvm.genx.lsc.xatomic.stateless.v1i32.v1i1.v1i64(<1 x i1> <i1 true>, i8 24, i8 1, i8 1, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <1 x i64> [[AND_VADDR]], <1 x i32> [[AND_VDATA]], <1 x i32> undef, i32 0, <1 x i32> undef)
  ; CHECK-LSC: call void @llvm.genx.lsc.fence.i1(i1 true, i8 0, i8 0, i8 4)
