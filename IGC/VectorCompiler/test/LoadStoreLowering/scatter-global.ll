...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i32(<8 x i1> %mask, i8 3, i8 5, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDR8]], i16 1, i32 0, <8 x i32> [[DATA8]])
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i32(<8 x i1> %mask, i8 3, i8 6, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDR16]], i16 1, i32 0, <8 x i32> [[DATA16]])
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i32(<8 x i1> %mask, i8 3, i8 3, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDR32]], i16 1, i32 0, <8 x i32> %data)
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i64(<8 x i1> %mask, i8 3, i8 4, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDR32]], i16 1, i32 0, <8 x i64> %data)
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i32(<8 x i1> %mask, i8 3, i8 6, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDRH]], i16 1, i32 0, <8 x i32> [[DATAH]])
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8f32(<8 x i1> %mask, i8 3, i8 3, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDRF]], i16 1, i32 0, <8 x float> %data)
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8f64(<8 x i1> %mask, i8 3, i8 4, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDRD]], i16 1, i32 0, <8 x double> %data)
...
; CHECK-LSC: call void @llvm.vc.internal.lsc.store.ugm.v8i1.v8i64.v8i64(<8 x i1> %mask, i8 3, i8 4, i8 1, i8 0, i8 0, i64 0, <8 x i64> [[ADDRP]], i16 1, i32 0, <8 x i64> [[PTI]])
