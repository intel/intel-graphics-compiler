...
; CHECK-DAG: [[ADDR8:[^ ]+]] = ptrtoint <8 x i8 addrspace(6)*> %pi8 to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i32(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <8 x i32> [[ADDR8]], <8 x i32> [[DATA8]], i32 255)
...
; CHECK-DAG: [[ADDR16:[^ ]+]] = ptrtoint <8 x i16 addrspace(6)*> %pi16 to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i32(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <8 x i32> [[ADDR16]], <8 x i32> [[DATA16]], i32 255)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i32(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <8 x i32> [[ADDR32]], <8 x i32> %data, i32 255)
...
; CHECK: [[ADDR64:[^ ]+]] = ptrtoint <8 x i64 addrspace(6)*> %pi64 to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i64(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDR64]], <8 x i64> %data, i32 255)
...
; CHECK-DAG: [[ADDRH:[^ ]+]] = ptrtoint <8 x half addrspace(6)*> %pi16 to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i32(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <8 x i32> [[ADDRH]], <8 x i32> [[DATAH]], i32 255)
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8f32(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, <8 x i32> [[ADDRF]], <8 x float> %data, i32 255)
...
; CHECK-DAG: [[ADDRD:[^ ]+]] = ptrtoint <8 x double addrspace(6)*> %pi64 to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8f64(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDRD]], <8 x double> %data, i32 255)
...
; CHECK-DAG: [[ADDRP:[^ ]+]] = ptrtoint <8 x i8* addrspace(6)*> %pptr to <8 x i32>
...
; CHECK-LSC: call void @llvm.genx.lsc.store.bti.v8i1.v8i32.v8i64(<8 x i1> %mask, i8 4, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, <8 x i32> [[ADDRP]], <8 x i64> [[PTI]], i32 255)
