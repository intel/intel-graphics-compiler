...
; CHECK-LSC: [[LD8:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.v1i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <1 x i64> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: [[LD16:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.v1i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i64> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i64 %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call <1 x i64> @llvm.genx.lsc.load.stateless.v1i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i64 %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK: call <4 x i8> @llvm.genx.svm.gather.v4i8.v1i1.v1i64(<1 x i1> <i1 true>, i32 1, <1 x i64> %{{[a-zA-Z0-9.]+}}, <4 x i8> undef)
; CHECK-LSC: [[LD16F:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.v1i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i64> %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call <1 x float> @llvm.genx.lsc.load.stateless.v1f32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i64 %{{[a-zA-Z0-9.]+}}, i32 0)
...
; CHECK-LSC: call <1 x double> @llvm.genx.lsc.load.stateless.v1f64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i64 %{{[a-zA-Z0-9.]+}}, i32 0)
