...
;
; RUN: opt %use_old_pass_manager% -enable-debugify -GenXLoadStoreLowering -march=genx64 -mcpu=Gen9 -mtriple=spir-unkonwn-unknown -enable-ldst-lowering=true -mattr=+ocl_runtime -S < %s 2>&1 | FileCheck %s
; RUN: opt %use_old_pass_manager% -enable-debugify -GenXLoadStoreLowering -march=genx64 -mcpu=XeHPC -mtriple=spir-unkonwn-unknown -enable-ldst-lowering=true -mattr=+ocl_runtime -S < %s 2>&1 | FileCheck --check-prefix=CHECK-LSC %s
;
; CHECK-NOT: WARNING
...
; CHECK-LSC: [[LD8:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.merge.bti.v1i32.v1i1.v1i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <1 x i32> %{{[a-zA-Z0-9.]+}}, i32 255, <1 x i32> undef)
...
; CHECK-LSC: [[LD16:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.merge.bti.v1i32.v1i1.v1i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i32> %{{[a-zA-Z0-9.]+}}, i32 255, <1 x i32> undef)
...
; CHECK-LSC: call <1 x i32> @llvm.genx.lsc.load.merge.bti.v1i32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, i32 255, <1 x i32> undef)
...
; CHECK-LSC: call <1 x i64> @llvm.genx.lsc.load.merge.bti.v1i64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, i32 255, <1 x i64> undef)
...
; CHECK: call <1 x i32> @llvm.genx.gather.scaled.v1i32.v1i1.v1i32(<1 x i1> <i1 true>, i32 1, i16 0, i32 255, i32 %{{[^ ,]+}}, <1 x i32> zeroinitializer, <1 x i32> undef)
; CHECK-LSC: [[LD16F:%[0-9a-zA-Z.]+]] = call <1 x i32> @llvm.genx.lsc.load.merge.bti.v1i32.v1i1.v1i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 6, i8 1, i8 1, i8 0, <1 x i32> %{{[a-zA-Z0-9.]+}}, i32 255, <1 x i32> undef)
...
; CHECK-LSC: call <1 x float> @llvm.genx.lsc.load.merge.bti.v1f32.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, i32 255, <1 x float> undef)
...
; CHECK: call <2 x i32> @llvm.genx.gather.scaled.v2i32.v2i1.v2i32(<2 x i1> <i1 true, i1 true>, i32 2, i16 0, i32 255, i32 %{{[^ ,]+}}, <2 x i32> <i32 0, i32 4>, <2 x i32> undef)
; CHECK-LSC: call <1 x double> @llvm.genx.lsc.load.merge.bti.v1f64.v1i1.i32(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 1, i8 1, i8 0, i32 %{{[a-zA-Z0-9.]+}}, i32 255, <1 x double> undef)
