...
; CHECK-LSC: [[LOAD:%[^ ]+]] = call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.v1i64(
...
; CHECK-LSC: [[LOAD:%[^ ]+]] = call <1 x i32> @llvm.genx.lsc.load.stateless.v1i32.v1i1.i64(
...
; CHECK-LSC: [[LOAD:%[^ ]+]] = call <3 x i32> @llvm.genx.lsc.load.stateless.v3i32.v3i1.v3i64(
