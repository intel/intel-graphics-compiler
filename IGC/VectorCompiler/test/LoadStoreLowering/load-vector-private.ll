...
define void @replace_load_i8_block(<16 x i8>* %pi8) {
  ...
  ; CHECK-LSC: call <2 x i64> @llvm.genx.lsc.load.stateless.v2i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 2, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i16_block(<16 x i16>* %pi16) {
  ...
  ; CHECK-LSC: call <4 x i64> @llvm.genx.lsc.load.stateless.v4i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 4, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i32_block(<16 x i32>* %pi32) {
  ...
  ; CHECK-LSC: call <8 x i64> @llvm.genx.lsc.load.stateless.v8i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 5, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i64_block(<16 x i64>* %pi64) {
  ...
  ; CHECK-LSC: call <16 x i64> @llvm.genx.lsc.load.stateless.v16i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 6, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i8_block_unaligned(<16 x i8>* %pi8) {
  ...
  ; CHECK-LSC: call <16 x i32> @llvm.genx.lsc.load.stateless.v16i32.v16i1.v16i64
...
define void @replace_load_i64_block_unaligned(<16 x i64>* %pi64) {
  ...
  ; CHECK-LSC: call <16 x i64> @llvm.genx.lsc.load.stateless.v16i64.v16i1.v16i64
...
define void @replace_load_i8_block_dwalign(<16 x i8>* %pi8) {
  ...
  ; CHECK-LSC: call <4 x i32> @llvm.genx.lsc.load.stateless.v4i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 4, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i16_block_dwalign(<16 x i16>* %pi16) {
  ...
  ; CHECK-LSC: call <8 x i32> @llvm.genx.lsc.load.stateless.v8i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 5, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i32_block_dwalign(<16 x i32>* %pi32) {
  ...
  ; CHECK-LSC: call <16 x i32> @llvm.genx.lsc.load.stateless.v16i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 6, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i64_block_dwalign(<16 x i64>* %pi64) {
  ...
  ; CHECK-LSC: call <32 x i32> @llvm.genx.lsc.load.stateless.v32i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 7, i8 2, i8 0, i64 %{{[0-9a-zA-Z.]+}}, i32 0)
...
define void @replace_load_i8_block_1023bytes(<1023 x i8>* %pi8) {
  ...
  ; CHECK-LSC: call <64 x i64> @llvm.genx.lsc.load.stateless.v64i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 8, i8 2, i8 0, i64 [[ADDR:%[0-9a-zA-Z.]+]], i32 0)
  ; CHECK-LSC: [[ADDR512:%[^ ]+]] = add i64 [[ADDR]], 512
  ; CHECK-LSC: call <32 x i64> @llvm.genx.lsc.load.stateless.v32i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 7, i8 2, i8 0, i64 [[ADDR512]], i32 0)
  ; CHECK-LSC: [[ADDR768:%[^ ]+]] = add i64 [[ADDR]], 768
  ; CHECK-LSC: call <16 x i64> @llvm.genx.lsc.load.stateless.v16i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 6, i8 2, i8 0, i64 [[ADDR768]], i32 0)
  ; CHECK-LSC: [[ADDR896:%[^ ]+]] = add i64 [[ADDR]], 896
  ; CHECK-LSC: call <8 x i64> @llvm.genx.lsc.load.stateless.v8i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 5, i8 2, i8 0, i64 [[ADDR896]], i32 0)
  ; CHECK-LSC: [[ADDR960:%[^ ]+]] = add i64 [[ADDR]], 960
  ; CHECK-LSC: call <4 x i64> @llvm.genx.lsc.load.stateless.v4i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 4, i8 2, i8 0, i64 [[ADDR960]], i32 0)
  ; CHECK-LSC: [[ADDR992:%[^ ]+]] = add i64 [[ADDR]], 992
  ; CHECK-LSC: call <3 x i64> @llvm.genx.lsc.load.stateless.v3i64.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 4, i8 3, i8 2, i8 0, i64 [[ADDR992]], i32 0)
  ; CHECK-LSC: call <7 x i32> @llvm.genx.lsc.load.stateless.v7i32.v7i1.v7i64(<7 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <7 x i64> %{{[0-9a-zA-Z]+}}, i32 0)
...
define void @replace_load_i8_block_1023bytes_dwalign(<1023 x i8>* %pi8) {
  ...
  ; CHECK: call <60 x i8> @llvm.genx.svm.gather.v60i8.v15i1.v15i64
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.stateless.v64i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i64 [[ADDRDW:%[0-9a-zA-Z.]+]], i32 0)
  ; CHECK-LSC: [[ADDRDW256:%[^ ]+]] = add i64 [[ADDRDW]], 256
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.stateless.v64i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i64 [[ADDRDW256]], i32 0)
  ; CHECK-LSC: [[ADDRDW512:%[^ ]+]] = add i64 [[ADDRDW]], 512
  ; CHECK-LSC: call <64 x i32> @llvm.genx.lsc.load.stateless.v64i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 8, i8 2, i8 0, i64 [[ADDRDW512]], i32 0)
  ; CHECK-LSC: [[ADDRDW768:%[^ ]+]] = add i64 [[ADDRDW]], 768
  ; CHECK-LSC: call <32 x i32> @llvm.genx.lsc.load.stateless.v32i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 7, i8 2, i8 0, i64 [[ADDRDW768]], i32 0)
  ; CHECK-LSC: [[ADDRDW896:%[^ ]+]] = add i64 [[ADDRDW]], 896
  ; CHECK-LSC: call <16 x i32> @llvm.genx.lsc.load.stateless.v16i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 6, i8 2, i8 0, i64 [[ADDRDW896]], i32 0)
  ; CHECK-LSC: [[ADDRDW960:%[^ ]+]] = add i64 [[ADDRDW]], 960
  ; CHECK-LSC: call <8 x i32> @llvm.genx.lsc.load.stateless.v8i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 5, i8 2, i8 0, i64 [[ADDRDW960]], i32 0)
  ; CHECK-LSC: [[ADDRDW992:%[^ ]+]] = add i64 [[ADDRDW]], 992
  ; CHECK-LSC: call <4 x i32> @llvm.genx.lsc.load.stateless.v4i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 4, i8 2, i8 0, i64 [[ADDRDW992]], i32 0)
  ; CHECK-LSC: [[ADDRDW1008:%[^ ]+]] = add i64 [[ADDRDW]], 1008
  ; CHECK-LSC: call <3 x i32> @llvm.genx.lsc.load.stateless.v3i32.v1i1.i64(<1 x i1> <i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 3, i8 3, i8 2, i8 0, i64 [[ADDRDW1008]], i32 0)
  ; CHECK-LSC: call <3 x i32> @llvm.genx.lsc.load.stateless.v3i32.v3i1.v3i64(<3 x i1> <i1 true, i1 true, i1 true>, i8 0, i8 0, i8 0, i16 1, i32 0, i8 5, i8 1, i8 1, i8 0, <3 x i64> %{{[0-9a-zA-Z]+}}, i32 0)
