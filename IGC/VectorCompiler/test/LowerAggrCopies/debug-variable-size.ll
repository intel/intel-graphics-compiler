...
;
; RUN: %opt %use_old_pass_manager% -genx-lower-aggr-copies -march=genx64 -mtriple=spir64-unknown-unknown -mcpu=XeHPG -S < %s | FileCheck %s
; RUN: %opt_new_pm_typed -passes=GenXLowerAggrCopies -march=genx64 -mtriple=spir64-unknown-unknown -mcpu=XeHPG -S < %s | FileCheck %s
; ------------------------------------------------
; GenXLowerAggrCopies
; ------------------------------------------------
...
;
; Note, these use standart llvm expanders,
; that dont set line info on loop blocks.
;
; Variable size mem instrinsics
...
define void @test_loweraggr(i8 addrspace(4)* %a, i8 addrspace(4)* %b, i32 %size) !dbg !6 {
entry:
  call void @llvm.memcpy.p4i8.p4i8.i32(i8 addrspace(4)* %a, i8 addrspace(4)* %b, i32 %size, i1 false), !dbg !8
  br label %bb1
bb1:
  call void @llvm.memmove.p4i8.p4i8.i32(i8 addrspace(4)* %a, i8 addrspace(4)* %b, i32 %size, i1 false), !dbg !9
  br label %bb2
bb2:
  call void @llvm.memset.p4i8.i32(i8 addrspace(4)* %a, i8 13, i32 %size, i1 false), !dbg !10
  br label %end
end:
  ret void, !dbg !11
}

; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "variable-size.ll", directory: "/")
...
!1 = !DIFile(filename: "variable-size.ll", directory: "/")
!2 = !{}
!3 = !{i32 4}
!4 = !{i32 0}
