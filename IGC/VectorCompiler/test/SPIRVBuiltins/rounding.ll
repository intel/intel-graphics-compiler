...
; CHECK-LABEL: define internal spir_func {{.*}}float @_Z16__spirv_ocl_ceilf
; CHECK-SAME: (float {{(noundef )?}}%[[ARG1:[^ ]+]])
; CHECK: %[[CALL1:[^ ]+]] = tail call {{(noundef )?}}float @llvm.ceil.f32(float %[[ARG1]])
; CHECK-NEXT: ret float %[[CALL1]]

declare spir_func float @_Z17__spirv_ocl_floorf(float) #0
; CHECK-LABEL: define internal spir_func {{.*}}float @_Z17__spirv_ocl_floorf
; CHECK-SAME: (float {{(noundef )?}}%[[ARG2:[^ ]+]])
; CHECK: %[[CALL2:[^ ]+]] = tail call {{(noundef )?}}float @llvm.floor.f32(float %[[ARG2]])
; CHECK-NEXT: ret float %[[CALL2]]

declare spir_func float @_Z17__spirv_ocl_truncf(float) #0
; CHECK-LABEL: define internal spir_func {{.*}}float @_Z17__spirv_ocl_truncf
; CHECK-SAME: (float {{(noundef )?}}%[[ARG3:[^ ]+]])
; CHECK: %[[CALL3:[^ ]+]] = tail call {{(noundef )?}}float @llvm.trunc.f32(float %[[ARG3]])
; CHECK-NEXT: ret float %[[CALL3]]

declare spir_func float @_Z19__spirv_ocl_roundnef(float) #0
; CHECK-LABEL: define internal spir_func {{.*}}float @_Z19__spirv_ocl_roundnef
; CHECK-SAME: (float {{(noundef )?}}%[[ARG4:[^ ]+]])
; CHECK: %[[CALL4:[^ ]+]] = tail call {{(noundef )?}}float @llvm.genx.rnde.f32(float %[[ARG4]])
...
; CHECK: %[[CALL5:[^ ]+]] = tail call {{(noundef )?}}<2 x float> @llvm.ceil.v2f32(<2 x float> %[[ARG5]])
...
; CHECK: %[[CALL6:[^ ]+]] = tail call {{(noundef )?}}<16 x float> @llvm.ceil.v16f32(<16 x float> %[[ARG6]])
...
; CHECK: %[[CALL7:[^ ]+]] = tail call {{(noundef )?}}<2 x float> @llvm.floor.v2f32(<2 x float> %[[ARG7]])
...
; CHECK: %[[CALL8:[^ ]+]] = tail call {{(noundef )?}}<16 x float> @llvm.floor.v16f32(<16 x float> %[[ARG8]])
...
; CHECK: %[[CALL9:[^ ]+]] = tail call {{(noundef )?}}<2 x float> @llvm.trunc.v2f32(<2 x float> %[[ARG9]])
...
; CHECK: %[[CALL10:[^ ]+]] = tail call {{(noundef )?}}<16 x float> @llvm.trunc.v16f32(<16 x float> %[[ARG10]])
...
; CHECK: %[[CALL11:[^ ]+]] = tail call {{(noundef )?}}<2 x float> @llvm.genx.rnde.v2f32(<2 x float> %[[ARG11]])
...
; CHECK: %[[CALL12:[^ ]+]] = tail call {{(noundef )?}}<16 x float> @llvm.genx.rnde.v16f32(<16 x float> %[[ARG12]])
