...
; RUN: %opt_typed_ptrs %use_old_pass_manager% -CMImpParam -march=genx64 -mcpu=Gen9 -S < %s | FileCheck %s
; RUN: %opt_opaque_ptrs %use_old_pass_manager% -CMImpParam -march=genx64 -mcpu=Gen9 -S < %s | FileCheck %s
