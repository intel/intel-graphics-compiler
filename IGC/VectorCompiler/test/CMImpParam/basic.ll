...
; CHECK-DAG: @__imparg_llvm.genx.print.buffer = internal global i64 undef
...
; CHECK-DAG: i64 %impl.arg.llvm.genx.print.buffer
...
; CHECK-DAG: store i64 %impl.arg.llvm.genx.print.buffer, i64* @__imparg_llvm.genx.print.buffer
...
; CHECK: %d.grp.z = call i32 @llvm.genx.group.id.z()
  ...
  %d.print = call i64 @llvm.genx.print.buffer()
; CHECK: %d.grp.sz = load <3 x i32>, <3 x i32>* @__imparg_llvm.genx.group.count
; CHECK: %d.print = load i64, i64* @__imparg_llvm.genx.print.buffer
  ret void
}
...
; CHECK-SAME: i64 %impl.arg.llvm.genx.print.buffer
; CHECK-SAME: ) #[[KERN_ATTR]] {
...
define internal spir_func void @indir_func_common() {
  %i.c.print = call i64 @llvm.genx.print.buffer()
; CHECK: %i.c.print = load i64, i64* @__imparg_llvm.genx.print.buffer
  ret void
}
