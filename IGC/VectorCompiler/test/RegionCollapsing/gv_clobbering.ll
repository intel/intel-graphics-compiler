...
;
; RUN: %opt_typed_ptrs %use_old_pass_manager% -GenXRegionCollapsing -march=genx64 -mtriple=spir64-unknown-unknown -mcpu=Xe2 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK-TYPED-PTRS
; RUN: %opt_opaque_ptrs %use_old_pass_manager% -GenXRegionCollapsing -march=genx64 -mtriple=spir64-unknown-unknown -mcpu=Xe2 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK-OPAQUE-PTRS
; ------------------------------------------------
...
; CHECK-TYPED-PTRS:   %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(<4 x i32>* @g1)
; CHECK-OPAQUE-PTRS:   %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(ptr @g1)
...
; CHECK-TYPED-PTRS: call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> %wrr2, <4 x i32>* @g1)
; CHECK-OPAQUE-PTRS: call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> %wrr2, ptr @g1)
  ret void
}
...
; CHECK-TYPED-PTRS: call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> zeroinitializer, <4 x i32>* @g1)
; CHECK-OPAQUE-PTRS: call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> zeroinitializer, ptr @g1)
  call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> zeroinitializer, <4 x i32>* @g1)
...
define spir_kernel void @chkRdr0AndRdr1_Wrr0AndWrr1_Collapse() #1 {
  %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(<4 x i32>* @g1)
; CHECK-TYPED-PTRS-NEXT:  %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(<4 x i32>* @g1)
; CHECK-OPAQUE-PTRS-NEXT:  %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(ptr @g1)
...
; CHECK-TYPED-PTRS-NOT: %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0v4i32(<4 x i32>* @g1)
; CHECK-TYPED-PTRS-NOT: call void @llvm.genx.vstore.v4i32.p0v4i32(<4 x i32> zeroinitializer, <4 x i32>* @g1
; CHECK-OPAQUE-PTRS-NOT: %vload1 = call <4 x i32> @llvm.genx.vload.v4i32.p0(ptr @g1)
; CHECK-OPAQUE-PTRS-NOT: call void @llvm.genx.vstore.v4i32.p0(<4 x i32> zeroinitializer, ptr @g1
...
; CHECK-TYPED-PTRS:  %vload2 = load volatile <4 x i32>, <4 x i32>* @g1, align 16
; CHECK-OPAQUE-PTRS:  %vload2 = load volatile <4 x i32>, ptr @g1, align 16
...
;------------------------------
; CHECK-TYPED-PTRS: %vload1 = load volatile <3584 x float>, <3584 x float>* @g2, align 16384
; CHECK-OPAQUE-PTRS: %vload1 = load volatile <3584 x float>, ptr @g2, align 16384
...
; This also checks that store volatile is treated same as genx.vstore
  store volatile <3584 x float> zeroinitializer, <3584 x float>* @g2, align 16384
; CHECK-TYPED-PTRS: store volatile <3584 x float> zeroinitializer, <3584 x float>* @g2, align 16384
; CHECK-OPAQUE-PTRS: store volatile <3584 x float> zeroinitializer, ptr @g2, align 16384
