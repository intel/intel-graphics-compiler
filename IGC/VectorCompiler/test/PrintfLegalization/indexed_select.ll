...
; CHECK-DAG: %[[SIMPLE_GEP_TRUE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.true)
; CHECK-DAG: %[[SIMPLE_GEP_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.false)
...
; CHECK: %[[SIMPLE_GEP_SELECT:[^ ]+]] = select i1 %cond, i32 %[[SIMPLE_GEP_TRUE_IDX]], i32 %[[SIMPLE_GEP_FALSE_IDX]]
  %idx.select.gep = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.gep)
  %user.gep = add i32 %idx.select.gep, 1
; CHECK: %user.gep = add i32 %[[SIMPLE_GEP_SELECT]], 1

; CHECK-DAG: %[[SIMPLE_MIXED_TRUE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.true)
; CHECK-DAG: %[[SIMPLE_MIXED_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* getelementptr inbounds ([6 x i8], [6 x i8] addrspace(2)* @str.false, i64 0, i64 0))
...
; CHECK: %[[SIMPLE_MIXED_SELECT:[^ ]+]] = select i1 %cond, i32 %[[SIMPLE_MIXED_TRUE_IDX]], i32 %[[SIMPLE_MIXED_FALSE_IDX]]
  %idx.select.mixed = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.mixed)

; CHECK-DAG: %[[SIMPLE_DIRECT_TRUE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* getelementptr inbounds ([5 x i8], [5 x i8] addrspace(2)* @str.true, i64 0, i64 0))
; CHECK-DAG: %[[SIMPLE_DIRECT_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* getelementptr inbounds ([6 x i8], [6 x i8] addrspace(2)* @str.false, i64 0, i64 0))
...
; CHECK: %[[SIMPLE_DIRECT_SELECT:[^ ]+]] = select i1 %cond, i32 %[[SIMPLE_DIRECT_TRUE_IDX]], i32 %[[SIMPLE_DIRECT_FALSE_IDX]]
  %idx.select.direct = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.direct)
  ret void
}
...
; CHECK: %gep.true = getelementptr inbounds [5 x i8], [5 x i8] addrspace(2)* @str.true, i64 0, i64 0
; CHECK: %gep.false = getelementptr inbounds [6 x i8], [6 x i8] addrspace(2)* @str.false, i64 0, i64 0
; CHECK-DAG: %[[IDX2SEL1_TRUE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.true)
; CHECK-DAG: %[[IDX2SEL1_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.false)
  %select.gep = select i1 %cond, i8 addrspace(2)* %gep.true, i8 addrspace(2)* %gep.false
; CHECK: %[[IDX2SEL1_SELECT:[^ ]+]] = select i1 %cond, i32 %[[IDX2SEL1_TRUE_IDX]], i32 %[[IDX2SEL1_FALSE_IDX]]
  %idx.select.gep.0 = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.gep)
  %idx.select.gep.1 = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.gep)
...
; CHECK: %gep.true = getelementptr inbounds [5 x i8], [5 x i8] addrspace(2)* @str.true, i64 0, i64 0
; CHECK: %gep.false = getelementptr inbounds [6 x i8], [6 x i8] addrspace(2)* @str.false, i64 0, i64 0
; CHECK-DAG: %[[ENTANGLED_TOP_TRUE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.true)
; CHECK-DAG: %[[ENTANGLED_TOP_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.false)
...
; CHECK: %[[ENTANGLED_RIGHT_FALSE_IDX:[^ ]+]] = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %gep.false)
...
; CHECK: %[[ENTANGLED_BOTTOM_SELECT:[^ ]+]] = select i1 %cond, i32 %[[ENTANGLED_LEFT_SELECT]], i32 %[[ENTANGLED_RIGHT_SELECT]]
  %idx = call i32 @llvm.genx.print.format.index.p2i8(i8 addrspace(2)* %select.bottom)
  %user = add i32 %idx, 1
