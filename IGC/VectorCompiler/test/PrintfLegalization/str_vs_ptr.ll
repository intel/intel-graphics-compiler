...
define dllexport void @str_vs_ptr(<1 x i64> %addr) {
  ...
  %idx.gep = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %gep)
; CHECK: %idx.gep = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.indexed, i32 0, i32 0))
  %idx.direct = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str, i64 0, i64 0))
; CHECK: %idx.direct = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.indexed, i32 0, i32 0))
