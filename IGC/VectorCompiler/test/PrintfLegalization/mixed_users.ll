...
define dllexport void @mixed_users() {
  ...
  %idx.a.gep.legal.0 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %a.gep.legal)
  %idx.a.gep.legal.1 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %a.gep.legal)
; COM: the same line
; CHECK: %idx.a.gep.legal.0 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.a.indexed, i32 0, i32 0))
; CHECK: %idx.a.gep.legal.1 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.a.indexed, i32 0, i32 0))
...
; CHECK: %a.gep.mixed = getelementptr inbounds [2 x i8], [2 x i8]* @str.a, i64 0, i64 0
  %idx.a.gep.mixed = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %a.gep.mixed)
  %usr.a.gep.mixed = ptrtoint i8* %a.gep.mixed to i64
; CHECK: %idx.a.gep.mixed = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.a.indexed, i32 0, i32 0))
; COM: the same line, continues using the original gep
; CHECK: %usr.a.gep.mixed = ptrtoint i8* %a.gep.mixed to i64


  %idx.b.direct.1 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.b, i64 0, i64 0))
  %idx.b.direct.2 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.b, i64 0, i64 0))
; CHECK: %idx.b.direct.1 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.b.indexed, i32 0, i32 0))
; CHECK: %idx.b.direct.2 = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.b.indexed, i32 0, i32 0))
...
; COM: originally legal indexed string case
  %idx.no.a.direct = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.no.a, i64 0, i64 0))
  %no.a.gep.legal = getelementptr inbounds [5 x i8], [5 x i8]* @str.no.a, i64 0, i64 0
  %idx.no.a.gep.legal = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %no.a.gep.legal)
; COM: no transformation is applied, the lines stay the same
; CHECK: %idx.no.a.direct = tail call i32 @llvm.genx.print.format.index.p0i8(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.no.a, i64 0, i64 0))
; CHECK: %no.a.gep.legal = getelementptr inbounds [5 x i8], [5 x i8]* @str.no.a, i64 0, i64 0
; CHECK: %idx.no.a.gep.legal = tail call i32 @llvm.genx.print.format.index.p0i8(i8* %no.a.gep.legal)
