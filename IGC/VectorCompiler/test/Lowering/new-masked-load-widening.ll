...
; CHECK-NEXT: [[WRITE_CHANNEL1:%.*]] = call <16 x i32> @llvm.genx.wrregioni.v16i32.v8i32.i16.v8i1(<16 x i32> undef, <8 x i32> [[READ_CHANNEL1]], i32 0, i32 8, i32 1, i16 0, i32 undef, <8 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}})
...
; CHECK-NEXT: [[WRITE_CHANNEL2:%.*]] = call <16 x i32> @llvm.genx.wrregioni.v16i32.v8i32.i16.v8i1(<16 x i32> [[WRITE_CHANNEL1]], <8 x i32> [[READ_CHANNEL2]], i32 0, i32 8, i32 1, i16 32, i32 undef, <8 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}})
