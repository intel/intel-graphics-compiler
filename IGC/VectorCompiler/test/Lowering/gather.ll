...
; CHECK: [[GATHER_SPLIT1:%[^ ]+]] = call <16 x float> @llvm.genx.gather.masked.scaled2.v16f32.v16i32.v16i1(i32 0, i16 0, i32 0, i32 0, <16 x i32> [[ADDR_SPLIT1]], <16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}})
...
; CHECK: [[GATHER_SPLIT2:%[^ ]+]] = call <16 x float> @llvm.genx.gather.masked.scaled2.v16f32.v16i32.v16i1(i32 0, i16 0, i32 0, i32 0, <16 x i32> [[ADDR_SPLIT2]], <16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}})
