...
define spir_kernel void @test() #1 {
  %left.local = alloca <8 x double>, i32 0, align 64 ; In original testcase input this was a global variable, at this point it is "localized".
  %gload47.i = call <8 x double> @llvm.genx.vload.v8f64.p0v8f64(<8 x double>* @left2)
  store <8 x double> %gload47.i, <8 x double>* %left.local, align 64
  call void @llvm.genx.vstore.v8f64.p0v8f64(<8 x double> zeroinitializer, <8 x double>* @left2)
  %local_load = load <8 x double>, <8 x double>* %left.local, align 64
  %rdr39.i = call <1 x double> @llvm.genx.rdregionf.v1f64.v8f64.i16(<8 x double> %local_load, i32 0, i32 1, i32 0, i16 0, i32 0)
  ret void
}

; FIXED: define spir_kernel void @test()
; FIXED:  %gload47.i = call <8 x double> @llvm.genx.vload.v8f64.p0v8f64(<8 x double>* @left2)
; FIXED:  %gload47.i._gvload_legalized_rdr = call <8 x double> @llvm.genx.rdregionf.v8f64.v8f64.i16(<8 x double> %gload47.i, i32 0, i32 8, i32 1, i16 0, i32 undef)
; FIXED:  call void @llvm.genx.vstore.v8f64.p0v8f64(<8 x double> zeroinitializer, <8 x double>* @left2)
; FIXED:  %rdr39.i = call <1 x double> @llvm.genx.rdregionf.v1f64.v8f64.i16(<8 x double> %gload47.i._gvload_legalized_rdr, i32 0, i32 1, i32 0, i16 0, i32 0)

; UNFIXED: define spir_kernel void @test()
; UNFIXED:  %gload47.i = call <8 x double> @llvm.genx.vload.v8f64.p0v8f64(<8 x double>* @left2)
; UNFIXED:  call void @llvm.genx.vstore.v8f64.p0v8f64(<8 x double> zeroinitializer, <8 x double>* @left2)
; UNFIXED:  %rdr39.i = call <1 x double> @llvm.genx.rdregionf.v1f64.v8f64.i16(<8 x double> %gload47.i, i32 0, i32 1, i32 0, i16 0, i32 0)
