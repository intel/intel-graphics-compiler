...
define void @test_patternmatch(i16* %a, i16* %b, i16* %c) !dbg !6 {
  ...
  call void @llvm.dbg.value(metadata i16 %1, metadata !9, metadata !DIExpression()), !dbg !15
  %2 = load i16, i16* %b, !dbg !16
  call void @llvm.dbg.value(metadata i16 %2, metadata !11, metadata !DIExpression()), !dbg !16
  %3 = load i16, i16* %c, !dbg !17
  call void @llvm.dbg.value(metadata i16 %3, metadata !12, metadata !DIExpression()), !dbg !17
  %4 = add i16 %1, %2, !dbg !18
  call void @llvm.dbg.value(metadata i16 %4, metadata !13, metadata !DIExpression()), !dbg !18
  %5 = add i16 %4, %3, !dbg !19
  call void @llvm.dbg.value(metadata i16 %5, metadata !14, metadata !DIExpression()), !dbg !19
  store i16 %5, i16* %a, !dbg !20
  ret void, !dbg !21
}

; CHECK-DAG: [[FILE:![0-9]*]] = !DIFile(filename: "add3.ll", directory: "/")
...
!1 = !DIFile(filename: "add3.ll", directory: "/")
!2 = !{}
!3 = !{i32 7}
!4 = !{i32 5}
