...
; CHECK: call <4 x i32> @llvm.vc.internal.sampler.load.surf.v4i32.v4i1.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i16 26, i8 8, i16 0, i64 %addr, i8 0, <4 x i32> undef, <4 x i32> %param1, <4 x i32> %param2, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer)
...
; CHECK: call <4 x i32> @llvm.vc.internal.sample.surf.v4i32.v4i1.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i16 0, i8 1, i16 0, i64 %addr, i8 0, i64 %addr, i8 0, <4 x i32> undef, <4 x i32> %param1, <4 x i32> %param2, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer)
