...
; CHECK: @test_ugm
; CHECK: call void @llvm.vc.internal.lsc.prefetch.surf.v1i1.v3i8.i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 4, i8 3, i8 5, <3 x i8> zeroinitializer, i64 %arg1, i8 0, i32 32, i16 1, i32 0)
; CHECK: [[LOAD:%[^ ]*]] = call <8 x i32> @llvm.vc.internal.lsc.load.surf.v8i32.v1i1.v3i8.i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 4, i8 3, i8 5, <3 x i8> zeroinitializer, i64 %arg1, i8 0, i32 32, i16 1, i32 0, <8 x i32> undef)
; CHECK: call void @llvm.vc.internal.lsc.store.surf.v1i1.v3i8.i32.v8i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 4, i8 3, i8 5, <3 x i8> zeroinitializer, i64 %arg2, i8 0, i32 16, i16 1, i32 0, <8 x i32> [[LOAD]])
...
; CHECK: @test_tgm_2d
; CHECK: [[LOAD:%[^ ]*]] = call <32 x i16> @llvm.vc.internal.lsc.load.2d.tgm.surf.v32i16.v2i8(<2 x i8> {{(splat \(i8 1\)|<i8 1(, i8 1)*>)}}, i64 %arg1, i8 0, i32 2, i32 8, i32 %x, i32 %y)
; CHECK: call void @llvm.vc.internal.lsc.store.2d.tgm.surf.v2i8.v32i16(<2 x i8> {{(splat \(i8 1\)|<i8 1(, i8 1)*>)}}, i64 %arg2, i8 0, i32 2, i32 8, i32 %x, i32 %y, <32 x i16> [[LOAD]])
...
; CHECK: @test_tgm_quad
; CHECK: call void @llvm.vc.internal.lsc.prefetch.quad.tgm.surf.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 1, i64 %arg1, i8 0, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod)
; CHECK: [[LOAD:%[^ ]*]] = call <16 x i32> @llvm.vc.internal.lsc.load.quad.tgm.surf.v16i32.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 15, i64 %arg1, i8 0, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod, <16 x i32> %passthru)
; CHECK: call void @llvm.vc.internal.lsc.store.quad.tgm.surf.v4i1.v2i8.v4i32.v16i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, <2 x i8> zeroinitializer, i8 15, i64 %arg2, i8 0, <4 x i32> %u, <4 x i32> %v, <4 x i32> %r, <4 x i32> %lod, <16 x i32> [[LOAD]])
...
; CHECK: call <1 x float> @llvm.vc.internal.lsc.atomic.surf.v1f32.v1i1.v2i8.v1i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 20, i8 4, i8 3, <2 x i8> zeroinitializer, i64 %arg1, i8 0, <1 x i32> %arg2, i16 1, i32 0, <1 x float> %arg3, <1 x float> undef, <1 x float> undef)
...
; CHECK: call <8 x i32> @llvm.vc.internal.lsc.load.surf.v8i32.v1i1.v3i8.i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 4, i8 3, i8 5, <3 x i8> zeroinitializer, i64 [[RDREG]], i8 0, i32 32, i16 1, i32 0, <8 x i32> undef)
