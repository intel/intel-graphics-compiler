...
; RUN: %igc-lld --relocatable -o dbginfo_%basename_t_linked.elf dbginfo_%basename_t_test_kernel_dwarf.elf
; RUN: oneapi-readelf -r dbginfo_%basename_t_linked.elf | FileCheck %s

; CHECK: Relocation section '.rela.debug_info'
; CHECK: R_X86_64_64
; CHECK: Relocation section '.rela.debug_line'
; CHECK: R_X86_64_64
