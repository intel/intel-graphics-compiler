...
; COM: this test checks that stack call does not have low_pc equal to high_pc
; COM: another potential problem with this test is that when Subr does not have
...
; CHECK_STACK: DW_AT_low_pc : 0x[[LOW_PC:[0-9a-f]+]]
; CHECK_STACK-NOT: DW_AT_high_pc : 0x[[LOW_PC]]
...
define internal spir_func void @Subr(<8 x i32> %0) unnamed_addr #0 !dbg !15 {
  tail call void @llvm.genx.media.st.v8i32(i32 0, i32 1, i32 0, i32 32, i32 0, i32 0, <8 x i32> %0)
  ret void
}
