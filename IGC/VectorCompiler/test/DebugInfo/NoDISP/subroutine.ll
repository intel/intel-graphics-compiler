...
define internal spir_func <8 x i64> @subroutine(<8 x i64> %0, <8 x i64> %1) local_unnamed_addr #3 {
  %3 = add <8 x i64> %0, %1
  ret <8 x i64> %3
}
...
define dllexport spir_kernel void @test_kernel(i32 %0, i32 %1) local_unnamed_addr #0 !dbg !12 {
  ...
  %5 = tail call spir_func <8 x i64> @subroutine(<8 x i64> %3, <8 x i64> %4) #5
  tail call void @llvm.genx.oword.st.v8i64(i32 %0, i32 2, <8 x i64> %5), !dbg !21
  ret void, !dbg !22
}
