...
define internal spir_func <8 x i64> @subroutine(<8 x i64> %0, <8 x i64> %1) local_unnamed_addr #4 {
  %3 = add <8 x i64> %0, %1
  ret <8 x i64> %3
}

; Function Attrs: noinline nounwind
define internal spir_func void @stack_call(<8 x i64> %0) unnamed_addr #0 !FuncArgSize !26 !FuncRetSize !27 {
  %res = tail call spir_func <8 x i64> @subroutine(<8 x i64> %0, <8 x i64> %0)
  tail call void @llvm.genx.oword.st.v8i64(i32 3, i32 0, <8 x i64> %res), !dbg !13
  ret void, !dbg !17
}
...
define dllexport void @main_kernel(i32 %0, i32 %1, i32 %2, i64 %privBase) local_unnamed_addr #2 !dbg !18 {
  ...
  %7 = tail call spir_func <8 x i64> @subroutine(<8 x i64> %6, <8 x i64> %6)
  tail call spir_func void @stack_call(<8 x i64> %7) #9, !dbg !22, !FuncArgSize !26, !FuncRetSize !27
  ret void, !dbg !23
}
