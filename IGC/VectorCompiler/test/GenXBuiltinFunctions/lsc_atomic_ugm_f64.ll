...
define dllexport spir_kernel void @test_fadd_kernel(<16 x i1> %pred, <16 x i64> %index, <16 x double> %src1, <16 x double> %src2, <16 x double> %passthru) {
  %1 = tail call <16 x double> @llvm.vc.internal.lsc.atomic.ugm.v16f64.v16i1.v16i64(<16 x i1> %pred, i8 19, i8 3, i8 4, i8 0, i8 0, i64 0, <16 x i64> %index, i16 1, i32 0, <16 x double> %src1, <16 x double> %src2, <16 x double> %passthru)
  ret void
}
...
define <16 x double> @__vc_builtin_atomic_ugm_v16f64(<16 x i8> noundef %pred, i8 noundef signext %op, i8 noundef signext %l1cachecontrol, i8 noundef signext %l3cachecontrol, i64 noundef %base, <16 x i64> noundef %index, i16 noundef signext %scale, i32 noundef %offset, <16 x double> noundef %src1, <16 x double> noundef %src2, <16 x double> noundef %passthru) #0 {
