...
define internal spir_func <16 x float> @foo___vyfvyf(<16 x float> %a, <16 x float> %b, <16 x i1> %__mask) #4 !FuncArgSize !18 !FuncRetSize !19 {
allocas:
...
define internal spir_func <16 x float> @bar___vyfvyf(<16 x float> %a, <16 x float> %b, <16 x i1> %__mask) #5 !FuncArgSize !18 !FuncRetSize !19 {
allocas:
...
define dllexport void @f_f(float* noalias %RET, float* noalias %aFOO, i64 %privBase) #6 {
  ...
  %calltmp = call spir_func <16 x float> %fptr(<16 x float> %src1, <16 x float> %src1, <16 x i1> zeroinitializer) #7, !FuncArgSize !18, !FuncRetSize !19
...
define dllexport void @result(float* noalias %RET, i64 %privBase) #6 {
  ...
  %rawaddr = extractelement <1 x i64> %rawaddr_v, i32 0
  %fptr = inttoptr i64 %rawaddr to <16 x float> (<16 x float>, <16 x float>, <16 x i1>)*
  %calltmp = call spir_func <16 x float> %fptr(<16 x float> zeroinitializer, <16 x float> zeroinitializer, <16 x i1> zeroinitializer) #7, !FuncArgSize !18, !FuncRetSize !19
  %svm_st_ptrtoint = ptrtoint float* %RET to i64
