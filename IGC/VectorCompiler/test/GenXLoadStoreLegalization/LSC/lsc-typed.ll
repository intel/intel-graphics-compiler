...
declare <128 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v128i32.v64i1.v2i8.v64i32(<64 x i1>, <2 x i8>, i8, i32, <64 x i32>, <64 x i32>, <64 x i32>, <64 x i32>, <128 x i32>)
declare void @llvm.vc.internal.lsc.store.quad.tgm.v64i1.v2i8.v64i32.v128i32(<64 x i1>, <2 x i8>, i8, i32, <64 x i32>, <64 x i32>, <64 x i32>, <64 x i32>, <128 x i32>)
declare void @llvm.vc.internal.lsc.prefetch.quad.tgm.v64i1.v2i8.v64i32(<64 x i1>, <2 x i8>, i8, i32, <64 x i32>, <64 x i32>, <64 x i32>, <64 x i32>)

declare <66 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v66i32.v33i1.v2i8.v33i32(<33 x i1>, <2 x i8>, i8, i32, <33 x i32>, <33 x i32>, <33 x i32>, <33 x i32>, <66 x i32>)
...
define <128 x i32> @test_load_split(<64 x i1> %pred, <64 x i32> %u, <128 x i32> %src) {
  ...
  ; CHECK: [[LOAD0:%[^ ]+]] = call <64 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v64i32.v32i1.v2i8.v32i32(<32 x i1> [[PRED0]], <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[LU0]],
  ...
  ; CHECK: [[LOAD32:%[^ ]+]] = call <64 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v64i32.v32i1.v2i8.v32i32(<32 x i1> [[PRED32]], <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[LU32]],
  ...
  %res = call <128 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v128i32.v64i1.v2i8.v64i32(<64 x i1> %pred, <2 x i8> zeroinitializer, i8 3, i32 1, <64 x i32> %u, <64 x i32> undef, <64 x i32> undef, <64 x i32> undef, <128 x i32> %src)
  ret <128 x i32> %res
}
...
define void @test_store_split(<64 x i1> %pred, <64 x i32> %u, <128 x i32> %src) {
  ...
  ; CHECK: call void @llvm.vc.internal.lsc.store.quad.tgm.v32i1.v2i8.v32i32.v64i32(<32 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[SU0]],
  ...
  ; CHECK: call void @llvm.vc.internal.lsc.store.quad.tgm.v32i1.v2i8.v32i32.v64i32(<32 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[SU32]],
  ; CHECK-SAME:  <64 x i32> [[SRC32]])
  call void @llvm.vc.internal.lsc.store.quad.tgm.v64i1.v2i8.v64i32.v128i32(<64 x i1> %pred, <2 x i8> zeroinitializer, i8 3, i32 1, <64 x i32> %u, <64 x i32> undef, <64 x i32> undef, <64 x i32> undef, <128 x i32> %src)
  ret void
}
...
define void @test_prefetch_split(<64 x i1> %pred, <64 x i32> %u) {
  ...
  ; CHECK: call void @llvm.vc.internal.lsc.prefetch.quad.tgm.v32i1.v2i8.v32i32(<32 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[PU0]],
  ; CHECK: [[PU32:%[^ ]+]] = call <32 x i32> @llvm.genx.rdregioni.v32i32.v64i32.i16(<64 x i32> %u, i32 64, i32 32, i32 1, i16 128, i32 undef)
  ; CHECK: call void @llvm.vc.internal.lsc.prefetch.quad.tgm.v32i1.v2i8.v32i32(<32 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[PU32]],
  call void @llvm.vc.internal.lsc.prefetch.quad.tgm.v64i1.v2i8.v64i32(<64 x i1> %pred, <2 x i8> zeroinitializer, i8 3, i32 1, <64 x i32> %u, <64 x i32> undef, <64 x i32> undef, <64 x i32> undef)
  ret void
}
...
define <66 x i32> @test_load_split_tail(<33 x i1> %pred, <33 x i32> %u, <66 x i32> %src) {
  ...
  ; CHECK: [[TLOAD0:%[^ ]+]] = call <64 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v64i32.v32i1.v2i8.v32i32(<32 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <32 x i32> [[U0]],
  ; CHECK-SAME:  <64 x i32> [[SRC0]])
  ...
  ; CHECK: [[TLOAD32:%[^ ]+]] = call <32 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v32i32.v16i1.v2i8.v16i32(<16 x i1> %{{[^,]+}}, <2 x i8> zeroinitializer, i8 3, i32 1, <16 x i32> %{{[^,]+}},
  ...
  %res = call <66 x i32> @llvm.vc.internal.lsc.load.quad.tgm.v66i32.v33i1.v2i8.v33i32(<33 x i1> %pred, <2 x i8> zeroinitializer, i8 3, i32 1, <33 x i32> %u, <33 x i32> undef, <33 x i32> undef, <33 x i32> undef, <66 x i32> %src)
  ret <66 x i32> %res
}
