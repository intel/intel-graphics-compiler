...
; CHECK-NEXT: [[ZERO:%[^ ]+]] = call <8 x i32> @llvm.genx.wrregioni.v8i32.v6i32.i16.i1(<8 x i32> undef, <6 x i32> zeroinitializer, i32 8, i32 6, i32 1, i16 0, i32 undef, i1 true)
; CHECK-NEXT: [[LOAD:%[^ ]+]] = call <8 x i32> @llvm.vc.internal.lsc.load.ugm.v8i32.v8i1.v2i8.v8i64(<8 x i1> [[CMP]], i8 3, i8 5, i8 1, <2 x i8> zeroinitializer, i64 0, <8 x i64> [[ADDR]], i16 1, i32 0, <8 x i32> [[ZERO]])
