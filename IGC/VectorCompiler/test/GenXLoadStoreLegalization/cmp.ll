...
; CHECK-NEXT: [[CMP_OP1:%[^ ]+]] = call <8 x i16> @llvm.genx.wrregioni.v8i16.v6i16.i16.i1(<8 x i16> {{(splat \(i16 -1\)|<i16 -1(, i16 -1)*>)}}, <6 x i16> zeroinitializer, i32 8, i32 6, i32 1, i16 0, i32 undef, i1 true)
