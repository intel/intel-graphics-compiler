...
; CHECK: %data = tail call <4 x i64> @llvm.vc.internal.lsc.load.slm.v4i64.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 2, i8 4, i8 1, <2 x i8> zeroinitializer, i32 0, <4 x i32> %arg, i16 8, i32 16, <4 x i64> undef)
...
; CHECK: [[SCALE:%[^ ]+]] = shl <4 x i32> %arg, {{(splat \(i32 2\)|<i32 2(, i32 2)*>)}}
; CHECK: %data = tail call <4 x i64> @llvm.vc.internal.lsc.load.slm.v4i64.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 2, i8 4, i8 1, <2 x i8> zeroinitializer, i32 0, <4 x i32> [[SCALE]], i16 1, i32 16, <4 x i64> undef)
...
; CHECK: [[SCALE:%[^ ]+]] = shl <4 x i32> %arg, {{(splat \(i32 3\)|<i32 3(, i32 3)*>)}}
; CHECK: [[OFFSET:%[^ ]+]] = add <4 x i32> [[SCALE]], {{(splat \(i32 12\)|<i32 12(, i32 12)*>)}}
; CHECK: %data = tail call <4 x i64> @llvm.vc.internal.lsc.load.slm.v4i64.v4i1.v2i8.v4i32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 2, i8 4, i8 1, <2 x i8> zeroinitializer, i32 0, <4 x i32> [[OFFSET]], i16 1, i32 0, <4 x i64> undef)
  %1 = shl <4 x i32> %arg, <i32 3, i32 3, i32 3, i32 3>
...
; CHECK: %data = tail call <32 x i64> @llvm.vc.internal.lsc.load.slm.v32i64.v32i1.v2i8.v32i32(<32 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 %ibase, <32 x i32> %index, i16 1, i32 0, <32 x i64> undef)
...
; CHECK: %data = tail call <32 x i64> @llvm.vc.internal.lsc.load.slm.v32i64.v32i1.v2i8.v32i32(<32 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 %ibase, <32 x i32> %index, i16 8, i32 256, <32 x i64> undef)
  %data = tail call <32 x i64> @llvm.vc.internal.lsc.load.slm.v32i64.v32i1.v2i8.v32i32(<32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 0, <32 x i32> %addr, i16 1, i32 0, <32 x i64> undef)
  ret <32 x i64> %data
}
...
define void @vadd(i8 addrspace(3)* %0, i8 addrspace(3)* %1, i8 addrspace(3)* %2, <3 x i16> %impl.arg.llvm.genx.local.id16, <3 x i32> %impl.arg.llvm.genx.local.size) {
  ...
  ; CHECK: %a = call <32 x i32> @llvm.vc.internal.lsc.load.slm.v32i32.v1i1.v2i8.i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 3, i8 7, <2 x i8> zeroinitializer, i32 %ibase0, i32 %scale, i16 1, i32 0, <32 x i32> undef)
  ...
  ; CHECK: %b = call <32 x i32> @llvm.vc.internal.lsc.load.slm.v32i32.v1i1.v2i8.i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 3, i8 7, <2 x i8> zeroinitializer, i32 %ibase1, i32 %scale, i16 1, i32 0, <32 x i32> undef)
  ...
  ; CHECK: call void @llvm.vc.internal.lsc.store.slm.v1i1.v2i8.i32.v32i32(<1 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 3, i8 7, <2 x i8> zeroinitializer, i32 %ibase2, i32 %scale, i16 1, i32 0, <32 x i32> %c)
...
; CHECK: %data = tail call <16 x i64> @llvm.vc.internal.lsc.load.slm.v16i64.v16i1.v2i8.v16i32(<16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 %base, <16 x i32> %index, i16 1, i32 128, <16 x i64> undef)
...
; CHECK: %data = tail call <16 x i64> @llvm.vc.internal.lsc.load.slm.v16i64.v16i1.v2i8.v16i32(<16 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 %base, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>, i16 8, i32 8, <16 x i64> undef)
  %data = tail call <16 x i64> @llvm.vc.internal.lsc.load.slm.v16i64.v16i1.v2i8.v16i32(<16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, i8 3, i8 4, i8 1, <2 x i8> zeroinitializer, i32 0, <16 x i32> %addr, i16 1, i32 0, <16 x i64> undef)
  ret <16 x i64> %data
}
...
; CHECK: tail call void @llvm.vc.internal.lsc.store.slm.v4i1.v2i8.v4i32.v32f32(<4 x i1> {{(splat \(i1 true\)|<i1 true(, i1 true)*>)}}, i8 2, i8 3, i8 5, <2 x i8> zeroinitializer, i32 0, <4 x i32> <i32 0, i32 128, i32 256, i32 384>, i16 1, i32 0, <32 x float> %arg)
