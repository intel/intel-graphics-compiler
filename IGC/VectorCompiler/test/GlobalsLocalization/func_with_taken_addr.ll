...
; CHECK-TYPED-PTRS: %indirect.int.load = load i64, i64* %__imparg_llvm.vc.internal.print.buffer.local, align 8
; CHECK-OPAQUE-PTRS: %indirect.int.load = load i64, ptr %__imparg_llvm.vc.internal.print.buffer.local, align 8
  ret void
}
