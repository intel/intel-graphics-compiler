...
define dllexport spir_kernel void @direct(i64 %privBase, <3 x i16> %__arg_llvm.genx.local.id16, <3 x i32> %__arg_llvm.genx.local.size, i64 %__arg_llvm.genx.print.buffer, <3 x i32> %__arg_llvm.genx.group.count) #0 {
; CHECK-LABEL:  @direct
...
; CHECK-NOT: alloca
  ...
  store i64 %__arg_llvm.genx.print.buffer, i64* @__imparg_llvm.genx.print.buffer
...
; CHECK: store i64 %__arg_llvm.genx.print.buffer, i64* %__imparg_llvm.genx.print.buffer.local
; CHECK: store <3 x i32> %__arg_llvm.genx.group.count, <3 x i32>* %__imparg_llvm.genx.group.count.local
  ...
  %d.print = load i64, i64* @__imparg_llvm.genx.print.buffer
...
; CHECK: %d.print = load i64, i64* %__imparg_llvm.genx.print.buffer.local

  ret void
}

define dllexport spir_kernel void @indir(i64 %privBase, i64 %__arg_llvm.genx.print.buffer, <3 x i32> %__arg_llvm.genx.group.count, <3 x i16> %__arg_llvm.genx.local.id16) #0 {
; CHECK-LABEL: @indir
  store i64 %__arg_llvm.genx.print.buffer, i64* @__imparg_llvm.genx.print.buffer
  store <3 x i32> %__arg_llvm.genx.group.count, <3 x i32>* @__imparg_llvm.genx.group.count
  store <3 x i16> %__arg_llvm.genx.local.id16, <3 x i16>* @__imparg_llvm.genx.local.id16
...
; CHECK-DAG: i64 %__imparg_llvm.genx.print.buffer.in
; CHECK: ) #0 {
...
; CHECK: define internal spir_func {{.*}} @indir_func_3(i64 %__imparg_llvm.genx.print.buffer.in)
  call void @indir_func_common()
  ret void
}

define internal spir_func void @indir_func_common() #0 {
; CHECK: define internal spir_func {{.*}} @indir_func_common(i64 %__imparg_llvm.genx.print.buffer.in)
  %i.c.print = load i64, i64* @__imparg_llvm.genx.print.buffer
  ret void
}
