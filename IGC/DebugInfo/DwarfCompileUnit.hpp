...
namespace IGC
{
    ...
    private:
     ...
     private:
        ...
        bool buildSlicedLoc(const DbgVariable&, IGC::DIEBlock*, const VISAVariableLocation&,
                            const std::vector<DbgDecoder::LiveIntervalsVISA>*);
        bool buildValidVar(const DbgVariable&, IGC::DIEBlock*, const VISAVariableLocation&,
