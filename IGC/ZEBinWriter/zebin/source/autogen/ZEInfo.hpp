...
struct zeInfoExecutionEnv
{
    ...
    zeinfo_int32_t slm_alloc_mode = 0;
    ...
    zeinfo_int32_t quantum_size = 0;
    zeinfo_int32_t quantum_walk_order = 0;
    zeinfo_int32_t quantum_partition_dimension = 0;
    ...
    zeinfo_bool_t has_bindless_image_read = false;
};
...
struct PreDefinedAttrGetter{
    static zeinfo_str_t getVersionNumber() { return "1.73"; }
    ...
    static zeinfo_str_t get(ArgType val) {
        ...
        case ArgType::region_group_dimension:
            return "region_group_dimension";
