...
{
    return SPIRV_OCL_BUILTIN(half_sin, _f32, )( x );
}

INLINE float2 OVERLOADABLE half_sin( float2 x )
{
    return SPIRV_OCL_BUILTIN(half_sin, _v2f32, )( x );
}

INLINE float3 OVERLOADABLE half_sin( float3 x )
{
    return SPIRV_OCL_BUILTIN(half_sin, _v3f32, )( x );
}

INLINE float4 OVERLOADABLE half_sin( float4 x )
{
    return SPIRV_OCL_BUILTIN(half_sin, _v4f32, )( x );
}

INLINE float8 OVERLOADABLE half_sin( float8 x )
{
    return SPIRV_OCL_BUILTIN(half_sin, _v8f32, )( x );
}

INLINE float16 OVERLOADABLE half_sin( float16 x )
{
    return SPIRV_OCL_BUILTIN(half_sin, _v16f32, )( x );
}
