...
{
    return SPIRV_OCL_BUILTIN(half_log2, _f32, )( x );
}

INLINE float2 OVERLOADABLE half_log2( float2 x )
{
    return SPIRV_OCL_BUILTIN(half_log2, _v2f32, )( x );
}

INLINE float3 OVERLOADABLE half_log2( float3 x )
{
    return SPIRV_OCL_BUILTIN(half_log2, _v3f32, )( x );
}

INLINE float4 OVERLOADABLE half_log2( float4 x )
{
    return SPIRV_OCL_BUILTIN(half_log2, _v4f32, )( x );
}

INLINE float8 OVERLOADABLE half_log2( float8 x )
{
    return SPIRV_OCL_BUILTIN(half_log2, _v8f32, )( x );
}

INLINE float16 OVERLOADABLE half_log2( float16 x )
{
    return SPIRV_OCL_BUILTIN(half_log2, _v16f32, )( x );
}
