...
#ifndef __SUN_POW_CL__
#define __SUN_POW_CL__
...
double sun_pow(double x, double y)
{
    ...
    i0 = ((*(constant int*)&one)>>29)^1; i1=1-i0;
    hx = __HI(x); lx = __LO(x);
    hy = __HI(y); ly = __LO(y);
    ix = hx&0x7fffffff;  iy = hy&0x7fffffff;

    //Special case following ISO/IEC 9899:TC2
    if (x == 1.0){return 1.0;}
    if (x == -1.0 && iy == 0x7ff00000) {return 1.0;}
