...
{
    atomic_operation_1op(__builtin_IB_atomic_xchg_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_xchg_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicExchange, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicExchange, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicExchange, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_xchg_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_xchg_global_i32, float, (__global int*)Pointer, Scope, Semantics, as_int(Value), true);
}
...
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_xchg_local_i32, float, (__local int*)Pointer, Scope, Semantics, as_int(Value), false);
}
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicExchange, _p4f32_i32_i32_f32, )(__generic float *Pointer, int Scope, int Semantics, float Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicExchange, _p3f32_i32_i32_f32, )((__local int*)Pointer, Scope, Semantics, as_int(Value));
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicExchange, _p1f32_i32_i32_f32, )((__global int*)Pointer, Scope, Semantics, as_int(Value));
    }
}
...
{
    atomic_cmpxhg(__builtin_IB_atomic_cmpxchg_global_i32, uint, Pointer, Scope, Equal, Value, Comparator, true);
}
...
{
    atomic_cmpxhg(__builtin_IB_atomic_cmpxchg_local_i32, uint, Pointer, Scope, Equal, Value, Comparator, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicCompareExchange, _p4i32_i32_i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Equal, int Unequal, int Value, int Comparator)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicCompareExchange, _p3i32_i32_i32_i32_i32_i32, )((__local int*)Pointer, Scope, Equal, Unequal, Value, Comparator);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicCompareExchange, _p1i32_i32_i32_i32_i32_i32, )((__global int*)Pointer, Scope, Equal, Unequal, Value, Comparator);
    }
}
...
{
    atomic_cmpxhg(__builtin_IB_atomic_cmpxchg_global_i64, ulong, Pointer, Scope, Equal, Value, Comparator, true);
}
...
long SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicCompareExchange, _p3i64_i32_i32_i32_i64_i64, )(__local long *Pointer, int Scope, int Equal, int Unequal, long Value, long Comparator)
{
    if (BIF_FLAG_CTRL_GET(HasInt64SLMAtomicCAS))
    {
        atomic_cmpxhg(__builtin_IB_atomic_cmpxchg_local_i64, ulong, Pointer, Scope, Equal, Value, Comparator, false);
    }
    ulong orig;
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicCompareExchange, _p4f32_i32_i32_i32_f32_f32, )(__generic float *Pointer, int Scope, int Equal, int Unequal, float Value, float Comparator)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicCompareExchange, _p3f32_i32_i32_i32_f32_f32, )((__local int*)Pointer, Scope, Equal, Unequal, Value, Comparator);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicCompareExchange, _p1f32_i32_i32_i32_f32_f32, )((__global int*)Pointer, Scope, Equal, Unequal, Value, Comparator);
    }
}
...
{
    atomic_operation_0op(__builtin_IB_atomic_inc_global_i32, uint, Pointer, Scope, Semantics, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIIncrement, _p3i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics)
{
    atomic_operation_0op(__builtin_IB_atomic_inc_local_i32, uint, Pointer, Scope, Semantics, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIIncrement, _p4i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicIIncrement, _p3i32_i32_i32, )((__local int*)Pointer, Scope, Semantics);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicIIncrement, _p1i32_i32_i32, )((__global int*)Pointer, Scope, Semantics);
    }
}
...
{
    atomic_operation_0op(__builtin_IB_atomic_inc_global_i64, ulong, Pointer, Scope, Semantics, true);
}
...
{
    atomic_operation_0op(__builtin_IB_atomic_dec_global_i32, uint, Pointer, Scope, Semantics, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIDecrement, _p3i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics)
{
    atomic_operation_0op(__builtin_IB_atomic_dec_local_i32, uint, Pointer, Scope, Semantics, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIDecrement, _p4i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicIDecrement, _p3i32_i32_i32, )((__local int*)Pointer, Scope, Semantics);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicIDecrement, _p1i32_i32_i32, )((__global int*)Pointer, Scope, Semantics);
    }
}
...
{
    atomic_operation_0op(__builtin_IB_atomic_dec_global_i64, ulong, Pointer, Scope, Semantics, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_add_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIAdd, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_add_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicIAdd, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicIAdd, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicIAdd, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_add_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_sub_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicISub, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_sub_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicISub, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicISub, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicISub, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_sub_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_min_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicSMin, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_min_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicSMin, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicSMin, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicSMin, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_min_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
uint SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicUMin, _p4i32_i32_i32_i32, )(__generic uint *Pointer, int Scope, int Semantics, uint Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicUMin, _p3i32_i32_i32_i32, )((__local uint*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicUMin, _p1i32_i32_i32_i32, )((__global uint*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_max_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicSMax, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_max_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicSMax, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicSMax, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicSMax, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_max_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
uint SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicUMax, _p4i32_i32_i32_i32, )(__generic uint *Pointer, int Scope, int Semantics, uint Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicUMax, _p3i32_i32_i32_i32, )((__local uint*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicUMax, _p1i32_i32_i32_i32, )((__global uint*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_and_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicAnd, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_and_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicAnd, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicAnd, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicAnd, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_and_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_or_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicOr, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_or_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicOr, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicOr, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicOr, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_or_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_xor_global_i32, uint, Pointer, Scope, Semantics, Value, true);
}

int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicXor, _p3i32_i32_i32_i32, )(__local int *Pointer, int Scope, int Semantics, int Value)
{
    atomic_operation_1op(__builtin_IB_atomic_xor_local_i32, uint, Pointer, Scope, Semantics, Value, false);
}
...
int SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicXor, _p4i32_i32_i32_i32, )(__generic int *Pointer, int Scope, int Semantics, int Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicXor, _p3i32_i32_i32_i32, )((__local int*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicXor, _p1i32_i32_i32_i32, )((__global int*)Pointer, Scope, Semantics, Value);
    }
}
...
{
    atomic_operation_1op(__builtin_IB_atomic_xor_global_i64, ulong, Pointer, Scope, Semantics, Value, true);
}
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFAddEXT, _p4f32_i32_i32_f32, )(__generic float *Pointer, int Scope, int Semantics, float Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicFAddEXT, _p3f32_i32_i32_f32, )((__local float*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicFAddEXT, _p1f32_i32_i32_f32, )((__global float*)Pointer, Scope, Semantics, Value);
    }
}
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFAddEXT, _p4f64_i32_i32_f64, )(__generic double *Pointer, int Scope, int Semantics, double Value)
{
    ...
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
        return SPIRV_BUILTIN(AtomicFAddEXT, _p3f64_i32_i32_f64, )((__local double*)Pointer, Scope, Semantics, Value);
    }
    else if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p0i8_p4i8_i32, _ToPrivate)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
    ...
    {
        return SPIRV_BUILTIN(AtomicFAddEXT, _p1f64_i32_i32_f64, )((__global double*)Pointer, Scope, Semantics, Value);
    }
}
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)

half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p0f16_i32_i32_f16, )(__private half* Pointer, int Scope, int Semantics, half Value)
{
    half orig = *Pointer;
    *Pointer = orig < Value ? orig : Value;
    return orig;
...
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p1f16_i32_i32_f16, )(__global half* Pointer, int Scope, int Semantics, half Value)
{
...
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p3f16_i32_i32_f16, )(__local half* Pointer, int Scope, int Semantics, half Value)
{
    if (BIF_FLAG_CTRL_GET(UseNativeFP16AtomicMinMax))
    {
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p4f16_i32_i32_f16, )(__generic half* Pointer, int Scope, int Semantics, half Value)
{
    __builtin_assume((__local half*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p0f32_i32_i32_f32, )(__private float* Pointer, int Scope, int Semantics, float Value)
{
    float orig = *Pointer;
    *Pointer = orig < Value ? orig : Value;
    return orig;
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p1f32_i32_i32_f32, )(__global float* Pointer, int Scope, int Semantics, float Value)
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_min_global_f32, float, Pointer, Scope, Semantics, Value, true);
}

float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p3f32_i32_i32_f32, )(__local float* Pointer, int Scope, int Semantics, float Value)
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_min_local_f32, float, Pointer, Scope, Semantics, Value, false);
}

#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p4f32_i32_i32_f32, )(__generic float* Pointer, int Scope, int Semantics, float Value)
{
    __builtin_assume((__local float*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p0f64_i32_i32_f64, )(__private double* Pointer, int Scope, int Semantics, double Value)
{
    double orig = *Pointer;
    *Pointer = orig < Value ? orig : Value;
    return orig;
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p1f64_i32_i32_f64, )(__global double* Pointer, int Scope, int Semantics, double Value)
{
    // We don't use SPINLOCK_START and SPINLOCK_END emulation here, since do-while loop is more efficient for global atomics.
    // Another important reason of using do-while loop emulation is to avoid HW Bug on XeHP SDV:
    // "NodeDSS works in fixed arbitration mode where writes are always prioritized over reads.
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p3f64_i32_i32_f64, )(__local double* Pointer, int Scope, int Semantics, double Value)
{
    double orig;
    double desired;
    do {
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMinEXT, _p4f64_i32_i32_f64, )(__generic double* Pointer, int Scope, int Semantics, double Value)
{
    __builtin_assume((__local double*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
...
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p0f16_i32_i32_f16, )(__private half* Pointer, int Scope, int Semantics, half Value)
{
    half orig = *Pointer;
    *Pointer = orig > Value ? orig : Value;
    return orig;
...
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p1f16_i32_i32_f16, )(__global half* Pointer, int Scope, int Semantics, half Value)
{
    if (BIF_FLAG_CTRL_GET(UseNativeFP16AtomicMinMax))
    {
...
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p3f16_i32_i32_f16, )(__local half* Pointer, int Scope, int Semantics, half Value)
{
    if (BIF_FLAG_CTRL_GET(UseNativeFP16AtomicMinMax))
    {
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p4f16_i32_i32_f16, )(__generic half* Pointer, int Scope, int Semantics, half Value)
{
    __builtin_assume((__local half*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p0f32_i32_i32_f32, )(__private float* Pointer, int Scope, int Semantics, float Value)
{
    float orig = *Pointer;
    *Pointer = orig > Value ? orig : Value;
    return orig;
...
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p1f32_i32_i32_f32, )(__global float* Pointer, int Scope, int Semantics, float Value)
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_max_global_f32, float, Pointer, Scope, Semantics, Value, true);
}

float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p3f32_i32_i32_f32, )(__local float* Pointer, int Scope, int Semantics, float Value)
{
    atomic_operation_1op_as_float(__builtin_IB_atomic_max_local_f32, float, Pointer, Scope, Semantics, Value, false);
}

#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p4f32_i32_i32_f32, )(__generic float* Pointer, int Scope, int Semantics, float Value)
{
    __builtin_assume((__local float*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p0f64_i32_i32_f64, )(__private double* Pointer, int Scope, int Semantics, double Value)
{
    double orig = *Pointer;
    *Pointer = orig > Value ? orig : Value;
    return orig;
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p1f64_i32_i32_f64, )(__global double* Pointer, int Scope, int Semantics, double Value)
{
    // We don't use SPINLOCK_START and SPINLOCK_END emulation here, since do-while loop is more efficient for global atomics.
    // Another important reason of using do-while loop emulation is to avoid HW Bug on XeHP SDV:
    // "NodeDSS works in fixed arbitration mode where writes are always prioritized over reads.
...
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p3f64_i32_i32_f64, )(__local double* Pointer, int Scope, int Semantics, double Value)
{
    double orig;
    double desired;
    do {
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double SPIRV_OVERLOADABLE SPIRV_BUILTIN(AtomicFMaxEXT, _p4f64_i32_i32_f64, )(__generic double* Pointer, int Scope, int Semantics, double Value)
{
    __builtin_assume((__local double*)Pointer != 0);
    if (SPIRV_BUILTIN(GenericCastToPtrExplicit, _p3i8_p4i8_i32, _ToLocal)(__builtin_astype((Pointer), __generic char*), StorageWorkgroup))
    {
