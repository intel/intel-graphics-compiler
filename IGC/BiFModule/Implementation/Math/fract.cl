                                      ...
                                      __global half* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _f16_f16_i16, )( SPIRV_OCL_BUILTIN(floor, _f16, )( x ), SPIRV_OCL_BUILTIN(nan, _i16, )( (short)0 ), (short)(SPIRV_BUILTIN(IsNan, _f16, )( x )) );
    half temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _f16_f16_i16, )( (half)SPIRV_OCL_BUILTIN(fmin, _f16_f16, )( temp, (half)(0x1.ffcp-1f)), (half)SPIRV_OCL_BUILTIN(copysign, _f16_f16, )((half)0.0f, x), (short)SPIRV_BUILTIN(IsInf, _f16, )(x));
                                           ...
                                           __global half2* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _v2f16_v2f16_v2i16, )( SPIRV_OCL_BUILTIN(floor, _v2f16, )( x ), SPIRV_OCL_BUILTIN(nan, _v2i16, )( (short2)0 ), __convert_short2(SPIRV_BUILTIN(IsNan, _v2f16, )( x )) );
    half2 temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _v2f16_v2f16_v2i16, )( (half2)SPIRV_OCL_BUILTIN(fmin, _v2f16_v2f16, )( temp, (half2)(0x1.ffcp-1f)), (half2)SPIRV_OCL_BUILTIN(copysign, _v2f16_v2f16, )((half2)0.0f, x), __convert_short2(SPIRV_BUILTIN(IsInf, _v2f16, )(x)));
                                           ...
                                           __global half3* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _v3f16_v3f16_v3i16, )( SPIRV_OCL_BUILTIN(floor, _v3f16, )( x ), SPIRV_OCL_BUILTIN(nan, _v3i16, )( (short3)0 ), __convert_short3(SPIRV_BUILTIN(IsNan, _v3f16, )( x )) );
    half3 temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _v3f16_v3f16_v3i16, )( (half3)SPIRV_OCL_BUILTIN(fmin, _v3f16_v3f16, )( temp, (half3)(0x1.ffcp-1f)), (half3)SPIRV_OCL_BUILTIN(copysign, _v3f16_v3f16, )((half3)0.0f, x), __convert_short3(SPIRV_BUILTIN(IsInf, _v3f16, )(x)));
                                           ...
                                           __global half4* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _v4f16_v4f16_v4i16, )( SPIRV_OCL_BUILTIN(floor, _v4f16, )( x ), SPIRV_OCL_BUILTIN(nan, _v4i16, )( (short4)0 ), __convert_short4(SPIRV_BUILTIN(IsNan, _v4f16, )( x )) );
    half4 temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _v4f16_v4f16_v4i16, )( (half4)SPIRV_OCL_BUILTIN(fmin, _v4f16_v4f16, )( temp, (half4)(0x1.ffcp-1f)), (half4)SPIRV_OCL_BUILTIN(copysign, _v4f16_v4f16, )((half4)0.0f, x), __convert_short4(SPIRV_BUILTIN(IsInf, _v4f16, )(x)));
                                           ...
                                           __global half8* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _v8f16_v8f16_v8i16, )( SPIRV_OCL_BUILTIN(floor, _v8f16, )( x ), SPIRV_OCL_BUILTIN(nan, _v8i16, )( (short8)0 ), __convert_short8(SPIRV_BUILTIN(IsNan, _v8f16, )( x )) );
    half8 temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _v8f16_v8f16_v8i16, )( (half8)SPIRV_OCL_BUILTIN(fmin, _v8f16_v8f16, )( temp, (half8)(0x1.ffcp-1f)), (half8)SPIRV_OCL_BUILTIN(copysign, _v8f16_v8f16, )((half8)0.0f, x), __convert_short8(SPIRV_BUILTIN(IsInf, _v8f16, )(x)));
                                              ...
                                              __global half16* iptr )
{
    *iptr = SPIRV_OCL_BUILTIN(select, _v16f16_v16f16_v16i16, )( SPIRV_OCL_BUILTIN(floor, _v16f16, )( x ), SPIRV_OCL_BUILTIN(nan, _v16i16, )( (short16)0 ), __convert_short16(SPIRV_BUILTIN(IsNan, _v16f16, )( x )) );
    half16 temp = x - *iptr;
    temp = SPIRV_OCL_BUILTIN(select, _v16f16_v16f16_v16i16, )( (half16)SPIRV_OCL_BUILTIN(fmin, _v16f16_v16f16, )( temp, (half16)(0x1.ffcp-1f)), (half16)SPIRV_OCL_BUILTIN(copysign, _v16f16_v16f16, )((half16)0.0f, x), __convert_short16(SPIRV_BUILTIN(IsInf, _v16f16, )(x)));
