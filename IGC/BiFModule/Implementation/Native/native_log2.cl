...
GENERATE_VECTOR_FUNCTIONS_1ARG( __builtin_spirv_OpenCL_native_log2, float, float, f32 )
...
GENERATE_VECTOR_FUNCTIONS_1ARG( __builtin_spirv_OpenCL_native_log2, half, half, f16 )
