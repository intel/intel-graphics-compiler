...
static __constant union {
  ...
  int s32[2];
  double f;
} __dacos_ha_c12 = {0x3fa07520c559a401uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c11 = {0xbf90fb17f2824aa0uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c10 = {0x3f943f44bc0c21f0uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c9 = {0x3f7a58339bb6f20cuL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c8 = {0x3f88f8dc2a3c76d7uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c7 = {0x3f8c6dbbcba98e67uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c6 = {0x3f91c6dcf536c796uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c5 = {0x3f96e89cebdf209cuL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c4 = {0x3f9f1c72e13ad6d3uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c3 = {0x3fa6db6db3b44600uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c2 = {0x3fb333333337e0deuL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c1 = {0x3fc555555555529cuL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_c0 = {0x3c70d208999dc313uL};
// pi/2
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_pi2h = {0x3ff921fb54442d18uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_pi2l = {0x3c91a62633145c07uL};
// pi
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_pih = {0x400921fb54442d18uL};
static __constant union {
  unsigned long w;
  unsigned int w32[2];
  int s32[2];
  double f;
} __dacos_ha_pil = {0x3ca1a62633145c07uL};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __dacos_ha_small_float = {0x01800000u};
__attribute__((always_inline)) inline int
__ocl_svml_internal_dacos_ha(double *pxin, double *pres) {
  int nRet = 0;
  double xin = *pxin;
  union {
    unsigned long w;
  ...
  // double acos(double xin)
  {
    ...
    Low.f = (xa.f <= 0.5) ? __dacos_ha_pi2l.f : Low.f;
    // rsqrt((1-|x|)/2), ~23 bits
    yf = (float)y.f;
    // fixup for |x|<=0.5 (set RS=0)
    fcorr.w = (xa.f <= 0.5) ? 0x7f800000 : 0; // 0x3f800000;
...
double __ocl_svml_acos_ha(double x) {
  double r;
  __ocl_svml_internal_dacos_ha(&x, &r);
  return r;
}
