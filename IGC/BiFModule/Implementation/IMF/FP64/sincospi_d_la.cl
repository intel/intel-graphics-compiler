...
void __ocl_svml_sincospi (double a,  __private double *b, __private double *c)
{
...

    {
        ...
        spoly = __spirv_ocl_fma(c8,Rs2,c7);
        cpoly = __spirv_ocl_fma(c8,Rc2,c7);
        spoly = __spirv_ocl_fma(spoly,Rs2,c6);
        cpoly = __spirv_ocl_fma(cpoly,Rc2,c6);
        spoly = __spirv_ocl_fma(spoly,Rs2,c5);
        cpoly = __spirv_ocl_fma(cpoly,Rc2,c5);
        spoly = __spirv_ocl_fma(spoly,Rs2,c4);
        cpoly = __spirv_ocl_fma(cpoly,Rc2,c4);

        spoly = __spirv_ocl_fma(spoly,Rs2,c3);
        cpoly = __spirv_ocl_fma(cpoly,Rc2,c3);
