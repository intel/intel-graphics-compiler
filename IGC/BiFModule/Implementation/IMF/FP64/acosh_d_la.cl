...
typedef struct
{
    ...
    unsigned long L2H;
    unsigned long L2L;
} __internal_dacosh_la_data_avx512_t;
static __constant __internal_dacosh_la_data_avx512_t __internal_dacosh_la_data_avx512 = {
    {
    ...
    , 0x3ff0000000000000uL, 0x7fffffffffffffffuL, 0x3ef0000000000000uL, 0x5fe0000000000000uL, 0x7fefffffffffffffuL, 0x3fb333220eaf02e7uL,
...
} __internal_dacosh_la_data_t;
static __constant __internal_dacosh_la_data_t __internal_dacosh_la_data = {
    ...
    , 0x000fffffffffffffuL, 0x3f50000000000000uL, 0xbfefffffffffffffuL, 0x7f3ffffffffff000uL, 0xfffffffffc000000uL, 0x3ff0000000000000uL,
        ...
        0x3fe0000000000000uL, 0x3fd7fffffffffffauL, 0x3fd3fffffffffffauL, 0x3fd1800013d9d428uL, 0x3fcf800025de102fuL, 0x7FEFFFFFFFFFFFFFuL,
...
static __constant _iml_v2_dp_union_t __dacosh_la_CoutTab[4] = {
...
inline int __internal_dacosh_la_cout (double *a, double *r)
{
    int nRet = 0;
    ...
    purex = (*a);
    {
        ...
        if ((((_iml_v2_dp_union_t *) & (purex))->hex[0] == ((__constant _iml_v2_dp_union_t *) & (((__constant double *) __dacosh_la_CoutTab)[0]))->hex[0])
            && (((_iml_v2_dp_union_t *) & (purex))->hex[1] ==
                ((__constant _iml_v2_dp_union_t *) & (((__constant double *) __dacosh_la_CoutTab)[0]))->hex[1]))
        {
            (*r) = ((__constant double *) __dacosh_la_CoutTab)[1];
            return nRet;
        }

        if ((((_iml_v2_dp_union_t *) & (purex))->hex[0] == ((__constant _iml_v2_dp_union_t *) & (((__constant double *) __dacosh_la_CoutTab)[2]))->hex[0])
            && (((_iml_v2_dp_union_t *) & (purex))->hex[1] ==
                ((__constant _iml_v2_dp_union_t *) & (((__constant double *) __dacosh_la_CoutTab)[2]))->hex[1]))
        {
            (*r) = purex;
            return nRet;
        }
        ...
        {
            (*r) = ((__constant double *) __dacosh_la_CoutTab)[2] * ((__constant double *) __dacosh_la_CoutTab)[1];
            nRet = 1;
            return nRet;
        }
    }
...
double __ocl_svml_acosh (double a)
{
...

    {
        ...
        One = as_double (__internal_dacosh_la_data.One);

        SgnMask = as_double (__internal_dacosh_la_data.SgnMask);
        XThreshold = as_double (__internal_dacosh_la_data.XThreshold);
        XhMask = as_double (__internal_dacosh_la_data.XhMask);

        dLargestFinite = as_double (__internal_dacosh_la_data.dLargestFinite);
        dInfinityMask = as_double ((unsigned long) (((!(va1 <= dLargestFinite)) ? 0xffffffffffffffff : 0x0)));
        dTooSmallMask = as_double ((unsigned long) (((!(va1 > One)) ? 0xffffffffffffffff : 0x0)));
        dSpecialMask = as_double ((as_ulong (dInfinityMask) | as_ulong (dTooSmallMask)));
        lSpecialMask = as_ulong (dSpecialMask);
        vm = 0;
        vm = lSpecialMask;
        dBigThreshold = as_double (__internal_dacosh_la_data.dBigThreshold);
        dModerateMask = as_double ((unsigned long) ((va1 < dBigThreshold) ? 0xffffffffffffffff : 0x0));

        dU = (va1 - One);
        dV = (va1 + One);
        dTmp5 = (dU * dV);
        dTmpf2 = (__spirv_ocl_sqrt (dTmp5));
        dH = (dU + dTmpf2);
        A = ((One > dH) ? One : dH);
        B = ((One < dH) ? One : dH);
        ...
        XScale = as_double (__internal_dacosh_la_data.XScale);
        XScale = (va1 * XScale);
        ...
        ExpMask = as_double (__internal_dacosh_la_data.ExpMask);
        Two10 = as_double (__internal_dacosh_la_data.Two10);

        Mantissa = as_double ((as_ulong (X) & as_ulong (ExpMask)));
        Mantissa = as_double ((as_ulong (Mantissa) | as_ulong (Two10)));

        MinLog1p = as_double (__internal_dacosh_la_data.MinLog1p);
        MaxLog1p = as_double (__internal_dacosh_la_data.MaxLog1p);
        ExpMask0 = (__internal_dacosh_la_data.ExpMask0);
        ExpMask2 = (__internal_dacosh_la_data.ExpMask2);
        ...
        dThirtyOne = as_double (__internal_dacosh_la_data.dThirtyOne);
        ...
        T = as_double (((__constant unsigned long *) ((__constant char *) (&__internal_dacosh_la_data.Log_LA_table[0]) - 0x408000))[Index >> 3]);
        Threshold = as_double (__internal_dacosh_la_data.Threshold);
        Bias = as_double (__internal_dacosh_la_data.Bias);
        Bias1 = as_double (__internal_dacosh_la_data.Bias1);
        L2 = as_double (__internal_dacosh_la_data.L2);
        ...
        poly_coeff[4] = as_double (__internal_dacosh_la_data.poly_coeff[0]);
    ...
    if ((vm) != 0)
    {
        ...
        __internal_dacosh_la_cout (_vapi_arg1, _vapi_res1);
