...
inline int __internal_dacospi_la_cout (double *pxin, double *pres)
{
    ...
    int_double y, res;
    {
        ...
        poly = __spirv_ocl_fma(__dacospi_la_c12.f,R,__dacospi_la_c11.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c10.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c9.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c8.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c7.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c6.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c5.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c4.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c3.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c2.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c1.f);
        poly = __spirv_ocl_fma(poly,R,__dacospi_la_c0.f);
