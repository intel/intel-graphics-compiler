...
double __ocl_svml_tanh (double a)
{
...

    {
        ...
        dScaledX = (dAbsX + p[12]);
        poly = __spirv_ocl_fma(p[11],dScaledX,p[10]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[9]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[8]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[7]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[6]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[5]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[4]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[3]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[2]);
        poly = __spirv_ocl_fma(poly,dScaledX,p[1]);
