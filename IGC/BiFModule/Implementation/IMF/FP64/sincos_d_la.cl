...
void __ocl_svml_sincos (double a, double *b, double *c)
{
...

    {
        ...
        dSinY = __spirv_ocl_fma(dSinX,dInvPI,dRShifter);
        ...
        dSinR = __spirv_ocl_fma(-(dSinN),dPI1,dSinX);

        dSinR = __spirv_ocl_fma(-(dSinN),dPI2,dSinR);
        ...
        dCosR = __spirv_ocl_fma(-(dCosN),dPI1,dSinX);

        dCosR = __spirv_ocl_fma(-(dCosN),dPI2,dCosR);

        dPI3 = as_double (__internal_dsincos_la_data._dPI3);

        dSinR = __spirv_ocl_fma(-(dSinN),dPI3,dSinR);

        dCosR = __spirv_ocl_fma(-(dCosN),dPI3,dCosR);
        ...
        dSinR = __spirv_ocl_fma(-(dSinN),dPI4,dSinR);

        dCosR = __spirv_ocl_fma(-(dCosN),dPI4,dCosR);
        dC7 = as_double (__internal_dsincos_la_data._dC7);
        dC6 = as_double (__internal_dsincos_la_data._dC6);

        dSinRp2 = (dSinR * dSinR);
        dSinPoly = __spirv_ocl_fma(dC7,dSinRp2,dC6);

        dCosRp2 = (dCosR * dCosR);
        dCosPoly = __spirv_ocl_fma(dC7,dCosRp2,dC6);
        dC5 = as_double (__internal_dsincos_la_data._dC5);
        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinRp2,dC5);
        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosRp2,dC5);
        dC4 = as_double (__internal_dsincos_la_data._dC4);
        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinRp2,dC4);
        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosRp2,dC4);
        dC3 = as_double (__internal_dsincos_la_data._dC3);

        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinRp2,dC3);

        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosRp2,dC3);
        dC2 = as_double (__internal_dsincos_la_data._dC2_0);

        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinRp2,dC2);

        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosRp2,dC2);
        dC1 = as_double (__internal_dsincos_la_data._dC1);

        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinRp2,dC1);

        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosRp2,dC1);

        dSinPoly = (dSinPoly * dSinRp2);

        dCosPoly = (dCosPoly * dCosRp2);

        dSinPoly = __spirv_ocl_fma(dSinPoly,dSinR,dSinR);

        dCosPoly = __spirv_ocl_fma(dCosPoly,dCosR,dCosR);
        ...
        if ((mReductionRangeMask) != 0)
        {
            ...
            dD = __spirv_ocl_fma(-(dZ),dSHi,dCosB);
            ...
            dResLo = __spirv_ocl_fma(dPS,dCosB,dCorr);
            ...
            dcD = __spirv_ocl_fma(-(dZ),dcSHi,dcCosB);
            dcSLo = as_double (((__constant unsigned long *) (__internal_dsincos_la_data_ha._dT))[(((0 + lcIndex) * (4 * 8)) >> (3)) + 3]);

            dcCorr = __spirv_ocl_fma(dE,dcD,dcSLo);

            dcResLo = __spirv_ocl_fma(dPS,dcCosB,dcCorr);
            ...
            dcK0 = (dcSHi - dcResInt);
            dcK2 = (dcK0 + dcZSigma);
            dcResLo = __spirv_ocl_fma(dPC,dcSHi,dcResLo);
