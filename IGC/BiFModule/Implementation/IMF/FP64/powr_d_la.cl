...
} __internal_dpowr_la_data_avx512_t;
static __constant __internal_dpowr_la_data_avx512_t __internal_dpowr_la_data_avx512 = {
    {
...
} __internal_dpowr_la_data_t;
static __constant __internal_dpowr_la_data_t __internal_dpowr_la_data = {
...
static __constant _iml_v2_dp_union_t __dpowr_la_CoutTab[860] = {
...
inline int __internal_dpowr_la_cout (double *a, double *b, double *r)
{
    int nRet = 0;
...

    {
        ...
        if (iXisNAN)
        {
            dbVTmp1 = ((__constant double *) __dpowr_la_CoutTab)[852];
        ...
        if (iXisZero)
        {
            ...
            if (((((((_iml_v2_dp_union_t *) & dY)->dwords.hi_dword >> 20) & 0x7FF) != 0x7FF)) && (!iSignY))
            {
                *r = ((__constant double *) __dpowr_la_CoutTab)[852];
                return nRet;

            }
        }

        if (dX == ((__constant double *) __dpowr_la_CoutTab)[853])
        {

            if (((((((_iml_v2_dp_union_t *) & dY)->dwords.hi_dword >> 20) & 0x7FF) != 0x7FF)))
            {
                *r = ((__constant double *) __dpowr_la_CoutTab)[853];
                return nRet;
    ...
    if (!((iSignX == 0) && (iEXB == 0x3FF) && iIsSigZeroX) && !((iEYB == 0) && iIsSigZeroY))
    {
        ...
        if ((iXIsFinite || iIsSigZeroX) && (iYIsFinite || iIsSigZeroY))
        {
            ...
            if (dX != ((__constant double *) __dpowr_la_CoutTab)[852])
            {

                if (!((dX == ((__constant double *) __dpowr_la_CoutTab)[854]) && (iYIsInt || !iYIsFinite)))
                {

                    if (iXIsFinite && iYIsFinite)
                    {

                        if ((dX > ((__constant double *) __dpowr_la_CoutTab)[852]) || iYIsInt)
                        {

                            dbSignRes = ((__constant double *) __dpowr_la_CoutTab)[853 + (iSignX & iYIsInt)];
                            iDenoExpAdd = 0;
                            dbAX = dX;
                            ...
                            if (iEXB == 0)
                            {
                                ...
                                dbAX = dbAX * ((__constant double *) __dpowr_la_CoutTab)[858];
                            ...
                            dbRcp1 = ((__constant double *) __dpowr_la_CoutTab)[0 + i1];

                            dbL1Hi = ((__constant double *) __dpowr_la_CoutTab)[33 + 2 * (i1) + 0];
                            dbL1Lo = ((__constant double *) __dpowr_la_CoutTab)[33 + 2 * (i1) + 1];
                            ...
                            dbRcp2 = ((__constant double *) __dpowr_la_CoutTab)[99 + i2];

                            dbL2Hi = ((__constant double *) __dpowr_la_CoutTab)[132 + 2 * (i2) + 0];
                            dbL2Lo = ((__constant double *) __dpowr_la_CoutTab)[132 + 2 * (i2) + 1];
                            ...
                            dbRcp3C = ((__constant double *) __dpowr_la_CoutTab)[198 + i3];

                            dbL3Hi = ((__constant double *) __dpowr_la_CoutTab)[327 + 2 * (i3) + 0];
                            dbL3Lo = ((__constant double *) __dpowr_la_CoutTab)[327 + 2 * (i3) + 1];
                            ...
                            dbR1 = (dbX3 * dbRcp3C);
                            dbCQ = (dbR1 - ((__constant double *) __dpowr_la_CoutTab)[856]);

                            dbRcpC = (dbRcp1 * dbRcp2);
                            dbRcpC = (dbRcpC * dbRcp3C);

                            dbVTmp1 = ((dbX1) * (((__constant double *) __dpowr_la_CoutTab)[857]));
                            ...
                            dbVTmp1 = ((dbRcpC) * (((__constant double *) __dpowr_la_CoutTab)[857]));
                            ...
                            if (iELogAX + iEYB < 11 + 2 * 0x3FF)
                            {
                                ...
                                if (iELogAX + iEYB > -62 + 2 * 0x3FF)
                                {
                                    ...
                                    dbLog2Poly =
                                        ((((((__constant double *) __dpowr_la_CoutTab)[844]) * dbR +
                                           ((__constant double *) __dpowr_la_CoutTab)[843]) * dbR +
                                          ((__constant double *) __dpowr_la_CoutTab)[842]) * dbR +
                                         ((__constant double *) __dpowr_la_CoutTab)[841]) * dbR;
                                    ...
                                    dbVTmp1 = ((dbHH) * (((__constant double *) __dpowr_la_CoutTab)[857]));
                                    ...
                                    dbVTmp1 = ((dY) * (((__constant double *) __dpowr_la_CoutTab)[857]));
                                    dbVTmp2 = (dbVTmp1 - (dY));
                                    dbVTmp1 = (dbVTmp1 - dbVTmp2);
                                    dbVTmp2 = ((dY) - dbVTmp1);
                                    dbYHi = dbVTmp1;
                                    ...
                                    dbVTmp1 = (dbPH + ((__constant double *) __dpowr_la_CoutTab)[855]);
                                    iN = (((_iml_v2_dp_union_t *) & dbVTmp1)->dwords.lo_dword);
                                    j = iN & 0x7F;
                                    iN = iN >> 7;
                                    dbVPHH = (dbVTmp1 - ((__constant double *) __dpowr_la_CoutTab)[855]);
                                    dbVPHL = (dbPH - dbVPHH);
                                    ...
                                    dbExp2Poly =
                                        (((((((__constant double *) __dpowr_la_CoutTab)[849]) * dbZ +
                                            ((__constant double *) __dpowr_la_CoutTab)[848]) * dbZ +
                                           ((__constant double *) __dpowr_la_CoutTab)[847]) * dbZ +
                                          ((__constant double *) __dpowr_la_CoutTab)[846]) * dbZ +
                                         ((__constant double *) __dpowr_la_CoutTab)[845]) * dbZ;

                                    dbExp2PolyT = (dbExp2Poly * ((__constant double *) __dpowr_la_CoutTab)[585 + 2 * (j) + 0]);
                                    dbResLo = (dbExp2PolyT + ((__constant double *) __dpowr_la_CoutTab)[585 + 2 * (j) + 1]);
                                    dbResHi = ((__constant double *) __dpowr_la_CoutTab)[585 + 2 * (j) + 0];
                                    ...
                                    if (iERes < 1024)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (iERes >= -1022 - 10)
                                            {
                                                ...
                                                dbVTmp1 = ((dbResHi) * (((__constant double *) __dpowr_la_CoutTab)[857]));
                                                ...
                                                dbSignRes *= ((__constant double *) __dpowr_la_CoutTab)[859];
                                                iN = (iN + 200);

                                                dbTwoPowN = ((__constant double *) __dpowr_la_CoutTab)[853];
                                                ...
                                                dbVTmp1 = ((__constant double *) __dpowr_la_CoutTab)[851];
                                                dbVTmp1 = (dbVTmp1 * dbVTmp1);
                                                dbRes = (dbRes + dbVTmp1);
                                    ...
                                    else
                                    {
                                        ...
                                        dbVTmp1 = ((__constant double *) __dpowr_la_CoutTab)[850];
                                        dbVTmp1 = (dbVTmp1 * dbVTmp1);
                                        dbRes = (dbVTmp1 * dbSignRes);
                                        dR = dbRes;
                                        nRet = 3;
                                ...
                                else
                                {
                                    ...
                                    dbVTmp1 = ((__constant double *) __dpowr_la_CoutTab)[853];
                                    dbVTmp1 = (dbVTmp1 + ((__constant double *) __dpowr_la_CoutTab)[851]);
                            ...
                            else
                            {
                                ...
                                dbTmp1 = ((__constant double *) __dpowr_la_CoutTab)[850 + (iSign)];
                    ...
                    else
                    {
                        ...
                        if (iEXB < 0x3FF)
                        {
                            ...
                            else
                            {
                                ...
                                dR = ((__constant double *) __dpowr_la_CoutTab)[852];
                            }
                        }
                        else
                        {
                            ...
                            if (iSignY)
                            {
                                ...
                                dR = ((__constant double *) __dpowr_la_CoutTab)[852] * ((__constant double *) __dpowr_la_CoutTab)[853 +
                                                                                                                                  (iYIsInt & iSignX)];
                            }
                            else
                            {
                                ...
                                dbTmp1 = dX * dX;
                                dbTmp1 = dbTmp1 * dY;
                                dR = dbTmp1 * ((__constant double *) __dpowr_la_CoutTab)[853 + (iYIsInt & iSignX)];
                            }
                        }
                    }
                }
                else
                {
                    ...
                    dR = ((__constant double *) __dpowr_la_CoutTab)[853 + (iYIsInt & 1)];
                }
            }
            else
            {
                ...
                if (iSignY)
                {
                    ...
                    dR = ((__constant double *) __dpowr_la_CoutTab)[853 + (iYIsInt & iSignX)] / dbTmp1;
                    nRet = 1;
                }
                else
                {
    ...
    else
    {
        ...
        dbVTmp2 = ((__constant double *) __dpowr_la_CoutTab)[853];
...
double __ocl_svml_powr (double a, double b)
{
...

    {
        ...
        _HIDELTA = (__internal_dpowr_la_data.HIDELTA);
        _LORANGE = (__internal_dpowr_la_data.LORANGE);
        _ABSMASK = (__internal_dpowr_la_data.ABSMASK);
        _INF = (__internal_dpowr_la_data.INF);
        ...
        dMantissaMask = as_double (__internal_dpowr_la_data.iMantissaMask);

        dX1 = as_double ((as_ulong (va1) & as_ulong (dMantissaMask)));
        dOne = as_double (__internal_dpowr_la_data.dbOne);
        dX1 = as_double ((as_ulong (dX1) | as_ulong (dOne)));

        iIndex = ((unsigned int) ((unsigned long) lX >> 32));
        iIndexMask = (__internal_dpowr_la_data.iIndexMask);

        iIndex = (iIndex & iIndexMask);
        iIndexAdd = (__internal_dpowr_la_data.iIndexAdd);
        ...
        dRcp = as_double (((__constant unsigned long *) (__internal_dpowr_la_data.rcp_t1))[iIndexR >> 3]);
        dL1[0] = as_double (((__constant unsigned long *) (__internal_dpowr_la_data.log2_t1))[iIndexL >> 3]);
        dL1[1] = as_double (((__constant unsigned long *) (__internal_dpowr_la_data.log2_t1))[(iIndexL >> 3) + 1]);

        i3fe7fe00 = (__internal_dpowr_la_data.i3fe7fe00);
        iK = (iXHi - i3fe7fe00);
        iK = ((signed int) iK >> (20));
        i2p20_2p19 = (__internal_dpowr_la_data.i2p20_2p19);
        iK = (iK + i2p20_2p19);
        lK = (((unsigned long) (unsigned int) iK << 32) | (unsigned long) (unsigned int) iK);
        dK = as_double (lK);
        dHighHalfMask = as_double (__internal_dpowr_la_data.iffffffff00000000);
        dK = as_double ((as_ulong (dK) & as_ulong (dHighHalfMask)));
        db2p20_2p19 = as_double (__internal_dpowr_la_data.db2p20_2p19);
        dK = (dK - db2p20_2p19);

        dHighMask = as_double (__internal_dpowr_la_data.iHighMask);
        ...
        LHN = as_double (__internal_dpowr_la_data.LHN);
        dCq = (dR1 + LHN);

        dE = __spirv_ocl_fma(dX1Hi,dRcp,-(dR1));

        dE = __spirv_ocl_fma(dX1Lo,dRcp,dE);
        ...
        dA[6] = as_double (__internal_dpowr_la_data.clv[1]);
        dA[5] = as_double (__internal_dpowr_la_data.clv[2]);

        dPoly = __spirv_ocl_fma(dA[6],dCq,dA[5]);
        dA[4] = as_double (__internal_dpowr_la_data.clv[3]);
        dPoly = __spirv_ocl_fma(dPoly,dCq,dA[4]);
        dA[3] = as_double (__internal_dpowr_la_data.clv[4]);
        dPoly = __spirv_ocl_fma(dPoly,dCq,dA[3]);
        dA[2] = as_double (__internal_dpowr_la_data.clv[5]);
        dPoly = __spirv_ocl_fma(dPoly,dCq,dA[2]);
        dA[1] = as_double (__internal_dpowr_la_data.clv[6]);
        dPoly = __spirv_ocl_fma(dPoly,dCq,dA[1]);
        dHLL = __spirv_ocl_fma(dPoly,dCq,dHLL);
        ...
        iAbsZ = (iZ & _ABSMASK);
        _DOMAINRANGE = (__internal_dpowr_la_data.DOMAINRANGE);
        ...
        dPL = (dYLo * dHL);
        dPL = __spirv_ocl_fma(dYHi,dHL,dPL);
        dPL = __spirv_ocl_fma(dYLo,dHH,dPL);

        dPLL = (va2 * dHLL);
        db2p45_2p44 = as_double (__internal_dpowr_la_data.db2p45_2p44);

        dPHH = (dPH + db2p45_2p44);
        lPHH = as_ulong (dPHH);
        iPHH = (((unsigned int) lPHH & (unsigned int) -1));

        jIndexMask = (__internal_dpowr_la_data.jIndexMask);

        jIndex = (iPHH & jIndexMask);
        jIndex = ((unsigned int) (jIndex) << (4));

        iN = ((unsigned int) (iPHH) << (13));
        iOne = (__internal_dpowr_la_data.iOne);
        iN = (iN + iOne);
        lN = (((unsigned long) (unsigned int) iN << 32) | (unsigned long) (unsigned int) iN);
        dN = as_double (lN);
        dExpSignMask = as_double (__internal_dpowr_la_data.ifff0000000000000);
        dN = as_double ((as_ulong (dN) & as_ulong (dExpSignMask)));
        dExpT[0] = as_double (((__constant unsigned long *) (__internal_dpowr_la_data.exp2_tbl))[jIndex >> 3]);
        ...
        dB[5] = as_double (__internal_dpowr_la_data.cev[0]);
        dB[4] = as_double (__internal_dpowr_la_data.cev[1]);
        dRes = __spirv_ocl_fma(dB[5],dT,dB[4]);
        dB[3] = as_double (__internal_dpowr_la_data.cev[2]);
        dRes = __spirv_ocl_fma(dRes,dT,dB[3]);
        dB[2] = as_double (__internal_dpowr_la_data.cev[3]);
        dRes = __spirv_ocl_fma(dRes,dT,dB[2]);
        dB[1] = as_double (__internal_dpowr_la_data.cev[4]);
        dRes = __spirv_ocl_fma(dRes,dT,dB[1]);
        vr1 = __spirv_ocl_fma(dRes,dTEN,dEN);
    }
    ...
    if ((vm) != 0)
    {
        ...
        __internal_dpowr_la_cout (_vapi_arg1, _vapi_arg2, _vapi_res1);
