...
inline int __internal_dexp_la_cout (double *a, double *r)
{
    ...
    idx.f = __spirv_ocl_fma(xf,__dexp_la_p_L2Ef.f,__dexp_la_p_Shifterf.f);
    ...
    R0 = __spirv_ocl_fma(__dexp_la_p_NL2H.f,N,x);

    R = __spirv_ocl_fma(__dexp_la_p_NL2L.f,N,R0);

    poly = __spirv_ocl_fma(__dexp_la_c5.f,R0,__dexp_la_c4.f);
    poly = __spirv_ocl_fma(poly,R0,__dexp_la_c3.f);
    poly = __spirv_ocl_fma(poly,R0,__dexp_la_c2.f);
    poly = __spirv_ocl_fma(poly,R,__dexp_la_c1.f);
    poly = __spirv_ocl_fma(poly,R,__dexp_la_c0.f);

    if (__spirv_ocl_fabs (xf) > __dexp_la_p_fthres.f)
