...
double __ocl_svml_log10_v2 (double a)
{
...

    {
        ...
        P45 = __spirv_ocl_fma(poly_coeff[5],dR,poly_coeff[4]);
        P23 = __spirv_ocl_fma(poly_coeff[3],dR,poly_coeff[2]);
        R2 = (dR * dR);
        P1 = (dR * poly_coeff[1]);
        dP = __spirv_ocl_fma(P45,R2,P23);
        dP = __spirv_ocl_fma(dP,R2,P1);
        dR = (dP + dT);
        vr1 = (dR + dK);
    }
