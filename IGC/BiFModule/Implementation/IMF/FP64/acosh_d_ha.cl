...
} __ocl_svml_internal_dacosh_ha_data_t;
static __ocl_svml_internal_dacosh_ha_data_t __ocl_svml_internal_dacosh_ha_data =
    {
        /* Log_HA_table */
        ...
        /*== dC2 ==*/
        ,
        0x3fd7fffffffffffauL
        /*== dC3 ==*/
        ,
        0x3fd3fffffffffffauL
        /*== dC4 ==*/
        ,
        0x3fd1800013d9d428uL
        /*== dC5 ==*/
        ,
        0x3fcf800025de102fuL
        /*== dLargestFinite ==*/
        ,
...
static __constant _iml_v2_dp_union_t __dacosh_ha_CoutTab[4] = {
...
__ocl_svml_internal_dacosh_ha(double *a, double *r) {
  int nRet = 0;
  double yM;
  double purex, y, yN;
  ...
  purex = (*a);
  {
    ...
    if ((((((_iml_v2_dp_union_t *)&*a)->dwords.hi_dword >> 20) & 0x7FF) ==
         0x7FF) &&
        (((((_iml_v2_dp_union_t *)&*a)->dwords.hi_dword & 0x000FFFFF) != 0x0) ||
         ((((_iml_v2_dp_union_t *)&*a)->dwords.lo_dword) != 0x0))) {
      (*r) = (*a) * (*a);
      return nRet;
    }
    // If x = 1, return +0
    if ((((_iml_v2_dp_union_t *)&(purex))->hex[0] ==
         ((__constant _iml_v2_dp_union_t *)&(
              ((__constant double *)__dacosh_ha_CoutTab)[0]))
             ->hex[0]) &&
        (((_iml_v2_dp_union_t *)&(purex))->hex[1] ==
         ((__constant _iml_v2_dp_union_t *)&(
              ((__constant double *)__dacosh_ha_CoutTab)[0]))
             ->hex[1])) {
      (*r) = ((__constant double *)__dacosh_ha_CoutTab)[1];
      return nRet;
    }
    // If x = +inf, return +inf
    if ((((_iml_v2_dp_union_t *)&(purex))->hex[0] ==
         ((__constant _iml_v2_dp_union_t *)&(
              ((__constant double *)__dacosh_ha_CoutTab)[2]))
             ->hex[0]) &&
        (((_iml_v2_dp_union_t *)&(purex))->hex[1] ==
         ((__constant _iml_v2_dp_union_t *)&(
              ((__constant double *)__dacosh_ha_CoutTab)[2]))
    ...
    // Otherwise it's x < 1 (including -inf), so return NaN + invalid
    {
      (*r) = ((__constant double *)__dacosh_ha_CoutTab)[2] *
             ((__constant double *)__dacosh_ha_CoutTab)[1];
      nRet = 1;
      return nRet;
    }
  }
}
double __ocl_svml_acosh_ha(double x) {
  double r;
  unsigned int vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    double XScale;
    double dThirtyOne;
    double dInfinityMask;
    double dTooSmallMask;
    double dSpecialMask;
    ...
    One = as_double(__ocl_svml_internal_dacosh_ha_data.One);
    SgnMask = as_double(__ocl_svml_internal_dacosh_ha_data.SgnMask);
    XThreshold = as_double(__ocl_svml_internal_dacosh_ha_data.XThreshold);
    XhMask = as_double(__ocl_svml_internal_dacosh_ha_data.XhMask);
    dLargestFinite =
        as_double(__ocl_svml_internal_dacosh_ha_data.dLargestFinite);
    dInfinityMask = as_double((unsigned long)((
        (!(va1 <= dLargestFinite)) ? 0xffffffffffffffff : 0x0)));
    dTooSmallMask =
        as_double((unsigned long)(((!(va1 > One)) ? 0xffffffffffffffff : 0x0)));
    dSpecialMask =
        as_double((as_ulong(dInfinityMask) | as_ulong(dTooSmallMask)));
    ...
    dBigThreshold = as_double(__ocl_svml_internal_dacosh_ha_data.dBigThreshold);
    dModerateMask = as_double(
        (unsigned long)((va1 < dBigThreshold) ? 0xffffffffffffffff : 0x0));
    // dU is needed later on
    dU = (va1 - One);
    // dTmp5-dTmp6=rounded(x^2)-1, dTmp4=x^2-rounded(x^2)
    // dTmp5 + (dTmp4-dTmp6) = x^2-1
    dTmp1 = (va1 * va1);
    dTmp4 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, )(va1, va1, -(dTmp1));
    dTmp5 = (dTmp1 - One);
    dTmp6 = (dTmp5 - dTmp1);
    dTmp6 = (dTmp6 + One);
    dTmp7 = (dTmp4 - dTmp6);
    ...
    dTopMask29 = as_double(__ocl_svml_internal_dacosh_ha_data.dTopMask29);
    dY = as_double((as_ulong(dTmp5) & as_ulong(dTopMask29)));
    dTmp8 = (dTmp5 - dY);
    dW = (dTmp8 + dTmp7);
    ...
    dTopMask12 = as_double(__ocl_svml_internal_dacosh_ha_data.dTopMask12);
    ...
    // C4 = 35/128
    // C5 = 63/256
    dC5 = as_double(__ocl_svml_internal_dacosh_ha_data.dC5);
    dC4 = as_double(__ocl_svml_internal_dacosh_ha_data.dC4);
    dPol4 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, )(dC5, dE, dC4);
    dC3 = as_double(__ocl_svml_internal_dacosh_ha_data.dC3);
    dPol3 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, )(dPol4, dE, dC3);
    dC2 = as_double(__ocl_svml_internal_dacosh_ha_data.dC2);
    dPol2 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, )(dPol3, dE, dC2);
    dC1 = as_double(__ocl_svml_internal_dacosh_ha_data.dC1);
    ...
    //   = [U + S] + [T + (S + T) * Corr]
    //
    // The bottom part is computed directly as dTmpf2:
    dTmpf1 = (dS + dT);
    dTmpf2 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, )(dTmpf1, dCorr, dT);
    // The top part uses a compensated summation dTmpf3 + dTmpf5. Note that
    //
    ...
    XMask = as_double(
        (unsigned long)((Xabs < XThreshold) ? 0xffffffffffffffff : 0x0));
    XhMask = as_double((as_ulong(XhMask) | as_ulong(XMask)));
    X = (A + B);
    X = as_double((as_ulong(X) & as_ulong(XhMask)));
    Xl = (A - X);
    Xl = (Xl + B);
    // Now multiplex to the case X = 2^-30 * input, Xl = dL = 0 in the "big"
    // case.
    XScale = as_double(__ocl_svml_internal_dacosh_ha_data.XScale);
    XScale = (va1 * XScale);
    X = as_double((((~as_ulong(dModerateMask)) & as_ulong(XScale)) |
                   (as_ulong(dModerateMask) & as_ulong(X))));
    Xl = as_double((as_ulong(Xl) & as_ulong(dModerateMask)));
    dL = as_double((as_ulong(dL) & as_ulong(dModerateMask)));
    // Now resume the main code.
    ExpMask = as_double(__ocl_svml_internal_dacosh_ha_data.ExpMask);
    Two10 = as_double(__ocl_svml_internal_dacosh_ha_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(X) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinLog1p = as_double(__ocl_svml_internal_dacosh_ha_data.MinLog1p);
    MaxLog1p = as_double(__ocl_svml_internal_dacosh_ha_data.MaxLog1p);
    ExpMask0 = (__ocl_svml_internal_dacosh_ha_data.ExpMask0);
    ExpMask2 = (__ocl_svml_internal_dacosh_ha_data.ExpMask2);
    ...
    dThirtyOne = as_double(__ocl_svml_internal_dacosh_ha_data.dThirtyOne);
    FpExponPlus = (FpExpon + dThirtyOne);
    FpExpon = as_double((((~as_ulong(dModerateMask)) & as_ulong(FpExponPlus)) |
                         (as_ulong(dModerateMask) & as_ulong(FpExpon))));
    /* prepare table index */
    ...
    THL[0] = as_double(
        ((unsigned long *)((char *)(&__ocl_svml_internal_dacosh_ha_data
                                         .Log_HA_table[0]) -
                           0x810000))[Index >> 3]);
    THL[1] = as_double(
        ((unsigned long *)((char *)(&__ocl_svml_internal_dacosh_ha_data
    ...
    /* K = exponent*log(2.0) */
    L2H = as_double(__ocl_svml_internal_dacosh_ha_data.L2H);
    L2L = as_double(__ocl_svml_internal_dacosh_ha_data.L2L);
    ...
    /* polynomial: */
    poly_coeff[4] = as_double(__ocl_svml_internal_dacosh_ha_data.poly_coeff[0]);
    poly_coeff[3] = as_double(__ocl_svml_internal_dacosh_ha_data.poly_coeff[1]);
    poly_coeff[2] = as_double(__ocl_svml_internal_dacosh_ha_data.poly_coeff[2]);
    poly_coeff[1] = as_double(__ocl_svml_internal_dacosh_ha_data.poly_coeff[3]);
    // P34 = C4*R + C3
    P34 =
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __ocl_svml_internal_dacosh_ha(&__cout_a1, &__cout_r1);
