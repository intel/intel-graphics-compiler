...
inline int __internal_dasin_la_cout (double *pxin, double *pres)
{
    ...
    int_double y, res;
    {
        ...
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (__dasin_la_c12.f, R, __dasin_la_c11.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c10.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c9.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c8.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c7.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c6.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c5.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c4.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c3.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c2.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c1.f);
        poly = __builtin_spirv_OpenCL_fma_f64_f64_f64 (poly, R, __dasin_la_c0.f);
