...
static double __ocl_svml_asinh (double a)
{
...

    {
        ...
        dZ = ((double) (1.0f / SPIRV_OCL_BUILTIN(sqrt, _f32, ) ((float) (dY))));
        ...
        dX46 = SPIRV_OCL_BUILTIN(fma, _f64_f64_f64, ) (dX2over2, dX4over4, -(dX4over4));
        dX46over2 = (dX46 * dC1);
