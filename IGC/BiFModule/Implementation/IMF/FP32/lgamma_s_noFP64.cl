...
inline float __slgamma_nofp64_own_lgamma_fast_fp32 (float arg)
{
    ...
    float result = 0.5f * ((*(float *) &(__slgamma_nofp64_own_log2pif)) - __spirv_ocl_log(arg));
