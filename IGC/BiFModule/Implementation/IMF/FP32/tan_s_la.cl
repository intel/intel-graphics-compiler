...
float __ocl_svml_tanf (float a)
{
...

    {
        ...
        if ((mRangeReductionMask) != 0)
        {
            ...
            sEr = __spirv_ocl_fma(-(sR_hi),sRecip_hi,sOne);

            dR_RE = __spirv_ocl_fma(sRecip_hi,sEr,sRecip_hi);
            sE2 = __spirv_ocl_fma(sEr,sEr,sOne);
            sRecip_ok = (dR_RE * sE2);

            sR_lo = (sR_lo * sRecip_ok);

            dD_E = (sR_lo - sEr);
            sRecip_lo = __spirv_ocl_fma(sR_lo,sR_lo,-(dD_E));
            ...
            sH8 = (sH6 + sH2);
            sH9 = (sH7 + sH8);
            sP3 = __spirv_ocl_fma(sC2,sR,sC1_lo);
            sP4 = __spirv_ocl_fma(sC4,sR,sC3);

            sZ2 = (sR * sR);
            sC1 = (sC1_hi + sC1_lo);

            sP6 = __spirv_ocl_fma(sZ2,sP4,sP3);

            sP9 = (sC0_lo + sH9);

            sP10 = __spirv_ocl_fma(sP6,sR,sP9);
