...
} __internal_spow_la_data_avx512_t;
static __constant __internal_spow_la_data_avx512_t __internal_spow_la_data_avx512 = {
    {
...
} __internal_spow_la_data_avx2_t;
static __constant __internal_spow_la_data_avx2_t __internal_spow_la_data_avx2 = {
...
typedef struct
{
    ...
    unsigned int _sHuge;
    unsigned int _sTiny;
} __internal_spow_la_data_t;
static __constant __internal_spow_la_data_t __internal_spow_la_data = {
    0xFFFFF000u,
    0x45800800u,
    0x80800000u,
    0xfeffffffu,
...
static __constant _iml_v2_sp_union_t __spow_la_CoutTab[380] = {
...
static int __spow_la_TestIntFunc (float a)
{
...
inline int __internal_spow_la_cout (float *a, float *b, float *r)
{
    int nRet = 0;
    ...
    iYIsInt = __spow_la_TestIntFunc (flBi);
    ...
    if (!((iSignX == 0) && (iEXB == 0x7F) && iIsSigZeroX) && !((iEYB == 0) && iIsSigZeroY))
    {
        ...
        if ((iXIsFinite || iIsSigZeroX) && (iYIsFinite || iIsSigZeroY))
        {
            ...
            if (flAi != ((__constant float *) __spow_la_CoutTab)[370])
            {
                ;

                if (!((flAi == ((__constant float *) __spow_la_CoutTab)[372]) && (iYIsInt || !iYIsFinite)))
                {
                    ;
                    ...
                    if (iXIsFinite && iYIsFinite)
                    {
                        ...
                        if ((flAi > ((__constant float *) __spow_la_CoutTab)[370]) || iYIsInt)
                        {
                            ;

                            flSignRes = ((__constant float *) __spow_la_CoutTab)[371 + (iSignX & iYIsInt)];
                            iDenoExpAdd = 0;
                            flAX = flAi;
                            ...
                            if (iEXB == 0)
                            {
                                ...
                                flAX = flAX * ((__constant float *) __spow_la_CoutTab)[376];
                            ...
                            flRcp1 = ((__constant float *) __spow_la_CoutTab)[0 + i1];

                            flL1Hi = ((__constant float *) __spow_la_CoutTab)[9 + 2 * (i1) + 0];
                            flL1Lo = ((__constant float *) __spow_la_CoutTab)[9 + 2 * (i1) + 1];
                            ...
                            flRcp2 = ((__constant float *) __spow_la_CoutTab)[27 + i2];

                            flL2Hi = ((__constant float *) __spow_la_CoutTab)[36 + 2 * (i2) + 0];
                            flL2Lo = ((__constant float *) __spow_la_CoutTab)[36 + 2 * (i2) + 1];
                            ...
                            flRcp3C = ((__constant float *) __spow_la_CoutTab)[54 + i3];

                            flL3Hi = ((__constant float *) __spow_la_CoutTab)[71 + 2 * (i3) + 0];
                            flL3Lo = ((__constant float *) __spow_la_CoutTab)[71 + 2 * (i3) + 1];
                            ...
                            flR1 = (flX3 * flRcp3C);
                            flCQ = (flR1 - ((__constant float *) __spow_la_CoutTab)[374]);

                            flRcpC = (flRcp1 * flRcp2);
                            flRcpC = (flRcpC * flRcp3C);

                            flVTmp1 = ((flX1) * (((__constant float *) __spow_la_CoutTab)[375]));
                            ...
                            flVTmp1 = ((flRcpC) * (((__constant float *) __spow_la_CoutTab)[375]));
                            ...
                            if (iELogAX + iEYB < 11 + 2 * 0x7F)
                            {
                                ...
                                if (iELogAX + iEYB > -62 + 2 * 0x7F)
                                {
                                    ...
                                    flLog2Poly =
                                        ((((((__constant float *) __spow_la_CoutTab)[364]) * flR +
                                           ((__constant float *) __spow_la_CoutTab)[363]) * flR +
                                          ((__constant float *) __spow_la_CoutTab)[362]) * flR + ((__constant float *) __spow_la_CoutTab)[361]) * flR;
                                    ...
                                    flVTmp1 = ((flHH) * (((__constant float *) __spow_la_CoutTab)[375]));
                                    ...
                                    flVTmp1 = ((flBi) * (((__constant float *) __spow_la_CoutTab)[375]));
                                    ...
                                    flVTmp1 = (flPH + ((__constant float *) __spow_la_CoutTab)[373]);
                                    flVPHH = (flVTmp1 - ((__constant float *) __spow_la_CoutTab)[373]);
                                    ...
                                    flExp2Poly =
                                        (((((__constant float *) __spow_la_CoutTab)[367]) * flZ +
                                          ((__constant float *) __spow_la_CoutTab)[366]) * flZ + ((__constant float *) __spow_la_CoutTab)[365]) * flZ;

                                    flExp2PolyT = (flExp2Poly * ((__constant float *) __spow_la_CoutTab)[105 + 2 * (j) + 0]);
                                    flResLo = (flExp2PolyT + ((__constant float *) __spow_la_CoutTab)[105 + 2 * (j) + 1]);
                                    flResHi = ((__constant float *) __spow_la_CoutTab)[105 + 2 * (j) + 0];
                                    ...
                                    if (iERes < 128)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (iERes >= -126 - 10)
                                            {
                                                ...
                                                flVTmp1 = ((flResHi) * (((__constant float *) __spow_la_CoutTab)[375]));
                                                ...
                                                flTwoPowN = ((__constant float *) __spow_la_CoutTab)[371];
                                                ...
                                                flRes = (flResHi + flResLo);
                                                flRes = (flRes * ((__constant float *) __spow_la_CoutTab)[377]);

                                                flVTmp1 = ((__constant float *) __spow_la_CoutTab)[369];
                                            ...
                                            else
                                            {
                                                ...
                                                if (iERes >= -149 - 10)
                                                {
                                                    ...
                                                    flSignRes *= ((__constant float *) __spow_la_CoutTab)[377];
                                                    iN = iN + 64;
                                    ...
                                    else
                                    {
                                        ...
                                        flVTmp1 = ((__constant float *) __spow_la_CoutTab)[368];
                                        flVTmp1 = (flVTmp1 * flVTmp1);
                                        flRes = (flVTmp1 * flSignRes);
                                        *r = flRes;
                                ...
                                else
                                {
                                    ...
                                    flVTmp1 = ((__constant float *) __spow_la_CoutTab)[371];
                                    flVTmp1 = (flVTmp1 + ((__constant float *) __spow_la_CoutTab)[369]);
                                    *r = (flVTmp1 * flSignRes);
                                }
                            }
                            else
                            {
                                ...
                                flTmp1 = ((__constant float *) __spow_la_CoutTab)[368 + (iSign)];
                                ...
                                *r = flTmp1;
                                ...
                                if ((!(((((_iml_v2_sp_union_t *) & flTmp1)->hex[0] >> 23) & 0xFF) != 0xFF)
                                     && ((((_iml_v2_sp_union_t *) & flTmp1)->hex[0] & 0x007FFFFF) == 0)))
                                {
                                    nRet = 3;
                                }
                        ...
                        else
                        {
                            ...
                            flVTmp1 = ((__constant float *) __spow_la_CoutTab)[370];
                            flVTmp1 = (flVTmp1 / flVTmp1);
                            *r = flVTmp1;
                            nRet = 1;
                        }
                    ...
                    else
                    {
                        ...
                        if (iEXB < 0x7F)
                        {
                            ...
                            else
                            {
                                ...
                                *r = ((__constant float *) __spow_la_CoutTab)[370];
                            }
                        }
                        else
                        {
                            ...
                            if (iSignY)
                            {
                                ...
                                flRes = ((__constant float *) __spow_la_CoutTab)[378 + (iYIsInt & iSignX)];
                                *r = flRes;
                            }
                            else
                            {
                                ...
                                flTmp1 = (flAi * flAi);
                                flTmp1 = (flTmp1 * flBi);
                                *r = flTmp1 * ((__constant float *) __spow_la_CoutTab)[371 + (iYIsInt & iSignX)];
                            }
                        }
                    }
                }
                else
                {
                    ...
                    *r = ((__constant float *) __spow_la_CoutTab)[371 + (iYIsInt & 1)];
                }
            }
            else
            {
                ...
                if (iSignY)
                {
                    ...
                    *r = ((__constant float *) __spow_la_CoutTab)[371 + (iYIsInt & iSignX)] / flTmp1;
                    nRet = 1;
    ...
    else
    {
        ...
        flVTmp2 = ((__constant float *) __spow_la_CoutTab)[371];
...
float __ocl_svml_powf (float a, float b)
{
...

    {
        ...
        _NMINNORM = (__internal_spow_la_data.NMINNORM);
        _NMAXVAL = (__internal_spow_la_data.NMAXVAL);
        _INF = (__internal_spow_la_data.INF);
        iAbsMask = (__internal_spow_la_data._iAbsMask);
        ...
        S_MANT_MASK = as_float (__internal_spow_la_data.S_MANT_MASK);

        LFR_sXMant = as_float ((as_uint (va1) & as_uint (S_MANT_MASK)));
        S_ONE = as_float (__internal_spow_la_data.S_ONE);
        LFR_sM = as_float ((as_uint (LFR_sXMant) | as_uint (S_ONE)));
        LFR_iN = ((unsigned int) (LFR_iX) >> (23));
        I_BIAS = (__internal_spow_la_data.I_BIAS);
        LFR_iN = (LFR_iN - I_BIAS);
        LFR_sN = ((float) ((int) (LFR_iN)));

        LFR_I_INDEX_MASK = (__internal_spow_la_data.LFR_I_INDEX_MASK);
        LFR_iInd = (LFR_iX & LFR_I_INDEX_MASK);

        LFR_I_INDEX_ADD = (__internal_spow_la_data.LFR_I_INDEX_ADD);

        LFR_iInd = (LFR_iInd + LFR_I_INDEX_ADD);

        LFR_iInd = ((unsigned int) (LFR_iInd) >> (17));
        LFR_sLnRcprYHi = as_float (((__constant unsigned int *) (__internal_spow_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 0]);
        LFR_sLnRcprYLo = as_float (((__constant unsigned int *) (__internal_spow_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 1]);
        LFR_sRcprY = as_float (((__constant unsigned int *) (__internal_spow_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 2]);

        S_HI10BITS_MASK = as_float (__internal_spow_la_data.S_HI10BITS_MASK);

        LFR_sYHi = as_float ((as_uint (LFR_sM) & as_uint (S_HI10BITS_MASK)));
        LFR_sYLo = (LFR_sM - LFR_sYHi);

        LFR_sRHi = __spirv_ocl_fma(LFR_sYHi,LFR_sRcprY,-(S_ONE));
        LFR_sRLo = (LFR_sYLo * LFR_sRcprY);
        LFR_sR = (LFR_sRHi + LFR_sRLo);

        LFR_S_P4 = as_float (__internal_spow_la_data.LFR_S_P4);
        LFR_S_P3 = as_float (__internal_spow_la_data.LFR_S_P3);
        LFR_sP = __spirv_ocl_fma(LFR_S_P4,LFR_sR,LFR_S_P3);

        LFR_S_P2 = as_float (__internal_spow_la_data.LFR_S_P2);
        LFR_sP = __spirv_ocl_fma(LFR_sP,LFR_sR,LFR_S_P2);

        LFR_sR2 = (LFR_sR * LFR_sR);
        LFR_sP = (LFR_sP * LFR_sR2);

        S_LOG2_HI = as_float (__internal_spow_la_data.S_LOG2_HI);

        LFR_sNLog2Hi = __spirv_ocl_fma(LFR_sN,S_LOG2_HI,LFR_sLnRcprYHi);

        S_LOG2_LO = as_float (__internal_spow_la_data.S_LOG2_LO);
        ...
        sRSValue = as_float (__internal_spow_la_data.sRSValue);
        sHiMask = as_float (__internal_spow_la_data.sHiMask);

        {
            ...
            V1 = (sL[0] + sL[1]);
            V2 = (V1 * sRSValue);
            V1 = __spirv_ocl_fma(V1,1.0f,V2);
            V2 = __spirv_ocl_fma(V1,1.0f,-(V2));
            V1 = __spirv_ocl_fma(sL[0],1.0f,-(V2));
            V1 = (sL[1] + V1);;
            sL[0] = V2;
            sL[1] = V1;
        };
        ...
        };
        {
            ...
            V1 = (sL[0] * sY[0]);
            V2 = (sL[1] * sY[1]);
            V2 = __spirv_ocl_fma(sL[0],sY[1],V2);
            V2 = __spirv_ocl_fma(sL[1],sY[0],V2);;
            sZ0[0] = V1;
            sZ0[1] = V2;
        };
        ...
        sInvLn2 = as_float (__internal_spow_la_data._sInvLn2);
        sShifter = as_float (__internal_spow_la_data._sShifter);

        sM = __spirv_ocl_fma(sZ[0],sInvLn2,sShifter);
        sN = (sM - sShifter);

        iAbsZ = as_uint (sZ[0]);

        iAbsZ = (iAbsZ & iAbsMask);
        iDomainRange = (__internal_spow_la_data._iDomainRange);
        ...
        sLn2hi = as_float (__internal_spow_la_data._sLn2hi);
        sR = __spirv_ocl_fma(-(sN),sLn2hi,sZ[0]);
        sLn2lo = as_float (__internal_spow_la_data._sLn2lo);
        sR = __spirv_ocl_fma(-(sN),sLn2lo,sR);
        sR = (sR + sZ[1]);
        sPC[4] = as_float (__internal_spow_la_data._sPC4);
        sPC[5] = as_float (__internal_spow_la_data._sPC5);

        sP = __spirv_ocl_fma(sPC[5],sR,sPC[4]);
        sPC[3] = as_float (__internal_spow_la_data._sPC3);
        sP = __spirv_ocl_fma(sP,sR,sPC[3]);
        sPC[2] = as_float (__internal_spow_la_data._sPC2);
        sP = __spirv_ocl_fma(sP,sR,sPC[2]);
        sPC[1] = as_float (__internal_spow_la_data._sPC1);
        sP = __spirv_ocl_fma(sP,sR,sPC[1]);
        sPC[0] = as_float (__internal_spow_la_data._sPC0);
    ...
    if ((vm) != 0)
    {
        ...
        __internal_spow_la_cout (_vapi_arg1, _vapi_arg2, _vapi_res1);
