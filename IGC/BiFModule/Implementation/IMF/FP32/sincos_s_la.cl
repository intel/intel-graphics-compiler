...
void __ocl_svml_sincosf (float a, float *b, float *c)
{
...

    {
...

        {
            ...
            sSinN = __spirv_ocl_fma(sAbsX,sInvPI,sRShifter);
            ...
            sSinR = __spirv_ocl_fma(-(sSinN),sPI1,sAbsX);
            sSinR = __spirv_ocl_fma(-(sSinN),sPI2,sSinR);
            ...
            sCosR = __spirv_ocl_fma(-(sCosN),sPI1,sAbsX);
            sCosR = __spirv_ocl_fma(-(sCosN),sPI2,sCosR);

            sPI3 = as_float (__internal_ssincos_la_data._sPI3);

            sSinR = __spirv_ocl_fma(-(sSinN),sPI3,sSinR);
            sCosR = __spirv_ocl_fma(-(sCosN),sPI3,sCosR);

            sPI4 = as_float (__internal_ssincos_la_data._sPI4);
            sSinR = __spirv_ocl_fma(-(sSinN),sPI4,sSinR);
            sCosR = __spirv_ocl_fma(-(sCosN),sPI4,sCosR);
            ...
            sSinP = __spirv_ocl_fma(sA9,sSinR2,sA7);
            sCosP = __spirv_ocl_fma(sA9,sCosR2,sA7);
            sSinP = __spirv_ocl_fma(sSinP,sSinR2,sA5);
            sCosP = __spirv_ocl_fma(sCosP,sCosR2,sA5);
            sA3 = as_float (__internal_ssincos_la_data._sA3);
            sSinP = __spirv_ocl_fma(sSinP,sSinR2,sA3);
            sCosP = __spirv_ocl_fma(sCosP,sCosR2,sA3);

            sSinP = (sSinP * sSinR2);
            vr1 = __spirv_ocl_fma(sSinP,sSinR,sSinR);
            vr1 = as_float ((as_uint (vr1) ^ as_uint (sSignX)));

            sCosP = (sCosP * sCosR2);
            vr2 = __spirv_ocl_fma(sCosP,sCosR,sCosR);
        ...
        if ((mRangeReductionMask) != 0)
        {
            ...
            sK3 = (sK1 + sMed);
            sResLo0 = (sK3 + sK2);
            sD = __spirv_ocl_fma(-(sR),sSHi,sD);
            sCorr = __spirv_ocl_fma(sE,sD,sSLo);
            sResLo = __spirv_ocl_fma(sPC,sSHi,sCorr);
            sResLo = __spirv_ocl_fma(sPS,sD,sResLo);
            ...
            scK3 = (scK1 + scMed);
            scResLo0 = (scK3 + scK2);
            scD = __spirv_ocl_fma(-(sR),scSHi,scD);
            scCorr = __spirv_ocl_fma(sE,scD,scSLo);
            scResLo = __spirv_ocl_fma(sPC,scSHi,scCorr);
            scResLo = __spirv_ocl_fma(sPS,scD,scResLo);
