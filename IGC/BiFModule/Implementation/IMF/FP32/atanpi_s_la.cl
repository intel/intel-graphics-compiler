...
inline int __internal_satanpi_la_cout (float *pxin, float *pres)
{
    ...
    int_float invpi = { 0x3ea2f983 };
    {
        ...
        poly = __spirv_ocl_fma(__satanpi_la_c7.f,R,__satanpi_la_c6.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c5.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c4.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c3.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c2.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c1.f);
        poly = __spirv_ocl_fma(poly,R,__satanpi_la_c0.f);
