...
inline int __internal_sexpm1_la_cout (float *a, float *pres)
{
    ...
    xf.f = xin;
    xL2E.f = __spirv_ocl_fma(xf.f,__sexpm1_la_fL2E.f,0.0f);
    fN.f = __spirv_ocl_trunc(xL2E.f);
    fS.f = __sexpm1_la_fShifter.f + fN.f;

    R = __spirv_ocl_fma(fN.f,__sexpm1_la_NL2H.f,xf.f);
    R = __spirv_ocl_fma(fN.f,__sexpm1_la_NL2L.f,R);

    T.w = fS.w << 23;

    poly = __spirv_ocl_fma(__sexpm1_la_c6.f,R,__sexpm1_la_c5.f);
    poly = __spirv_ocl_fma(poly,R,__sexpm1_la_c4.f);
    poly = __spirv_ocl_fma(poly,R,__sexpm1_la_c3.f);
    poly = __spirv_ocl_fma(poly,R,__sexpm1_la_c2.f);
    poly = __spirv_ocl_fma(poly,R,__sexpm1_la_c1.f);
    poly = __spirv_ocl_fma(poly,R,__sexpm1_la_c0.f);
