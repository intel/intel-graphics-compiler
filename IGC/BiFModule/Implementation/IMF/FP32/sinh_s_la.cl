...
inline int __internal_ssinh_la_cout (float *a, float *r)
{
    ...
    S.f = __spirv_ocl_fma(x,__ssinh_la_L2E.f,__ssinh_la_Shifter.f);
    N = S.f - __ssinh_la_Shifter.f;

    R = __spirv_ocl_fma(-N,__ssinh_la_L2H.f,x);
    R = __spirv_ocl_fma(-N,__ssinh_la_L2L.f,R);
    ...
    poly = __spirv_ocl_fma(R,__ssinh_la_c5.f,__ssinh_la_c4.f);
    poly = __spirv_ocl_fma(R,poly,__ssinh_la_c3.f);
    poly = __spirv_ocl_fma(R,poly,__ssinh_la_c2.f);
    poly = __spirv_ocl_fma(R,poly,__ssinh_la_c1.f);
...
float __ocl_svml_sinhf (float a)
{
...

    {
        ...
        sM = __spirv_ocl_fma(sAbsX,sInvLn2,sShifter);
        ...
        sR = __spirv_ocl_fma(-(sOut),sN,sAbsX);
        sR = __spirv_ocl_fma(-(sG1),sN,sR);
        ...
        sSinh_r = __spirv_ocl_fma(sPC[4],sR2,sPC[2]);
        sSinh_r = (sSinh_r * sR2);
        sSinh_r = __spirv_ocl_fma(sSinh_r,sR,sR);

        sOut = __spirv_ocl_fma(sPC[5],sR2,sPC[3]);
        sOut = __spirv_ocl_fma(sOut,sR2,sPC[1]);
        sOut = (sOut * sR2);
        sOut = (sOut * sG2);
        sOut = __spirv_ocl_fma(sG1,sSinh_r,sOut);
        sOut = (sOut + sG2);
