...
static __constant union {
  ...
  float f;
  int i;
} __sacos_ep_c2 = {0x3dc4c6aeu};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_c1 = {0x3e2876b2u};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_c0 = {0x3f80010bu};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_small_float = {0x01800000u};
// 2.0
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_two = {0x40000000u};
// pi/2
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_pi2h = {0x3FC90FDBu};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_pi2l = {0xB33BBD2Eu};
// pi
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_pih = {0x40490FDBu};
static __constant union {
  unsigned int w;
  float f;
  int i;
} __sacos_ep_pil = {0xB3BBBD2Eu};
__attribute__((always_inline)) inline int
__ocl_svml_internal_sacos_ep(float *pxin, float *pres) {
  int nRet = 0;
  float xin = *pxin;
  union {
    unsigned int w;
...
float __ocl_svml_acosf_ep(float x) {
  float r;
  __ocl_svml_internal_sacos_ep(&x, &r);
  return r;
}
