...
float __ocl_svml_cosf (float a)
{
...

    {
...

        {
            ...
            sR = __spirv_ocl_fma(-(sN),sPI3,sR);

            sPI4 = as_float (__internal_scos_la_data._sPI4);
            sR = __spirv_ocl_fma(-(sN),sPI4,sR);
            sR2 = (sR * sR);
            ...
            sP = __spirv_ocl_fma(sA9,sR2,sA7);
            sP = __spirv_ocl_fma(sP,sR2,sA5);
            sA3 = as_float (__internal_scos_la_data._sA3);
            sP = __spirv_ocl_fma(sP,sR2,sA3);

            sR3 = (sR2 * sR);
            vr1 = __spirv_ocl_fma(sP,sR3,sR);
        ...
        if ((mRangeReductionMask) != 0)
        {
            ...
            sResLo0 = __spirv_ocl_fma(sPS,sD,sResLo0);
