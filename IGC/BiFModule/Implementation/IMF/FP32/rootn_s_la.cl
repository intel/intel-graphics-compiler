...
typedef struct
{
    ...
    unsigned int _sHuge;
    unsigned int _sTiny;
} __internal_srootn_la_data_t;
static __constant __internal_srootn_la_data_t __internal_srootn_la_data = {
    0xFFFFF000u,
    0x45800800u,
    0x80800000u,
    0xfeffffffu,
...
static __constant _iml_v2_sp_union_t __srootn_la_CoutTab[380] = {
...
static int __srootn_la_TestIntFunc (float a)
{
...
inline int __internal_srootn_la_cout (float *a, int *b, float *r)
{
    int nRet = 0;
    ...
    float flAX, flSignRes, flX1, flRcp1, flL1Hi, flL1Lo, flX2, flRcp2, flL2Hi, flL2Lo,
        ...
        flExp2Poly, flExp2PolyT, flResLo, flResHi, flRes, flTwoPowN, flAY, flAi, flBi, flVTmp3;
    ...
    int i, iEXB, iEYB, iSignX, iSignY, iYHi, iYLo, iYIsFinite, iEY, iYIsInt, iXIsFinite,
        iDenoExpAdd, iXHi, k, i1, i2, i3, iELogAX, iN, j, iERes, iSign, iIsSigZeroX, iIsSigZeroY, iYMantissa, iEX, iBi = *b;
    float flBOrig = (float) (*b), flBOrigLo;
...

    {
        ...
        if (iYisZero)
        {
            flVTmp1 = ((__constant float *) __srootn_la_CoutTab)[370];
        ...
        if (iXisZero && iYisEven)
        {
            if (iSignY)
            {
                flVTmp1 = ((__constant float *) __srootn_la_CoutTab)[371];
                flVTmp2 = ((__constant float *) __srootn_la_CoutTab)[370];
                *r = (float) (flVTmp1 / flVTmp2);
                return nRet;
            }
            else
            {
    ...
    iYIsInt = __srootn_la_TestIntFunc (flBi);
    ...
    if (!((iSignX == 0) && (iEXB == 0x7F) && iIsSigZeroX) && !((iEYB == 0) && iIsSigZeroY))
    {
        ...
        if ((iXIsFinite || iIsSigZeroX) && (iYIsFinite || iIsSigZeroY))
        {
            ...
            if (flAi != ((__constant float *) __srootn_la_CoutTab)[370])
            {
                ;

                if (!((flAi == ((__constant float *) __srootn_la_CoutTab)[372]) && (iYIsInt || !iYIsFinite)))
                {
                    ;
                    ...
                    if (iXIsFinite && iYIsFinite)
                    {
                        ...
                        if ((flAi > ((__constant float *) __srootn_la_CoutTab)[370]) || iYIsInt)
                        {
                            ;

                            flSignRes = ((__constant float *) __srootn_la_CoutTab)[371 + (iSignX & iYIsInt)];
                            iDenoExpAdd = 0;
                            flAX = flAi;
                            ...
                            if (iEXB == 0)
                            {
                                ...
                                flAX = flAX * ((__constant float *) __srootn_la_CoutTab)[376];
                            ...
                            flRcp1 = ((__constant float *) __srootn_la_CoutTab)[0 + i1];

                            flL1Hi = ((__constant float *) __srootn_la_CoutTab)[9 + 2 * (i1) + 0];
                            flL1Lo = ((__constant float *) __srootn_la_CoutTab)[9 + 2 * (i1) + 1];
                            ...
                            flRcp2 = ((__constant float *) __srootn_la_CoutTab)[27 + i2];

                            flL2Hi = ((__constant float *) __srootn_la_CoutTab)[36 + 2 * (i2) + 0];
                            flL2Lo = ((__constant float *) __srootn_la_CoutTab)[36 + 2 * (i2) + 1];
                            ...
                            flRcp3C = ((__constant float *) __srootn_la_CoutTab)[54 + i3];

                            flL3Hi = ((__constant float *) __srootn_la_CoutTab)[71 + 2 * (i3) + 0];
                            flL3Lo = ((__constant float *) __srootn_la_CoutTab)[71 + 2 * (i3) + 1];
                            ...
                            flR1 = (flX3 * flRcp3C);
                            flCQ = (flR1 - ((__constant float *) __srootn_la_CoutTab)[374]);

                            flRcpC = (flRcp1 * flRcp2);
                            flRcpC = (flRcpC * flRcp3C);

                            flVTmp1 = ((flX1) * (((__constant float *) __srootn_la_CoutTab)[375]));
                            ...
                            flVTmp1 = ((flRcpC) * (((__constant float *) __srootn_la_CoutTab)[375]));
                            ...
                            if (iELogAX + iEYB < 11 + 2 * 0x7F)
                            {
                                ...
                                if (iELogAX + iEYB > -62 + 2 * 0x7F)
                                {
                                    ...
                                    flLog2Poly =
                                        ((((((__constant float *) __srootn_la_CoutTab)[364]) * flR +
                                           ((__constant float *) __srootn_la_CoutTab)[363]) * flR +
                                          ((__constant float *) __srootn_la_CoutTab)[362]) * flR +
                                         ((__constant float *) __srootn_la_CoutTab)[361]) * flR;
                                    ...
                                    flVTmp1 = ((flHH) * (((__constant float *) __srootn_la_CoutTab)[375]));
                                    ...
                                    flVTmp1 = (((__constant float *) __srootn_la_CoutTab)[371] / flBOrig);
                                    flVTmp2 = (flVTmp1 * ((__constant float *) __srootn_la_CoutTab)[375]);
                                    flVTmp3 = (flVTmp2 - flVTmp1);
                                    flVTmp3 = (flVTmp2 - flVTmp3);
                                    flVTmp1 = (flBOrig * flVTmp3);
                                    flVTmp1 = (((__constant float *) __srootn_la_CoutTab)[371] - flVTmp1);
                                    flVTmp2 = (((__constant float *) __srootn_la_CoutTab)[370] * flVTmp3);
                                    flVTmp2 = (flVTmp1 - flVTmp2);
                                    flVTmp1 = (((__constant float *) __srootn_la_CoutTab)[371] + flVTmp2);
                                    flYHi = flVTmp3;
                                    flVTmp1 = (flVTmp1 * flVTmp2);
                                    ...
                                    flVTmp1 = (flPH + ((__constant float *) __srootn_la_CoutTab)[373]);
                                    flVPHH = (flVTmp1 - ((__constant float *) __srootn_la_CoutTab)[373]);
                                    ...
                                    flExp2Poly =
                                        (((((__constant float *) __srootn_la_CoutTab)[367]) * flZ +
                                          ((__constant float *) __srootn_la_CoutTab)[366]) * flZ +
                                         ((__constant float *) __srootn_la_CoutTab)[365]) * flZ;

                                    flExp2PolyT = (flExp2Poly * ((__constant float *) __srootn_la_CoutTab)[105 + 2 * (j) + 0]);
                                    flResLo = (flExp2PolyT + ((__constant float *) __srootn_la_CoutTab)[105 + 2 * (j) + 1]);
                                    flResHi = ((__constant float *) __srootn_la_CoutTab)[105 + 2 * (j) + 0];
                                    ...
                                    if (iERes < 128)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (iERes >= -126 - 10)
                                            {
                                                ...
                                                flVTmp1 = ((flResHi) * (((__constant float *) __srootn_la_CoutTab)[375]));
                                                ...
                                                flSignRes *= ((__constant float *) __srootn_la_CoutTab)[377];
                                                iN = (iN + 64);

                                                flTwoPowN = ((__constant float *) __srootn_la_CoutTab)[371];
                                                ...
                                                flVTmp1 = ((__constant float *) __srootn_la_CoutTab)[369];
                                                flVTmp1 = (flVTmp1 * flVTmp1);
                                                flRes = (flRes + flVTmp1);
                                    ...
                                    else
                                    {
                                        ...
                                        flVTmp1 = ((__constant float *) __srootn_la_CoutTab)[368];
                                        flVTmp1 = (flVTmp1 * flVTmp1);
                                        flRes = (flVTmp1 * flSignRes);
                                        *r = flRes;
                                    }
                                ...
                                else
                                {
                                    ...
                                    flVTmp1 = ((__constant float *) __srootn_la_CoutTab)[371];
                                    flVTmp1 = (flVTmp1 + ((__constant float *) __srootn_la_CoutTab)[369]);
                                    *r = (flVTmp1 * flSignRes);
                                }
                            }
                            else
                            {
                                ...
                                flTmp1 = ((__constant float *) __srootn_la_CoutTab)[368 + (iSign)];
                    ...
                    else
                    {
                        ...
                        if (iEXB < 0x7F)
                        {
                            ...
                            else
                            {
                                ...
                                *r = ((__constant float *) __srootn_la_CoutTab)[370];
                            }
                        }
                        else
                        {
                            ...
                            if (iSignY)
                            {
                                ...
                                flRes = ((__constant float *) __srootn_la_CoutTab)[378 + (iYIsInt & iSignX)];
                                *r = flRes;
                            }
                            else
                            {
                                ...
                                flTmp1 = (flAi * flAi);
                                flTmp1 = (flTmp1 * flBi);
                                *r = flTmp1 * ((__constant float *) __srootn_la_CoutTab)[371 + (iYIsInt & iSignX)];
                            }
                        }
                    }
                }
                else
                {
                    ...
                    *r = ((__constant float *) __srootn_la_CoutTab)[371 + (iYIsInt & 1)];
                }
            }
            else
            {
                ...
                if (iSignY)
                {
                    ...
                    *r = ((__constant float *) __srootn_la_CoutTab)[371 + (iYIsInt & iSignX)] / flTmp1;
                    nRet = 1;
    ...
    else
    {
        ...
        flVTmp2 = ((__constant float *) __srootn_la_CoutTab)[371];
...
float __ocl_svml_rootnf (float a, int b)
{
...

    {
        ...
        iNegX = as_uint (sX);
        iNegX = ((unsigned int) (-(signed int) ((signed int) iNegX < (signed int) iZero)));
        iEvenY = ((unsigned int) (-(signed int) ((signed int) iOddY == (signed int) iZero)));
        iNegXEvenY = (iNegX & iEvenY);

        iAbsMask = (__internal_srootn_la_data._iAbsMask);
        ...
        _NMINNORM = (__internal_srootn_la_data.NMINNORM);
        _NMAXVAL = (__internal_srootn_la_data.NMAXVAL);
        _INF = (__internal_srootn_la_data.INF);
        ...
        LFR_I_NZ_ADD = (__internal_srootn_la_data.LFR_I_NZ_ADD);
        LFR_iXNearOne = (LFR_iX + LFR_I_NZ_ADD);
        LFR_I_NZ_CMP = (__internal_srootn_la_data.LFR_I_NZ_CMP);
        ...
        S_MANT_MASK = as_float (__internal_srootn_la_data.S_MANT_MASK);
        LFR_sXMant = as_float ((as_uint (sX) & as_uint (S_MANT_MASK)));
        S_ONE = as_float (__internal_srootn_la_data.S_ONE);
        LFR_sM = as_float ((as_uint (LFR_sXMant) | as_uint (S_ONE)));
        LFR_iN = ((unsigned int) (LFR_iX) >> (23));
        I_BIAS = (__internal_srootn_la_data.I_BIAS);
        LFR_iN = (LFR_iN - I_BIAS);
        LFR_sN = ((float) ((int) (LFR_iN)));

        LFR_I_INDEX_MASK = (__internal_srootn_la_data.LFR_I_INDEX_MASK);
        LFR_iInd = (LFR_iX & LFR_I_INDEX_MASK);

        LFR_I_INDEX_ADD = (__internal_srootn_la_data.LFR_I_INDEX_ADD);
        LFR_iInd = (LFR_iInd + LFR_I_INDEX_ADD);

        LFR_iInd = ((unsigned int) (LFR_iInd) >> (17));
        LFR_sLnRcprYHi = as_float (((__constant unsigned int *) (__internal_srootn_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 0]);
        LFR_sLnRcprYLo = as_float (((__constant unsigned int *) (__internal_srootn_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 1]);
        LFR_sRcprY = as_float (((__constant unsigned int *) (__internal_srootn_la_data.LFR_TBL))[(((0 + LFR_iInd) * (3 * 4)) >> (2)) + 2]);

        S_HI10BITS_MASK = as_float (__internal_srootn_la_data.S_HI10BITS_MASK);
        ...
        LFR_S_P4 = as_float (__internal_srootn_la_data.LFR_S_P4);
        LFR_S_P3 = as_float (__internal_srootn_la_data.LFR_S_P3);
        LFR_sP = __spirv_ocl_fma(LFR_S_P4,LFR_sR,LFR_S_P3);

        LFR_S_P2 = as_float (__internal_srootn_la_data.LFR_S_P2);
        LFR_sP = __spirv_ocl_fma(LFR_sP,LFR_sR,LFR_S_P2);

        LFR_sR2 = (LFR_sR * LFR_sR);
        LFR_sP = (LFR_sP * LFR_sR2);

        S_LOG2_HI = as_float (__internal_srootn_la_data.S_LOG2_HI);
        LFR_sNLog2Hi = (LFR_sN * S_LOG2_HI);

        S_LOG2_LO = as_float (__internal_srootn_la_data.S_LOG2_LO);
        ...
        sRSValue = as_float (__internal_srootn_la_data.sRSValue);
        sHiMask = as_float (__internal_srootn_la_data.sHiMask);
        {
            float V1;
            float V2;;
            V1 = (sL[0] + sL[1]);
        ...
        };
        {
            ...
            V1 = (sL[0] * sW[0]);
            V2 = (sL[1] * sW[1]);
            V2 = __spirv_ocl_fma(sL[0],sW[1],V2);
            V2 = __spirv_ocl_fma(sL[1],sW[0],V2);;
            sZ[0] = V1;
            sZ[1] = V2;
        };

        sInvLn2 = as_float (__internal_srootn_la_data._sInvLn2);
        sShifter = as_float (__internal_srootn_la_data._sShifter);
        sM = __spirv_ocl_fma(sZ[0],sInvLn2,sShifter);
        sN = (sM - sShifter);

        iAbsZ = as_uint (sZ[0]);
        iAbsZ = (iAbsZ & iAbsMask);
        iDomainRange = (__internal_srootn_la_data._iDomainRange);
        ...
        sLn2hi = as_float (__internal_srootn_la_data._sLn2hi);
        sR = __spirv_ocl_fma(-(sN),sLn2hi,sZ[0]);
        sLn2lo = as_float (__internal_srootn_la_data._sLn2lo);
        sR = __spirv_ocl_fma(-(sN),sLn2lo,sR);
        sR = (sR + sZ[1]);

        sPC[4] = as_float (__internal_srootn_la_data._sPC4);
        sPC[5] = as_float (__internal_srootn_la_data._sPC5);
        sP = __spirv_ocl_fma(sPC[5],sR,sPC[4]);
        sPC[3] = as_float (__internal_srootn_la_data._sPC3);
        sP = __spirv_ocl_fma(sP,sR,sPC[3]);
        sPC[2] = as_float (__internal_srootn_la_data._sPC2);
        sP = __spirv_ocl_fma(sP,sR,sPC[2]);
        sPC[1] = as_float (__internal_srootn_la_data._sPC1);
        sP = __spirv_ocl_fma(sP,sR,sPC[1]);
        sPC[0] = as_float (__internal_srootn_la_data._sPC0);
    ...
    if ((vm) != 0)
    {
        ...
        __internal_srootn_la_cout (_vapi_arg1, _vapi_arg2, _vapi_res1);
