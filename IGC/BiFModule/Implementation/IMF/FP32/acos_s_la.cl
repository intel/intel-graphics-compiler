...
inline int __internal_sacos_la_cout (float *pxin, float *pres)
{
    ...
    int_float y, res;
    {
        ...
        RS.f = 1.0f / __spirv_ocl_sqrt((y.f + __sacos_la_small_float.f));
        ...
        poly = __spirv_ocl_fma(__sacos_la_c5.f,R,__sacos_la_c4.f);
        poly = __spirv_ocl_fma(poly,R,__sacos_la_c3.f);
        poly = __spirv_ocl_fma(poly,R,__sacos_la_c2.f);
        poly = __spirv_ocl_fma(poly,R,__sacos_la_c1.f);
        poly = __spirv_ocl_fma(poly,R,__sacos_la_c0.f);
