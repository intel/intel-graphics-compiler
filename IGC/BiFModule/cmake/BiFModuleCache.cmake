...
function(generate_bif_src_checksum bifModuleTgt)
    set(x64_check_code "")
    string(APPEND x64_check_code "#include <stdint.h>\n")
    string(APPEND x64_check_code "#define SIZEOF_POINTER (UINTPTR_MAX / 255 % 255)\n")
    string(APPEND x64_check_code "#if SIZEOF_POINTER == 4\n")
    string(APPEND x64_check_code "#error 'x86'\n")
    string(APPEND x64_check_code "#endif\n")
    string(APPEND x64_check_code "int main() { return 0; }\n")

    cmake_minimum_required(VERSION 3.25.0)
    # In oldest version cmake, this try_compile catch error
    try_compile(COMPILE_RESULT_CHECK SOURCE_FROM_VAR "x64_check_code.c" x64_check_code)
    if(COMPILE_RESULT_CHECK)
        set(BIF_ARCH "x64")
    else()
        set(BIF_ARCH "x86")
    endif()
