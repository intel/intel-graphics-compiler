...
float __attribute__((overloadable))
    __spirv_ocl_fclamp(float x, float y, float z);
float2 __attribute__((overloadable))
    __spirv_ocl_fclamp(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_fclamp(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_fclamp(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_fclamp(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable))
    __spirv_ocl_fclamp(float16 x, float16 y, float16 z);
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_fclamp(double x, double y, double z);
double2 __attribute__((overloadable))
    __spirv_ocl_fclamp(double2 x, double2 y, double2 z);
double3 __attribute__((overloadable))
    __spirv_ocl_fclamp(double3 x, double3 y, double3 z);
double4 __attribute__((overloadable))
    __spirv_ocl_fclamp(double4 x, double4 y, double4 z);
double8 __attribute__((overloadable))
    __spirv_ocl_fclamp(double8 x, double8 y, double8 z);
double16 __attribute__((overloadable)) __spirv_ocl_fclamp(
...
half2 __attribute__((overloadable))
    __spirv_ocl_fclamp(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_fclamp(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_fclamp(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_fclamp(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_fclamp(half16 x, half16 y, half16 z);

float __attribute__((overloadable)) __spirv_ocl_fmax_common(float x, float y);
float2
    __attribute__((overloadable)) __spirv_ocl_fmax_common(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_fmax_common(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_fmax_common(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_fmax_common(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_fmax_common(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_fmax_common(double x, double y);
double2 __attribute__((overloadable))
    __spirv_ocl_fmax_common(double2 x, double2 y);
double3 __attribute__((overloadable))
    __spirv_ocl_fmax_common(double3 x, double3 y);
double4 __attribute__((overloadable))
    __spirv_ocl_fmax_common(double4 x, double4 y);
double8 __attribute__((overloadable))
    __spirv_ocl_fmax_common(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_fmax_common(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16 __attribute__((overloadable))
    __spirv_ocl_fmax_common(half16 x, half16 y);
...
float2
    __attribute__((overloadable)) __spirv_ocl_fmin_common(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_fmin_common(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_fmin_common(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_fmin_common(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_fmin_common(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_fmin_common(double x, double y);
double2 __attribute__((overloadable))
    __spirv_ocl_fmin_common(double2 x, double2 y);
double3 __attribute__((overloadable))
    __spirv_ocl_fmin_common(double3 x, double3 y);
double4 __attribute__((overloadable))
    __spirv_ocl_fmin_common(double4 x, double4 y);
double8 __attribute__((overloadable))
    __spirv_ocl_fmin_common(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_fmin_common(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16 __attribute__((overloadable))
    __spirv_ocl_fmin_common(half16 x, half16 y);

float
    __attribute__((overloadable)) __spirv_ocl_mix(float x, float y, float a);
float2 __attribute__((overloadable))
    __spirv_ocl_mix(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_mix(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_mix(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_mix(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable))
    __spirv_ocl_mix(float16 x, float16 y, float16 z);
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_mix(double x, double y, double a);
double2 __attribute__((overloadable))
    __spirv_ocl_mix(double2 x, double2 y, double2 z);
double3 __attribute__((overloadable))
    __spirv_ocl_mix(double3 x, double3 y, double3 z);
double4 __attribute__((overloadable))
    __spirv_ocl_mix(double4 x, double4 y, double4 z);
double8 __attribute__((overloadable))
    __spirv_ocl_mix(double8 x, double8 y, double8 z);
double16 __attribute__((overloadable))
    __spirv_ocl_mix(double16 x, double16 y, double16 z);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable)) __spirv_ocl_mix(half x, half y, half a);
half2 __attribute__((overloadable))
    __spirv_ocl_mix(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_mix(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_mix(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_mix(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_mix(half16 x, half16 y, half16 z);
...
float2 __attribute__((overloadable))
    __spirv_ocl_smoothstep(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_smoothstep(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_smoothstep(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_smoothstep(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable)) __spirv_ocl_smoothstep(
...
double16 __attribute__((overloadable)) __spirv_ocl_smoothstep(
    double16 x, double16 y, double16 z);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable))
    __spirv_ocl_smoothstep(half edge0, half edge1, half x);
half2 __attribute__((overloadable))
    __spirv_ocl_smoothstep(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_smoothstep(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_smoothstep(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_smoothstep(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_smoothstep(half16 x, half16 y, half16 z);
...
float16
    __attribute__((overloadable)) __spirv_ocl_step(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_step(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
#if defined(cl_khr_fp64)
double3
    __attribute__((overloadable)) __spirv_ocl_cross(double3 p0, double3 p1);
double4
    __attribute__((overloadable)) __spirv_ocl_cross(double4 p0, double4 p1);
#endif // defined(cl_khr_fp64)
...
float
    __attribute__((overloadable)) __spirv_ocl_distance(float2 p0, float2 p1);
float
    __attribute__((overloadable)) __spirv_ocl_distance(float3 p0, float3 p1);
float
    __attribute__((overloadable)) __spirv_ocl_distance(float4 p0, float4 p1);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_distance(double p0, double p1);
double __attribute__((overloadable))
    __spirv_ocl_distance(double2 p0, double2 p1);
double __attribute__((overloadable))
    __spirv_ocl_distance(double3 p0, double3 p1);
double __attribute__((overloadable))
    __spirv_ocl_distance(double4 p0, double4 p1);
#endif // defined(cl_khr_fp64)
...
float __attribute__((overloadable))
    __spirv_ocl_fast_distance(float2 p0, float2 p1);
float __attribute__((overloadable))
    __spirv_ocl_fast_distance(float3 p0, float3 p1);
float __attribute__((overloadable))
    __spirv_ocl_fast_distance(float4 p0, float4 p1);
...
float2
    __attribute__((overloadable)) __spirv_ocl_half_divide(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_half_divide(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_half_divide(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_half_divide(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_half_divide(float16 x, float16 y);
...
float2
    __attribute__((overloadable)) __spirv_ocl_half_powr(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_half_powr(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_half_powr(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_half_powr(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_half_powr(float16 x, float16 y);
...
uchar16
    __attribute__((overloadable)) __spirv_ocl_s_abs_diff(char16 x, char16 y);
...
uchar16 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(uchar16 x, uchar16 y);
ushort __attribute__((overloadable)) __spirv_ocl_s_abs_diff(short x, short y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_s_abs_diff(short2 x, short2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_s_abs_diff(short3 x, short3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_s_abs_diff(short4 x, short4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_s_abs_diff(short8 x, short8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_s_abs_diff(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ushort x, ushort y);
ushort2 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ushort2 x, ushort2 y);
ushort3 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ushort3 x, ushort3 y);
ushort4 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ushort4 x, ushort4 y);
ushort8 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ushort16 x, ushort16 y);
...
uint16
    __attribute__((overloadable))  __spirv_ocl_s_abs_diff(int16 x, int16 y);
...
uint16 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(uint16 x, uint16 y);
...
ulong16 __attribute__((overloadable))
    __spirv_ocl_s_abs_diff(long16 x, long16 y);
ulong __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ulong x, ulong y);
ulong2
    __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ulong2 x, ulong2 y);
ulong3
    __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ulong3 x, ulong3 y);
ulong4
    __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ulong4 x, ulong4 y);
ulong8
    __attribute__((overloadable)) __spirv_ocl_u_abs_diff(ulong8 x, ulong8 y);
ulong16 __attribute__((overloadable))
    __spirv_ocl_u_abs_diff(ulong16 x, ulong16 y);
...
char16
    __attribute__((overloadable))   __spirv_ocl_s_add_sat(char16 x, char16 y);
...
uchar16
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(uchar16 x, uchar16 y);
short __attribute__((overloadable)) __spirv_ocl_s_add_sat(short x, short y);
short2
    __attribute__((overloadable)) __spirv_ocl_s_add_sat(short2 x, short2 y);
short3
    __attribute__((overloadable)) __spirv_ocl_s_add_sat(short3 x, short3 y);
short4
    __attribute__((overloadable)) __spirv_ocl_s_add_sat(short4 x, short4 y);
short8
    __attribute__((overloadable)) __spirv_ocl_s_add_sat(short8 x, short8 y);
short16 __attribute__((overloadable))
    __spirv_ocl_s_add_sat(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_add_sat(ushort x, ushort y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ushort2 x, ushort2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ushort3 x, ushort3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ushort4 x, ushort4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_add_sat(ushort16 x, ushort16 y);
...
uint16
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(uint16 x, uint16 y);
...
long16
    __attribute__((overloadable)) __spirv_ocl_s_add_sat(long16 x, long16 y);
ulong __attribute__((overloadable)) __spirv_ocl_u_add_sat(ulong x, ulong y);
ulong2
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ulong2 x, ulong2 y);
ulong3
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ulong3 x, ulong3 y);
ulong4
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ulong4 x, ulong4 y);
ulong8
    __attribute__((overloadable)) __spirv_ocl_u_add_sat(ulong8 x, ulong8 y);
ulong16 __attribute__((overloadable))
    __spirv_ocl_u_add_sat(ulong16 x, ulong16 y);

char __attribute__((overloadable))
    __spirv_ocl_s_clamp(char x, char minval, char maxval);
...
int __attribute__((overloadable))
    __spirv_ocl_s_clamp(int x, int minval, int maxval);
uint __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint x, uint minval, uint maxval);
long __attribute__((overloadable))
    __spirv_ocl_s_clamp(long x, long minval, long maxval);
ulong __attribute__((overloadable))
    __spirv_ocl_u_clamp(ulong x, ulong minval, ulong maxval);
char2 __attribute__((overloadable))
    __spirv_ocl_s_clamp(char2 x, char2 y, char2 z);
char3 __attribute__((overloadable))
    __spirv_ocl_s_clamp(char3 x, char3 y, char3 z);
char4 __attribute__((overloadable))
    __spirv_ocl_s_clamp(char4 x, char4 y, char4 z);
char8 __attribute__((overloadable))
    __spirv_ocl_s_clamp(char8 x, char8 y, char8 z);
char16 __attribute__((overloadable))
    __spirv_ocl_s_clamp(char16 x, char16 y, char16 z);
uchar2 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uchar2 x, uchar2 y, uchar2 z);
uchar3 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uchar3 x, uchar3 y, uchar3 z);
uchar4 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uchar4 x, uchar4 y, uchar4 z);
uchar8 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uchar8 x, uchar8 y, uchar8 z);
uchar16 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uchar16 x, uchar16 y, uchar16 z);
short2 __attribute__((overloadable))
    __spirv_ocl_s_clamp(short2 x, short2 y, short2 z);
short3 __attribute__((overloadable))
    __spirv_ocl_s_clamp(short3 x, short3 y, short3 z);
short4 __attribute__((overloadable))
    __spirv_ocl_s_clamp(short4 x, short4 y, short4 z);
short8 __attribute__((overloadable))
    __spirv_ocl_s_clamp(short8 x, short8 y, short8 z);
short16 __attribute__((overloadable))
...
ushort16 __attribute__((overloadable)) __spirv_ocl_u_clamp(
    ushort16 x, ushort16 y, ushort16 z);
int2 __attribute__((overloadable))
    __spirv_ocl_s_clamp(int2 x, int2 y, int2 z);
int3 __attribute__((overloadable))
    __spirv_ocl_s_clamp(int3 x, int3 y, int3 z);
int4 __attribute__((overloadable))
    __spirv_ocl_s_clamp(int4 x, int4 y, int4 z);
int8 __attribute__((overloadable))
    __spirv_ocl_s_clamp(int8 x, int8 y, int8 z);
int16 __attribute__((overloadable))
    __spirv_ocl_s_clamp(int16 x, int16 y, int16 z);
uint2 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint2 x, uint2 y, uint2 z);
uint3 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint3 x, uint3 y, uint3 z);
uint4 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint4 x, uint4 y, uint4 z);
uint8 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint8 x, uint8 y, uint8 z);
uint16 __attribute__((overloadable))
    __spirv_ocl_u_clamp(uint16 x, uint16 y, uint16 z);
long2 __attribute__((overloadable))
    __spirv_ocl_s_clamp(long2 x, long2 y, long2 z);
long3 __attribute__((overloadable))
    __spirv_ocl_s_clamp(long3 x, long3 y, long3 z);
long4 __attribute__((overloadable))
    __spirv_ocl_s_clamp(long4 x, long4 y, long4 z);
long8 __attribute__((overloadable))
    __spirv_ocl_s_clamp(long8 x, long8 y, long8 z);
long16 __attribute__((overloadable))
    __spirv_ocl_s_clamp(long16 x, long16 y, long16 z);
ulong2 __attribute__((overloadable))
    __spirv_ocl_u_clamp(ulong2 x, ulong2 y, ulong2 z);
ulong3 __attribute__((overloadable))
    __spirv_ocl_u_clamp(ulong3 x, ulong3 y, ulong3 z);
ulong4 __attribute__((overloadable))
    __spirv_ocl_u_clamp(ulong4 x, ulong4 y, ulong4 z);
ulong8 __attribute__((overloadable))
    __spirv_ocl_u_clamp(ulong8 x, ulong8 y, ulong8 z);
ulong16 __attribute__((overloadable))
...
uchar16
    __attribute__((overloadable))    __spirv_ocl_u_hadd(uchar16 x, uchar16 y);
...
short16
    __attribute__((overloadable)) __spirv_ocl_s_hadd(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_hadd(ushort x, ushort y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_hadd(ushort2 x, ushort2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_hadd(ushort3 x, ushort3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_hadd(ushort4 x, ushort4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_hadd(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_hadd(ushort16 x, ushort16 y);
...
ulong16
    __attribute__((overloadable)) __spirv_ocl_u_hadd(ulong16 x, ulong16 y);

char __attribute__((overloadable)) __spirv_ocl_s_mad_hi(char a, char b, char c);
char2 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(char2 a, char2 b, char2 c);
char3 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(char3 a, char3 b, char3 c);
char4 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(char4 a, char4 b, char4 c);
char8 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(char8 a, char8 b, char8 c);
char16 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(char16 a, char16 b, char16 c);
uchar __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar a, uchar b, uchar c);
uchar2 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar2 a, uchar2 b, uchar2 c);
uchar3 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar3 a, uchar3 b, uchar3 c);
uchar4 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar4 a, uchar4 b, uchar4 c);
uchar8 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar8 a, uchar8 b, uchar8 c);
uchar16 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uchar16 a, uchar16 b, uchar16 c);
short __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short a, short b, short c);
short2 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short2 a, short2 b, short2 c);
short3 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short3 a, short3 b, short3 c);
short4 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short4 a, short4 b, short4 c);
short8 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short8 a, short8 b, short8 c);
short16 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(short16 a, short16 b, short16 c);
ushort __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ushort a, ushort b, ushort c);
ushort2 __attribute__((overloadable))
...
ushort16 __attribute__((overloadable)) __spirv_ocl_u_mad_hi(
    ushort16 a, ushort16 b, ushort16 c);
int __attribute__((overloadable)) __spirv_ocl_s_mad_hi(int a, int b, int c);
int2 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(int2 a, int2 b, int2 c);
int3 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(int3 a, int3 b, int3 c);
int4 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(int4 a, int4 b, int4 c);
int8 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(int8 a, int8 b, int8 c);
int16 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(int16 a, int16 b, int16 c);
uint __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint a, uint b, uint c);
uint2 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint2 a, uint2 b, uint2 c);
uint3 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint3 a, uint3 b, uint3 c);
uint4 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint4 a, uint4 b, uint4 c);
uint8 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint8 a, uint8 b, uint8 c);
uint16 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(uint16 a, uint16 b, uint16 c);
long __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long a, long b, long c);
long2 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long2 a, long2 b, long2 c);
long3 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long3 a, long3 b, long3 c);
long4 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long4 a, long4 b, long4 c);
long8 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long8 a, long8 b, long8 c);
long16 __attribute__((overloadable))
    __spirv_ocl_s_mad_hi(long16 a, long16 b, long16 c);
ulong __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ulong a, ulong b, ulong c);
ulong2 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ulong2 a, ulong2 b, ulong2 c);
ulong3 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ulong3 a, ulong3 b, ulong3 c);
ulong4 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ulong4 a, ulong4 b, ulong4 c);
ulong8 __attribute__((overloadable))
    __spirv_ocl_u_mad_hi(ulong8 a, ulong8 b, ulong8 c);
ulong16 __attribute__((overloadable))
...
char2 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(char2 a, char2 b, char2 c);
char3 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(char3 a, char3 b, char3 c);
char4 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(char4 a, char4 b, char4 c);
char8 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(char8 a, char8 b, char8 c);
char16 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(char16 a, char16 b, char16 c);
uchar __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar a, uchar b, uchar c);
uchar2 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar2 a, uchar2 b, uchar2 c);
uchar3 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar3 a, uchar3 b, uchar3 c);
uchar4 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar4 a, uchar4 b, uchar4 c);
uchar8 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar8 a, uchar8 b, uchar8 c);
uchar16 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uchar16 a, uchar16 b, uchar16 c);
short __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(short a, short b, short c);
short2 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(short2 a, short2 b, short2 c);
short3 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(short3 a, short3 b, short3 c);
short4 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(short4 a, short4 b, short4 c);
short8 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(short8 a, short8 b, short8 c);
short16 __attribute__((overloadable)) __spirv_ocl_s_mad_sat(
    short16 a, short16 b, short16 c);
ushort __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ushort a, ushort b, ushort c);
ushort2 __attribute__((overloadable))
...
ushort16 __attribute__((overloadable)) __spirv_ocl_u_mad_sat(
    ushort16 a, ushort16 b, ushort16 c);
int __attribute__((overloadable)) __spirv_ocl_s_mad_sat(int a, int b, int c);
int2 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(int2 a, int2 b, int2 c);
int3 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(int3 a, int3 b, int3 c);
int4 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(int4 a, int4 b, int4 c);
int8 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(int8 a, int8 b, int8 c);
int16 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(int16 a, int16 b, int16 c);
uint __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint a, uint b, uint c);
uint2 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint2 a, uint2 b, uint2 c);
uint3 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint3 a, uint3 b, uint3 c);
uint4 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint4 a, uint4 b, uint4 c);
uint8 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint8 a, uint8 b, uint8 c);
uint16 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(uint16 a, uint16 b, uint16 c);
long __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long a, long b, long c);
long2 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long2 a, long2 b, long2 c);
long3 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long3 a, long3 b, long3 c);
long4 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long4 a, long4 b, long4 c);
long8 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long8 a, long8 b, long8 c);
long16 __attribute__((overloadable))
    __spirv_ocl_s_mad_sat(long16 a, long16 b, long16 c);
ulong __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ulong a, ulong b, ulong c);
ulong2 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ulong2 a, ulong2 b, ulong2 c);
ulong3 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ulong3 a, ulong3 b, ulong3 c);
ulong4 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ulong4 a, ulong4 b, ulong4 c);
ulong8 __attribute__((overloadable))
    __spirv_ocl_u_mad_sat(ulong8 a, ulong8 b, ulong8 c);
ulong16 __attribute__((overloadable)) __spirv_ocl_u_mad_sat(
    ulong16 a, ulong16 b, ulong16 c);

int __attribute__((overloadable)) __spirv_ocl_s_mad24(int x, int y, int z);
int2 __attribute__((overloadable))
    __spirv_ocl_s_mad24(int2 x, int2 y, int2 z);
int3 __attribute__((overloadable))
    __spirv_ocl_s_mad24(int3 x, int3 y, int3 z);
int4 __attribute__((overloadable))
    __spirv_ocl_s_mad24(int4 x, int4 y, int4 z);
int8 __attribute__((overloadable))
    __spirv_ocl_s_mad24(int8 x, int8 y, int8 z);
int16 __attribute__((overloadable))
    __spirv_ocl_s_mad24(int16 x, int16 y, int16 z);
uint
    __attribute__((overloadable)) __spirv_ocl_u_mad24(uint x, uint y, uint z);
uint2 __attribute__((overloadable))
    __spirv_ocl_u_mad24(uint2 x, uint2 y, uint2 z);
uint3 __attribute__((overloadable))
    __spirv_ocl_u_mad24(uint3 x, uint3 y, uint3 z);
uint4 __attribute__((overloadable))
    __spirv_ocl_u_mad24(uint4 x, uint4 y, uint4 z);
uint8 __attribute__((overloadable))
    __spirv_ocl_u_mad24(uint8 x, uint8 y, uint8 z);
uint16 __attribute__((overloadable))
    __spirv_ocl_u_mad24(uint16 x, uint16 y, uint16 z);
...
short16
    __attribute__((overloadable)) __spirv_ocl_s_max(short16 x, short16 y);
...
ushort16
    __attribute__((overloadable)) __spirv_ocl_u_max(ushort16 x, ushort16 y);
...
ulong16
    __attribute__((overloadable)) __spirv_ocl_u_max(ulong16 x, ulong16 y);
...
uchar16
    __attribute__((overloadable)) __spirv_ocl_u_mul_hi(uchar16 x, uchar16 y);
...
short16 __attribute__((overloadable))
    __spirv_ocl_s_mul_hi(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_mul_hi(ushort x, ushort y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_mul_hi(ushort2 x, ushort2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_mul_hi(ushort3 x, ushort3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_mul_hi(ushort4 x, ushort4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_mul_hi(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_mul_hi(ushort16 x, ushort16 y);
...
uint16
    __attribute__((overloadable))  __spirv_ocl_u_mul_hi(uint16 x, uint16 y);
...
long16
    __attribute__((overloadable)) __spirv_ocl_s_mul_hi(long16 x, long16 y);
...
ulong16 __attribute__((overloadable))
    __spirv_ocl_u_mul_hi(ulong16 x, ulong16 y);
...
uint16
    __attribute__((overloadable)) __spirv_ocl_u_mul24(uint16 x, uint16 y);
...
uchar16
    __attribute__((overloadable))   __spirv_ocl_u_rhadd(uchar16 x, uchar16 y);
...
short16
    __attribute__((overloadable)) __spirv_ocl_s_rhadd(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_rhadd(ushort x, ushort y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_rhadd(ushort2 x, ushort2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_rhadd(ushort3 x, ushort3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_rhadd(ushort4 x, ushort4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_rhadd(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_rhadd(ushort16 x, ushort16 y);
...
uint16
    __attribute__((overloadable))   __spirv_ocl_u_rhadd(uint16 x, uint16 y);
...
long16
    __attribute__((overloadable))   __spirv_ocl_s_rhadd(long16 x, long16 y);
...
ulong16
    __attribute__((overloadable)) __spirv_ocl_u_rhadd(ulong16 x, ulong16 y);
...
short16
    __attribute__((overloadable))  __spirv_ocl_rotate(short16 v, short16 i);
...
char16
    __attribute__((overloadable))   __spirv_ocl_s_sub_sat(char16 x, char16 y);
...
uchar16
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(uchar16 x, uchar16 y);
short __attribute__((overloadable)) __spirv_ocl_s_sub_sat(short x, short y);
short2
    __attribute__((overloadable)) __spirv_ocl_s_sub_sat(short2 x, short2 y);
short3
    __attribute__((overloadable)) __spirv_ocl_s_sub_sat(short3 x, short3 y);
short4
    __attribute__((overloadable)) __spirv_ocl_s_sub_sat(short4 x, short4 y);
short8
    __attribute__((overloadable)) __spirv_ocl_s_sub_sat(short8 x, short8 y);
short16 __attribute__((overloadable))
    __spirv_ocl_s_sub_sat(short16 x, short16 y);
ushort __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ushort x, ushort y);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ushort2 x, ushort2 y);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ushort3 x, ushort3 y);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ushort4 x, ushort4 y);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ushort8 x, ushort8 y);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_sub_sat(ushort16 x, ushort16 y);
...
uint16
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(uint16 x, uint16 y);
...
long16
    __attribute__((overloadable)) __spirv_ocl_s_sub_sat(long16 x, long16 y);
ulong __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ulong x, ulong y);
ulong2
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ulong2 x, ulong2 y);
ulong3
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ulong3 x, ulong3 y);
ulong4
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ulong4 x, ulong4 y);
ulong8
    __attribute__((overloadable)) __spirv_ocl_u_sub_sat(ulong8 x, ulong8 y);
ulong16 __attribute__((overloadable))
    __spirv_ocl_u_sub_sat(ulong16 x, ulong16 y);

short __attribute__((overloadable)) __spirv_ocl_s_upsample(char hi, uchar lo);
short2
    __attribute__((overloadable)) __spirv_ocl_s_upsample(char2 hi, uchar2 lo);
short3
    __attribute__((overloadable)) __spirv_ocl_s_upsample(char3 hi, uchar3 lo);
short4
    __attribute__((overloadable)) __spirv_ocl_s_upsample(char4 hi, uchar4 lo);
short8
    __attribute__((overloadable)) __spirv_ocl_s_upsample(char8 hi, uchar8 lo);
short16 __attribute__((overloadable))
    __spirv_ocl_s_upsample(char16 hi, uchar16 lo);
ushort __attribute__((overloadable)) __spirv_ocl_u_upsample(uchar hi, uchar lo);
ushort2
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uchar2 hi, uchar2 lo);
ushort3
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uchar3 hi, uchar3 lo);
ushort4
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uchar4 hi, uchar4 lo);
ushort8
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uchar8 hi, uchar8 lo);
ushort16 __attribute__((overloadable))
    __spirv_ocl_u_upsample(uchar16 hi, uchar16 lo);
int __attribute__((overloadable)) __spirv_ocl_s_upsample(short hi, ushort lo);
int2 __attribute__((overloadable))
    __spirv_ocl_s_upsample(short2 hi, ushort2 lo);
int3 __attribute__((overloadable))
    __spirv_ocl_s_upsample(short3 hi, ushort3 lo);
int4 __attribute__((overloadable))
    __spirv_ocl_s_upsample(short4 hi, ushort4 lo);
int8 __attribute__((overloadable))
    __spirv_ocl_s_upsample(short8 hi, ushort8 lo);
int16 __attribute__((overloadable))
    __spirv_ocl_s_upsample(short16 hi, ushort16 lo);
uint __attribute__((overloadable)) __spirv_ocl_u_upsample(ushort hi, ushort lo);
uint2 __attribute__((overloadable))
    __spirv_ocl_u_upsample(ushort2 hi, ushort2 lo);
uint3 __attribute__((overloadable))
    __spirv_ocl_u_upsample(ushort3 hi, ushort3 lo);
uint4 __attribute__((overloadable))
    __spirv_ocl_u_upsample(ushort4 hi, ushort4 lo);
uint8 __attribute__((overloadable))
    __spirv_ocl_u_upsample(ushort8 hi, ushort8 lo);
uint16 __attribute__((overloadable))
    __spirv_ocl_u_upsample(ushort16 hi, ushort16 lo);
...
long16 __attribute__((overloadable))
    __spirv_ocl_s_upsample(int16 hi, uint16 lo);
ulong __attribute__((overloadable)) __spirv_ocl_u_upsample(uint hi, uint lo);
ulong2
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uint2 hi, uint2 lo);
ulong3
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uint3 hi, uint3 lo);
ulong4
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uint4 hi, uint4 lo);
ulong8
    __attribute__((overloadable)) __spirv_ocl_u_upsample(uint8 hi, uint8 lo);
ulong16 __attribute__((overloadable))
    __spirv_ocl_u_upsample(uint16 hi, uint16 lo);
...
float16
    __attribute__((overloadable)) __spirv_ocl_atan2(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_atan2(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float16
    __attribute__((overloadable)) __spirv_ocl_atan2pi(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_atan2pi(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_atan2pi(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_atan2pi(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_atan2pi(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_atan2pi(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_atan2pi(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16
    __attribute__((overloadable)) __spirv_ocl_atan2pi(half16 x, half16 y);
...
float16 __attribute__((overloadable))
    __spirv_ocl_copysign(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_copysign(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_copysign(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_copysign(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_copysign(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_copysign(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_copysign(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16
    __attribute__((overloadable)) __spirv_ocl_copysign(half16 x, half16 y);
...
float16
    __attribute__((overloadable)) __spirv_ocl_fdim(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_fdim(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float
    __attribute__((overloadable)) __spirv_ocl_fma(float a, float b, float c);
float2 __attribute__((overloadable))
    __spirv_ocl_fma(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_fma(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_fma(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_fma(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable))
    __spirv_ocl_fma(float16 x, float16 y, float16 z);
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_fma(double a, double b, double c);
double2 __attribute__((overloadable))
    __spirv_ocl_fma(double2 x, double2 y, double2 z);
double3 __attribute__((overloadable))
    __spirv_ocl_fma(double3 x, double3 y, double3 z);
double4 __attribute__((overloadable))
    __spirv_ocl_fma(double4 x, double4 y, double4 z);
double8 __attribute__((overloadable))
    __spirv_ocl_fma(double8 x, double8 y, double8 z);
double16 __attribute__((overloadable))
    __spirv_ocl_fma(double16 x, double16 y, double16 z);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable)) __spirv_ocl_fma(half x, half y, half z);
half2 __attribute__((overloadable))
    __spirv_ocl_fma(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_fma(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_fma(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_fma(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_fma(half16 x, half16 y, half16 z);
...
float16
    __attribute__((overloadable))    __spirv_ocl_fmax(float16 x, float16 y);
...
double16
    __attribute__((overloadable)) __spirv_ocl_fmax(double16 x, double16 y);
...
float16
    __attribute__((overloadable)) __spirv_ocl_fmin(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_fmin(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float16
    __attribute__((overloadable)) __spirv_ocl_fmod(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_fmod(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float __attribute__((overloadable))
    __spirv_ocl_fract(float x, __global float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_fract(float2 x, __global float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_fract(float3 x, __global float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_fract(float4 x, __global float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_fract(float8 x, __global float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_fract(float16 x, __global float16* iptr);
float __attribute__((overloadable))
    __spirv_ocl_fract(float x, __private float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_fract(float2 x, __private float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_fract(float3 x, __private float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_fract(float4 x, __private float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_fract(float8 x, __private float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_fract(float16 x, __private float16* iptr);
float __attribute__((overloadable))
    __spirv_ocl_fract(float x, __local float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_fract(float2 x, __local float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_fract(float3 x, __local float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_fract(float4 x, __local float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_fract(float8 x, __local float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_fract(float16 x, __local float16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float __attribute__((overloadable))
    __spirv_ocl_fract(float x, __generic float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_fract(float2 x, __generic float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_fract(float3 x, __generic float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_fract(float4 x, __generic float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_fract(float8 x, __generic float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_fract(float16 x, __generic float16* iptr);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half __attribute__((overloadable))
    __spirv_ocl_fract(half x, __global half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_fract(half2 x, __global half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_fract(half3 x, __global half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_fract(half4 x, __global half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_fract(half8 x, __global half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_fract(half16 x, __global half16* iptr);
half __attribute__((overloadable))
    __spirv_ocl_fract(half x, __private half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_fract(half2 x, __private half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_fract(half3 x, __private half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_fract(half4 x, __private half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_fract(half8 x, __private half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_fract(half16 x, __private half16* iptr);
half
    __attribute__((overloadable)) __spirv_ocl_fract(half x, __local half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_fract(half2 x, __local half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_fract(half3 x, __local half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_fract(half4 x, __local half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_fract(half8 x, __local half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_fract(half16 x, __local half16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half __attribute__((overloadable))
    __spirv_ocl_fract(half x, __generic half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_fract(half2 x, __generic half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_fract(half3 x, __generic half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_fract(half4 x, __generic half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_fract(half8 x, __generic half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_fract(half16 x, __generic half16* iptr);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_fract(double x, __global double* iptr);
double2 __attribute__((overloadable))
...
double __attribute__((overloadable))
    __spirv_ocl_fract(double x, __private double* iptr);
double2 __attribute__((overloadable))
...
double __attribute__((overloadable))
    __spirv_ocl_fract(double x, __local double* iptr);
double2 __attribute__((overloadable))
    __spirv_ocl_fract(double2 x, __local double2* iptr);
double3 __attribute__((overloadable))
    __spirv_ocl_fract(double3 x, __local double3* iptr);
double4 __attribute__((overloadable))
    __spirv_ocl_fract(double4 x, __local double4* iptr);
double8 __attribute__((overloadable))
    __spirv_ocl_fract(double8 x, __local double8* iptr);
double16 __attribute__((overloadable))
    __spirv_ocl_fract(double16 x, __local double16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double __attribute__((overloadable))
    __spirv_ocl_fract(double x, __generic double* iptr);
double2 __attribute__((overloadable))
...
float
    __attribute__((overloadable)) __spirv_ocl_frexp(float x, __global int* exp);
float2 __attribute__((overloadable))
    __spirv_ocl_frexp(float2 x, __global int2* exp);
float3 __attribute__((overloadable))
    __spirv_ocl_frexp(float3 x, __global int3* exp);
float4 __attribute__((overloadable))
    __spirv_ocl_frexp(float4 x, __global int4* exp);
float8 __attribute__((overloadable))
    __spirv_ocl_frexp(float8 x, __global int8* exp);
float16 __attribute__((overloadable))
    __spirv_ocl_frexp(float16 x, __global int16* exp);
float __attribute__((overloadable))
    __spirv_ocl_frexp(float x, __private int* exp);
float2 __attribute__((overloadable))
    __spirv_ocl_frexp(float2 x, __private int2* exp);
float3 __attribute__((overloadable))
    __spirv_ocl_frexp(float3 x, __private int3* exp);
float4 __attribute__((overloadable))
    __spirv_ocl_frexp(float4 x, __private int4* exp);
float8 __attribute__((overloadable))
    __spirv_ocl_frexp(float8 x, __private int8* exp);
float16 __attribute__((overloadable))
    __spirv_ocl_frexp(float16 x, __private int16* exp);
float
    __attribute__((overloadable)) __spirv_ocl_frexp(float x, __local int* exp);
float2 __attribute__((overloadable))
    __spirv_ocl_frexp(float2 x, __local int2* exp);
float3 __attribute__((overloadable))
    __spirv_ocl_frexp(float3 x, __local int3* exp);
float4 __attribute__((overloadable))
    __spirv_ocl_frexp(float4 x, __local int4* exp);
float8 __attribute__((overloadable))
    __spirv_ocl_frexp(float8 x, __local int8* exp);
float16 __attribute__((overloadable))
    __spirv_ocl_frexp(float16 x, __local int16* exp);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float __attribute__((overloadable))
    __spirv_ocl_frexp(float x, __generic int* exp);
float2 __attribute__((overloadable))
    __spirv_ocl_frexp(float2 x, __generic int2* exp);
float3 __attribute__((overloadable))
    __spirv_ocl_frexp(float3 x, __generic int3* exp);
float4 __attribute__((overloadable))
    __spirv_ocl_frexp(float4 x, __generic int4* exp);
float8 __attribute__((overloadable))
    __spirv_ocl_frexp(float8 x, __generic int8* exp);
float16 __attribute__((overloadable))
    __spirv_ocl_frexp(float16 x, __generic int16* exp);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half __attribute__((overloadable)) __spirv_ocl_frexp(half x, __global int* exp);
half2 __attribute__((overloadable))
    __spirv_ocl_frexp(half2 x, __global int2* exp);
half3 __attribute__((overloadable))
    __spirv_ocl_frexp(half3 x, __global int3* exp);
half4 __attribute__((overloadable))
    __spirv_ocl_frexp(half4 x, __global int4* exp);
half8 __attribute__((overloadable))
    __spirv_ocl_frexp(half8 x, __global int8* exp);
half16 __attribute__((overloadable))
    __spirv_ocl_frexp(half16 x, __global int16* exp);
half
    __attribute__((overloadable)) __spirv_ocl_frexp(half x, __private int* exp);
half2 __attribute__((overloadable))
    __spirv_ocl_frexp(half2 x, __private int2* exp);
half3 __attribute__((overloadable))
    __spirv_ocl_frexp(half3 x, __private int3* exp);
half4 __attribute__((overloadable))
    __spirv_ocl_frexp(half4 x, __private int4* exp);
half8 __attribute__((overloadable))
    __spirv_ocl_frexp(half8 x, __private int8* exp);
half16 __attribute__((overloadable))
    __spirv_ocl_frexp(half16 x, __private int16* exp);
half __attribute__((overloadable)) __spirv_ocl_frexp(half x, __local int* exp);
half2 __attribute__((overloadable))
    __spirv_ocl_frexp(half2 x, __local int2* exp);
half3 __attribute__((overloadable))
    __spirv_ocl_frexp(half3 x, __local int3* exp);
half4 __attribute__((overloadable))
    __spirv_ocl_frexp(half4 x, __local int4* exp);
half8 __attribute__((overloadable))
    __spirv_ocl_frexp(half8 x, __local int8* exp);
half16 __attribute__((overloadable))
    __spirv_ocl_frexp(half16 x, __local int16* exp);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half
    __attribute__((overloadable)) __spirv_ocl_frexp(half x, __generic int* exp);
half2 __attribute__((overloadable))
    __spirv_ocl_frexp(half2 x, __generic int2* exp);
half3 __attribute__((overloadable))
    __spirv_ocl_frexp(half3 x, __generic int3* exp);
half4 __attribute__((overloadable))
    __spirv_ocl_frexp(half4 x, __generic int4* exp);
half8 __attribute__((overloadable))
    __spirv_ocl_frexp(half8 x, __generic int8* exp);
half16 __attribute__((overloadable))
    __spirv_ocl_frexp(half16 x, __generic int16* exp);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_frexp(double x, __global int* exp);
double2 __attribute__((overloadable))
    __spirv_ocl_frexp(double2 x, __global int2* exp);
double3 __attribute__((overloadable))
    __spirv_ocl_frexp(double3 x, __global int3* exp);
double4 __attribute__((overloadable))
    __spirv_ocl_frexp(double4 x, __global int4* exp);
double8 __attribute__((overloadable))
    __spirv_ocl_frexp(double8 x, __global int8* exp);
double16 __attribute__((overloadable))
    __spirv_ocl_frexp(double16 x, __global int16* exp);
double __attribute__((overloadable))
    __spirv_ocl_frexp(double x, __private int* exp);
double2 __attribute__((overloadable))
    __spirv_ocl_frexp(double2 x, __private int2* exp);
double3 __attribute__((overloadable))
    __spirv_ocl_frexp(double3 x, __private int3* exp);
double4 __attribute__((overloadable))
    __spirv_ocl_frexp(double4 x, __private int4* exp);
double8 __attribute__((overloadable))
    __spirv_ocl_frexp(double8 x, __private int8* exp);
double16 __attribute__((overloadable))
    __spirv_ocl_frexp(double16 x, __private int16* exp);
double
    __attribute__((overloadable)) __spirv_ocl_frexp(double x, __local int* exp);
double2 __attribute__((overloadable))
    __spirv_ocl_frexp(double2 x, __local int2* exp);
double3 __attribute__((overloadable))
    __spirv_ocl_frexp(double3 x, __local int3* exp);
double4 __attribute__((overloadable))
    __spirv_ocl_frexp(double4 x, __local int4* exp);
double8 __attribute__((overloadable))
    __spirv_ocl_frexp(double8 x, __local int8* exp);
double16 __attribute__((overloadable))
    __spirv_ocl_frexp(double16 x, __local int16* exp);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double __attribute__((overloadable))
    __spirv_ocl_frexp(double x, __generic int* exp);
double2 __attribute__((overloadable))
    __spirv_ocl_frexp(double2 x, __generic int2* exp);
double3 __attribute__((overloadable))
    __spirv_ocl_frexp(double3 x, __generic int3* exp);
double4 __attribute__((overloadable))
    __spirv_ocl_frexp(double4 x, __generic int4* exp);
double8 __attribute__((overloadable))
    __spirv_ocl_frexp(double8 x, __generic int8* exp);
double16 __attribute__((overloadable))
...
float16
    __attribute__((overloadable)) __spirv_ocl_hypot(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_hypot(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_ldexp(double16 x, int16 y);
#endif // defined(cl_khr_fp64)
...
float __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float x, __global int* signp);
float2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float2 x, __global int2* signp);
float3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float3 x, __global int3* signp);
float4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float4 x, __global int4* signp);
float8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float8 x, __global int8* signp);
float16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float16 x, __global int16* signp);
float __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float x, __local int* signp);
float2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float2 x, __local int2* signp);
float3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float3 x, __local int3* signp);
float4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float4 x, __local int4* signp);
float8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float8 x, __local int8* signp);
float16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float16 x, __local int16* signp);
float __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float x, __private int* signp);
float2 __attribute__((overloadable))
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float __attribute__((overloadable))
    __spirv_ocl_lgamma_r(float x, __generic int* signp);
float2 __attribute__((overloadable))
...
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half x, __global int* signp);
half2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half2 x, __global int2* signp);
half3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half3 x, __global int3* signp);
half4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half4 x, __global int4* signp);
half8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half8 x, __global int8* signp);
half16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half16 x, __global int16* signp);
half __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half x, __private int* signp);
half2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half2 x, __private int2* signp);
half3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half3 x, __private int3* signp);
half4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half4 x, __private int4* signp);
half8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half8 x, __private int8* signp);
half16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half16 x, __private int16* signp);
half __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half x, __local int* signp);
half2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half2 x, __local int2* signp);
half3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half3 x, __local int3* signp);
half4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half4 x, __local int4* signp);
half8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half8 x, __local int8* signp);
half16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half16 x, __local int16* signp);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half x, __generic int* signp);
half2 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half2 x, __generic int2* signp);
half3 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half3 x, __generic int3* signp);
half4 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half4 x, __generic int4* signp);
half8 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half8 x, __generic int8* signp);
half16 __attribute__((overloadable))
    __spirv_ocl_lgamma_r(half16 x, __generic int16* signp);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_lgamma_r(double x, __global int* signp);
double2 __attribute__((overloadable))
...
double __attribute__((overloadable))
    __spirv_ocl_lgamma_r(double x, __private int* signp);
double2 __attribute__((overloadable))
...
double __attribute__((overloadable))
    __spirv_ocl_lgamma_r(double x, __local int* signp);
double2 __attribute__((overloadable))
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double __attribute__((overloadable))
    __spirv_ocl_lgamma_r(double x, __generic int* signp);
double2 __attribute__((overloadable))
...
float
    __attribute__((overloadable)) __spirv_ocl_mad(float a, float b, float c);
float2 __attribute__((overloadable))
    __spirv_ocl_mad(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_mad(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_mad(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_mad(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable))
    __spirv_ocl_mad(float16 x, float16 y, float16 z);
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_mad(double a, double b, double c);
double2 __attribute__((overloadable))
    __spirv_ocl_mad(double2 x, double2 y, double2 z);
double3 __attribute__((overloadable))
    __spirv_ocl_mad(double3 x, double3 y, double3 z);
double4 __attribute__((overloadable))
    __spirv_ocl_mad(double4 x, double4 y, double4 z);
double8 __attribute__((overloadable))
    __spirv_ocl_mad(double8 x, double8 y, double8 z);
double16 __attribute__((overloadable))
    __spirv_ocl_mad(double16 x, double16 y, double16 z);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable)) __spirv_ocl_mad(half x, half y, half z);
half2 __attribute__((overloadable))
    __spirv_ocl_mad(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_mad(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_mad(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_mad(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_mad(half16 x, half16 y, half16 z);
...
float16
    __attribute__((overloadable)) __spirv_ocl_maxmag(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_maxmag(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_maxmag(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_maxmag(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_maxmag(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_maxmag(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_maxmag(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float16
    __attribute__((overloadable)) __spirv_ocl_minmag(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_minmag(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_minmag(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_minmag(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_minmag(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_minmag(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_minmag(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float __attribute__((overloadable))
    __spirv_ocl_modf(float x, __global float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_modf(float2 x, __global float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_modf(float3 x, __global float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_modf(float4 x, __global float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_modf(float8 x, __global float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_modf(float16 x, __global float16* iptr);
float __attribute__((overloadable))
    __spirv_ocl_modf(float x, __private float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_modf(float2 x, __private float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_modf(float3 x, __private float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_modf(float4 x, __private float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_modf(float8 x, __private float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_modf(float16 x, __private float16* iptr);
float __attribute__((overloadable))
    __spirv_ocl_modf(float x, __local float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_modf(float2 x, __local float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_modf(float3 x, __local float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_modf(float4 x, __local float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_modf(float8 x, __local float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_modf(float16 x, __local float16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float __attribute__((overloadable))
    __spirv_ocl_modf(float x, __generic float* iptr);
float2 __attribute__((overloadable))
    __spirv_ocl_modf(float2 x, __generic float2* iptr);
float3 __attribute__((overloadable))
    __spirv_ocl_modf(float3 x, __generic float3* iptr);
float4 __attribute__((overloadable))
    __spirv_ocl_modf(float4 x, __generic float4* iptr);
float8 __attribute__((overloadable))
    __spirv_ocl_modf(float8 x, __generic float8* iptr);
float16 __attribute__((overloadable))
    __spirv_ocl_modf(float16 x, __generic float16* iptr);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half
    __attribute__((overloadable)) __spirv_ocl_modf(half x, __global half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_modf(half2 x, __global half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_modf(half3 x, __global half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_modf(half4 x, __global half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_modf(half8 x, __global half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_modf(half16 x, __global half16* iptr);
half __attribute__((overloadable))
    __spirv_ocl_modf(half x, __private half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_modf(half2 x, __private half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_modf(half3 x, __private half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_modf(half4 x, __private half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_modf(half8 x, __private half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_modf(half16 x, __private half16* iptr);
half __attribute__((overloadable)) __spirv_ocl_modf(half x, __local half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_modf(half2 x, __local half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_modf(half3 x, __local half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_modf(half4 x, __local half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_modf(half8 x, __local half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_modf(half16 x, __local half16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half __attribute__((overloadable))
    __spirv_ocl_modf(half x, __generic half* iptr);
half2 __attribute__((overloadable))
    __spirv_ocl_modf(half2 x, __generic half2* iptr);
half3 __attribute__((overloadable))
    __spirv_ocl_modf(half3 x, __generic half3* iptr);
half4 __attribute__((overloadable))
    __spirv_ocl_modf(half4 x, __generic half4* iptr);
half8 __attribute__((overloadable))
    __spirv_ocl_modf(half8 x, __generic half8* iptr);
half16 __attribute__((overloadable))
    __spirv_ocl_modf(half16 x, __generic half16* iptr);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_modf(double x, __global double* iptr);
double2 __attribute__((overloadable))
    __spirv_ocl_modf(double2 x, __global double2* iptr);
double3 __attribute__((overloadable))
    __spirv_ocl_modf(double3 x, __global double3* iptr);
double4 __attribute__((overloadable))
    __spirv_ocl_modf(double4 x, __global double4* iptr);
double8 __attribute__((overloadable))
    __spirv_ocl_modf(double8 x, __global double8* iptr);
double16 __attribute__((overloadable))
    __spirv_ocl_modf(double16 x, __global double16* iptr);
double __attribute__((overloadable))
    __spirv_ocl_modf(double x, __private double* iptr);
double2 __attribute__((overloadable))
...
double __attribute__((overloadable))
    __spirv_ocl_modf(double x, __local double* iptr);
double2 __attribute__((overloadable))
    __spirv_ocl_modf(double2 x, __local double2* iptr);
double3 __attribute__((overloadable))
    __spirv_ocl_modf(double3 x, __local double3* iptr);
double4 __attribute__((overloadable))
    __spirv_ocl_modf(double4 x, __local double4* iptr);
double8 __attribute__((overloadable))
    __spirv_ocl_modf(double8 x, __local double8* iptr);
double16 __attribute__((overloadable))
    __spirv_ocl_modf(double16 x, __local double16* iptr);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double __attribute__((overloadable))
    __spirv_ocl_modf(double x, __generic double* iptr);
double2 __attribute__((overloadable))
...
float2
    __attribute__((overloadable)) __spirv_ocl_nextafter(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_nextafter(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_nextafter(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_nextafter(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_nextafter(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_nextafter(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_nextafter(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_nextafter(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_nextafter(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_nextafter(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_nextafter(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16
    __attribute__((overloadable)) __spirv_ocl_nextafter(half16 x, half16 y);
...
double16
    __attribute__((overloadable)) __spirv_ocl_pow(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_pown(double16 x, int16 y);
#endif // defined(cl_khr_fp64)
...
float16
    __attribute__((overloadable)) __spirv_ocl_powr(float16 x, float16 y);
#if defined(cl_khr_fp64)
...
double16
    __attribute__((overloadable)) __spirv_ocl_powr(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
float2
    __attribute__((overloadable)) __spirv_ocl_remainder(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_remainder(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_remainder(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_remainder(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_remainder(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_remainder(double x, double y);
double2
    __attribute__((overloadable)) __spirv_ocl_remainder(double2 x, double2 y);
double3
    __attribute__((overloadable)) __spirv_ocl_remainder(double3 x, double3 y);
double4
    __attribute__((overloadable)) __spirv_ocl_remainder(double4 x, double4 y);
double8
    __attribute__((overloadable)) __spirv_ocl_remainder(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_remainder(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16
    __attribute__((overloadable)) __spirv_ocl_remainder(half16 x, half16 y);

float __attribute__((overloadable))
    __spirv_ocl_remquo(float xx, float yy, __global int* quo);
float2 __attribute__((overloadable)) __spirv_ocl_remquo(
    float2 xx, float2 yy, __global int2* quo);
float3 __attribute__((overloadable)) __spirv_ocl_remquo(
    float3 xx, float3 yy, __global int3* quo);
float4 __attribute__((overloadable)) __spirv_ocl_remquo(
    float4 xx, float4 yy, __global int4* quo);
float8 __attribute__((overloadable)) __spirv_ocl_remquo(
    float8 xx, float8 yy, __global int8* quo);
float16 __attribute__((overloadable)) __spirv_ocl_remquo(
...
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half __attribute__((overloadable))
    __spirv_ocl_remquo(half xx, half yy, __global int* quo);
half2 __attribute__((overloadable)) __spirv_ocl_remquo(
    half2 xx, half2 yy, __global int2* quo);
half3 __attribute__((overloadable)) __spirv_ocl_remquo(
    half3 xx, half3 yy, __global int3* quo);
half4 __attribute__((overloadable)) __spirv_ocl_remquo(
    half4 xx, half4 yy, __global int4* quo);
half8 __attribute__((overloadable)) __spirv_ocl_remquo(
    half8 xx, half8 yy, __global int8* quo);
half16 __attribute__((overloadable)) __spirv_ocl_remquo(
...
half __attribute__((overloadable))
    __spirv_ocl_remquo(half xx, half yy, __local int* quo);
half2 __attribute__((overloadable)) __spirv_ocl_remquo(
...
double2 __attribute__((overloadable)) __spirv_ocl_remquo(
    double2 xx, double2 yy, __global int2* quo);
double3 __attribute__((overloadable)) __spirv_ocl_remquo(
    double3 xx, double3 yy, __global int3* quo);
double4 __attribute__((overloadable)) __spirv_ocl_remquo(
    double4 xx, double4 yy, __global int4* quo);
double8 __attribute__((overloadable)) __spirv_ocl_remquo(
    double8 xx, double8 yy, __global int8* quo);
double16 __attribute__((overloadable)) __spirv_ocl_remquo(
...
double16
    __attribute__((overloadable)) __spirv_ocl_rootn(double16 x, int16 y);
#endif // defined(cl_khr_fp64)
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
float __attribute__((overloadable))
    __spirv_ocl_sincos(float x, __generic float* cosval);
float2 __attribute__((overloadable))
...
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
half __attribute__((overloadable))
    __spirv_ocl_sincos(half x, __private half* cosval);
half __attribute__((overloadable))
    __spirv_ocl_sincos(half x, __global half* cosval);
half __attribute__((overloadable))
    __spirv_ocl_sincos(half x, __local half* cosval);
half2 __attribute__((overloadable))
    __spirv_ocl_sincos(half2 x, __private half2* cosval);
half2 __attribute__((overloadable))
    __spirv_ocl_sincos(half2 x, __global half2* cosval);
half2 __attribute__((overloadable))
    __spirv_ocl_sincos(half2 x, __local half2* cosval);
half3 __attribute__((overloadable))
    __spirv_ocl_sincos(half3 x, __private half3* cosval);
half3 __attribute__((overloadable))
    __spirv_ocl_sincos(half3 x, __global half3* cosval);
half3 __attribute__((overloadable))
    __spirv_ocl_sincos(half3 x, __local half3* cosval);
half4 __attribute__((overloadable))
    __spirv_ocl_sincos(half4 x, __private half4* cosval);
half4 __attribute__((overloadable))
    __spirv_ocl_sincos(half4 x, __global half4* cosval);
half4 __attribute__((overloadable))
    __spirv_ocl_sincos(half4 x, __local half4* cosval);
half8 __attribute__((overloadable))
    __spirv_ocl_sincos(half8 x, __private half8* cosval);
half8 __attribute__((overloadable))
    __spirv_ocl_sincos(half8 x, __global half8* cosval);
half8 __attribute__((overloadable))
    __spirv_ocl_sincos(half8 x, __local half8* cosval);
half16 __attribute__((overloadable))
    __spirv_ocl_sincos(half16 x, __private half16* cosval);
half16 __attribute__((overloadable))
    __spirv_ocl_sincos(half16 x, __global half16* cosval);
half16 __attribute__((overloadable))
    __spirv_ocl_sincos(half16 x, __local half16* cosval);
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
half __attribute__((overloadable))
    __spirv_ocl_sincos(half x, __generic half* cosval);
half2 __attribute__((overloadable))
    __spirv_ocl_sincos(half2 x, __generic half2* cosval);
half3 __attribute__((overloadable))
    __spirv_ocl_sincos(half3 x, __generic half3* cosval);
half4 __attribute__((overloadable))
    __spirv_ocl_sincos(half4 x, __generic half4* cosval);
half8 __attribute__((overloadable))
    __spirv_ocl_sincos(half8 x, __generic half8* cosval);
half16 __attribute__((overloadable))
    __spirv_ocl_sincos(half16 x, __generic half16* cosval);
#endif // __OPENCL_C_VERSION__ >= CL_VERSION_2_0
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_sincos(double x, __private double* cosval);
double __attribute__((overloadable))
    __spirv_ocl_sincos(double x, __local double* cosval);
double __attribute__((overloadable))
...
#if (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
double __attribute__((overloadable))
    __spirv_ocl_sincos(double x, __generic double* cosval);
double2 __attribute__((overloadable))
...
float2 __attribute__((overloadable))
    __spirv_ocl_native_divide(float2 x, float2 y);
float3 __attribute__((overloadable))
    __spirv_ocl_native_divide(float3 x, float3 y);
float4 __attribute__((overloadable))
    __spirv_ocl_native_divide(float4 x, float4 y);
float8 __attribute__((overloadable))
    __spirv_ocl_native_divide(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_native_divide(float16 x, float16 y);
#if defined(cl_khr_fp64)
double
    __attribute__((overloadable)) __spirv_ocl_native_divide(double x, double y);
double2 __attribute__((overloadable))
    __spirv_ocl_native_divide(double2 x, double2 y);
double3 __attribute__((overloadable))
    __spirv_ocl_native_divide(double3 x, double3 y);
double4 __attribute__((overloadable))
    __spirv_ocl_native_divide(double4 x, double4 y);
double8 __attribute__((overloadable))
    __spirv_ocl_native_divide(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_native_divide(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable)) __spirv_ocl_native_divide(half x, half y);
half2
    __attribute__((overloadable)) __spirv_ocl_native_divide(half2 x, half2 y);
half3
    __attribute__((overloadable)) __spirv_ocl_native_divide(half3 x, half3 y);
half4
    __attribute__((overloadable)) __spirv_ocl_native_divide(half4 x, half4 y);
half8
    __attribute__((overloadable)) __spirv_ocl_native_divide(half8 x, half8 y);
half16 __attribute__((overloadable))
    __spirv_ocl_native_divide(half16 x, half16 y);
...
float2
    __attribute__((overloadable)) __spirv_ocl_native_powr(float2 x, float2 y);
float3
    __attribute__((overloadable)) __spirv_ocl_native_powr(float3 x, float3 y);
float4
    __attribute__((overloadable)) __spirv_ocl_native_powr(float4 x, float4 y);
float8
    __attribute__((overloadable)) __spirv_ocl_native_powr(float8 x, float8 y);
float16 __attribute__((overloadable))
    __spirv_ocl_native_powr(float16 x, float16 y);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) __spirv_ocl_native_powr(double x, double y);
double2 __attribute__((overloadable))
    __spirv_ocl_native_powr(double2 x, double2 y);
double3 __attribute__((overloadable))
    __spirv_ocl_native_powr(double3 x, double3 y);
double4 __attribute__((overloadable))
    __spirv_ocl_native_powr(double4 x, double4 y);
double8 __attribute__((overloadable))
    __spirv_ocl_native_powr(double8 x, double8 y);
double16 __attribute__((overloadable))
    __spirv_ocl_native_powr(double16 x, double16 y);
#endif // defined(cl_khr_fp64)
...
half16 __attribute__((overloadable))
    __spirv_ocl_native_powr(half16 x, half16 y);
...
char2 __attribute__((overloadable))
    __spirv_ocl_bitselect(char2 x, char2 y, char2 z);
char3 __attribute__((overloadable))
    __spirv_ocl_bitselect(char3 x, char3 y, char3 z);
char4 __attribute__((overloadable))
    __spirv_ocl_bitselect(char4 x, char4 y, char4 z);
char8 __attribute__((overloadable))
    __spirv_ocl_bitselect(char8 x, char8 y, char8 z);
char16 __attribute__((overloadable))
    __spirv_ocl_bitselect(char16 x, char16 y, char16 z);
short __attribute__((overloadable))
    __spirv_ocl_bitselect(short a, short b, short c);
short2 __attribute__((overloadable))
    __spirv_ocl_bitselect(short2 x, short2 y, short2 z);
short3 __attribute__((overloadable))
    __spirv_ocl_bitselect(short3 x, short3 y, short3 z);
short4 __attribute__((overloadable))
    __spirv_ocl_bitselect(short4 x, short4 y, short4 z);
short8 __attribute__((overloadable))
    __spirv_ocl_bitselect(short8 x, short8 y, short8 z);
short16 __attribute__((overloadable)) __spirv_ocl_bitselect(
    short16 x, short16 y, short16 z);
int __attribute__((overloadable)) __spirv_ocl_bitselect(int a, int b, int c);
int2 __attribute__((overloadable))
    __spirv_ocl_bitselect(int2 x, int2 y, int2 z);
int3 __attribute__((overloadable))
    __spirv_ocl_bitselect(int3 x, int3 y, int3 z);
int4 __attribute__((overloadable))
    __spirv_ocl_bitselect(int4 x, int4 y, int4 z);
int8 __attribute__((overloadable))
    __spirv_ocl_bitselect(int8 x, int8 y, int8 z);
int16 __attribute__((overloadable))
    __spirv_ocl_bitselect(int16 x, int16 y, int16 z);
long __attribute__((overloadable))
    __spirv_ocl_bitselect(long a, long b, long c);
long2 __attribute__((overloadable))
    __spirv_ocl_bitselect(long2 x, long2 y, long2 z);
long3 __attribute__((overloadable))
    __spirv_ocl_bitselect(long3 x, long3 y, long3 z);
long4 __attribute__((overloadable))
    __spirv_ocl_bitselect(long4 x, long4 y, long4 z);
long8 __attribute__((overloadable))
    __spirv_ocl_bitselect(long8 x, long8 y, long8 z);
long16 __attribute__((overloadable))
    __spirv_ocl_bitselect(long16 x, long16 y, long16 z);
float __attribute__((overloadable))
    __spirv_ocl_bitselect(float a, float b, float c);
float2 __attribute__((overloadable))
    __spirv_ocl_bitselect(float2 x, float2 y, float2 z);
float3 __attribute__((overloadable))
    __spirv_ocl_bitselect(float3 x, float3 y, float3 z);
float4 __attribute__((overloadable))
    __spirv_ocl_bitselect(float4 x, float4 y, float4 z);
float8 __attribute__((overloadable))
    __spirv_ocl_bitselect(float8 x, float8 y, float8 z);
float16 __attribute__((overloadable)) __spirv_ocl_bitselect(
    float16 x, float16 y, float16 z);
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_bitselect(double a, double b, double c);
double2 __attribute__((overloadable))
...
double16 __attribute__((overloadable)) __spirv_ocl_bitselect(
    double16 x, double16 y, double16 z);
#endif // defined(cl_khr_fp64)
half __attribute__((overloadable))
    __spirv_ocl_bitselect(half a, half b, half c);
half2 __attribute__((overloadable))
    __spirv_ocl_bitselect(half2 x, half2 y, half2 z);
half3 __attribute__((overloadable))
    __spirv_ocl_bitselect(half3 x, half3 y, half3 z);
half4 __attribute__((overloadable))
    __spirv_ocl_bitselect(half4 x, half4 y, half4 z);
half8 __attribute__((overloadable))
    __spirv_ocl_bitselect(half8 x, half8 y, half8 z);
half16 __attribute__((overloadable))
    __spirv_ocl_bitselect(half16 x, half16 y, half16 z);

char __attribute__((overloadable)) __spirv_ocl_select(char a, char b, char c);
short __attribute__((overloadable))
    __spirv_ocl_select(short a, short b, short c);
...
float
    __attribute__((overloadable)) __spirv_ocl_select(float a, float b, int c);
float2 __attribute__((overloadable))
    __spirv_ocl_select(float2 a, float2 b, int2 c);
float3 __attribute__((overloadable))
    __spirv_ocl_select(float3 a, float3 b, int3 c);
float4 __attribute__((overloadable))
    __spirv_ocl_select(float4 a, float4 b, int4 c);
float8 __attribute__((overloadable))
    __spirv_ocl_select(float8 a, float8 b, int8 c);
float16 __attribute__((overloadable))
    __spirv_ocl_select(float16 a, float16 b, int16 c);

#if defined(cl_khr_fp64)
double __attribute__((overloadable))
    __spirv_ocl_select(double a, double b, long c);
double2 __attribute__((overloadable))
    __spirv_ocl_select(double2 a, double2 b, long2 c);
double3 __attribute__((overloadable))
    __spirv_ocl_select(double3 a, double3 b, long3 c);
double4 __attribute__((overloadable))
    __spirv_ocl_select(double4 a, double4 b, long4 c);
double8 __attribute__((overloadable))
    __spirv_ocl_select(double8 a, double8 b, long8 c);
double16 __attribute__((overloadable))
...
#if defined(cl_khr_fp16)
half
    __attribute__((overloadable)) __spirv_ocl_select(half a, half b, short c);
half2 __attribute__((overloadable))
    __spirv_ocl_select(half2 a, half2 b, short2 c);
half3 __attribute__((overloadable))
    __spirv_ocl_select(half3 a, half3 b, short3 c);
half4 __attribute__((overloadable))
    __spirv_ocl_select(half4 a, half4 b, short4 c);
half8 __attribute__((overloadable))
    __spirv_ocl_select(half8 a, half8 b, short8 c);
half16 __attribute__((overloadable))
    __spirv_ocl_select(half16 a, half16 b, short16 c);
