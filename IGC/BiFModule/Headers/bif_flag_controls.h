...
BIF_FLAG_CONTROL(bool, UseNativeBF16Conversion)
...
BIF_FLAG_CONTROL(bool, HasHWTileIDRegister)
BIF_FLAG_CONTROL(bool, HasWideMulMad)
BIF_FLAG_CONTROL(bool, HasNativeTanh)
BIF_FLAG_CONTROL(bool, HasNativeSigm)
BIF_FLAG_CONTROL(bool, UseNativeFP32LocalAtomicAdd)
BIF_FLAG_CONTROL(bool, HasEfficient64bEnabled)
BIF_FLAG_CONTROL(bool, HasNativeSinCos)
BIF_FLAG_CONTROL(bool, HasAccurateLog2)
BIF_FLAG_CONTROL(bool, SupportsRayTracingExtendedCacheControl)
