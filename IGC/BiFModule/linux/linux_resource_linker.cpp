...
int main(int argc, char **argv)
{
    ...
    if (!argv[1] || !strcmp(argv[1], "-h") || !strcmp(argv[1], "--help") || !argv[2] ||
        !argv[3])
    {
    ...
    fprintf(
        output,
        "unsigned char __attribute__((visibility(\"default\"))) %s[] =\n{\n    ",
        argv[3]);
    ...
    fprintf(
        output,
        "unsigned int __attribute__((visibility(\"default\"))) %s_size = %d;\n\n",
        argv[3],
        count);
    fclose(input);
    fclose(output);
