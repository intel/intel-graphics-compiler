    ...
    const Twine &FrameName)
{
    ...
    return IRB.CreateInBoundsGEP(Ty, Ptr, Indices, VALUE_NAME("&ReturnIP"));
}
    ...
    const Twine &FrameName)
{
    ...
    return IRB.CreateInBoundsGEP(Ty, Ptr, Indices, VALUE_NAME("&Payload"));
}
    ...
    const Twine &FrameName)
{
    ...
    return IRB.CreateInBoundsGEP(Ty, Ptr, Indices, VALUE_NAME("&PayloadPad"));
}
    ...
    Type *CustomHitAttrTy)
{
    ...
    return IRB.CreateInBoundsGEP(Ty, Ptr, Indices, VALUE_NAME("&CustomHitAttr"));
}
    ...
    IRBuilder<>& IRB, RTBuilder::SWStackPtrVal* FrameAddr)
{
    ...
    return IRB.CreateInBoundsGEP(Ty, Ptr, Indices, VALUE_NAME("&HitKind"));
}
