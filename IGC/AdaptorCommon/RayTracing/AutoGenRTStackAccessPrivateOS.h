...
void _copyMemHitInProceed_deprecated_Xe(Value* arg_0, Value* arg_1, Value* arg_2)
{
  auto* BB_3 = GetInsertBlock();
  auto* _CurIP = &*GetInsertPoint();
  auto *_JoinBB = BB_3->splitBasicBlock(_CurIP, VALUE_NAME("_copyMemHitInProceed_deprecated_Xe.join"));
  BB_3->getTerminator()->eraseFromParent();
  auto* BB_4 = BasicBlock::Create(*Ctx.getLLVMContext(), VALUE_NAME("_copyMemHitInProceed_deprecated_Xe."), _JoinBB->getParent(), _JoinBB);
  auto* BB_5 = BasicBlock::Create(*Ctx.getLLVMContext(), VALUE_NAME("_copyMemHitInProceed_deprecated_Xe."), _JoinBB->getParent(), _JoinBB);
  auto* BB_6 = BasicBlock::Create(*Ctx.getLLVMContext(), VALUE_NAME("_copyMemHitInProceed_deprecated_Xe."), _JoinBB->getParent(), _JoinBB);
  SetInsertPoint(BB_3);
  CreateCondBr(arg_2, BB_4, BB_5);
  SetInsertPoint(BB_4);
