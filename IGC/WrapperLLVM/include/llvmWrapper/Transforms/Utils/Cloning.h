...
enum CloneFunctionChangeType { LocalChangesOnly, GlobalChanges, DifferentModule, ClonedModule };
inline void CloneFunctionInto(llvm::Function *NewFunc, const llvm::Function *OldFunc, llvm::ValueToValueMapTy &VMap,
                              IGCLLVM::CloneFunctionChangeType Changes,
  ...
  llvm::CloneFunctionInto(NewFunc, OldFunc, VMap, ModuleLevelChanges, Returns, NameSuffix, CodeInfo, TypeMapper,
                          Materializer);
}
#else
