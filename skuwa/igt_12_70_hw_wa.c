...
void InitGt_12_70HwWaTable(PWA_TABLE pWaTable, PSKU_FEATURE_TABLE pSkuTable, PWA_INIT_PARAM pWaParam)
{
        int iStepId_GT_12_70 = (int)pWaParam->usRenderRevID;
        (void)iStepId_GT_12_70;
