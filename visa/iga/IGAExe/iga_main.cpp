...
extern "C" int iga_main(int argc, const char **argv) {
  ...
  opts::CmdlineSpec<Opts> cmdline(
      title.c_str(), opts::exeName(argv[0]),
      ...
      "similar to above, but the mode and platform are inferred by the "
      "extension\n"
      "(.asm* => -a) and (.*9 => -p=9)\n"
  ...
  cmdline.defineFlag("n", "numeric-labels", "use numeric labels",
                     "labels will be in bytes relative to the IP pre-increment "
                     "(even for jmpi and on HSW)",
                     opts::OptAttrs::ALLOW_UNSET,
                     [](const char *, const opts::ErrorHandler &,
                        Opts &baseOpts) { baseOpts.numericLabels = true; });
  cmdline.defineFlag("q", "quiet", "lower verbosity output",
                     "This is the same as -v=-1", opts::OptAttrs::ALLOW_UNSET,
                     [](const char *, const opts::ErrorHandler &,
                        Opts &baseOpts) { baseOpts.verbosity = -1; });
  cmdline.defineOpt(
      "v", "verbosity", "INT", "Sets the verbosity level",
  ...
  try {
    ...
    for (const auto &pi : platforms) {
      ss << "  - " << std::setw(5) << std::left << pi.suffix << " for ";
      if (pi.names.empty())
    ...
    std::stringstream ss;
    ss << err.api << ": " << iga_status_to_string(err.status)
  ...
  cmdline.defineOpt(
      "p", "platform", "PLATFORM", "specifies the platform (e.g. \"GEN9\")",
      platformExtendedDescription.c_str(), opts::OptAttrs::ALLOW_UNSET,
      [&](const char *cinp, const opts::ErrorHandler &eh, Opts &baseOpts) {
  ...
  cmdline.defineOpt(
      ...
      opts::OptAttrs::ALLOW_UNSET, baseOpts.outputFile);

  cmdline.defineFlag(nullptr, "output-on-fail",
                     "write the disassembling result to output on fail",
                     "This option is effecitve only on disassembling mode",
                     opts::OptAttrs::ALLOW_UNSET,
                     [](const char *, const opts::ErrorHandler &,
                        Opts &baseOpts) { baseOpts.outputOnFail = true; });
  ...
  wGrp.defineFlag("none", nullptr, "disables all warnings", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.enabledWarnings = IGA_WARNINGS_NONE;
                  });
  wGrp.defineFlag("all", nullptr, "enables all warnings", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.enabledWarnings = IGA_WARNINGS_ALL;
                  });
  wGrp.defineFlag("default", nullptr, "uses default warnings", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.enabledWarnings = IGA_WARNINGS_DEFAULT;
                  });
  wGrp.defineFlag("normal-form", nullptr,
  ...
  wGrp.defineFlag("regions", nullptr, "enables warnings on invalid regions",
                  nullptr, opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.enabledWarnings |= IGA_WARNINGS_REGIONS;
                  });
  wGrp.defineFlag("types", nullptr,
                  "enables warnings on invalid operand type combinations",
                  nullptr, opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.enabledWarnings |= IGA_WARNINGS_TYPES;
                  });
  wGrp.defineFlag("scheduling", nullptr,
  ...
  xGrp.defineFlag(
      "no-ir-checking", nullptr, "disables the IR checking on assembly",
      nullptr, opts::OptAttrs::ALLOW_UNSET,
      [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
        baseOpts.enabledWarnings = IGA_WARNINGS_NONE;
        std::cerr << "-Xdisable-ir-checking is deprecated; use -W* options\n";
      });
  xGrp.defineFlag(
      "auto-deps", nullptr,
  ...
  xGrp.defineFlag(
      ...
      opts::OptAttrs::ALLOW_UNSET, baseOpts.autoCompact);
  xGrp.defineFlag("force-no-compact", nullptr,
                  "forcely uncompact any instruction",
                  "Forcely un-compact any instruction even if 'Compacted' is "
                  "set in instruction option."
                  "This will override the effect by -Xautocompact",
                  opts::OptAttrs::ALLOW_UNSET, baseOpts.forceNoCompact);
  xGrp.defineFlag(
      "dcmp", nullptr, "debug compaction",
  ...
  xGrp.defineFlag(
      "dsd", nullptr, "decode send descriptor",
  ...
  xGrp.defineFlag(
      "ifs", nullptr, "decode instruction fields",
      ...
      "  % iga -p=12p1 -Xifs \"64 00 43 00  a0 0a 05 00   24 01 00 80  00 00 "
      "00 00\"\n"
      "    both examples decode the hex bits above into ISA\n"
      "  % iga -p=12p1 -Xifs foo.krn12p1 "
      "\"00000000`80000124`00050AA0`00430064\"\n"
      "    decodes and compares the fields between foo.krn12p1 and the given "
      "bits\n"
  ...
  xGrp.defineFlag("ldst-syntax", nullptr,
                  "emits an experimental load/store syntax", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler &, Opts &baseOpts) {
                    baseOpts.printLdSt = true;
                  });
  xGrp.defineFlag(
      "legacy-directives", nullptr, "enable some IsaAsm era directives",
      "enables .default_execution_width and .default_type directives",
      opts::OptAttrs::ALLOW_UNSET, baseOpts.legacyDirectives);
  xGrp.defineFlag("list-ops", nullptr,
                  "displays all ops for the given platform", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler, Opts &baseOpts) {
                    baseOpts.mode = Opts::Mode::XLST;
                  });
  xGrp.defineFlag("native", nullptr, "Use IGA's native encoder/decoder", "",
                  opts::OptAttrs::ALLOW_UNSET, baseOpts.useNativeEncoder);
  xGrp.defineFlag("no-autocompact", nullptr,
                  "the inverse (default) of -Xautocompact", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler &, Opts &baseOpts) {
                    baseOpts.autoCompact = false;
                  });
  xGrp.defineFlag("no-print-bfnexprs", nullptr,
                  "the inverse (default) of -Xprint-bfnexprs", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler &, Opts &baseOpts) {
                    baseOpts.printBfnExprs = false;
                  });
  xGrp.defineFlag("no-print-ldst", nullptr,
                  "the inverse (default) of -Xprint-ldst", nullptr,
                  opts::OptAttrs::ALLOW_UNSET,
                  [](const char *, const opts::ErrorHandler &, Opts &baseOpts) {
                    baseOpts.printLdSt = false;
                  });
  xGrp.defineFlag("syntax-exts", nullptr, "enables certain syntax extensions",
                  "", opts::OptAttrs::ALLOW_UNSET, baseOpts.syntaxExts);
  xGrp.defineFlag("print-hex-floats", nullptr, "format floats in hexadecimal",
                  "The intent is that IGA should always format floats in a way "
                  "such that it "
                  "will parse back them bit-precise; however, if we muck that "
                  "up or if you just"
                  "like the consistency, this option enables that behavior.",
                  opts::OptAttrs::ALLOW_UNSET, baseOpts.printHexFloats);
  xGrp.defineFlag("print-pc", nullptr, "print PC with each instruction",
                  "An instruction PC will be added as a comment",
                  opts::OptAttrs::ALLOW_UNSET, baseOpts.printInstructionPc);
  xGrp.defineOpt(
      "set-pc-base", nullptr, "INT", "print pc offset by specified",
      "An instruction PC offset by a user specified base will be added as a "
      "comment -- use with Xprint-pc flag",
      opts::OptAttrs::ALLOW_UNSET,
      [](const char *cinp, const opts::ErrorHandler &eh, Opts &baseOpts) {
        if (cinp == nullptr) {
          baseOpts.pcOffset = 0;
  ...
  xGrp.defineFlag("print-bits", nullptr,
                  "prints bits decoded with each instruction",
                  "The instruction bits are emitted with each instruction",
                  opts::OptAttrs::ALLOW_UNSET, baseOpts.printBits);
  xGrp.defineFlag("print-defs", nullptr,
                  "prints dependency definitions from each instruction",
                  "The analysis may be coarse.", opts::OptAttrs::ALLOW_UNSET,
                  baseOpts.printDefs);
  xGrp.defineFlag("print-deps", nullptr,
  ...
  auto optsForFile = [&](const std::string &inpFile) {
    ...
    if (os.mode == Opts::Mode::AUTO) {
      fatalExitWithMessage(inpFile,
                           ": cannot infer mode based on file extension"
                           " (use -d or -a to set mode)");
    }
    if (os.platform == IGA_GEN_INVALID) {
      fatalExitWithMessage(inpFile,
                           ": cannot infer project based on file extension"
                           " (use -p=...)");
    }
    return os;
  }; // optsForFile
  ...
  if (baseOpts.mode == Opts::Mode::XLST) {
    ...
    for (auto &inpFile : baseOpts.inputFiles) {
      if (inpFile != IGA_STDIN_FILENAME && !doesFileExist(inpFile.c_str())) {
      ...
      try {
        ...
        if (opts.mode == Opts::Mode::DIS) {
          ...
          fatalExitWithMessage(
              inpFile, ": mode (-a or -d) must be specified for this file");
        }
      } catch (const igax::Error &err) {
        err.emit(std::cerr);
      }
