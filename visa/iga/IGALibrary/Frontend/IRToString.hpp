...
#define MAKE_CASE(C, S)                                                        \
  case C::S:                                                                   \
    return #C "::" #S
#define MAKE_DEFAULT_CASE(C)                                                   \
  default:                                                                     \
    return MakeErrorString(#C, (int)x)
...
static inline std::string ToSymbol(bool x) { return x ? "true" : "false"; }
...
static inline std::string ToSymbol(Region x) {
  if (x == Region::INVALID)
    ...
    ss << "{";
    switch (x.getVt()) {
    case Region::Vert::VT_0:
      ss << "Region::Vert::VT_0";
      break;
    case Region::Vert::VT_1:
      ss << "Region::Vert::VT_1";
      break;
    case Region::Vert::VT_2:
      ss << "Region::Vert::VT_2";
      break;
    case Region::Vert::VT_4:
      ss << "Region::Vert::VT_4";
      break;
    case Region::Vert::VT_8:
      ss << "Region::Vert::VT_8";
      break;
    case Region::Vert::VT_16:
      ss << "Region::Vert::VT_16";
      break;
    case Region::Vert::VT_32:
      ss << "Region::Vert::VT_32";
      break;
    case Region::Vert::VT_VxH:
      ss << "Region::Vert::VT_VxH";
      break;
    case Region::Vert::VT_INVALID:
      ss << "Region::Vert::VT_INVALID";
    default:
      ss << x.v << "?";
      break;
    }
    ...
    switch (x.getWi()) {
    case Region::Width::WI_1:
      ss << "Region::Width::WI_1";
      break;
    case Region::Width::WI_2:
      ss << "Region::Width::WI_2";
      break;
    case Region::Width::WI_4:
      ss << "Region::Width::WI_4";
      break;
    case Region::Width::WI_8:
      ss << "Region::Width::WI_8";
      break;
    case Region::Width::WI_16:
      ss << "Region::Width::WI_16";
      break;
    case Region::Width::WI_INVALID:
      ss << "Region::Width::WI_INVALID";
      break;
    default:
      ss << x.v << "?";
      break;
    ...
    case Region::Horz::HZ_4:
      ss << "Region::Horz::HZ_4";
      break;
    case Region::Horz::HZ_INVALID:
      ss << "Region::Horz::HZ_INVALID";
      break;
    default:
      ss << x.v << "?";
      break;
...
static inline std::string ToSyntax(PredCtrl pc) {
  ...
  case PredCtrl::ALL:
    return ".all";
  default:
    return MakeErrorString("PredCtrl", (int)pc);
  }
}
...
static inline std::string ToSyntax(ExecSize es) {
  ...
  case ExecSize::SIMD32:
    return "32";
  default:
    return MakeErrorString("ExecSize", (int)es);
  }
}
...
static inline std::string ToSyntax(ChannelOffset es) {
  ...
  case ChannelOffset::M28:
    return "M28";
  default:
    return MakeErrorString("ChannelOffset", (int)es);
  }
}
...
static inline std::string ToSyntax(FlagModifier fm) {
  ...
  case FlagModifier::UN:
    return "un";
  case FlagModifier::EO:
    return "eo";
  default:
    return MakeErrorString("FlagModifier", (int)fm);
  }
}
...
static inline std::string ToSyntax(BranchCntrl bc) {
  ...
  case BranchCntrl::ON:
    return ".b";
  default:
    return MakeErrorString("BranchCntrl", (int)bc);
  }
}
...
static inline std::string ToSyntax(Op op, SrcModifier sm) {
  ...
  case SrcModifier::NEG_ABS:
    return "-(abs)";
  default:
    return MakeErrorString("SrcModifier", (int)sm);
  }
}
...
static inline std::string ToSyntax(RegName regName) {
  ...
  case RegName::GRF_R:
    return "r";
  default:
    return MakeErrorString("RegName", (int)regName);
  }
}
...
static inline std::string ToSyntax(MathMacroExt MathMacroReg) {
  ...
  default:
    return MakeErrorString("MathMacroExt", (int)MathMacroReg);
  }
}
...
static inline std::string ToSyntax(const Region &rgn) {
  ...
  if (rgn.getVt() != Region::Vert::VT_INVALID &&
    ...
    if (rgn.getVt() == Region::Vert::VT_VxH) {
      ...
      ss << "<" << (int)rgn.v << ";" << (int)rgn.w << "," << (int)rgn.h << ">";
    }
...
static inline std::string ToSyntax(const InstOpt &i) {
  switch (i) {
  case InstOpt::ACCWREN:
    return "AccWrEn";
  case InstOpt::ATOMIC:
    return "Atomic";
  case InstOpt::BREAKPOINT:
    return "Breakpoint";
  case InstOpt::COMPACTED:
    return "Compacted";
  case InstOpt::EOT:
    return "EOT";
  case InstOpt::NOCOMPACT:
    return "NoCompact";
  case InstOpt::NODDCHK:
    return "NoDDChk";
  case InstOpt::NODDCLR:
    return "NoDDClr";
  case InstOpt::NOPREEMPT:
    return "NoPreempt";
  case InstOpt::NOSRCDEPSET:
    return "NoSrcDepSet";
  case InstOpt::SWITCH:
    return "Switch";
  case InstOpt::SERIALIZE:
    return "Serialize";
  case InstOpt::EXBSO:
    return "ExBSO";
  case InstOpt::CPS:
...
static inline void ToSyntaxNoBraces(std::ostream &os,
  ...
  bool first = true;
  for (size_t i = 0; i < sizeof(ALL_INST_OPTS) / sizeof(ALL_INST_OPTS[0]);
       i++) {
