...
namespace iga {
    static const iga::OpSpec MODEL_XE_HP_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
        ...
        {Op::BFE /* Op::7 */, Platform::XE_HP, 0x78,
            "bfe",
            "Bit Field Extract",
            OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
            {
        ...
        {Op::BFI1 /* Op::8 */, Platform::XE_HP, 0x79,
            "bfi1",
            "Bit Field Insert 1",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::BFI2 /* Op::9 */, Platform::XE_HP, 0x7A,
            "bfi2",
            "Bit Field Insert 2",
            OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
            {
        ...
        {Op::BFN /* Op::10 */, Platform::XE_HP, 0x6B,
            "bfn",
            "Boolean Function",
            OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
            {
        ...
        {Op::BFREV /* Op::11 */, Platform::XE_HP, 0x77,
            "bfrev",
            "Bit Field Reverse",
        ...
        {Op::BRC /* Op::12 */, Platform::XE_HP, 0x23,
            "brc",
            "Branch Converging",
        ...
        {Op::BRD /* Op::13 */, Platform::XE_HP, 0x21,
            "brd",
            "Branch Diverging",
        ...
        {Op::BREAK /* Op::14 */, Platform::XE_HP, 0x28,
            "break",
            "Break",
        ...
        {Op::CALL /* Op::15 */, Platform::XE_HP, 0x2C,
            "call",
            "Call",
        ...
        {Op::CALLA /* Op::16 */, Platform::XE_HP, 0x2B,
            "calla",
            "Call Absolute",
            OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
            { }, // no type mappings
        ...
        {Op::CBIT /* Op::17 */, Platform::XE_HP, 0x4D,
            "cbit",
            "Count Bits Set",
            OpSpec::Format::BASIC_UNARY_REGIMM,
            {
        ...
        {Op::CMP /* Op::18 */, Platform::XE_HP, 0x70,
            "cmp",
            "Compare",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::CMPN /* Op::19 */, Platform::XE_HP, 0x71,
            "cmpn",
            "Compare NaN",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::CONT /* Op::20 */, Platform::XE_HP, 0x29,
            "cont",
            "Continue",
            OpSpec::Format::JUMP_BINARY_IMM_IMM,
            { }, // no type mappings
        ...
        {Op::CSEL /* Op::21 */, Platform::XE_HP, 0x72,
            "csel",
            "Conditional Select",
            OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
            {
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::DP4A /* Op::26 */, Platform::XE_HP, 0x58,
            "dp4a",
        ...
        {Op::DPAS /* Op::27 */, Platform::XE_HP, 0x59,
            "dpas",
        ...
        {Op::DPASW /* Op::28 */, Platform::XE_HP, 0x5A,
            "dpasw",
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::ELSE /* Op::30 */, Platform::XE_HP, 0x24,
            "else",
            "Else",
            OpSpec::Format::JUMP_BINARY_IMM_IMM,
            { }, // no type mappings
        ...
        {Op::ENDIF /* Op::31 */, Platform::XE_HP, 0x25,
            "endif",
            "End If",
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::FBH /* Op::34 */, Platform::XE_HP, 0x4B,
            "fbh",
        ...
        {Op::FBL /* Op::35 */, Platform::XE_HP, 0x4C,
            "fbl",
        ...
        {Op::FRC /* Op::36 */, Platform::XE_HP, 0x43,
            "frc",
            "Fraction",
            OpSpec::Format::BASIC_UNARY_REGIMM,
            {
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::LZD /* Op::47 */, Platform::XE_HP, 0x4A,
            "lzd",
        ...
        {Op::MAC /* Op::48 */, Platform::XE_HP, 0x48,
            "mac",
            "Multiply Accumulate",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::MACH /* Op::49 */, Platform::XE_HP, 0x49,
            "mach",
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::MAD /* Op::51 */, Platform::XE_HP, 0x5B,
            "mad",
            "Multiply Add",
            OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
            {
        ...
        {Op::MADM /* Op::52 */, Platform::XE_HP, 0x5D,
            "madm",
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::MATH /* Op::55 */, Platform::XE_HP, 0x38,
            "math",
        ...
        {Op::MOV /* Op::56 */, Platform::XE_HP, 0x61,
            "mov",
            "Move",
            OpSpec::Format::BASIC_UNARY_REGIMM,
            {
        ...
        {Op::MOVI /* Op::57 */, Platform::XE_HP, 0x63,
            "movi",
            "Move Indexed",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::MUL /* Op::58 */, Platform::XE_HP, 0x41,
            "mul",
            "Multiply",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::SHL /* Op::80 */, Platform::XE_HP, 0x69,
            "shl",
            "Shift Left",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::SHR /* Op::81 */, Platform::XE_HP, 0x68,
            "shr",
            "Shift Right",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::SUBB /* Op::84 */, Platform::XE_HP, 0x4F,
            "subb",
        ...
        {Op::SYNC /* Op::85 */, Platform::XE_HP, 0x01,
            "sync",
            "Synchronize",
        ...
        {Op::INVALID, Platform::XE_HP, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::WHILE /* Op::87 */, Platform::XE_HP, 0x27,
            "while",
            "While",
            OpSpec::Format::JUMP_UNARY_IMM,
            { }, // no type mappings
        ...
        {Op::XOR /* Op::88 */, Platform::XE_HP, 0x67,
            "xor",
            "Logic Xor",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
