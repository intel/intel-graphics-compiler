...
static const iga::OpSpec MODEL_GEN9_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::INVALID, Platform::GEN9, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::NOP /* Op::56 */, Platform::GEN9, 0x7E,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::57 */, Platform::GEN9, 0x04,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::OR /* Op::58 */, Platform::GEN9, 0x06,
    "or",
    "Logic Or",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::PLN /* Op::59 */, Platform::GEN9, 0x5A,
    "pln",
    "Plane",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::RET /* Op::60 */, Platform::GEN9, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::61 */, Platform::GEN9, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::62 */, Platform::GEN9, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::63 */, Platform::GEN9, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::64 */, Platform::GEN9, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN9, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN9, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SAD2 /* Op::67 */, Platform::GEN9, 0x50,
    "sad2",
  ...
  {Op::SADA2 /* Op::68 */, Platform::GEN9, 0x51,
    "sada2",
  ...
  {Op::INVALID, Platform::GEN9, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::70 */, Platform::GEN9, 0x02,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::71 */, Platform::GEN9, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::72 */, Platform::GEN9, 0x32,
    "sendc",
