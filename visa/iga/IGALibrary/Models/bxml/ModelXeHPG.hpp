...
static const iga::OpSpec MODEL_XE_HPG_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::NOP /* Op::55 */, Platform::XE_HPG, 0x60,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::56 */, Platform::XE_HPG, 0x64,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::OR /* Op::57 */, Platform::XE_HPG, 0x66,
    "or",
    "Logic Or",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::RET /* Op::59 */, Platform::XE_HPG, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::60 */, Platform::XE_HPG, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::61 */, Platform::XE_HPG, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::62 */, Platform::XE_HPG, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::63 */, Platform::XE_HPG, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::ROL /* Op::64 */, Platform::XE_HPG, 0x6F,
    "rol",
    "Rotate Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::ROR /* Op::65 */, Platform::XE_HPG, 0x6E,
    "ror",
    "Rotate Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::69 */, Platform::XE_HPG, 0x62,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::70 */, Platform::XE_HPG, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::71 */, Platform::XE_HPG, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::76 */, Platform::XE_HPG, 0x69,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::77 */, Platform::XE_HPG, 0x68,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::80 */, Platform::XE_HPG, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::81 */, Platform::XE_HPG, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE_HPG, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::83 */, Platform::XE_HPG, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::84 */, Platform::XE_HPG, 0x67,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
