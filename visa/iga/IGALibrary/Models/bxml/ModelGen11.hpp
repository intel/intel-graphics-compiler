...
static const iga::OpSpec MODEL_GEN11_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BFE /* Op::8 */, Platform::GEN11, 0x18,
    "bfe",
    "Bit Field Extract",
  ...
  {Op::BFI1 /* Op::9 */, Platform::GEN11, 0x19,
    "bfi1",
    "Bit Field Insert 1",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::BFI2 /* Op::10 */, Platform::GEN11, 0x1A,
    "bfi2",
    "Bit Field Insert 2",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BFREV /* Op::12 */, Platform::GEN11, 0x17,
    "bfrev",
    "Bit Field Reverse",
  ...
  {Op::BRC /* Op::13 */, Platform::GEN11, 0x23,
    "brc",
    "Branch Converging",
  ...
  {Op::BRD /* Op::14 */, Platform::GEN11, 0x21,
    "brd",
    "Branch Diverging",
  ...
  {Op::BREAK /* Op::15 */, Platform::GEN11, 0x28,
    "break",
    "Break",
  ...
  {Op::CALL /* Op::16 */, Platform::GEN11, 0x2C,
    "call",
    "Call",
  ...
  {Op::CALLA /* Op::17 */, Platform::GEN11, 0x2B,
    "calla",
    "Call Absolute",
    OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
    {
  ...
  {Op::CBIT /* Op::18 */, Platform::GEN11, 0x4D,
    "cbit",
    "Count Bits Set",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::CMP /* Op::19 */, Platform::GEN11, 0x10,
    "cmp",
    "Compare",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CMPN /* Op::20 */, Platform::GEN11, 0x11,
    "cmpn",
    "Compare NaN",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CONT /* Op::21 */, Platform::GEN11, 0x29,
    "cont",
    "Continue",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::CSEL /* Op::22 */, Platform::GEN11, 0x12,
    "csel",
    "Conditional Select",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ELSE /* Op::32 */, Platform::GEN11, 0x24,
    "else",
    "Else",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ENDIF /* Op::33 */, Platform::GEN11, 0x25,
    "endif",
    "End If",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::FBH /* Op::36 */, Platform::GEN11, 0x4B,
    "fbh",
  ...
  {Op::FBL /* Op::37 */, Platform::GEN11, 0x4C,
    "fbl",
  ...
  {Op::FRC /* Op::38 */, Platform::GEN11, 0x43,
    "frc",
    "Fraction",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::LZD /* Op::48 */, Platform::GEN11, 0x4A,
    "lzd",
  ...
  {Op::MAC /* Op::49 */, Platform::GEN11, 0x48,
    "mac",
    "Multiply Accumulate",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MACH /* Op::50 */, Platform::GEN11, 0x49,
    "mach",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::MAD /* Op::52 */, Platform::GEN11, 0x5B,
    "mad",
    "Multiply Add",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::MADM /* Op::53 */, Platform::GEN11, 0x5D,
    "madm",
  ...
  {Op::MATH /* Op::54 */, Platform::GEN11, 0x38,
    "math",
  ...
  {Op::MOV /* Op::55 */, Platform::GEN11, 0x01,
    "mov",
    "Move",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::MOVI /* Op::56 */, Platform::GEN11, 0x03,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MUL /* Op::57 */, Platform::GEN11, 0x41,
    "mul",
    "Multiply",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::RET /* Op::66 */, Platform::GEN11, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::67 */, Platform::GEN11, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::68 */, Platform::GEN11, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::69 */, Platform::GEN11, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::70 */, Platform::GEN11, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::ROL /* Op::71 */, Platform::GEN11, 0x0F,
    "rol",
    "Rotate Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::ROR /* Op::72 */, Platform::GEN11, 0x0E,
    "ror",
    "Rotate Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::76 */, Platform::GEN11, 0x02,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::77 */, Platform::GEN11, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::78 */, Platform::GEN11, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SENDS /* Op::83 */, Platform::GEN11, 0x33,
    "sends",
    "Split Send Message",
  ...
  {Op::SENDSC /* Op::84 */, Platform::GEN11, 0x34,
    "sendsc",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::86 */, Platform::GEN11, 0x09,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::87 */, Platform::GEN11, 0x08,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SMOV /* Op::88 */, Platform::GEN11, 0x0A,
    "smov",
    "Scattered Move",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::90 */, Platform::GEN11, 0x4F,
    "subb",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WAIT /* Op::93 */, Platform::GEN11, 0x30,
    "wait",
    "Wait Notification",
  ...
  {Op::WHILE /* Op::94 */, Platform::GEN11, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::95 */, Platform::GEN11, 0x07,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
