...
static const iga::OpSpec MODEL_GEN11_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::SHL /* Op::78 */, Platform::GEN11, 0x09,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::79 */, Platform::GEN11, 0x08,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SMOV /* Op::80 */, Platform::GEN11, 0x0A,
    "smov",
    "Scattered Move",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::82 */, Platform::GEN11, 0x4F,
    "subb",
  ...
  {Op::INVALID, Platform::GEN11, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WAIT /* Op::84 */, Platform::GEN11, 0x30,
    "wait",
    "Wait Notification",
  ...
  {Op::WHILE /* Op::85 */, Platform::GEN11, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::86 */, Platform::GEN11, 0x07,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
