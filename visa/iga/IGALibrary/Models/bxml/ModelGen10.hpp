...
namespace iga {
static const iga::OpSpec MODEL_GEN10_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ADD /* Op::1 */, Platform::GEN10, 0x40,
    "add",
    "Addition",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ADDC /* Op::3 */, Platform::GEN10, 0x4E,
    "addc",
    "Addition with Carry",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::AND /* Op::4 */, Platform::GEN10, 0x05,
    "and",
    "Logic And",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::ASR /* Op::5 */, Platform::GEN10, 0x0C,
    "asr",
  ...
  {Op::AVG /* Op::6 */, Platform::GEN10, 0x42,
    "avg",
    "Average",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BFE /* Op::8 */, Platform::GEN10, 0x18,
    "bfe",
    "Bit Field Extract",
  ...
  {Op::BFI1 /* Op::9 */, Platform::GEN10, 0x19,
    "bfi1",
    "Bit Field Insert 1",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::BFI2 /* Op::10 */, Platform::GEN10, 0x1A,
    "bfi2",
    "Bit Field Insert 2",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BFREV /* Op::12 */, Platform::GEN10, 0x17,
    "bfrev",
    "Bit Field Reverse",
  ...
  {Op::BRC /* Op::13 */, Platform::GEN10, 0x23,
    "brc",
    "Branch Converging",
  ...
  {Op::BRD /* Op::14 */, Platform::GEN10, 0x21,
    "brd",
    "Branch Diverging",
  ...
  {Op::BREAK /* Op::15 */, Platform::GEN10, 0x28,
    "break",
    "Break",
  ...
  {Op::CALL /* Op::16 */, Platform::GEN10, 0x2C,
    "call",
    "Call",
  ...
  {Op::CALLA /* Op::17 */, Platform::GEN10, 0x2B,
    "calla",
    "Call Absolute",
    OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
    {
  ...
  {Op::CBIT /* Op::18 */, Platform::GEN10, 0x4D,
    "cbit",
    "Count Bits Set",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::CMP /* Op::19 */, Platform::GEN10, 0x10,
    "cmp",
    "Compare",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CMPN /* Op::20 */, Platform::GEN10, 0x11,
    "cmpn",
    "Compare NaN",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CONT /* Op::21 */, Platform::GEN10, 0x29,
    "cont",
    "Continue",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::CSEL /* Op::22 */, Platform::GEN10, 0x12,
    "csel",
    "Conditional Select",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::DP2 /* Op::25 */, Platform::GEN10, 0x57,
    "dp2",
    "Dot Product 2",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::DP3 /* Op::26 */, Platform::GEN10, 0x56,
    "dp3",
    "Dot Product 3",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::DP4 /* Op::27 */, Platform::GEN10, 0x54,
    "dp4",
    "Dot Product 4",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::DPH /* Op::31 */, Platform::GEN10, 0x55,
    "dph",
  ...
  {Op::ELSE /* Op::32 */, Platform::GEN10, 0x24,
    "else",
    "Else",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ENDIF /* Op::33 */, Platform::GEN10, 0x25,
    "endif",
    "End If",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::FBH /* Op::36 */, Platform::GEN10, 0x4B,
    "fbh",
  ...
  {Op::FBL /* Op::37 */, Platform::GEN10, 0x4C,
    "fbl",
  ...
  {Op::FRC /* Op::38 */, Platform::GEN10, 0x43,
    "frc",
    "Fraction",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::GOTO /* Op::39 */, Platform::GEN10, 0x2E,
    "goto",
    "Goto",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::HALT /* Op::40 */, Platform::GEN10, 0x2A,
    "halt",
    "Halt",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::IF /* Op::41 */, Platform::GEN10, 0x22,
    "if",
    "If",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ILLEGAL /* Op::42 */, Platform::GEN10, 0x00,
    "illegal",
    "Illegal",
  ...
  {Op::JMPI /* Op::43 */, Platform::GEN10, 0x20,
    "jmpi",
    "Jump Indexed",
    OpSpec::Format::JUMP_UNARY_REGIMM,
    {
  ...
  {Op::JOIN /* Op::44 */, Platform::GEN10, 0x2F,
    "join",
    "Join",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::LINE /* Op::46 */, Platform::GEN10, 0x59,
    "line",
    "Line",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::LRP /* Op::47 */, Platform::GEN10, 0x5C,
    "lrp",
  ...
  {Op::LZD /* Op::48 */, Platform::GEN10, 0x4A,
    "lzd",
  ...
  {Op::MAC /* Op::49 */, Platform::GEN10, 0x48,
    "mac",
    "Multiply Accumulate",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MACH /* Op::50 */, Platform::GEN10, 0x49,
    "mach",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::MAD /* Op::52 */, Platform::GEN10, 0x5B,
    "mad",
    "Multiply Add",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::MADM /* Op::53 */, Platform::GEN10, 0x5D,
    "madm",
  ...
  {Op::MATH /* Op::54 */, Platform::GEN10, 0x38,
    "math",
  ...
  {Op::MOV /* Op::55 */, Platform::GEN10, 0x01,
    "mov",
    "Move",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::MOVI /* Op::56 */, Platform::GEN10, 0x03,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MUL /* Op::57 */, Platform::GEN10, 0x41,
    "mul",
    "Multiply",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::NOP /* Op::59 */, Platform::GEN10, 0x7E,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::60 */, Platform::GEN10, 0x04,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::OR /* Op::61 */, Platform::GEN10, 0x06,
    "or",
    "Logic Or",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::PLN /* Op::62 */, Platform::GEN10, 0x5A,
    "pln",
    "Plane",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::RET /* Op::64 */, Platform::GEN10, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::65 */, Platform::GEN10, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::66 */, Platform::GEN10, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::67 */, Platform::GEN10, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::68 */, Platform::GEN10, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SAD2 /* Op::71 */, Platform::GEN10, 0x50,
    "sad2",
  ...
  {Op::SADA2 /* Op::72 */, Platform::GEN10, 0x51,
    "sada2",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::74 */, Platform::GEN10, 0x02,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::75 */, Platform::GEN10, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::76 */, Platform::GEN10, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SENDS /* Op::81 */, Platform::GEN10, 0x33,
    "sends",
    "Split Send Message",
  ...
  {Op::SENDSC /* Op::82 */, Platform::GEN10, 0x34,
    "sendsc",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::84 */, Platform::GEN10, 0x09,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::85 */, Platform::GEN10, 0x08,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SMOV /* Op::86 */, Platform::GEN10, 0x0A,
    "smov",
    "Scattered Move",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::88 */, Platform::GEN10, 0x4F,
    "subb",
  ...
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN10, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WAIT /* Op::91 */, Platform::GEN10, 0x30,
    "wait",
    "Wait Notification",
  ...
  {Op::WHILE /* Op::92 */, Platform::GEN10, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::93 */, Platform::GEN10, 0x07,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
