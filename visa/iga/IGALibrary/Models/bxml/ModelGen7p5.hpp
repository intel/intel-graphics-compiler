...
namespace iga {
    static const iga::OpSpec MODEL_GEN7P5_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
        ...
        {Op::INVALID, Platform::GEN7P5, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::GEN7P5, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::SHL /* Op::80 */, Platform::GEN7P5, 0x09,
            "shl",
            "Shift Left",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::SHR /* Op::81 */, Platform::GEN7P5, 0x08,
            "shr",
            "Shift Right",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
        ...
        {Op::INVALID, Platform::GEN7P5, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::INVALID, Platform::GEN7P5, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::SUBB /* Op::84 */, Platform::GEN7P5, 0x4F,
            "subb",
        ...
        {Op::INVALID, Platform::GEN7P5, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE,         },
        {Op::WAIT /* Op::86 */, Platform::GEN7P5, 0x30,
            "wait",
            "Wait Notification",
        ...
        {Op::WHILE /* Op::87 */, Platform::GEN7P5, 0x27,
            "while",
            "While",
            OpSpec::Format::JUMP_UNARY_IMM,
            { }, // no type mappings
        ...
        {Op::XOR /* Op::88 */, Platform::GEN7P5, 0x07,
            "xor",
            "Logic Xor",
            OpSpec::Format::BASIC_BINARY_REG_REGIMM,
            {
