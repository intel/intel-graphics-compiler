...
#ifndef IGA_MODELS_XE3_HPP
#define IGA_MODELS_XE3_HPP
// clang-format off
...
namespace iga {
static const iga::OpSpec MODEL_XE3_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ADD /* Op::1 */, Platform::XE3, 0x40,
    "add",
    "Addition",
  ...
  {Op::ADD3 /* Op::2 */, Platform::XE3, 0x52,
    "add3",
    "Addition Ternary",
  ...
  {Op::ADDC /* Op::3 */, Platform::XE3, 0x4E,
    "addc",
    "Addition with Carry",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::BFI1 /* Op::9 */, Platform::XE3, 0x79,
    "bfi1",
    "Bit Field Insert 1",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::BFI2 /* Op::10 */, Platform::XE3, 0x7A,
    "bfi2",
    "Bit Field Insert 2",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::BFN /* Op::11 */, Platform::XE3, 0x6B,
    "bfn",
    "Boolean Function",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::BFREV /* Op::12 */, Platform::XE3, 0x77,
    "bfrev",
    "Bit Field Reverse",
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BREAK /* Op::15 */, Platform::XE3, 0x28,
    "break",
    "Break",
  ...
  {Op::CALL /* Op::16 */, Platform::XE3, 0x2C,
    "call",
    "Call",
  ...
  {Op::CALLA /* Op::17 */, Platform::XE3, 0x2B,
    "calla",
    "Call Absolute",
    OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
    {}, // no type mappings
  ...
  {Op::CBIT /* Op::18 */, Platform::XE3, 0x4D,
    "cbit",
    "Count Bits Set",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
      // UD <- UD,UW,UB
      {TYPE(Type::UD),TYPE(Type::UD)|TYPE(Type::UW)|TYPE(Type::UB)}
    },
    OpSpec::Attr::SUPPORTS_PREDICATION
  },
  {Op::CMP /* Op::19 */, Platform::XE3, 0x70,
    "cmp",
    "Compare",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CMPN /* Op::20 */, Platform::XE3, 0x71,
    "cmpn",
    "Compare NaN",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CONT /* Op::21 */, Platform::XE3, 0x29,
    "cont",
    "Continue",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::CSEL /* Op::22 */, Platform::XE3, 0x72,
    "csel",
    "Conditional Select",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::DP4A /* Op::28 */, Platform::XE3, 0x58,
    "dp4a",
  ...
  {Op::DPAS /* Op::29 */, Platform::XE3, 0x59,
    "dpas",
    ...
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
      ...
      // F,BF <- F,BF
      {TYPE(Type::F)|TYPE(Type::BF),TYPE(Type::F)|TYPE(Type::BF)},
      // F,HF <- F,HF
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ELSE /* Op::32 */, Platform::XE3, 0x24,
    "else",
    "Else",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ENDIF /* Op::33 */, Platform::XE3, 0x25,
    "endif",
    "End If",
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::FBH /* Op::36 */, Platform::XE3, 0x4B,
    "fbh",
  ...
  {Op::FBL /* Op::37 */, Platform::XE3, 0x4C,
    "fbl",
  ...
  {Op::FRC /* Op::38 */, Platform::XE3, 0x43,
    "frc",
    "Fraction",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::GOTO /* Op::39 */, Platform::XE3, 0x2E,
    "goto",
    "Goto",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::HALT /* Op::40 */, Platform::XE3, 0x2A,
    "halt",
    "Halt",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ILLEGAL /* Op::42 */, Platform::XE3, 0x00,
    "illegal",
    "Illegal",
  ...
  {Op::JMPI /* Op::43 */, Platform::XE3, 0x20,
    "jmpi",
    "Jump Indexed",
  ...
  {Op::JOIN /* Op::44 */, Platform::XE3, 0x2F,
    "join",
    "Join",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::LZD /* Op::48 */, Platform::XE3, 0x4A,
    "lzd",
  ...
  {Op::MAC /* Op::49 */, Platform::XE3, 0x48,
    ...
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
      ...
      {TYPE(Type::HF),TYPE(Type::HF)},
      // F <- BF,F
      {TYPE(Type::F),TYPE(Type::BF)|TYPE(Type::F)},
      // DF <- DF
      {TYPE(Type::DF),TYPE(Type::DF)}
    },
    OpSpec::Attr::SUPPORTS_PREDICATION|OpSpec::Attr::SUPPORTS_FLAGMODIFIER|OpSpec::Attr::SUPPORTS_SATURATION|OpSpec::Attr::SUPPORTS_SRCMODS
  },
  {Op::MACH /* Op::50 */, Platform::XE3, 0x49,
    "mach",
  ...
  {Op::MACL /* Op::51 */, Platform::XE3, 0x53,
    "macl",
  ...
  {Op::MAD /* Op::52 */, Platform::XE3, 0x5B,
    "mad",
    "Multiply Add",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
      ...
      {TYPE(Type::DF),TYPE(Type::DF)},
      // UQ,Q <- UD,D,UQ,Q
      {TYPE(Type::UQ)|TYPE(Type::Q),TYPE(Type::UD)|TYPE(Type::D)|TYPE(Type::UQ)|TYPE(Type::Q)}
    },
    OpSpec::Attr::SUPPORTS_PREDICATION|OpSpec::Attr::SUPPORTS_FLAGMODIFIER|OpSpec::Attr::SUPPORTS_SATURATION|OpSpec::Attr::SUPPORTS_SRCMODS
  },
  {Op::MADM /* Op::53 */, Platform::XE3, 0x5D,
    "madm",
  ...
  {Op::MATH /* Op::54 */, Platform::XE3, 0x38,
    "math",
  ...
  {Op::MOV /* Op::55 */, Platform::XE3, 0x61,
    "mov",
    "Move",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::MOVI /* Op::56 */, Platform::XE3, 0x63,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MUL /* Op::57 */, Platform::XE3, 0x41,
    "mul",
    "Multiply",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::NOP /* Op::59 */, Platform::XE3, 0x60,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::60 */, Platform::XE3, 0x64,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::RET /* Op::64 */, Platform::XE3, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::65 */, Platform::XE3, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::66 */, Platform::XE3, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::67 */, Platform::XE3, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::68 */, Platform::XE3, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::ROL /* Op::69 */, Platform::XE3, 0x6F,
    "rol",
    "Rotate Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::ROR /* Op::70 */, Platform::XE3, 0x6E,
    "ror",
    "Rotate Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::74 */, Platform::XE3, 0x62,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::75 */, Platform::XE3, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::76 */, Platform::XE3, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::84 */, Platform::XE3, 0x69,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::85 */, Platform::XE3, 0x68,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
      // UB,UW,UD <- UB,B,UW,W,UD,D
      {TYPE(Type::UB)|TYPE(Type::UW)|TYPE(Type::UD),TYPE(Type::UB)|TYPE(Type::B)|TYPE(Type::UW)|TYPE(Type::W)|TYPE(Type::UD)|TYPE(Type::D)},
      // UQ <- UW,W,UD,D,UQ,Q
      {TYPE(Type::UQ),TYPE(Type::UW)|TYPE(Type::W)|TYPE(Type::UD)|TYPE(Type::D)|TYPE(Type::UQ)|TYPE(Type::Q)},
      // UW,UD <- UQ,Q
      {TYPE(Type::UW)|TYPE(Type::UD),TYPE(Type::UQ)|TYPE(Type::Q)}
    },
    OpSpec::Attr::IS_BITWISE|OpSpec::Attr::SUPPORTS_PREDICATION|OpSpec::Attr::SUPPORTS_FLAGMODIFIER|OpSpec::Attr::SUPPORTS_SATURATION|OpSpec::Attr::SUPPORTS_SRCMODS
  },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SRND /* Op::87 */, Platform::XE3, 0x54,
    "srnd",
    "StochasticRounding",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SUBB /* Op::88 */, Platform::XE3, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::89 */, Platform::XE3, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE3, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::92 */, Platform::XE3, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::93 */, Platform::XE3, 0x67,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
...
}; // end MODEL_XE3_OPSPECS
} // namespace iga
// clang-format on
#endif // IGA_MODELS_XE3_HPP
