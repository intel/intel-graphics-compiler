...
static const iga::OpSpec MODEL_GEN8_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::NOP /* Op::55 */, Platform::GEN8, 0x7E,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::56 */, Platform::GEN8, 0x04,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::OR /* Op::57 */, Platform::GEN8, 0x06,
    "or",
    "Logic Or",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::PLN /* Op::58 */, Platform::GEN8, 0x5A,
    "pln",
    "Plane",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::RET /* Op::59 */, Platform::GEN8, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::60 */, Platform::GEN8, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::61 */, Platform::GEN8, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::62 */, Platform::GEN8, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::63 */, Platform::GEN8, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SAD2 /* Op::66 */, Platform::GEN8, 0x50,
    "sad2",
  ...
  {Op::SADA2 /* Op::67 */, Platform::GEN8, 0x51,
    "sada2",
  ...
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::69 */, Platform::GEN8, 0x02,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::70 */, Platform::GEN8, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::71 */, Platform::GEN8, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::76 */, Platform::GEN8, 0x09,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::77 */, Platform::GEN8, 0x08,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SMOV /* Op::78 */, Platform::GEN8, 0x0A,
    "smov",
    "Scattered Move",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::80 */, Platform::GEN8, 0x4F,
    "subb",
  ...
  {Op::INVALID, Platform::GEN8, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WAIT /* Op::82 */, Platform::GEN8, 0x30,
    "wait",
    "Wait Notification",
  ...
  {Op::WHILE /* Op::83 */, Platform::GEN8, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::84 */, Platform::GEN8, 0x07,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
