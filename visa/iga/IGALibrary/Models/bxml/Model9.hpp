    ...
    static const iga::OpSpec MODEL_GEN9_OPSPECS[static_cast<unsigned int>(Op::TOTAL_OPS) + 1] = {
        ...
        /* Op::1 */ {            Op::ADD, "add", "add", 0x40, "Addition",
            ...
            OpSpec::Format::BASIC_BINARY_REG_REGIMM, {
                ...
                // HF <- B,UB,W,UW,D,UD
                {TYPE(Type::HF),TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // W,UW,D,UD <- W,UW,D,UD
                {TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // Q,UQ <- W,UW,D,UD
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // W,UW,D,UD <- Q,UQ
                {TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::Q)|TYPE(Type::UQ)},
                // Q,UQ <- Q,UQ
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::Q)|TYPE(Type::UQ)},
                // HF,F <- HF,F
        ...
        /* Op::19 */ {            Op::CONT, "cont", "cont", 0x29, "Continue",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::20 */ {            Op::CSEL, "csel", "csel", 0x12, "Conditional Select",
        ...
        /* Op::34 */ {            Op::FRC, "frc", "frc", 0x43, "Fraction",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::35 */ {            Op::GOTO, "goto", "goto", 0x2e, "Goto",
        ...
        /* Op::39 */ {            Op::JMPI, "jmpi", "jmpi", 0x20, "Jump Indexed",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::40 */ {            Op::JOIN, "join", "join", 0x2f, "Join",
        ...
        /* Op::301 */ {            Op::MAC, "mac", "mac", 0x48, "Multiply Accumulate",
            ...
            OpSpec::Format::BASIC_BINARY_REG_REGIMM, {
                // B,UB,W,UW,D,UD <- B,UB,W,UW
                {TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)},
                // F <- F
                {TYPE(Type::F),TYPE(Type::F)},
                // DF <- DF
                {TYPE(Type::DF),TYPE(Type::DF)},
        ...
        /* Op::303 */ {            Op::MAD, "mad", "mad", 0x5b, "Multiply Add",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::304 */ {            Op::MADM, "madm", "madm", 0x5d, "Multiply Add for Macro",
        ...
        /* Op::310 */ {            Op::MATH_INV, "inv", "math.inv", 0x38, "INV",
            ...
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::311 */ {            Op::MATH_INVM, "invm", "math.invm", 0x38, "INVM",
        ...
        /* Op::316 */ {            Op::MATH_RSQT, "rsqt", "math.rsqt", 0x38, "RSQT",
            ...
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::317 */ {            Op::MATH_RSQTM, "rsqtm", "math.rsqtm", 0x38, "RSQTM",
        ...
        /* Op::320 */ {            Op::MOV, "mov", "mov", 0x1, "Move",
            ...
            OpSpec::Format::BASIC_UNARY_REGIMM, {
                ...
                {TYPE(Type::F),TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // B,UB,W,UW,D,UD <- F
                {TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::F)},
                // F <- F
                {TYPE(Type::F),TYPE(Type::F)},
                // DF <- W,UW,D,UD
                {TYPE(Type::DF),TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // DF <- F
                {TYPE(Type::DF),TYPE(Type::F)},
                // W,UW,D,UD <- DF
                {TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::DF)},
                // F <- DF
                ...
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::Q)|TYPE(Type::UQ)},
                // Q,UQ <- F
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::F)},
                // Q,UQ <- DF
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::DF)},
                // F <- Q,UQ
                {TYPE(Type::F),TYPE(Type::Q)|TYPE(Type::UQ)},
                // DF <- Q,UQ
                {TYPE(Type::DF),TYPE(Type::Q)|TYPE(Type::UQ)},
                // HF <- B,UB,W,UW,D,UD
                {TYPE(Type::HF),TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)},
                // HF <- F
                {TYPE(Type::HF),TYPE(Type::F)},
                // B,UB,W,UW,D,UD <- HF
                {TYPE(Type::B)|TYPE(Type::UB)|TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::HF)},
                // F <- HF
        ...
        /* Op::322 */ {            Op::MUL, "mul", "mul", 0x41, "Multiply",
            ...
            OpSpec::Format::BASIC_BINARY_REG_REGIMM, {
                // B,UB <- B,UB
                {TYPE(Type::B)|TYPE(Type::UB),TYPE(Type::B)|TYPE(Type::UB)},
                // W,UW <- B,UB
                {TYPE(Type::W)|TYPE(Type::UW),TYPE(Type::B)|TYPE(Type::UB)},
                // D,UD <- B,UB
                {TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::B)|TYPE(Type::UB)},
                // W,UW <- W,UW
                {TYPE(Type::W)|TYPE(Type::UW),TYPE(Type::W)|TYPE(Type::UW)},
                // D,UD <- W,UW
                {TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::W)|TYPE(Type::UW)},
                // D,UD <- D,UD
                {TYPE(Type::D)|TYPE(Type::UD),TYPE(Type::D)|TYPE(Type::UD)},
                // Q,UQ <- D,UD
                {TYPE(Type::Q)|TYPE(Type::UQ),TYPE(Type::D)|TYPE(Type::UD)},
                // F <- F
                {TYPE(Type::F),TYPE(Type::F)},
                // DF <- DF
                {TYPE(Type::DF),TYPE(Type::DF)},
        ...
        /* Op::352 */ {            Op::SENDS, "sends", "sends", 0x33, "Split Send Message",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::353 */ {            Op::SENDSC, "sendsc", "sendsc", 0x34, "Conditional Split Send Message",
        ...
        /* Op::368 */ {            Op::SHR, "shr", "shr", 0x8, "Shift Right",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::369 */ {            Op::SMOV, "smov", "smov", 0xa, "Scattered Move",
            ...
            OpSpec::Format::BASIC_BINARY_REG_IMM, {
                // W,UW,D,UD,HF,F <- W,UW,D,UD,HF,F
                {TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)|TYPE(Type::HF)|TYPE(Type::F),TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)|TYPE(Type::HF)|TYPE(Type::F)},
                // Q,UQ,DF <- W,UW,D,UD,HF,F
                {TYPE(Type::Q)|TYPE(Type::UQ)|TYPE(Type::DF),TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)|TYPE(Type::HF)|TYPE(Type::F)},
                // W,UW,D,UD,HF,F <- Q,UQ,DF
                {TYPE(Type::W)|TYPE(Type::UW)|TYPE(Type::D)|TYPE(Type::UD)|TYPE(Type::HF)|TYPE(Type::F),TYPE(Type::Q)|TYPE(Type::UQ)|TYPE(Type::DF)},
                // Q,UQ,DF <- Q,UQ,DF
                {TYPE(Type::Q)|TYPE(Type::UQ)|TYPE(Type::DF),TYPE(Type::Q)|TYPE(Type::UQ)|TYPE(Type::DF)}
            },
            OpSpec::Attr::SUPPORTS_PREDICATION,
            Op::INVALID /* groupOp */,
            Op::INVALID /* subopsStart */,
