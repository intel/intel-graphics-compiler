...
namespace iga {
    static const iga::OpSpec MODEL_GEN9_OPSPECS[static_cast<unsigned int>(Op::TOTAL_OPS) + 1] = {
        ...
        /* Op::323 */ {            Op::FRC, "frc", "frc", 0x43, "Fraction",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::324 */ {            Op::GOTO, "goto", "goto", 0x2e, "Goto",
        ...
        /* Op::328 */ {            Op::JMPI, "jmpi", "jmpi", 0x20, "Jump Indexed",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::329 */ {            Op::JOIN, "join", "join", 0x2f, "Join",
        ...
        /* Op::335 */ {            Op::MAD, "mad", "mad", 0x5b, "Multiply Add",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::336 */ {            Op::MADM, "madm", "madm", 0x5d, "Multiply Add for Macro",
        ...
        /* Op::342 */ {            Op::MATH_INV, "inv", "math.inv", 0x38, "INV",
            ...
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::343 */ {            Op::MATH_INVM, "invm", "math.invm", 0x38, "INVM",
        ...
        /* Op::348 */ {            Op::MATH_RSQT, "rsqt", "math.rsqt", 0x38, "RSQT",
            ...
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::349 */ {            Op::MATH_RSQTM, "rsqtm", "math.rsqtm", 0x38, "RSQTM",
        ...
        /* Op::384 */ {            Op::SENDS, "sends", "sends", 0x33, "Split Send Message",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::385 */ {            Op::SENDSC, "sendsc", "sendsc", 0x34, "Conditional Split Send Message",
        ...
        /* Op::400 */ {            Op::SHR, "shr", "shr", 0x8, "Shift Right",
            ...
            -1 /* functionControlValue = N/A */,
            {{nullptr,0,0},{nullptr,0,0}} /* functionControlFields */},
        /* Op::401 */ {            Op::SMOV, "smov", "smov", 0xa, "Scattered Move",
