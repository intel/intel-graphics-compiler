...
static const iga::OpSpec MODEL_XE2_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::BFI1 /* Op::8 */, Platform::XE2, 0x79,
    "bfi1",
    "Bit Field Insert 1",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::BFI2 /* Op::9 */, Platform::XE2, 0x7A,
    "bfi2",
    "Bit Field Insert 2",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::BFN /* Op::10 */, Platform::XE2, 0x6B,
    "bfn",
    "Boolean Function",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::BFREV /* Op::11 */, Platform::XE2, 0x77,
    "bfrev",
    "Bit Field Reverse",
  ...
  {Op::BRC /* Op::12 */, Platform::XE2, 0x23,
    "brc",
    "Branch Converging",
  ...
  {Op::BRD /* Op::13 */, Platform::XE2, 0x21,
    "brd",
    "Branch Diverging",
  ...
  {Op::BREAK /* Op::14 */, Platform::XE2, 0x28,
    "break",
    "Break",
  ...
  {Op::CALL /* Op::15 */, Platform::XE2, 0x2C,
    "call",
    "Call",
  ...
  {Op::CALLA /* Op::16 */, Platform::XE2, 0x2B,
    "calla",
    "Call Absolute",
    OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
    {}, // no type mappings
  ...
  {Op::CBIT /* Op::17 */, Platform::XE2, 0x4D,
    "cbit",
    "Count Bits Set",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::CMP /* Op::18 */, Platform::XE2, 0x70,
    "cmp",
    "Compare",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CMPN /* Op::19 */, Platform::XE2, 0x71,
    "cmpn",
    "Compare NaN",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CONT /* Op::20 */, Platform::XE2, 0x29,
    "cont",
    "Continue",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::CSEL /* Op::21 */, Platform::XE2, 0x72,
    "csel",
    "Conditional Select",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::DP4A /* Op::26 */, Platform::XE2, 0x58,
    "dp4a",
  ...
  {Op::DPAS /* Op::27 */, Platform::XE2, 0x59,
    "dpas",
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ELSE /* Op::30 */, Platform::XE2, 0x24,
    "else",
    "Else",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ENDIF /* Op::31 */, Platform::XE2, 0x25,
    "endif",
    "End If",
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::FBH /* Op::34 */, Platform::XE2, 0x4B,
    "fbh",
  ...
  {Op::FBL /* Op::35 */, Platform::XE2, 0x4C,
    "fbl",
  ...
  {Op::FRC /* Op::36 */, Platform::XE2, 0x43,
    "frc",
    "Fraction",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::GOTO /* Op::37 */, Platform::XE2, 0x2E,
    "goto",
    "Goto",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::HALT /* Op::38 */, Platform::XE2, 0x2A,
    "halt",
    "Halt",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ILLEGAL /* Op::40 */, Platform::XE2, 0x00,
    "illegal",
    "Illegal",
  ...
  {Op::JMPI /* Op::41 */, Platform::XE2, 0x20,
    "jmpi",
    "Jump Indexed",
    OpSpec::Format::JUMP_UNARY_REGIMM,
    {}, // no type mappings
  ...
  {Op::JOIN /* Op::42 */, Platform::XE2, 0x2F,
    "join",
    "Join",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::LZD /* Op::45 */, Platform::XE2, 0x4A,
    "lzd",
  ...
  {Op::MAC /* Op::46 */, Platform::XE2, 0x48,
    "mac",
    "Multiply Accumulate",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MACH /* Op::47 */, Platform::XE2, 0x49,
    "mach",
  ...
  {Op::MACL /* Op::48 */, Platform::XE2, 0x53,
    "macl",
  ...
  {Op::MAD /* Op::49 */, Platform::XE2, 0x5B,
    "mad",
    "Multiply Add",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::MADM /* Op::50 */, Platform::XE2, 0x5D,
    "madm",
  ...
  {Op::MATH /* Op::51 */, Platform::XE2, 0x38,
    "math",
  ...
  {Op::MOV /* Op::52 */, Platform::XE2, 0x61,
    "mov",
    "Move",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::MOVI /* Op::53 */, Platform::XE2, 0x63,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::MUL /* Op::54 */, Platform::XE2, 0x41,
    "mul",
    "Multiply",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::NOP /* Op::56 */, Platform::XE2, 0x60,
    "nop",
    "No Operation",
    OpSpec::Format::NULLARY,
    {}, // no type mappings
  ...
  {Op::NOT /* Op::57 */, Platform::XE2, 0x64,
    "not",
    "Logic Not",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::RET /* Op::60 */, Platform::XE2, 0x2D,
    "ret",
    "Return",
  ...
  {Op::RNDD /* Op::61 */, Platform::XE2, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::62 */, Platform::XE2, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::63 */, Platform::XE2, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::64 */, Platform::XE2, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::ROL /* Op::65 */, Platform::XE2, 0x6F,
    "rol",
    "Rotate Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::ROR /* Op::66 */, Platform::XE2, 0x6E,
    "ror",
    "Rotate Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SEL /* Op::70 */, Platform::XE2, 0x62,
    "sel",
    "Select",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SEND /* Op::71 */, Platform::XE2, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::72 */, Platform::XE2, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SHL /* Op::79 */, Platform::XE2, 0x69,
    "shl",
    "Shift Left",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SHR /* Op::80 */, Platform::XE2, 0x68,
    "shr",
    "Shift Right",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SRND /* Op::82 */, Platform::XE2, 0x54,
    "srnd",
    "StochasticRounding",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::SUBB /* Op::83 */, Platform::XE2, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::84 */, Platform::XE2, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE2, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::86 */, Platform::XE2, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::XOR /* Op::87 */, Platform::XE2, 0x67,
    "xor",
    "Logic Xor",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
