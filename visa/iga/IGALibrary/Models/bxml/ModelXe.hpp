...
static const iga::OpSpec MODEL_XE_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::BFI2 /* Op::10 */, Platform::XE, 0x7A,
    "bfi2",
    "Bit Field Insert 2",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::BFREV /* Op::12 */, Platform::XE, 0x77,
    "bfrev",
    "Bit Field Reverse",
  ...
  {Op::BREAK /* Op::15 */, Platform::XE, 0x28,
    "break",
    "Break",
  ...
  {Op::CALL /* Op::16 */, Platform::XE, 0x2C,
    "call",
    "Call",
  ...
  {Op::CALLA /* Op::17 */, Platform::XE, 0x2B,
    "calla",
    "Call Absolute",
    OpSpec::Format::JUMP_UNARY_CALL_REGIMM,
    {}, // no type mappings
  ...
  {Op::CBIT /* Op::18 */, Platform::XE, 0x4D,
    "cbit",
    "Count Bits Set",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::CMPN /* Op::20 */, Platform::XE, 0x71,
    "cmpn",
    "Compare NaN",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::CONT /* Op::21 */, Platform::XE, 0x29,
    "cont",
    "Continue",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::CSEL /* Op::22 */, Platform::XE, 0x72,
    "csel",
    "Conditional Select",
    OpSpec::Format::TERNARY_REGIMM_REG_REGIMM,
    {
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::DP4A /* Op::28 */, Platform::XE, 0x58,
    "dp4a",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::ELSE /* Op::32 */, Platform::XE, 0x24,
    "else",
    "Else",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ENDIF /* Op::33 */, Platform::XE, 0x25,
    "endif",
    "End If",
  ...
  {Op::MACH /* Op::50 */, Platform::XE, 0x49,
    "mach",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::MATH /* Op::54 */, Platform::XE, 0x38,
    "math",
  ...
  {Op::MOVI /* Op::56 */, Platform::XE, 0x63,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::RNDD /* Op::67 */, Platform::XE, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::68 */, Platform::XE, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::69 */, Platform::XE, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::70 */, Platform::XE, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::SEND /* Op::77 */, Platform::XE, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::78 */, Platform::XE, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::90 */, Platform::XE, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::91 */, Platform::XE, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::94 */, Platform::XE, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
