...
static const iga::OpSpec MODEL_XE_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::GOTO /* Op::37 */, Platform::XE, 0x2E,
    "goto",
    "Goto",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::HALT /* Op::38 */, Platform::XE, 0x2A,
    "halt",
    "Halt",
    OpSpec::Format::JUMP_BINARY_IMM_IMM,
    {}, // no type mappings
  ...
  {Op::ILLEGAL /* Op::40 */, Platform::XE, 0x00,
    "illegal",
    "Illegal",
  ...
  {Op::JMPI /* Op::41 */, Platform::XE, 0x20,
    "jmpi",
    "Jump Indexed",
    OpSpec::Format::JUMP_UNARY_REGIMM,
    {}, // no type mappings
  ...
  {Op::JOIN /* Op::42 */, Platform::XE, 0x2F,
    "join",
    "Join",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
  ...
  {Op::MACH /* Op::47 */, Platform::XE, 0x49,
    "mach",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::MATH /* Op::51 */, Platform::XE, 0x38,
    "math",
  ...
  {Op::MOVI /* Op::53 */, Platform::XE, 0x63,
    "movi",
    "Move Indexed",
    OpSpec::Format::BASIC_BINARY_REG_REGIMM,
    {
  ...
  {Op::RNDD /* Op::61 */, Platform::XE, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::62 */, Platform::XE, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::63 */, Platform::XE, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::64 */, Platform::XE, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::SEND /* Op::71 */, Platform::XE, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::72 */, Platform::XE, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::83 */, Platform::XE, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::84 */, Platform::XE, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::86 */, Platform::XE, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
