...
static const iga::OpSpec MODEL_XE_OPSPECS[unsigned(Op::TOTAL_OPS) + 1] {
  ...
  {Op::RNDD /* Op::60 */, Platform::XE, 0x45,
    "rndd",
    "Round Down",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDE /* Op::61 */, Platform::XE, 0x46,
    "rnde",
  ...
  {Op::RNDU /* Op::62 */, Platform::XE, 0x44,
    "rndu",
    "Round Up",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::RNDZ /* Op::63 */, Platform::XE, 0x47,
    "rndz",
    "Round to Zero",
    OpSpec::Format::BASIC_UNARY_REGIMM,
    {
  ...
  {Op::SEND /* Op::70 */, Platform::XE, 0x31,
    "send",
    "Send Message",
  ...
  {Op::SENDC /* Op::71 */, Platform::XE, 0x32,
    "sendc",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::SUBB /* Op::80 */, Platform::XE, 0x4F,
    "subb",
  ...
  {Op::SYNC /* Op::81 */, Platform::XE, 0x01,
    "sync",
    "Synchronize",
  ...
  {Op::INVALID, Platform::XE, 0x0, nullptr, nullptr, OpSpec::Format::INVALID, {}, OpSpec::Attr::NONE, },
  {Op::WHILE /* Op::83 */, Platform::XE, 0x27,
    "while",
    "While",
    OpSpec::Format::JUMP_UNARY_IMM,
    {}, // no type mappings
