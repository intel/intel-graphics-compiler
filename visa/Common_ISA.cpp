...
const char *channel_mask_slm_str[CHANNEL_MASK_NUM] = {
    "RGBA", "GBA", "RBA", "BA", "RGA", "GA", "RA", "A",
    "RGB",  "GB",  "RB",  "B",  "RG",  "G",  "R",  "0000"};
...
const char *pixel_size_str[2] = {"VA_Y16_FORMAT", "VA_Y8_FORMAT"};

const char *lbp_creation_mode[3] = {"VA_5x5_mode", "VA_3x3_mode",
                                    "VA_BOTH_mode"};
...
const char *mmf_exec_mode[4] = {"VA_MMF_16x4", "VA_MMF_INVALID", "VA_MMF_16x1",
                                "VA_MMF_1x1"};

const char *mmf_enable_mode[3] = {"VA_MINMAX_ENABLE", "VA_MAX_ENABLE",
                                  "VA_MIN_ENABLE"};

const char *ed_exec_mode[4] = {"VA_ED_64x4", "VA_ED_32x4", "VA_ED_64x1",
                               "VA_ED_32x1"};

const char *conv_exec_mode[4] = {"VA_CONV_16x4", "VA_CONV_INVALID",
                                 "VA_CONV_16x1", "VA_CONV_1x1"};
...
unsigned output_format_control_size[4] = {16, 16, 8, 8};
...
int processCommonISAHeader(common_isa_header &cisaHdr, unsigned &byte_pos,
                           const void *cisaBuffer, vISA::Mem_Manager *mem) {
