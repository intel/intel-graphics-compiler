...
DEF_VISA_OPTION(vISA_Partitioning,          ET_BOOL, "-enablePartitioning", UNUSED, false)
...
DEF_VISA_OPTION(vISA_preRA_ScheduleIterative, ET_BOOL, "-presched-iterative", UNUSED, true)
