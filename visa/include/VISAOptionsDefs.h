...
DEF_VISA_OPTION(vISA_emitMoreMoviCases, ET_BOOL, "-emitMoreMoviCases",
                "Enable promoting to movi for the case that offsets (to base address) are in register",
                false)
DEF_VISA_OPTION(
...
DEF_VISA_OPTION(vISA_allowXe3ScalarRR, ET_BOOL, "-allowXe3ScalarRR", UNUSED, false)
