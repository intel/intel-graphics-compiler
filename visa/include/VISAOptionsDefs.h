...
DEF_VISA_OPTION(vISA_DumpUseInternalName,   ET_BOOL, "-dumpUseInternalName", "Apply to .g4/.dot dump file names only", false)
...
DEF_VISA_OPTION(vISA_EnableRRAccSub,        ET_BOOL,  "-roundRobinAccSub",      UNUSED, false)
...
DEF_VISA_OPTION(vISA_ShaderDataBaseStatsFilePath, ET_CSTR, "-sdbStatsFile", UNUSED, NULL)
