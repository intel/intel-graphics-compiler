            ...
            for (int i = 0, nsrc = (int)Inst->getNumSrc(); i < nsrc; ++i)
            {
                ...
                if (S->getType() == Type_BF)
                {
                        ...
                        || (i == (nsrc - 1) && !useGivenType(Inst, Type_F)))     // pure BF.
                    {
                        ...
                        G4_Declare* newDcl = builder.createTempVar(1, Type_UD, Even_Word, "cvtF", false);
                        ...
                        G4_INST* shlInst = builder.createBinOp(G4_shl,
                            g4::SIMD1, newDst, S, builder.createImm(16, Type_UD), InstOpt_WriteEnable, false);
                        ...
                        G4_SrcRegRegion* newSrc = builder.createSrc(
                            newDcl->getRegVar(), 0, 0, builder.getRegionScalar(), Type_F);
