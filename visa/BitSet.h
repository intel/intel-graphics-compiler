...
public:
    ...
    public:
        ...
        SparseBitSetIterator(const SparseBitSet *B, bool End = false) : Set(B) {
            ...
            if (!End && !isAtEnd()) {
                ...
                MUST_BE_TRUE(Bit < NUM_BITS_PER_ELT, "Bit position is beyond the word!");
            }
        }
    ...
    public:
        ...
        unsigned operator*() const {
            ...
            return ((LI->first & RI->first) * SegmentBitSize) + (Elt * NUM_BITS_PER_ELT) + Bit;
        }
    ...
    and_iterator and_begin(const SparseBitSet &Other) const { return and_iterator(this, &Other); }
    and_iterator and_end(const SparseBitSet &Other) const { return and_iterator(this, &Other, true); }
};
